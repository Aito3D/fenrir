#!/usr/bin/env python3
"""Seed Fenrir with a quick visual set of filament effect spools.

Usage:
    python scripts/fill_spool_effects.py --fenrir-url http://localhost:8000
    python scripts/fill_spool_effects.py --fenrir-url http://localhost:8000 --api-key YOUR_KEY
...
def create_bulk_spools(
    ...
    url = f"{fenrir_url.rstrip('/')}{API_PATH_BULK_CREATE}"
