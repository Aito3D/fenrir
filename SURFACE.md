...
CREATE TABLE calculator_defaults (
	...
	margin_min_mult FLOAT NOT NULL, 
	margin_max_mult FLOAT NOT NULL, 
	margin_k FLOAT NOT NULL, 
	qty_min_factor FLOAT NOT NULL, 
	qty_k FLOAT NOT NULL, 
	min_task_price FLOAT NOT NULL, 
...
```regen: grep -hoE "^export (const|function|type|interface|class|enum) [A-Za-z0-9_]+" frontend/src/utils/calculatorInsights.ts frontend/src/utils/quoteSummary.ts frontend/src/utils/pricing.ts frontend/src/hooks/useCalculatorState.ts frontend/src/hooks/useSettledValue.ts | sort```
```
...
1 export function CalculatorQuantityCurve
1 export function CalculatorQuotePage
1 export function CalculatorRealityCheckCard
1 export function CalculatorSettingsPanel
...
1 export function curveWarnings
1 export function DragHandle
1 export function FormulaPopover
1 export function MarginCurvePreview
1 export function Money
1 export function NoMatches
1 export function parsedExample
1 export function PrinterComparisonChips
1 export function qtyDomainMax
1 export function roundK
1 export function roundKQ
1 export function SearchBox
1 export function SegmentLegend
1 export function sizeDomainMax
...
1 export type CurveWarning
1 export type CurveWarningKey
