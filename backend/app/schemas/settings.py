...
class AppSettings(BaseModel):
    ...
    dark_accent: str = Field(
        default="green", description="Dark mode accent: green, teal, blue, cyan, orange, purple, red"
    )
    ...
    light_accent: str = Field(
        default="green", description="Light mode accent: green, teal, blue, cyan, orange, purple, red"
    )
