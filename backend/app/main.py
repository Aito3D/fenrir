        ...
        async with async_session() as db:
            ...
            for assignment in assignments:
                ...
                if not current_tray:
                    ...
                    # a firmware "empty" from Fenrir's own: apply_tray_exist_bits
...
PUBLIC_API_PATTERNS = [
    ...
    # Project covers take a ?token= media credential since #3025. Listed on its
    # own because the matcher above requires a segment boundary after the
    # pattern, so "/cover" does not cover "/cover-image".
    "/cover-image",  # /projects/{id}/cover-image
