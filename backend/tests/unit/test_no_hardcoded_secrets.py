...
``fenrir-secret-key-change-in-production`` string used as the JWT
...
could forge admin tokens for any Fenrir instance running unmodified.
...
FORBIDDEN_PATTERNS: tuple[str, ...] = (
    ...
    "fenrir-secret-key-change-in-production",
)
