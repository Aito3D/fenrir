...
# (require_any_permission_if_auth_enabled(AITO_CREATE, AITO_UPDATE)) — 21 in
...
assert len(WRITE_ROUTES) == 21, "WRITE_ROUTES must cover exactly the 21 gated write routes aito.py declares"
