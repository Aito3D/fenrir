...
class TestBuildCameraUrl:
    ...
    def test_special_chars_in_access_code_are_encoded(self):
        from backend.app.services.camera import build_camera_url

        url = build_camera_url("192.168.1.10", "pass:word#1@x", "X1C")
        assert url == "rtsps://bblp:pass%3Aword%231%40x@192.168.1.10:322/streaming/live/1"
