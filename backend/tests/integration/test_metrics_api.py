...
class TestMetricsAPI:
    ...
    async def test_metrics_contains_expected_metrics(self, async_client: AsyncClient):
        ...
        assert "fenrir_printers_connected" in content
        assert "fenrir_printers_total" in content
        assert "fenrir_prints_total" in content
        assert "fenrir_filament_used_grams" in content
        assert "fenrir_print_time_seconds" in content
        assert "fenrir_queue_pending" in content
