export default {
  ...
  aito: {
    ...
    descriptionPlaceholder: '設計・印刷する製品を説明してください…',
    create: 'プロジェクトを作成',
    created: '作成日 {{date}}',
    updated: '更新日 {{date}}',
    ...
    sendInvoice: '請求書を送信',
    sendInvoiceTitle: '請求書をメールで送信',
    sendInvoiceRecipient: '宛先',
    sendInvoiceSubject: '件名',
    sendInvoiceMessage: 'メッセージのプレビュー',
    ...
    createInvoiceTitle: '請求書の作成',
    createInvoiceIntro_one: '見積 {{quote}}、{{count}} 行。Zoho Books に請求書の下書きを作成します（メールは送信されません）。',
    createInvoiceIntro_other: '見積 {{quote}}、{{count}} 行。Zoho Books に請求書の下書きを作成します（メールは送信されません）。',
    createInvoiceAmount: '請求金額',
    createInvoiceRemaining: '未払い残高',
    createInvoiceLockWarning: '請求後、この見積は Fenrir からの明細変更を受け付けなくなります。',
    createInvoiceConfirm: '作成',
    createInvoiceLoadFailed: '請求書を準備できませんでした',
    createInvoiceDone: '請求書 {{number}} を作成しました',
    createInvoiceDonePaid: '請求書 {{number}} を作成し、前受金で充当しました',
    createInvoiceDonePartial: '請求書 {{number}} を作成しました — {{retainers}} は充当できませんでした',
    createInvoiceFailed: '請求書を作成できませんでした',
    acceptQuote: '見積書を承認',
    declineQuote: '見積書を却下',
    holdToConfirm: '0.5秒長押しで確定',
    quoteSent: '見積書を送信済みにしました',
    quoteAccepted: '見積書を承認しました',
    quoteDeclined: '見積書を却下しました',
    quoteUnaccepted: '承認を取り消しました — 見積もりは待機中に戻りました',
    unacceptLabel: '承認を取り消す',
    unacceptHint: '1秒間長押しで承認を取り消します',
    quoteConflictAccepted: 'この見積もりは既に他の担当者によって承認されています。',
    quoteConflictDeclined: 'この見積もりは既に他の担当者によって却下されています。',
    zohoNotUpdated: 'ローカルに保存されました — Zohoは更新されていません',
    progressLabel: '{{total}} 件中 {{done}} 件のステップが完了',
    trash: 'ゴミ箱',
    trashEmpty: 'ゴミ箱は空です',
    restore: '復元',
    restored: 'プロジェクトを復元しました',
    restoreFailed: 'プロジェクトを復元できませんでした。',
    deletedOn: '{{date}}に削除',
    ...
    markUrgent: '緊急にする',
    clearUrgent: '緊急を解除',
    holdToMarkUrgent: '0.5秒長押しで緊急にする',
    holdToClearUrgent: '0.5秒長押しで緊急を解除',
    sav: '返品対応',
    markSav: '返品対応にする',
    clearSav: '返品対応を解除',
    holdToMarkSav: '0.5秒長押しで返品対応にする',
    holdToClearSav: '0.5秒長押しで返品対応を解除',
    pause: '一時停止',
    markPause: '一時停止にする',
    clearPause: '一時停止を解除',
    holdToMarkPause: '0.5秒長押しで一時停止にする',
    holdToClearPause: '0.5秒長押しで一時停止を解除',
    markFlag: 'マーク',
    flagFailed: 'マークを変更できませんでした',
    dueDate: '約束日',
    dueDateClear: '日付をクリア',
    dueDateEmpty: '日付を設定',
    dueLateDays: '{{count}}日遅れ',
    dueBadge: '期限 {{date}}',
    dueDateFailed: '日付を変更できませんでした',
    datePickerPrev: '前の月',
    datePickerNext: '次の月',
    datePickerBackToSelected: '選択した月に戻る',
    datePickerPlusTwoDays: '+2日',
    datePickerPlusOneWeek: '+1週間',
    datePickerPlusTwoWeeks: '+2週間',
    datePickerSuggested: '候補',
    awaitingContact: '連絡待ち',
    markContacted: '顧客に連絡済みとして記録',
    holdToMarkContacted: '0.5秒長押しで顧客への連絡を確定',
    contacted: '連絡済み',
    clearContacted: '連絡済みを取り消す',
    holdToClearContacted: '0.5秒長押しで連絡済みを取り消す',
    contactedFailed: '連絡を記録できませんでした',
    smsPickupShort: 'SMS',
    smsPickup: '受け取りSMSを送信',
    smsTitle: '受け取りSMS',
    smsMessageLabel: 'メッセージ',
    smsGenerating: 'メッセージを作成中…',
    smsGenerateFailed: 'メッセージを作成できませんでした',
    smsRegenerate: '再生成',
    smsSend: '電話に送信',
    ...
    zohoNotConfigured: 'Zoho Books がまだ接続されていません。',
    zohoConfigureLink: 'Zoho Books を接続',
    zohoUnreachable: 'Zoho Books に接続できませんでした。もう一度お試しください。',
    resetToDefaultClient: 'デフォルトの取引先にリセット',
    clientPhone: '電話番号',
    clientEmail: 'メールアドレス',
    countryCode: '国番号',
    phonePlaceholder: '87123456',
    emailPlaceholder: 'client@example.com',
    revertPhone: '電話番号を元に戻す',
    revertEmail: 'メールアドレスを元に戻す',
    socialNetworkMessenger: 'Messenger',
    socialNetworkInstagram: 'Instagram',
    socialNetworkWhatsapp: 'WhatsApp',
    socialNetworkTiktok: 'TikTok',
    socialLabel: 'SNS（任意）',
    socialHandleLabel: 'ユーザー名',
    socialHandlePlaceholder: 'username',
    socialRemove: 'SNSを削除',
    contactsLabel: '連絡先',
    contactsHint: 'このプロジェクトは誰向けですか?',
    contactsLoading: 'Zoho Booksから連絡先を読み込み中…',
    contactsUnavailable: 'Zoho Booksから連絡先を読み込めませんでした — 以下に電話番号かメールアドレスを入力してください。',
    contactPrimary: '主担当',
    contactAdd: '連絡先を追加',
    contactAddTitle: '新しい連絡先',
    contactSaveToZoho: 'Zohoに保存',
    contactFirstNameRequired: '名を入力してください。',
    contactNeedsPhoneOrEmail: '連絡するには電話番号かメールアドレスが必要です。',
    contactAddFailed: '連絡先を追加できませんでした。もう一度お試しください。',
    contactOverrideToggle: 'このカードだけ別の電話番号 / メールアドレスを使う',
    contactOverrideHint: 'このカードだけに適用されます — Zoho Books側の連絡先は変更されません。',
    contactGone: 'この連絡先はZoho Booksに存在しません — 別の連絡先を選んでください。',
    clientEditFanOutPerson: 'この連絡先の開いている全カードに適用',
    clientEditTitle: '連絡先',
    clientEditSourceZoho: 'Zoho Books',
    clientEditSourceCard: 'このカードのみ',
    clientEditFanOut: 'この顧客の開いている全カードに適用',
    ...
    clientHistoryNoQuote: '見積なし',
    clientHistoryThisCard: 'このカード · {{stage}}',
    clientHistoryDeclined: '辞退',
    clientHistoryOpenCard: 'プロジェクト #{{id}} を開く',
    clientHistoryEmpty: 'この顧客のプロジェクトはまだありません。',
    clientHistoryError: '顧客の履歴を読み込めませんでした。',
    clientEditLoading: 'Zoho Books から連絡先を読み込み中…',
    clientEditWalkIn: '一見客：変更はこのカードにのみ保存され、Zoho Books には送信されません。',
    clientEditZohoReadFailed: 'Zoho Books から連絡先を読み込めませんでした — カードの値を表示しています。',
    clientEditFailed: '顧客を更新できませんでした。もう一度お試しください。',
    createClient: '新規取引先を作成',
    companyName: '会社名',
    firstName: '名',
    lastName: '姓',
    createClientSubmit: '取引先を作成',
    back: '戻る',
    clientNameRequired: '会社名、または姓と名の両方を入力してください。',
    newClientPersonHint: 'または担当者の姓名',
    newClientContactTag: '会社の担当者',
    newClientContactHint: '推奨 — 名だけでも可',
    newClientPreviewCompany: '会社：{{name}} · 担当者：{{person}}',
    newClientPreviewCompanyAlone: '会社：{{name}} · 担当者は未設定',
    newClientPreviewIndividual: '個人：{{name}}',
    clientCreateFailed: '取引先を作成できませんでした。もう一度お試しください。',
    clientSyncFailed: 'プロジェクトを作成しました — Zoho側の取引先を更新できませんでした。',
    ...
    recordLabel: '記録',
    duplicateProject: "複製",
    duplicateReplaceTitle: "作成中の下書きを置き換えますか？",
    duplicateReplaceBody: "新規プロジェクトのパネルには、まだ作成されていない作業が残っています。このカードを複製すると置き換えられます。",
    duplicateReplaceConfirm: "置き換える",
    ...
    editConflict: '他の担当者がこのプロジェクトを編集しました。ボードを更新しました。もう一度お試しください。',
    tasks: 'タスク',
    addTask: 'タスクを追加',
    taskFallbackName: 'タスク {{n}}',
    track: {
      pageTitle: '注文の追跡 · Aito 3D',
      title: 'ご注文の追跡',
      reference: '見積 No. {{ref}}',
      stepOf: 'ステップ {{n}} / {{total}}',
      stepsAria: 'ステップ',
      ...
      stepsList: 'ステップの詳細',
      tasksHeading: 'お客様の部品',
      showAllParts: '{{n}} 点すべてを見る',
      eta: '受け取り予定',
      etaSoon: 'できるだけ早く日程をお知らせします。',
      etaUpdating: '予定を更新中',
      updated: '更新 {{when}}',
      updatedToday: '本日 {{time}}',
      updatedYesterday: '昨日 {{time}}',
      updatedOn: '{{date}} {{time}}',
      error: '現在、追跡情報を読み込めません。',
      retry: '再試行',
      invalidTitle: 'この追跡リンクは無効になりました',
      invalidBody: '期限切れか、新しいリンクに置き換えられた可能性があります。ご連絡いただければ新しいリンクをお送りします。',
      footerQuestion: 'ご注文についてご質問がありますか？',
      enterTitle: '注文を追跡',
      enterHint: '見積書またはメッセージに記載された6文字のコードを入力してください。',
      codeLabel: '追跡コード',
      codeChecking: '確認中…',
      retrying: '再試行中…',
      codeFound: 'コードを確認しました。追跡ページを開きます。',
      codeNotFound: 'コードが見つかりません。確認してもう一度お試しください。',
      codeTooMany: '試行回数が多すぎます。1分ほどお待ちください。',
      codeError: '現在コードを確認できません。Enterキーで再試行してください。',
      ...
      paymentMethods: {
        ...
        beneficiary: '受取人',
        bank: '銀行',
        transferReference: '振込の備考',
        referenceUnknown: 'お見積番号',
        transferDelay: '振込の着金には1〜2日かかることがあります。',
        appTag: '{{app}} タグ',
        appMessage: 'メッセージ',
        appHint: '{{app}} アプリから、見積金額をこのタグへ送金してください。',
        shop: '店頭',
        shopSub: 'カード、現金、または小切手。',
        shopAddress: '住所',
      ...
      status: {
        ...
        pickedUpTitle: '受取済み',
        pickedUpSub: '{{date}}。ご利用ありがとうございました！',
        doneTitle: '完了',
        doneSub: 'ご利用ありがとうございました！',
      },
      invoice: {
        paidTitle: '請求書 支払済み',
        paidSub: 'ご利用ありがとうございました。',
        unpaidTitle: '請求書 未払い',
        unpaidSub: 'お受け取りまたは発送前にお支払いください。',
        overdueTitle: '請求書 期限超過',
        overdueSub: 'すでにお支払い済みの場合はご連絡ください。',
      },
      payment: {
        unpaidTitle: 'お支払いがまだのプロジェクト',
        unpaidSub: 'オンライン、銀行振込、または店頭でお支払いいただけます。',
        unpaidDepositSub: '着手金のお支払いでご注文が確定します。オンライン、銀行振込、または店頭でお支払いください。',
        validateTitle: '見積をご承認ください',
        validateSub: 'オンライン決済は見積の承認とみなされます。',
        validateDepositSub: '着手金のお支払いで見積が承認され、製作が始まります。',
        pay: 'オンラインで支払う',
        paidTitle: 'お支払いを受領しました',
        depositPaidTitle: '着手金を受領しました',
        paidSub: 'ご利用ありがとうございました。',
      },
    },
    trackingCopy: '追跡リンクをコピー',
    trackingOpen: '追跡リンクを開く',
    ...
    paymentLink: {
      ...
      open: '決済リンクを開く',
      copied: 'コピーしました',
      expiresIn_one: '{{count}} 日後に期限切れ',
      expiresIn_other: '{{count}} 日後に期限切れ',
      expiresToday: '本日期限切れ',
      retry: '再試行',
      state: { expired: '期限切れ', cancelled: 'キャンセル済み', failed: '拒否されました' },
    },
    payment: {
      dueQuote: '着手金未払い',
      dueInvoice: '未払い残高',
      ...
      cellManual: '手動',
      cellLinkTitle: '決済リンク',
      cellTerminalTitle: '決済端末でカード払い',
      cellManualTitle: '手動：支払いを記録',
      terminalOff: 'Heimdall が設定されていません',
      stateProcessing: '端末 · カード待ち',
      stateAttention: '結果不明 · 端末を確認してください',
      statePaid: '{{amount}} を支払済み · {{channel}} · {{date}}',
      statePaidNoDate: '{{amount}} を支払済み · {{channel}}',
      stateBookingFailed: 'Zoho Books に未記録 — Heimdall を確認してください',
      stateNoLink: 'リンクなし',
      channelTerminal: '端末',
      channelLink: 'オンライン',
      amountLabel: '金額',
      manualTitle: '支払いを記録',
      manualIntroQuote: '見積 {{number}} · 店頭で着手金を受領',
      manualIntroInvoice: '請求書 {{number}} · 店頭で支払いを受領',
      modeLabel: '方法',
      modeCard: 'カード',
      modeCheque: '小切手',
      modeCash: '現金',
      referenceLabel: '参照番号',
      referenceRequired: '小切手には番号が必要です',
      manualHintQuote: 'Zoho Books の見積に着手金請求書を作成し、支払いを記録します。',
      manualHintInvoice: 'Zoho Books の請求書に支払いを記録します。',
      manualConfirm: '記録する',
      manualDone: '支払いを記録しました',
      amountInvalid: 'ゼロより大きい整数の金額を入力してください',
      terminalTitle: 'カードで支払う',
      terminalIntro: '{{number}} · 店頭の決済端末で',
      terminalHintQuote: '着手金の金額を入力済みです。見積では任意の金額を受け付けます。',
      terminalHintInvoice: '残高を入力済みです。Heimdall は残高を上限とします。',
      terminalStart: '端末を開始',
      terminalWaiting: '端末でカードをお待ちしています…',
      terminalWaitingHint: '暗証番号の入力まで最大3分かかります。',
      terminalLeave: '閉じる（あとで戻ります）',
      terminalPaid: '支払いが承認されました',
      terminalBookingPending: 'Zoho Books に記録中…',
      terminalBookingDone: 'Zoho Books に記録しました',
      terminalBookingFailed: 'Zoho Books に未記録 — Heimdall を確認してください',
      terminalFailed: '拒否されました',
      terminalFailedHint: '請求は発生していません。もう一度お試しください。',
      terminalRetry: 'もう一度試す',
      terminalAttention: '結果不明',
      terminalAttentionHint: '端末から応答がありませんでした。再試行の前に紙のレシートを確認してください。',
      linkTitle: '決済リンク',
      linkCreate: 'リンクを作成',
      linkCreateAgain: '新しいリンクを作成',
      linkCancel: 'リンクをキャンセル',
      linkCancelConfirm: 'このリンクをキャンセルしますか？',
      linkExpires: '期限',
      linkHintInvoice: '残高を入力済みです。リンクは見積の有効期限後に失効します。',
      linkPending: 'リンクを作成しています…',
      linkDone: '決済リンクを作成しました',
      linkCancelled: '決済リンクをキャンセルしました',
    },
    pastCards_one: '過去のカード {{count}} 件',
    pastCards_other: '過去のカード {{count}} 件',
    reuseTasks: '再利用',
    rating: {
      good: '良好',
      medium: '普通',
      ...
      pastDue_one: '{{count}} 件が期日超過',
      pastDue_other: '{{count}} 件が期日超過',
    ...
    removeTask: 'タスクを削除',
    serviceScan3D: 'スキャン',
    serviceModelisation3D: 'モデリング',
    serviceImpression3D: 'プリント',
    serviceUsinage: '機械加工',
    serviceMainDoeuvre: '作業工数',
    serviceDescriptionRequired: '説明（必須）',
    maindoeuvreDescriptionRequired: '作業工数には説明が必要です',
    serviceCost: 'コスト',
    serviceUnitCost: '単価',
    discount: '割引',
    serviceTotal: '明細合計',
    ...
    importQuote: 'インポート',
    importTitle: '見積もりをインポート',
    quoteSearchLabel: '見積もり',
    quoteNumberLabel: '番号',
    ...
    quoteNoServiceLines: 'この見積もりには AITO 3D のサービス明細がありません。',
    quoteAlreadyImported: 'プロジェクト #{{id}} としてインポート済み',
    quoteImport: 'インポート',
    quoteSkipped: 'インポート対象外',
    quoteTotals: 'プロジェクト {{project}} · 見積もり {{quote}}',
    quoteCurrencyMismatch: 'この見積もりの通貨は {{code}} ですが、ボードの表示は {{configured}} です。',
    quoteOpenInZoho: 'Zoho Books で開く',
    changeQuote: '変更',
    quoteRowImported: 'インポート済み → #{{id}}',
    beforeImport: 'インポート前の確認',
    ruleQuoteLines: '見積もりに AITO のサービス明細がある',
    ruleQuoteFresh: '未インポート',
    ruleCurrencyOk: '通貨がボードと一致',
    ruleImportDescription: '説明が入力済み',
    importTaskCount_one: 'タスク{{count}}件',
    importTaskCount_other: 'タスク{{count}}件',
    printer: 'プリンター',
    material: '素材',
    weightG: '重量 (g)',
    printTime: '印刷時間',
    ...
    retrySync: '再試行',
    syncBlockedLabel: '同期がブロックされています',
    forceSync: '強制的に同期',
    forceSyncHint: 'Zoho の見積書を再確認して費用を再送信します',
    showDone: '完了を表示',
    backToBoard: 'ボードに戻る',
    statistics: '統計',
    stats: {
      ...
      ageDays: '{{range}} 日',
      winRate: '金額帯別の成約率',
      winRateEmpty: '決定済みの見積がまだ足りません',
      decisions: '{{count}} 件決定',
      stageTime: '完了プロジェクトごとの所要時間',
      reworkMoves: '後退した移動',
      reworkShare: '{{cards}} 件 · 移動したカードの {{pct}}%',
      overdue: '期限超過の請求書',
      overdueOldest: '最も古いもの {{days}} 日',
      nothingOverdue: '期限超過なし',
      serviceMix: 'サービス構成',
      serviceTasks: '{{count}} 件のタスク',
      clientsNew: '新規顧客',
      clientsReturning: 'リピーター',
      returningShare: '売上の {{pct}}% がリピーターから',
      arrivals: '依頼が届く時間帯',
      islands: '島別の発送',
      pickup: '店頭受取',
      declined: '辞退',
      acceptanceRate: '{{pct}}% 承認',
      ...
      strip: {
        onBoard: 'ボード上 {{amount}}',
        longest: '最も長く待っているのは <who>{{name}}、{{days}}</who>（{{stage}}）',
        oldest: '最長 {{days}} 日',
        noQuote: '見積はまだなし',
        dueSoon_one: '今週の納品 {{count}} 件',
        dueSoon_other: '今週の納品 {{count}} 件',
      },
      facts: {
        perDay: '1日 {{count}} 件',
        waiting15: '15日以上待ち',
        lostWith: '辞退された見積による失注額',
        shippingBilled: '請求した送料',
        parcels_one: '荷物 {{count}} 個',
        parcels_other: '荷物 {{count}} 個',
        invoices_one: '請求書 {{count}} 件',
        invoices_other: '請求書 {{count}} 件',
        cards_one: 'カード {{count}} 件',
        cards_other: 'カード {{count}} 件',
        today: '本日',
      },
      finding: {
        overview: '{{in}}、{{accepted}}、{{done}}。',
        overviewIn_one: '{{count}} 件の案件が届き',
        overviewIn_other: '{{count}} 件の案件が届き',
        overviewAccepted_one: '{{count}} 件が承認され',
        overviewAccepted_other: '{{count}} 件が承認され',
        overviewDone_one: '{{count}} 件が納品されました',
        overviewDone_other: '{{count}} 件が納品されました',
        overviewPeakWeek: '最も忙しかったのは {{date}} の週でした。',
        overviewPeakDay: '最も忙しかった日は {{date}} でした。',
        salesWin: '見積の {{pct}} % が成約しています。',
        salesLost_one: '{{count}} 件の見積を失注、{{total}} 分です。',
        salesLost_other: '{{count}} 件の見積を失注、合計 {{total}} 分です。',
        salesLostBig: '失注しているのは大口案件です: {{min}} 超の {{decided}} 件のうち {{lost}} 件、合計 {{total}}。',
        salesNone: 'この期間に決定した見積はありません。',
        timeLead: '案件1件あたり、見積から納品まで {{days}} かかります。',
        timeSlow: '一番時間がかかる段階は {{stage}} で、{{days}} です。',
        timeRework_one: '{{count}} 回の移動が後退しました。',
        timeRework_other: '{{cards}}で {{count}} 回の移動が後退しました。',
        timeNone: 'この期間に納品した案件はありません。',
        moneyTotals: '承認 {{accepted}}、請求済み {{invoiced}}。',
        moneyOut: '{{invoices}}で {{amount}} が未回収です。',
        moneyOverdue_one: 'そのうち {{count}} 件が {{days}} 日期限超過です。',
        moneyOverdue_other: 'そのうち {{count}} 件が期限超過で、最長 {{days}} 日です。',
        moneyClear: '未回収はありません。',
        clients: '{{new}}、{{returning}}。',
        clientsNew_one: '新規顧客 {{count}} 名',
        clientsNew_other: '新規顧客 {{count}} 名',
        clientsReturning_one: 'リピーター {{count}} 名',
        clientsReturning_other: 'リピーター {{count}} 名',
        clientsPeak: '依頼は {{day}} の {{hour}} 頃に届きます。',
        clientsParcels_one: '{{count}} 個の荷物が離島へ発送されました。',
        clientsParcels_other: '{{count}} 個の荷物が離島へ発送されました。',
        clientsNone: 'この期間に新規顧客はいません。',
      },
      brief: {
        chase_one: '催促する見積 {{count}} 件',
        chase_other: '催促する見積 {{count}} 件',
        tell_one: '連絡する顧客 {{count}} 名',
        tell_other: '連絡する顧客 {{count}} 名',
        collect: '回収する {{amount}}',
        allClear: '催促も連絡も回収も、今日はありません。',
        due_one: '今週の納品は {{count}} 件です。',
        due_other: '今週の納品は {{count}} 件です。',
        chaseHeading: '催促',
        tellHeading: '連絡',
        collectHeading: '回収',
        ready: '受取可能',
    ...
    history: {
      ...
      automatic: '自動',
      fromZoho: 'Zoho Booksより',
      projectCreated: 'プロジェクトを作成しました',
      quoteCreated: '見積もりが作成されました',
      quoteSent: '見積もりを送付済みにしました',
      ...
      quoteUnaccepted: '見積もりの承認を取り消しました',
      quoteDeclined: '見積もりを却下しました',
      quoteExpired: '見積もりの有効期限が切れました',
      stageChanged: 'プロジェクトを移動しました',
      projectTrashed: 'プロジェクトをごみ箱に移動しました',
      ...
      projectUrgentSet: '緊急に設定',
      projectUrgentCleared: '緊急を解除',
      projectSavSet: '返品対応に設定',
      projectSavCleared: '返品対応を解除',
      projectPauseSet: '一時停止に設定',
      ...
      paymentTerminalStarted: '決済端末でカード払いを開始しました',
      paymentTerminalPaid: '決済端末でカード払いが完了しました',
      paymentTerminalFailed: '端末での支払いが拒否またはキャンセルされました',
      paymentTerminalAttention: '端末の結果が不明です — 端末を確認してください',
      paymentManualRecorded: '支払いを記録しました',
      paymentManualPartial: '着手金請求書を作成しましたが、支払いは未記録です — Zoho Books で完了させてください',
      noteAdded: 'メモを追加しました',
      zohoComment: 'Zoho Booksでのコメント',
      syncQueued: 'Zohoへの送信待ち',
      syncPushed: 'Zohoに送信済み',
      syncFailed: 'Zohoへの送信に失敗しました',
      syncLocked: 'Zohoで見積もりがロックされています',
      syncConflict: 'Zohoとのステータスの競合',
      syncStatusRejected: 'Zohoがステータス変更を拒否しました',
      pollReconciled: 'Zohoと照合済み',
    },
    // New-project drawer
    workSection: '作業内容',
    clientSectionTitle: '顧客',
    workHintNone: 'タスクなし',
    workHintProgress: '{{total}}件中{{done}}件完了',
    addService: '{{service}}を追加',
    removeServiceChip: '{{service}}を削除',
    taskNeedsSubTask: 'サブタスクを追加',
    railSummary: '概要',
    summaryTitle: 'プロジェクト要約',
    summaryWaiting: '顧客ステップに進むと生成されます。',
    summaryGeneratedBy: '{{model}}が生成 — クリックで編集',
    summaryEdited: '手動編集済み — 自動再生成は停止',
    summaryFallback: 'AIを利用できません — 説明を手動で入力してください',
    aiFieldHint: 'AI がスペルを修正しました',
    aiChecking: 'スペルを確認中…',
    aiUndo: '自分のテキストに戻す',
    regenerate: '再生成',
    beforeCreate: '作成前の確認',
    ruleTasksOk_one: 'タスク{{count}}件 — 最低1件必要',
    ruleTasksOk_other: 'タスク{{count}}件 — 最低1件必要',
    ruleNeedTask: 'プロジェクトには最低1件のタスクが必要です — 追加してください',
    ruleSubTasksOk: 'すべてのタスクに価格付きサブタスクがあります',
    ruleSubTaskMissing: '「{{name}}」には価格付きサブタスクが最低1件必要です',
    ruleSubTasksPending: '各タスクには価格付きサブタスクが最低1件必要です',
    ruleClientAccount: '顧客アカウント — {{name}}',
    ruleClientReachable: '連絡可能 — {{contact}}',
    ruleClientContact: '顧客に電話、メール、またはSNSが必要です',
    warnNoEmail: 'メールなし — 見積をメール送信できません',
    warnNoPhone: '電話なし — 忘れずに確認してください',
    holdToReset: '長押しで下書きをリセット',
    resetDraft: '下書きをリセット',
    shippingAdd: '配送を追加',
    shippingTitle: '配送',
    shippingRemove: '配送を削除',
    shippingEdit: '配送を編集',
    shippingIsland: '配送先の島',
    shippingIslandPlaceholder: '島を検索…',
    shippingNoIslands: '島が見つかりません',
    shippingFirstName: '受取人の名',
    shippingLastName: '受取人の姓',
    shippingPhone: '受取人の電話番号',
    shippingRecipient: '受取人',
    shippingService: '配送サービス',
    shippingRate: '料金',
    shippingRateFromZoho: 'Zoho料金：{{rate}}',
    ...
    shippingLta: 'LTA番号',
    shippingLtaPlaceholder: '航空貨物運送状番号…',
    shippingUnavailable: 'Zohoに接続できない間、配送サービスは利用できません',
    ruleShippingPending: '配送情報を入力中',
    ruleShippingOk: '{{island}}への配送 · {{recipient}}',
    ruleShippingMissingIsland: '配送：島が未指定です',
    ruleShippingMissingRecipient: '配送：受取人名が未指定です',
    ruleShippingInvalidPhone: '配送：電話番号が無効です',
  },
  // Navigation
  nav: {
    aito: 'Aito',
    ...
    installAppSuccess: 'Fenrirをインストールしました',
  },
  ...
  printers: {
    ...
    maintenance: {
      ...
      editFieldHelp: '有効にすると、このプリンターはMQTT、キューディスパッチ、通知から一時停止されます — 修理、並列のFenrirインストール、または一時的な停止に役立ちます。',
    },
    // Chamber light
    ...
    nozzleWear: '摩耗',
    nozzleSlotEmpty: 'スロット {{slot}} — 空',
    humidityTooltip: '湿度: {{value}}% - {{status}}',
    temperatureTooltip: '温度: {{value}}°C - {{status}}',
    clickForHistory: 'クリックで履歴表示',
    nozzleMaxTemp: '最高温度',
    nozzleSerial: 'シリアル',
  ...
  archives: {
    ...
    no3mfBanner: {
      ...
      body: 'スライサーがプリンターのSDカードに.gcode.3mfファイルを残さなかったため、Fenrirはサムネイルもスライサーメタデータも取得できませんでした。これは通常、スライサー (Bambu Studio / OrcaSlicer のデバイスタブ) で「送信ファイルを外部ストレージに保存」がオフになっていることが原因です。',
      docsLink: 'インストール手順4を参照',
      docsLinkInternalStorage: '原因について',
      titleInternalStorage: '最近の一部の印刷はプリンターの内部ストレージに残りました',
      bodyInternalStorage: 'Bambu Studio がスライス済みファイルをカードではなくプリンターの内部ストレージに保存したため、Fenrir が FTP で読み取れるものがありませんでした。H2 シリーズ、P2S、X2D では「印刷」ボタンは常にそうなり、選択できるのは「送信」だけで、そちらも既定は「キャッシュ」です。これらの印刷は名前と時間付きでアーカイブされますが、サムネイルとスライサーのメタデータはありません。完全なアーカイブを残すには、Fenrir から印刷を開始するか、OrcaSlicer でスライスしてください。Bambu Studio を使う場合は「送信」で「外部ストレージ」を選び、その後に印刷を開始します。いずれもプリンターにカードまたは USB メモリーが必要です。',
      titleNoExternalStorage: '最近の一部の印刷をアーカイブできませんでした — プリンターにストレージがありません',
      bodyNoExternalStorage: 'プリンターのスロットにカードもUSBメモリも検出されないため、スライス済みファイルの保存先がなく、Fenrirが読み取るものもありませんでした。挿入すれば次の印刷は完全にアーカイブされます。',
      titleInternalHistory: '最近の一部の印刷は、すでにプリンター内にあるファイルから開始されました',
      bodyInternalHistory: 'これらの印刷はプリンター自身のライブラリから実行されました — 画面からの再印刷、Handy からの開始、または以前に送信して後から印刷したファイルです。Fenrir は印刷ファイルを FTP で読み取りますが、FTP が扱えるのはカードまたは USB メモリだけで、プリンターはそのライブラリを FTP の届かない領域に保存するため、読み取れる 3MF がありませんでした。これらの印刷では何も送信されていないので、スライサーの設定を変えても解決しません。名前と時間付きでのアーカイブは続き、「アーカイブを編集」で使用フィラメントを手入力できます。完全なアーカイブにするには、Fenrir またはスライサーから印刷を開始してください。',
      titleFtpsCooloff: '最近の一部の印刷を保存できませんでした — プリンターがファイル接続を拒否しました',
      bodyFtpsCooloff: 'Fenrir がプリンターのファイル転送ポート (FTPS 990) を開いたところ、プリンターは TLS ではないもので応答したため、何も読み取れませんでした。これらの印刷は名前と時間付きでアーカイブされていますが、サムネイルとスライサーのメタデータはありません。これはスライサーの設定でも、お客様が変更したことでもありません。同じ機種・同じファームウェアが他の環境では正常に動作しており、影響を受けたプリンターも通常はしばらくすると自然に復帰します。この失敗のあと Fenrir はそのプリンターへの転送を 5 分間停止し、停止が明けてからファイルを取りに戻ります。短時間の事象であれば自動的に埋まり、カードが空のままであれば拒否が再試行より長く続いたことを意味します。原因はまだ分かっていません。繰り返す場合は、システムページでデバッグログを有効にし、サポートバンドルを報告に添付してください。',
      titleFtpTransferFailed: '最近の一部の印刷を保存できませんでした — ファイル転送が時間切れになりました',
      bodyFtpTransferFailed: 'スライス済みファイルはプリンターのカードにあり、プリンターも実際に送り出していましたが、許容時間内に転送が完了しませんでした。印刷開始時のプリンターはカメラ、ステータス通知、ジョブのアップロードも同時に処理しているため、大きな 3MF はその中を通り切れないことがあります。これらの印刷は名前と時間つきで保存されていますが、サムネイルとスライサー情報がありません。これはスライサーの設定ではなく、お客様が変更した結果でもありません。Fenrir はその後 10 分のあいだにファイルを 3 回取りに戻るため、多くはひとりでに埋まります。カードが空のままの場合は、そのすべての試行も時間切れになったということです。繰り返す場合は、設定 > ネットワーク > FTP リトライ の 接続タイムアウト を大きくしてください。',
    ...
    card: {
      ...
      source: 'ソース',
      unverifiedFile: '未検証',
      unverifiedFileTooltip: 'このファイルは名前のみで照合されました。実際に印刷されたファイルとは異なる可能性があります。',
      project: 'プロジェクト: {{name}}',
      runsBadge: '{{count}} 回印刷',
  ...
  queue: {
    ...
    batchOrders: {
      ...
      strandedPlate: '設定をコピーできる実行がありません',
      strandedNotice: '未実行の {{owed}} 件のうち {{runs}} 件をキューに追加できません。このプレートには、設定をコピーできるキュー内または完了済みの実行が残っていません。ファイルからこのプレートを一度キューに追加するか、オーダーをキャンセルしてください。',
    ...
    cancelBatchConfirmMessage: 'このオーダーを終了しますか？キューに残っている実行はキャンセルされ、未生産分の要求も止まります。',
    batch: {
      defaultName: 'バッチ',
      label: '{{count}}件',
    ...
    toast: {
      ...
      keptForOrder: '削除ではなくキャンセルしました: バッチオーダーがこのプレートを再度キューに追加できる唯一の実行です',
      historyKeptForOrders: 'バッチオーダーがまだ必要とする {{kept}} 件は残しました。',
  ...
  stats: {
    ...
    failuresByFilament: 'フィラメント別の失敗',
    failuresByPrinter: 'プリンター別の失敗',
    deltaVsPrevious: '前の{{days}}日間との比較',
    utilizationBusy: '稼働{{hours}}時間',
    utilizationNoData: 'この期間に時間データのある印刷はありません',
    costBreakdown: 'コスト内訳',
    costFilament: 'フィラメント',
    costEnergy: '電力',
    costMachine: 'マシン',
    costPerPrintHour: '印刷1時間あたり',
    costPerKg: '1kgあたり',
    costCoverage: '{{total}}件中{{priced}}件を算出',
    costNoData: '現在の計算機設定ではコストを算出できる印刷がありません',
    filamentForecast: 'フィラメント予測',
    forecastDaysLeft: '残り約{{days}}日',
    forecastNoUsage: '最近の使用なし',
    forecastNoInventory: '在庫にスプールがありません',
    forecastRemaining: '残り{{amount}}',
    forecastBasis: '最近の使用量からの予測 — 詳細は在庫ページへ',
    maintenanceReliability: 'メンテナンスと信頼性',
    printsSinceMaintenance: '{{date}}以降 {{prints}}件の印刷 · {{failures}}件失敗',
    neverMaintained: 'メンテナンス記録なし',
    maintenanceDueBadge: '{{n}}件 期限切れ',
    maintenanceWarningBadge: '{{n}}件 まもなく',
    maintenanceNoData: 'メンテナンス管理中のプリンターがありません',
    maintenanceSinceCaption: '件数は選択した期間内のものです',
    energyWidgetTitle: '電力消費',
    aitoPipeline: 'Aito パイプライン',
    aitoPipelineEmpty: 'この期間、Aito ボードには何もありません',
    pipelineByStage: 'ステージ別',
    pipelineConversion: '見積の成約',
    pipelineSent: '送信',
    pipelineAccepted: '受注',
    pipelineDeclined: '辞退',
    pipelineAcceptedRate: '成約率 {{pct}}%',
    pipelineStageDays: 'ステージ滞在日数',
    pipelineInvoicing: '請求',
    pipelineInvoiced: '請求済み',
    pipelineOutstanding: '未回収',
    pipelineTracking: '顧客トラッキング',
    pipelineTrackingViews: 'ページ表示回数',
    pipelineTrackingCards: '閲覧されたカード',
    pipelineTrackingLinks: 'リンク付きカード',
    pipelineDays: '{{days}}日',
    pipelineSample_one: '{{count}} 件',
    pipelineSample_other: '{{count}} 件',
    energyTotalLabel: '合計',
    energyCostLabel: 'コスト',
    energyAvgPerDay: '1日平均',
    energyAvgPerPrint: '1印刷あたり平均',
    energyNoPlugs: '電力計測対応のスマートプラグが設定されていません',
    energyNoData: 'この期間の電力データはありません',
  ...
  settings: {
    ...
    ldap: {
      ...
      feature3: 'ログイン時にLDAPグループがFenrirグループにマッピングされます',
      ...
      autoProvisionHint: '初回LDAPログイン時にFenrirアカウントを自動作成',
      ...
      groupMappingHint: 'LDAPグループDNをFenrirグループにマッピング。利用可能なグループ: ',
    ...
    concurrentUploadsDescription: 'キューが同時にファイルを送信できるプリンター数です。プリンターのファイル受信は遅く（大きな造形では数分かかることもあります）、各プリンターは順番を待ちます。台数の多い環境では、この値を上げることで、バッチ内の最後のプリンターが先行するすべての転送を待たずに済みます。ネットワークや Fenrir ホストが並列転送に耐えられない場合は下げてください。',
    ...
    preheatFilamentTargetsHint: 'Fenrirはロード済みのAMSスロット中で最も高い目標値を選びます。すべてのスロットが0となる印刷（PLA、PETG、TPU、PVA）は予熱を完全にスキップし、すぐに開始します。',
    ...
    authDisabledDescription: '認証を有効にして、ユーザーアカウントの作成、権限の管理、Fenrirインスタンスのセキュリティを確保しましょう。',
    authDisabledMessage: '認証を有効にして、ユーザーアカウントの作成、権限の管理、Fenrirインスタンスのセキュリティを確保しましょう。',
    ...
    disableAuthenticationMessage: '認証を無効にしますか？Fenrirインスタンスにログインなしでアクセスできるようになります。ユーザーはデータベースに残りますが、認証は無効になります。',
    disableAuthentication: '認証を無効化',
    // Additional settings
    configureFenrir: 'Fenrirを設定',
    ...
    captureFinishPhotoDescription: '印刷完了時にプリンターカメラから写真を撮影します。Fenrir は印刷中に短いタイムラプスを記録し、ベッドが下がる前の瞬間から写真を取得できるようにします。この印刷でタイムラプスを有効にしていた場合はタイムラプスファイルが保存され、それ以外の場合は写真の取得後に自動的に削除されます。',
    finishPhotoRestorePlate: '完了写真のためにプレートを戻す',
    finishPhotoRestorePlateDescription: 'プリンターは印刷終了時にビルドプレートを約 100 mm 下降させるため、完成した造形物がカメラの画角より下に来ます。Fenrir はプレートを最終印刷レイヤーのすぐ上まで戻して写真を撮影し、その後再び下降させます。造形高さが不明な場合や次のジョブがキューにある場合はスキップされます。',
    ...
    cameraGpuAccelUnavailable: 'このサーバーではGPUアクセラレーションが検出されませんでした。',
    cameraGpuAccelBackends: '利用可能なバックエンド: {{backends}}',
    cameraEngine: 'カメラエンジン',
    cameraEngineFFmpeg: 'FFmpeg (MJPEG)',
    cameraEngineGo2rtc: 'go2rtc (WebRTC)',
    cameraEngineFFmpegDescription: 'FFmpeg を使用して RTSP を MJPEG にトランスコードします。すべてのブラウザで動作しますが、CPU 使用率が高くなります。',
    cameraEngineGo2rtcDescription: 'WebRTC 経由で H.264 をブラウザに直接中継します。トランスコードなし、低遅延、ハードウェアデコード対応。チャンバーカメラ（A1/P1）は引き続き FFmpeg を使用します。',
    ...
    updateViaHomeAssistant: 'アップデートはHome Assistant Supervisorによって管理されます。Home Assistantの設定→アドオン→Fenrirを開いて新しいバージョンをインストールしてください。',
    ...
    // Network tab
    externalUrl: '外部URL',
    externalUrlDescription: 'Fenrirがアクセス可能な外部URL。通知画像や外部連携に使用されます。',
    fenrirUrl: 'FenrirのURL',
    ...
    mqttDescription: 'Node-RED、Home Assistant、その他の自動化システムとの統合のため、外部MQTTブローカーにFenrirイベントをパブリッシュ。',
    ...
    encryption: {
      ...
      notConfiguredDesc: 'TOTPシークレットとOIDCのclient_secretsは平文で保存されています。MFA_ENCRYPTION_KEYを設定するか、書き込み可能なデータディレクトリでFenrirを再起動して自動生成してください。',
      ...
      migrationErrorWarning: '{{count}} 件のレガシー行を起動時に再暗号化できませんでした。サーバーログを確認し、Fenrir を再起動して再試行してください。',
    },
    ...
    aitoFollowupLinkDays: '決済リンクの期限切れ（日数）',
    aitoFollowupLinkDaysDescription: '決済リンクがこの日数以内に期限切れになる見積を表示します',
  },
  ...
  hmsErrors: {
    ...
    runoutSlotUnknown: 'フィラメントが切れて印刷が一時停止しています。プリンターが現在要求しているスロットを Fenrir が特定できませんでした。プリンターの画面で要求されているスロットを確認してください。',
    actions: {
  ...
  login: {
    ...
    twoFA: {
      ...
      instructionsTotp: '認証アプリを開いて、Fenrir用の6桁のコードを入力してください。',
  ...
  users: {
    title: 'ユーザー管理',
    subtitle: 'ユーザーとFenrirインスタンスへのアクセスを管理',
    backToSettings: '設定に戻る',
    createUser: 'ユーザーを作成',
    noPermission: 'このページにアクセスする権限がありません。',
    admin: '管理者',
  ...
  profiles: {
    ...
    orcaCloud: {
      ...
      connect: {
        title: 'Orca Cloudに接続',
        description: 'Orca Cloudアカウントにサインインして、スライサープロファイルをFenrirに同期します。',
      },
      device: {
        title: 'Orca CloudでFenrirを承認',
        instruction: 'Orca Cloudを開いてこのコードを承認してください。承認するとFenrirが自動的に接続されます。',
        codeLabel: 'ペアリングコード',
    ...
    login: {
      ...
      captchaBody: 'Bambu がサインインを受け付ける前にネットワークへ CAPTCHA を要求しており、この認証は Fenrir からは応答できません。メールアドレスやパスワードの問題ではありません。ブロックはグローバル IP アドレスに紐づいており、通常は数時間で自動的に解除されます。繰り返し再試行すると解除が遅くなります。今すぐサインインするには、ブラウザーのセッションから取得したアクセストークンを使用してください。',
      useEmail: 'メールでログイン',
      toast: {
        loggedIn: 'ログインしました',
  ...
  filamentProfiles: {
    ...
    allBrands: 'すべてのブランド',
    countOne: '{{n}} 件のプリセット',
    countOther: '{{n}} 件のプリセット',
    countFiltered: '{{filtered}} / {{total}}',
    gridSmall: '小グリッド',
    gridMedium: '中グリッド',
    gridLarge: '大グリッド',
    // Grid
    emptyTitle: 'プリセットはまだありません',
    emptySubtitle: 'プリセットを手動で作成するか、フォルダからインポートしてください。',
    ...
    delete: '削除',
    // Confirm
    deleteTitle: 'プリセットを削除しますか?',
    deleteBody: '{{name}} は完全に削除されます。',
    cancel: 'キャンセル',
    deleteConfirm: '削除',
    // Sync-base modal
    baseSyncedTitle: 'ベースプロファイルを同期しました',
    baseSyncFailedTitle: '同期に失敗しました',
    filesScanned: '{{n}} 件のファイルをスキャンしました',
    statNew: '新規',
    statUpdated: '更新',
    statUnchanged: '変更なし',
    close: '閉じる',
    // Sync modal
    syncTitle: 'PCに同期',
    syncSubtitle: '変更はBambuStudioのフィラメントフォルダに適用されます。',
    statRemoved: '削除',
    upToDate: 'すべて最新の状態です。',
    syncConfirm: '同期',
    ...
    // Import
    scanFailed: 'BambuStudioフォルダの読み込みエラー: {{error}}',
    allImported: '{{n}} 件のファイルが見つかりましたが、すべてインポート済みです。',
    ...
    inheritsNotFound: '(見つかりません)',
    reload: '再読み込み',
    serverChangedBanner: '編集中にこのプリセットがサーバー上で変更されました。',
    serverChangedReload: 'サーバーから再読み込み',
    save: '保存',
    create: '作成',
    saving: '保存中…',
    nameRequiredHint: 'ブランドと素材が必要です',
    deletePreset: '削除',
    invalidJson: '無効なJSON',
    tabGeneral: '一般',
    tabTemps: '温度',
    ...
    tabJson: 'JSON',
    // Editor General
    basePresetLabel: 'ベースプリセット',
    basePresetNone: '— なし(空から開始)—',
    basePresetMine: 'マイプリセット',
    basePresetBase: 'ベースプリセット',
    basePresetLoading: '読み込み中…',
    brand: 'ブランド',
    brandSelect: '— 選択 —',
    material: '素材',
    colorLabel: '色ラベル',
    colorPlaceholder: '白、黒…',
    nozzleSize: 'ノズルサイズ',
    paKValue: 'PA K値',
    cost: 'コスト',
    density: '密度',
    filamentColour: 'フィラメントカラー',
    extruder: 'エクストルーダー',
    ...
    fanMax: '最大速度',
    fanMin: '最小速度',
    overhangFan: 'オーバーハング速度',
    noFanLayers: 'ファンなし(パーツ)レイヤー数',
    noFanAdditional: 'ファンなし(追加)レイヤー数',
    initialFan: '初層ファン',
    minLayerTime: '最小レイヤー時間',
    overhangThreshold: 'オーバーハングしきい値',
    preStartFan: 'ファン事前始動',
    additionalFan: '追加ファン',
    overhangBridgeFan: 'オーバーハング/ブリッジファン',
    chamberVent: 'チャンバー換気',
    duringPrint: '印刷中',
    endOfPrint: '印刷終了時',
    nil: 'nil',
    ...
    primeVolume: 'プライム量',
    shrinkage: '収縮率',
    layerSlowdown: 'レイヤー減速',
    minTimePerLayer: 'レイヤーごとの最小時間',
    minSpeed: '最小速度',
    gcodeSection: 'Gコード',
    startGcode: '開始Gコード',
    endGcode: '終了Gコード',
    ...
    zHopSpiral: 'スパイラルリフト',
    wipeDistance: 'ワイプ距離',
    retractBeforeWipe: 'ワイプ前のリトラクション',
    options: 'オプション',
    retractOnLayerChange: 'レイヤー変更時にリトラクト',
    wipeOnRetract: 'リトラクト時にワイプ',
    // Editor JSON
    jsonCaption: '直接編集 — 他のタブは自動的に更新されます',
  },
  ...
  fileManager: {
    ...
    uploading: 'アップロード中...',
    checkingDuplicates: '確認中...',
    alreadyInLibrary: '既にライブラリにあります',
    duplicateIn: '{{folder}} 内',
    duplicatesWillBeSkipped: '{{count}}件の重複ファイルを検出 — スキップされます',
    uploadAnyway: 'そのままアップロード',
    skipDuplicate: 'スキップ',
    skippedDuplicate: 'スキップ済み（既にライブラリにあります）',
    changeLink: 'リンクを変更...',
    linkTo: 'リンク先...',
    ...
    fileHistory: {
      menuLabel: '履歴',
      title: '履歴 — {{name}}',
      viewHistoryAria: '印刷履歴を表示',
      noPermission: 'ファイル履歴を表示する権限がありません',
      loadFailed: 'ファイル履歴の読み込みに失敗しました',
      statusPending: 'キュー待ち',
      addedToLibrary: 'ライブラリに追加',
      bySomeone: '{{name}} による',
      noPrintsYet: 'このファイルはまだ印刷されていません。',
      externalUnavailable: '外部ファイルの印刷履歴は利用できません。',
      openArchive: 'アーカイブを開く',
      viewSource: 'ソースページを開く',
      stats: {
        prints: '印刷回数',
        success: '成功率',
        filament: 'フィラメント',
    ...
    toast: {
      ...
      moveSkipped: '{{moved}} 件移動、{{skipped}} 件スキップ: {{reasons}}',
      moveSkipReason: {
        not_owner: '所有者ではありません',
        source_readonly: '移動元が読み取り専用です',
        source_missing: 'ファイルがディスク上に見つかりません',
        target_readonly: '移動先が読み取り専用です',
        target_misconfigured: '移動先フォルダの設定が不正です',
        target_inaccessible: '移動先フォルダにアクセスできません',
        target_unwritable: '移動先フォルダに書き込めません',
        invalid_filename: '安全でないファイル名です',
        name_collision: 'ファイル名が重複しています',
  ...
  sponsors: {
    ...
    tagline: 'Fenrirは無料で、これからも無料です。支援してくださる方々のおかげで、VCもクラウドロックインもありません。',
    viewSupporters: 'サポーター一覧',
    toastPrints: 'Fenrirで{{count}}件の印刷を完了しました。Fenrirは支援者のおかげで無料で提供されています。',
    toastCost: 'Fenrirで{{total}}分のフィラメントを記録しました。プロジェクトを支えてくれている方々をご覧ください。',
    toastArchives: '{{count}}件の印刷をFenrirでアーカイブしました。独立を支えてくれている方々をご覧ください。',
    toastAnniversary: 'Fenrirとの1周年です！プロジェクトを支えてくれている方々をご覧ください。',
    toastVersionUpdate: 'v{{version}}にアップデートされました。Fenrirは支援者のおかげで無料で提供されています。',
    toastBusiness: '{{count}}台のプリンターでFenrirを運用中ですね。チーム向けのサポートプランがあります（優先対応、請求書発行、開発者への直接窓口）。',
    businessCta: 'ビジネス向けFenrir',
    businessTitle: 'ビジネス向けFenrir',
  ...
  inventory: {
    ...
    spoolmanMixedContentBody: 'Fenrir はリバースプロキシ経由で HTTPS 配信されていますが、Spoolman の URL は HTTP のままです。ブラウザはセキュリティ上の理由で混在コンテンツをブロックするため、埋め込みの Spoolman UI を表示できません。Spoolman も HTTPS でアクセスできる必要があります。',
    spoolmanMixedContentFixReverseProxy: 'Spoolman を Fenrir と同じリバースプロキシ（Traefik / Nginx / Caddy）の後ろに HTTPS で配置し、設定で Spoolman URL を新しい HTTPS アドレスに更新してください。',
  ...
  zoho: {
    title: 'Zoho Books',
    subtitle: 'Zoho Books を接続すると、Aito のプロジェクトを顧客に紐付け、請求書を同期できます。',
    clientId: 'クライアントID',
    clientSecret: 'クライアントシークレット',
    refreshToken: 'リフレッシュトークン',
    organizationId: '組織ID',
    baseUrl: 'APIベースURL',
    accountsUrl: 'アカウントURL',
    defaultContactId: 'デフォルトの顧客ID',
    defaultContactName: 'デフォルトの顧客名',
    defaultContactHint: 'Aitoの新規プロジェクトモーダルで事前選択されます。電話番号とメールアドレスはこの連絡先に書き込まれません。',
    secretSaved: '値は保存済みです — 変更しない場合は空欄のままにしてください',
    save: '保存',
    saved: 'Zoho設定を保存しました',
    test: '接続テスト',
    testOk: 'Zoho Books に接続しました',
    testUnreachable: '設定済みですが、Zoho Books に接続できません',
    testNotConfigured: 'Zoho Books が設定されていません',
  },

  heimdall: {
    title: 'Heimdall 決済',
    subtitle: 'Heimdall POS ブリッジ経由で、Aito の各見積にオンライン決済リンクを発行します。支払われたリンクは見積を自動的に承認します。',
    baseUrl: 'Heimdall の URL',
    token: 'API トークン',
    tokenHint: '書き込み専用 — 現在のトークンを保持するには空欄のままにしてください',
    depositPct: '着手金（%）',
    depositPctDescription: '0 の場合は見積の全額を請求し、それ以外はこの割合分のリンクになります。',
    validityDays: '見積の有効期間（日数）',
    validityDaysDescription: '新しい見積ごとに記載される有効期限です。決済リンクも同じ日に終了します。',
    save: '保存',
    saved: 'Heimdall の設定を保存しました',
    test: '接続をテスト',
    testOk: 'Heimdall に接続しました',
    testUnauthorized: 'Heimdall がトークンを拒否しました',
    ...
    paymentModesTitle: 'Zoho の支払い方法名',
    paymentModesHint: 'プロジェクトカードから記録する支払いに Zoho Books が使用する名称です。',
    paymentModeCard: 'カード',
    paymentModeCheque: '小切手',
    paymentModeCash: '現金',
  },
  ...
  backup: {
    ...
    repoIsPublicWarning: 'リポジトリが公開（PUBLIC）です。Fenrirのバックアップには MQTT 認証情報、Home Assistant トークン、Prometheus トークン、Bambu Cloud のメールアドレス、K-プロファイル経由のプリンタアクセスコードが含まれます。プロバイダー側でリポジトリをプライベートに変更するまで保存はブロックされます。',
    repoVisibilityUnknown: 'リポジトリの公開設定を確認できませんでした。Fenrir はプライベートと確認できないリポジトリへのバックアップを拒否します。保存はブロックされます。',
    ...
    appSettings: 'アプリ設定',
    appSettingsDescription: 'Fenrir設定（データベース全体）',
    ...
    restoreFromGit: {
      ...
      reloadHint: '復元したデータを全体に反映するには Fenrir を再読み込みしてください。',
      ...
      notes: {
        ...
        settingsMqttRelayFailed: 'MQTT 設定を復元しましたが、リレーを再接続できませんでした - Fenrir を再起動してください',
    ...
    localBackupDescription: 'データベース、アーカイブ、アップロード、すべてのファイルを含むFenrirデータの完全なバックアップを作成します。',
    ...
    backupRestoredRestart: 'バックアップが復元されました。Fenrirを再起動してください。',
    ...
    pathCheck: {
      title: 'Fenrir はこのディレクトリに書き込めません',
      howToFix: '対処方法:',
      sandboxed: 'Fenrir サービスは {{path}} に書き込めません。systemd ユニットが ProtectSystem=strict で動作しているため、インストール・データ・ログの各ディレクトリ以外はすべてサービスから読み取り専用になります。自分のシェルからは書き込める場所であっても同様です。',
      read_only: '{{path}} は読み取り専用のファイルシステム上にあります。',
      permission_denied: 'Fenrir には {{path}} への書き込み権限がありません。ディレクトリの所有者とパーミッションを確認してください。',
      no_space: '{{path}} があるファイルシステムに空き容量がありません。',
      not_a_directory: '{{path}} は存在しますが、ディレクトリではありません。',
      missing: '{{path}} は存在せず、作成もできませんでした。',
      error: 'Fenrir は {{path}} に書き込めません。',
      ephemeralTitle: 'これらのバックアップはコンテナの再作成で失われます',
      container_ephemeral: '{{path}} はホストではなく Fenrir コンテナ内にあります。そこに書き込まれたバックアップはコンテナを再作成すると失われます。ホスト側のディレクトリをマウントしてください:',
    },
  ...
  kProfiles: {
    ...
    modal: {
      ...
      notesHelp: 'メモはFenrirに保存され、プリンターには保存されません',
      syncing: 'プリンターと同期中...',
  ...
  virtualPrinter: {
    ...
    enable: {
      title: '仮想プリンターを有効化',
      visibleInSlicer: 'スライサーの検出リストに「Fenrir」として表示',
    ...
    remoteInterface: {
      ...
      hint: 'SSDPで広告され、TLS証明書に使用されるIPアドレスを上書きします。Fenrirに複数のネットワークインターフェースがある場合に便利です。',
    },
    mode: {
      title: 'モード',
      archive: 'アーカイブ',
    ...
    howItWorks: {
      ...
      step2: 'アーカイブ、レビュー、キューモードでは、スライサーの「送信」ボタンを使用して3MFファイルをFenrirにアップロードします。スライサーは「印刷成功」と表示しますが、ファイルは保存され、印刷はされません。',
    ...
    caCert: {
      title: 'スライサー証明書',
      description: '仮想プリンターは Fenrir CA が署名した TLS 証明書を使用します。この CA 証明書をスライサーの信頼ストアに一度インポートすると接続が受け入れられます — コマンドラインからコピーする必要はありません。',
      copy: 'コピー',
      copied: 'コピーしました',
      download: 'ダウンロード',
      fingerprint: 'SHA-256',
  ...
  locationHaSensors: {
    ...
    autoAdd: {
      ...
      confirmMessage: 'Fenrir がこの保管場所の他のセンサーも見つけました。追加するものを選んでください。',
    ...
    options: {
      ...
      pollInterval: '更新間隔（秒）',
      pollIntervalHint: 'Fenrirがホームアシスタントに問い合わせて画面上のセンサー値を更新する頻度です。最小60秒。',
  ...
  smartPlugs: {
    ...
    restEnergyTotalHint:
      '多くのスマートプラグ (Shelly はすべて) は、リセットされない積算カウンターしか返しません。その値は上の欄ではなく、ここに入力してください。今日の使用量として読むと深夜にリセットされず、昨日と合計は空のままになります。Fenrir は積算値から今日と昨日を算出しますが、そのためには 1〜2 日分の測定値が必要です。Shelly はワット時で返すため、乗数には 0.001 を指定してください。',
  ...
  notifications: {
    ...
    aitoPaymentReceivedLabel: 'Aito の入金',
    aitoPaymentReceivedDescription: 'Aito の見積がオンラインまたは十分な着手金で支払われたときに通知',
    printFailed: '印刷失敗',
    printStopped: '印刷停止',
  ...
  time: {
    ...
    today: '今日',
    yesterday: '昨日',
    daysElapsed_one: '{{count}}日前',
    daysElapsed_other: '{{count}}日前',
    monthsElapsed_one: '{{count}}ヶ月前',
    monthsElapsed_other: '{{count}}ヶ月前',
    yearsElapsed_one: '{{count}}年前',
    yearsElapsed_other: '{{count}}年前',
  },
  ...
  spoolbuddy: {
    ...
    settings: {
      ...
      backendUrl: 'FenrirバックエンドURL',
      apiToken: 'APIトークン',
      apiTokenPlaceholder: 'APIトークンを入力',
      saveConfig: '設定を保存',
      systemQueued: '設定がキューに追加されました。',
      nfcDiagnostic: 'NFC診断',
      scaleDiagnostic: 'スケール診断',
      readTagDiagnostic: 'タグ読取診断',
      testNfc: 'リーダーテスト',
      testScale: '精度テスト',
      testReadTag: 'タグ読取',
  ...
  diagnostic: {
    ...
    check: {
      ...
      external_storage: {
        ...
        warn_internal_storage: 'オプションは有効でストレージも装着されていますが、直近の印刷は Fenrir が読み取れないプリンターの内部ストレージに保存されました。H2 シリーズ、P2S、X2D では、この設定に関係なく Bambu Studio の「印刷」ボタンは常にそちらへ送信します。印刷は名前と時間付きでアーカイブされますが、サムネイルとスライサーのメタデータはありません。完全なアーカイブを残すには、Fenrir から印刷を開始するか、OrcaSlicer でスライスするか、Bambu Studio で「送信」から「外部ストレージ」を選んだあとに印刷を開始してください。',
        warn_internal_history: 'オプションは有効でストレージもありますが、直近の印刷はすでにプリンター内にあったファイルから実行されました — 画面からの再印刷、Handy からの開始、または以前に送信したファイルです。そのライブラリは Fenrir が読めない内部ストレージにあり、この印刷では何も送信されていないため、どの設定を変えても解決しません。名前と時間付きでアーカイブはされますが、サムネイルとスライサーのメタデータはありません。完全なアーカイブにするには、Fenrir から印刷を開始するか、スライサーから送信してください。',
      },
      port_rtsps: {
      ...
      subnet: {
        title: 'ネットワークサブネット',
        pass: 'プリンターとFenrirは同じサブネットにあります。',
        warn: 'プリンター ({{printer_ip}}) とFenrir ({{host_ip}}) は異なるサブネットにあります。サブネット間のルーティングが設定されていない限り、互いに到達できない可能性があります。',
        skip: 'サブネットを判定できませんでした — スキップしました。',
      },
      mqtt_auth: {
        title: 'プリンター認証情報',
        pass: 'プリンターが接続を受け入れました。',
        fail: 'プリンターには到達できますが、Fenrir は接続されていません。アクセスコードまたはシリアル番号が間違っている可能性が高いです — アクセスコードは LAN のみモードや開発者モードを切り替えるたびに変わるため、プリンター画面から再度コピーしてください。再起動中のプリンターや、同時接続数の上限に達しているプリンターでも同じ表示になります。',
        fail_auth_rejected: 'プリンターが Fenrir の認証情報を拒否しました。アクセスコードまたはシリアル番号が間違っています — アクセスコードは LAN のみモードや開発者モードを切り替えるたびに変わります。プリンター画面から再度コピーし、プリンター設定に保存してください。',
  ...
  systemHealth: {
    ...
    signature: {
      'ftp-auth-rejected': {
        ...
        fix: 'プリンター画面（LAN設定）からアクセスコードをコピーし直し、Fenrir のプリンター設定で更新してください。',
      },
      'ftp-connection-timeout': {
        name: 'ファイル転送の接続がタイムアウトしました',
        cause: 'Fenrir がプリンターのファイル転送ポート（FTPS 990）に到達できませんでした。ポートがブロックされているか、プリンターの電源が切れているか、別のサブネットにあります。',
        fix: 'Fenrir とプリンターの間でポート 990 がブロックされていないこと、両者が同じネットワークにあることを確認してください。',
      },
      'ftp-ssl-error': {
      ...
      'database-locked': {
        ...
        fix: 'Fenrir を外部の PostgreSQL データベースに切り替えてください。ドキュメントの PostgreSQL ガイドを参照してください。',
      },
    },
  },
  ...
  vpDiagnostic: {
    ...
    check: {
      ...
      running: {
        title: 'サービスが稼働中',
        fail: '仮想プリンターは有効ですが、サービスが稼働していません。Fenrir のログを確認してください — 通常はバインド IP の競合または権限エラーが原因で停止します。',
      },
      bind_interface: {
      ...
      certificate: {
        title: 'TLS 証明書',
        pass: '証明書の準備ができています。Fenrir CA 証明書（上記）がスライサーの信頼ストアにインポートされていることを確認してください。',
        fail: 'この仮想プリンターの TLS 証明書がありません。Fenrir のデータディレクトリが書き込み可能か確認してください。',
      },
    },
  },
  ...
  failureDetection: {
    ...
    externalUrlHint: 'ML APIはURLでカメラスナップショットを取得します。MLAPIコンテナがFenrirに到達できるよう、一般設定で外部URLを設定してください。',
  ...
  makerworld: {
    title: 'MakerWorld',
    description: 'MakerWorld モデルの URL を貼り付けると、Bambu Handy アプリを開かなくても Fenrir から直接インポート・印刷できます。',
    ...
    signInExpiredTitle: 'Bambu Cloud のサインインの有効期限が切れました',
    signInExpiredBody: 'Fenrir にはサインインしたままですが、Bambu Lab が保存されたトークンを受け付けなくなったため、ダウンロードは失敗します。Bambu Cloud に再度サインインしてください。',
    ...
    disclaimer: 'MakerWorld 連携はコミュニティで文書化された API エンドポイントを使用しています。Fenrir は MakerWorld または Bambu Lab との提携・承認関係はありません。',
  ...
  libraryPurge: {
    ...
    effect4: '外部（リンク済み）フォルダー内のファイルはスキップされます — Fenrirは所有していないバイトを削除しません。',    previewLoading: '対象ファイル数を確認中…',
  ...
  calculator: {
    ...
    material: '材料',
    title: '計算機',
    subtitle: '3Dプリントのコストと販売価格を見積もる',
    easyMode: 'かんたんモード',
    reset: 'リセット',
    resetConfirmTitle: '入力をリセット',
    resetConfirmMessage: '計算機のすべての入力を初期値に戻しますか？フィラメント・プリンター・既定値は保持されます。',
    informations: '基本情報',
    weight: 'オブジェクト重量',
    printingTime: '印刷時間 (h)',
    printingTimeLabel: '印刷時間',
    durationDays: '日',
    durationDaysShort: '日',
    durationHours: '時間',
    durationHoursShort: '時',
    durationMinutes: '分',
    durationMinutesShort: '分',
    emptyInputsTitle: '重量と印刷時間を入力してください',
    emptyInputsMessage: 'オブジェクトの重量と印刷時間を入力すると、推奨価格とコスト内訳が表示されます。',
    targetPrice: '目標価格',
    targetPriceLabel: '目標価格（税込）',
    targetPriceProfit: '純マージン',
    measuredEnergy: '実測エネルギー: {{kwh}} kWh（アーカイブより）',
    measuredEnergyClear: '実測エネルギーをクリア',
    qtyIncrease: '数量を増やす',
    qtyDecrease: '数量を減らす',
    fixErrors: '無効な入力があります。ハイライトされた項目を修正してください。無効な値は結果に反映されません。',
    breakEvenDiscount: '損益分岐点の割引率: {{pct}} — これを超える割引は原価割れになります。',
    laborAmortized: 'モデリングと準備は一回限りのコストで、{{count}} 個に分割されます。',
    copySummary: '概要をコピー',
    summaryCopied: '概要をクリップボードにコピーしました',
    summaryCopyFailed: 'コピーできませんでした — クリップボードへのアクセスがブロックされています',
    easyAssumptions: '保存済みの単価に基づく計算 — 既定値を確認',
    quantity: '数量',
    filament: 'フィラメント',
    printer: 'プリンター',
    difficulty: '難易度係数 (%)',
    difficultyTooltip: '難しい印刷向けの係数：研磨性フィラメント、高い失敗リスク、繊細な取り扱いなど。100% = 追加なし。',
    labor: '人件費',
    modeling: 'モデリング',
    workingHours: '作業時間',
    basePrice: '基本価格',
    preparation: '準備',
    modelPreparation: 'モデル準備',
    slicing: 'スライス',
    transferStart: '転送と開始',
    postProcessing: '後処理',
    jobRemoval: '造形物の取り外し',
    supportRemoval: 'サポート除去',
    additionalWork: '追加作業',
    fulfillment: '発送',
    stuff: '雑材料',
    amount: '金額',
    ...
    totals: '合計',
    machineCost: 'マシンコスト',
    machineCostSafety: '安全マージン込みマシンコスト',
    costsSoFar: '累計コスト',
    totalHT: '合計（税抜）',
    totalTTC: '合計（税込）',
    byPrinter: 'プリンター別価格',
    ...
    timeCorrection: {
      ...
      hintScoped: '{{scope}} の実績はスライサー推定の平均 {{pct}}% です',
      apply: '補正時間を適用',
      dismiss: '閉じる',
    },
    waterfall: {
      tax: '税',
      aria: 'コストから最終価格までの価格構成',
    },
    quote: {
      open: '印刷用見積もりを開く',
      back: '計算機に戻る',
      print: '印刷',
      title: '見積もり',
      empty: 'まだ見積もる仕事がありません。先に計算機に入力してください。',
      jobDetails: 'ジョブ詳細',
      footnote: '価格は税込です。見積もりは材料の在庫状況により変わる場合があります。',
    },
    marge: 'マージン',
    marginPct: '利益率',
    marginGlobal: '全体マージン',
    marginFilament: 'フィラメントマージン',
    marginStuff: '雑材料マージン',
    perUnit: '1個あたり',
    forQuantity: '{{count}}個の合計',
    breakdown: 'コスト内訳',
    costSplit: 'コストの構成',
    costFilament: 'フィラメント',
    costDepreciation: 'プリンター減価償却',
    costEnergy: '電力',
    costConsumables: '消耗品・梱包',
    costBaseFee: '基本料金',
    costRepairs: '修理',
    costPrototype: '試作',
    costFailures: '失敗',
    ...
    groupLabor: '人件費',
    splitPrinter: 'プリンター',
    splitAdsConsumables: '広告・消耗品',
    discountTitle: '割引計算',
    discountMachine: '割引後マシンコスト',
    discountSafety: '割引後安全コスト',
    discountPrice: '割引後価格',
    discountAmount: '割引額',
    potentialProfit: '見込み利益',
    bulkQuantity: '数量',
    emptyTitle: '計算機をセットアップ',
    emptyMessage: '価格計算を始めるには、フィラメントとプリンターを少なくとも1つずつ追加してください。',
    ...
    tabPrinters: 'プリンター',
    name: '名前',
    costPerKg: '1kgあたりのコスト ({{currency}})',
    printingCostPerKg: '1kgあたりの印刷コスト ({{currency}})',
    marginOverCost: 'コストに対するマージン (%)',
    zohoProductSearch: 'Zoho商品',
    zohoProductSearchPlaceholder: 'Zoho内のフィラメントを検索…',
    zohoNoDealerPrice: '販売店価格なし',
    zohoNoResults: '該当するZohoフィラメントがありません',
    zohoSearchError: 'Zohoに接続できませんでした',
    zohoLinkedProduct: '{{name}} にリンク済み',
    zohoUnlink: 'リンク解除',
    zohoWeightInferred: 'Zohoの商品名にスプール重量の記載がないため、1kgと仮定しました',
    spoolWeightKg: 'スプール重量 (kg)',
    ...
    addFilament: 'フィラメントを追加',
    editFilament: 'フィラメントを編集',
    deleteFilamentTitle: 'フィラメントを削除',
    deleteFilamentMessage: '「{{name}}」を削除しますか？この操作は元に戻せません。',
    filamentCreated: 'フィラメントを追加しました',
    filamentUpdated: 'フィラメントを更新しました',
    filamentDeleted: 'フィラメントを削除しました',
    purchasePrice: '購入価格 ({{currency}})',
    lifetimeYears: '寿命（年）',
    dailyUsage: '1日の使用時間 (h)',
    powerWatts: '消費電力 (W)',
    repairRate: '寿命中の修理費 (%)',
    lifetimeHours: '寿命時間',
    depreciationPerHour: '減価償却 / h',
    repairsPerHour: '修理費 / h',
    addPrinter: 'プリンターを追加',
    editPrinter: 'プリンターを編集',
    deletePrinterTitle: 'プリンターを削除',
    deletePrinterMessage: '「{{name}}」を削除しますか？この操作は元に戻せません。',
    printerCreated: 'プリンターを追加しました',
    printerUpdated: 'プリンターを更新しました',
    printerDeleted: 'プリンターを削除しました',
    inUse: '計算機ページで選択中',
    electricityTariff: '電気料金 ({{currency}}/kWh)',
    laborRate: '人件費レート ({{currency}}/h)',
    consumablesFlat: '消耗品・梱包 ({{currency}})',
    baseFee: '基本料金 ({{currency}})',
    marginCurveHint: '全体マージンは2つの曲線で決まります。部品の単価が上がるほど縮小するサイズマージンと、数量が増えるほど原価ではなくマージンを削る数量割引です。',
    sizeMarginGroup: 'サイズマージン',
    qtyDiscountGroup: '数量割引',
    floorGroup: '最低額',
    marginMinMult: '非常に大きい部品の乗数 (M_MIN)',
    marginMaxMult: '非常に小さい部品の乗数 (M_MAX)',
    marginK: '中間点の単価 (K、{{currency}})',
    qtyMinFactor: '大量注文時に維持するマージン (Q_MIN)',
    qtyK: '中間点の数量 (KQ)',
    minTaskPrice: 'タスクごとの最低価格 ({{currency}})',
    marginCurveMaxBelowMin: 'M_MAX は M_MIN 以上である必要があります',
    marginCurvePreviewSize: '単価別のサイズマージン',
    marginCurvePreviewQty: '数量別の数量係数',
    exampleTitle: 'サンプル案件',
    ...
    formulaAt: '{{x}} のとき → {{y}}',
    warnFlatSize: 'サイズ曲線が平坦です。すべての部品が ×{{m}} になります。',
    warnKFar: 'K が例のコストよりはるかに大きいため、ジョブが位置する範囲で曲線がほとんど曲がりません。',
    ...
    multiplier: '×{{value}}',
    multiplierDetail: 'サイズ ×{{size}} ・数量 {{qty}}',
    floorApplied: '最低価格を適用',
    curveTitle: '数量別価格',
    curveHint: '各数量での単価(税込) — 一時費用は分散し、数量割引がマージンを削ります。',
    curveUnitPrice: '単価',
    curveTaskPrice: 'タスク合計',
    curveQtyFactor: '数量係数',
    curveCurrent: '現在',
    failureRate: '失敗率 (%)',
    prototypeRate: '試作率 (%)',
    adsRate: '広告率 (%)',
    filamentMarkup: 'フィラメント上乗せ率 (%)',
    taxPct: '税 TGC (%)',
    defaultDifficulty: '既定の難易度 (%)',
    defaultMargin: '既定のコストマージン (%)',
    filamentSettings: 'フィラメント設定',
    filamentSettingsHint: '新しいフィラメントプロファイルの初期値。',
    stuffMarkup: '雑材料上乗せ率 (%)',
    ratesTitle: '単価',
    ratesHint: '作業にかかる実費。見積もり前に現地の価格と通貨に合わせてください。',
    provisionsTitle: '引当金と間接費',
    provisionsHint: '失敗した印刷、試作、広告、フィラメントと追加品の再販上乗せを賄うためにコストに加算する割合。',
    unsavedChanges_one: '未保存の変更 {{count}} 件',
    unsavedChanges_other: '未保存の変更 {{count}} 件',
    fixFields: '保存するには強調表示された項目を修正してください。',
    discardChanges: '破棄',
    tabSettings: '設定',
