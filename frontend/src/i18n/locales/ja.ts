export default {
  ...
  aito: {
    ...
    statistics: '統計',
    stats: {
      caption: '進行中 {{active}} 件 · 完了 {{done}} 件（累計）',
      added: '追加',
      accepted: '承認',
      completed: '完了',
      perDay: '1日あたりの追加',
      ...
      brief: {
        ...
        tellNone: '連絡する顧客はなし',
        collect: '回収する {{amount}}',
        collectNone: '回収する請求はなし',
        allClear: '催促も連絡も回収も、今日はありません。',
        due_one: '今週の納品は {{count}} 件です。',
        due_other: '今週の納品は {{count}} 件です。',
        dueNone: '今週の納品予定はありません。',
        finished_one: 'この期間に {{count}} 件完了。',
        finished_other: 'この期間に {{count}} 件完了。',
        more: '前の期間より {{count}} 件多い。',
        fewer: '前の期間より {{count}} 件少ない。',
        lead: '見積から納品まで {{days}}。',
        chaseHeading: '催促',
        tellHeading: '連絡',
        collectHeading: '回収',
        chaseEmpty: 'すべての見積に返答があります。',
        tellEmpty: 'すべての顧客に連絡済みです。',
        collectEmpty: 'すべての請求が支払済みです。',
        ready: '受取可能',
        late: '{{days}} 日超過',
        andMore: 'ほか {{count}} 件',
      },
      teaser: {
        sales: '承認 {{pct}}% · 失注 {{lost}} 件 {{total}}',
        time: '見積から納品まで {{lead}} · 後退 {{moves}} 回',
        money: '承認 {{accepted}} · 未払い {{outstanding}} · {{service}} が売上の {{pct}}%',
        moneyPlain: '承認 {{accepted}} · 未払い {{outstanding}}',
        clients: '新規 {{new}} · リピーター {{returning}}',
      },
    },
