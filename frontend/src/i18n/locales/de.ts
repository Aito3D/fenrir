export default {
  ...
  aito: {
    ...
    track: {
      ...
      paymentMethods: {
        referenceKnown: 'Bitte geben Sie die Angebotsnummer {{ref}} als Verwendungszweck an.',
        referenceUnknown: 'Bitte geben Sie Ihre Angebotsnummer als Verwendungszweck an.',
        ...
        appTransfer: '{{app}}-Überweisung',
        tag: 'Empfänger (Tag)',
        shop: 'Im Geschäft',
        shopSub: 'Bankkarte oder Bargeld.',
        copy: 'Kopieren',
        copied: 'Kopiert',
        copyIban: 'IBAN kopieren',
        copyTag: '{{app}}-Tag kopieren',
        question: 'Antworten Sie bei Fragen auf unsere Nachricht.',
      },
      stages: {
        devis: 'Angebot',
        waiting: 'Freigabe',
