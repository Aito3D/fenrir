export default {
  ...
  calculator: {
    ...
    basePrice: 'Grundpreis ({{currency}})',
    preparation: 'Vorbereitung',
    modelPreparation: 'Modellvorbereitung (Min.)',
    slicing: 'Slicen (Min.)',
    transferStart: 'Übertragung & Start (Min.)',
    postProcessing: 'Nachbearbeitung',
    jobRemoval: 'Entnahme des Drucks (Min.)',
    supportRemoval: 'Stützen entfernen (Min.)',
    additionalWork: 'Zusatzarbeiten (Min.)',
    fulfillment: 'Versand (Min.)',
