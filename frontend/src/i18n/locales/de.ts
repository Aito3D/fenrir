export default {
  ...
  aito: {
    ...
    descriptionPlaceholder: 'Beschreibe das Produkt, das entworfen und gedruckt werden soll …',
    ...
    sendInvoiceTitle: 'Rechnung per E-Mail senden',
    sendInvoiceRecipient: 'Empfänger',
    sendInvoiceSubject: 'Betreff',
    sendInvoiceMessage: 'Nachrichtenvorschau',
    sendInvoiceConfirm: 'Senden',
    sendInvoiceNoRecipients: 'Dieser Kunde hat keine E-Mail-Adresse in Zoho.',
    sendInvoiceLoadFailed: 'E-Mail-Details konnten nicht geladen werden',
    emailPreviewTitle: 'E-Mail-Vorschau',
    invoiceEmailed: 'Rechnung an {{email}} gesendet',
    invoiceEmailFailed: 'Rechnung konnte nicht gesendet werden',
    createInvoice: 'Rechnung erstellen',
    createInvoiceTitle: 'Rechnung erstellen',
    createInvoiceIntro_one: 'Angebot {{quote}}, {{count}} Position. In Zoho Books wird ein Rechnungsentwurf erstellt — es wird nichts versendet.',
    createInvoiceIntro_other: 'Angebot {{quote}}, {{count}} Positionen. In Zoho Books wird ein Rechnungsentwurf erstellt — es wird nichts versendet.',
    createInvoiceAmount: 'Rechnungsbetrag',
    createInvoiceRemaining: 'Offener Betrag',
    createInvoiceLockWarning: 'Nach der Rechnungsstellung nimmt dieses Angebot keine Positionsänderungen aus Fenrir mehr an.',
    createInvoiceConfirm: 'Erstellen',
    createInvoiceLoadFailed: 'Rechnung konnte nicht vorbereitet werden',
    createInvoiceDone: 'Rechnung {{number}} erstellt',
    createInvoiceDonePaid: 'Rechnung {{number}} erstellt und durch die Anzahlungen beglichen',
    createInvoiceDonePartial: 'Rechnung {{number}} erstellt — {{retainers}} konnte nicht angerechnet werden',
    createInvoiceFailed: 'Rechnung konnte nicht erstellt werden',
    acceptQuote: 'Angebot annehmen',
    declineQuote: 'Angebot ablehnen',
    holdToConfirm: 'Zum Bestätigen 0,5 s gedrückt halten',
    quoteSent: 'Angebot als versendet markiert',
    quoteAccepted: 'Angebot angenommen',
    quoteDeclined: 'Angebot abgelehnt',
    quoteUnaccepted: 'Annahme entfernt — Angebot zurück in Wartend',
    unacceptLabel: 'Annahme entfernen',
    unacceptHint: '1s halten, um die Annahme zu entfernen',
    quoteConflictAccepted: 'Dieses Angebot wurde bereits von jemand anderem angenommen.',
    quoteConflictDeclined: 'Dieses Angebot wurde bereits von jemand anderem abgelehnt.',
    zohoNotUpdated: 'Lokal gespeichert – Zoho wurde nicht aktualisiert',
    progressLabel: '{{done}} von {{total}} Schritten erledigt',
    trash: 'Papierkorb',
    trashEmpty: 'Papierkorb ist leer',
    restore: 'Wiederherstellen',
    restored: 'Projekt wiederhergestellt',
    restoreFailed: 'Das Projekt konnte nicht wiederhergestellt werden.',
    ...
    clearUrgent: 'Dringend aufheben',
    holdToMarkUrgent: 'Zum Markieren als dringend 0,5 s gedrückt halten',
    holdToClearUrgent: 'Zum Aufheben der Dringlichkeit 0,5 s gedrückt halten',
    sav: 'Rückläufer',
    markSav: 'Als Rückläufer markieren',
    clearSav: 'Rückläufer aufheben',
    holdToMarkSav: 'Zum Markieren als Rückläufer 0,5 s gedrückt halten',
    holdToClearSav: 'Zum Aufheben des Rückläufers 0,5 s gedrückt halten',
    pause: 'Pausiert',
    markPause: 'Pausieren',
    clearPause: 'Pause aufheben',
    holdToMarkPause: 'Zum Markieren als pausiert 0,5 s gedrückt halten',
    holdToClearPause: 'Zum Aufheben der Pause 0,5 s gedrückt halten',
    markFlag: 'Markieren',
    flagFailed: 'Markierung konnte nicht geändert werden',
    dueDate: 'Zugesagtes Datum',
    dueDateClear: 'Datum löschen',
    dueDateEmpty: 'Datum festlegen',
    dueLateDays: '{{count}} T überfällig',
    dueBadge: 'Fällig am {{date}}',
    dueDateFailed: 'Datum konnte nicht geändert werden',
    datePickerPrev: 'Vorheriger Monat',
    datePickerNext: 'Nächster Monat',
    datePickerBackToSelected: 'Zurück zum gewählten Monat',
    datePickerPlusTwoDays: '+2 Tage',
    datePickerPlusOneWeek: '+1 Woche',
    datePickerPlusTwoWeeks: '+2 Wochen',
    datePickerSuggested: 'vorgeschlagen',
    awaitingContact: 'Zu benachrichtigen',
    markContacted: 'Kunde als benachrichtigt markieren',
    holdToMarkContacted: '0,5 s halten, um zu bestätigen, dass der Kunde benachrichtigt wurde',
    contacted: 'Benachrichtigt',
    clearContacted: 'Benachrichtigung zurücknehmen',
    holdToClearContacted: '0,5 s halten, um die Benachrichtigung zurückzunehmen',
    contactedFailed: 'Kontakt konnte nicht gespeichert werden',
    smsPickupShort: 'SMS',
    smsPickup: 'Abhol-SMS senden',
    smsTitle: 'Abhol-SMS',
    smsMessageLabel: 'Nachricht',
    smsGenerating: 'Nachricht wird verfasst…',
    smsGenerateFailed: 'Nachricht konnte nicht verfasst werden',
    smsRegenerate: 'Neu erstellen',
    ...
    zohoNotConfigured: 'Zoho Books ist noch nicht verbunden.',
    zohoConfigureLink: 'Zoho Books verbinden',
    zohoUnreachable: 'Zoho Books war nicht erreichbar. Bitte versuche es erneut.',
    resetToDefaultClient: 'Auf den Standardkunden zurücksetzen',
    clientPhone: 'Telefon',
    clientEmail: 'E-Mail',
    countryCode: 'Landesvorwahl',
    phonePlaceholder: '87123456',
    emailPlaceholder: 'kunde@beispiel.de',
    revertPhone: 'Telefonnummer verwerfen',
    revertEmail: 'E-Mail verwerfen',
    socialNetworkMessenger: 'Messenger',
    socialNetworkInstagram: 'Instagram',
    socialNetworkWhatsapp: 'WhatsApp',
    socialNetworkTiktok: 'TikTok',
    socialLabel: 'Soziales Netzwerk (optional)',
    socialHandleLabel: 'Benutzername',
    socialHandlePlaceholder: 'benutzername',
    socialRemove: 'Soziales Netzwerk entfernen',
    contactsLabel: 'Kontakte',
    contactsHint: 'Für wen ist dieses Projekt?',
    contactsLoading: 'Kontakte werden aus Zoho Books gelesen…',
    contactsUnavailable: 'Die Kontakte konnten nicht aus Zoho Books gelesen werden — geben Sie unten eine Telefonnummer oder eine E-Mail-Adresse ein.',
    contactPrimary: 'primär',
    contactAdd: 'Kontakt hinzufügen',
    contactAddTitle: 'Neuer Kontakt',
    contactSaveToZoho: 'In Zoho speichern',
    contactFirstNameRequired: 'Geben Sie einen Vornamen ein.',
    contactNeedsPhoneOrEmail: 'Eine Telefonnummer oder eine E-Mail-Adresse wird benötigt, um diese Person zu erreichen.',
    contactAddFailed: 'Der Kontakt konnte nicht hinzugefügt werden. Bitte versuchen Sie es erneut.',
    contactOverrideToggle: 'Für diese Karte eine andere Telefonnummer / E-Mail-Adresse verwenden',
    contactOverrideHint: 'Gilt nur für diese Karte — der Kontakt in Zoho Books wird nicht geändert.',
    contactGone: 'Dieser Kontakt existiert nicht mehr in Zoho Books — wählen Sie eine andere Person.',
    clientEditFanOutPerson: 'Gilt für alle offenen Karten dieser Kontaktperson',
    clientEditTitle: 'Kontaktdaten',
    clientEditSourceZoho: 'Zoho Books',
    clientEditSourceCard: 'Nur diese Karte',
    clientEditFanOut: 'Gilt für alle offenen Karten dieses Kunden',
    ...
    clientHistoryNoQuote: 'kein Angebot',
    clientHistoryThisCard: 'Diese Karte · {{stage}}',
    clientHistoryDeclined: 'Abgelehnt',
    clientHistoryOpenCard: 'Projekt #{{id}} öffnen',
    clientHistoryEmpty: 'Noch keine Projekte für diesen Kunden.',
    clientHistoryError: 'Die Kundenhistorie konnte nicht geladen werden.',
    clientEditLoading: 'Kontakt wird aus Zoho Books gelesen…',
    clientEditWalkIn: 'Laufkunde: Die Änderung bleibt auf dieser Karte und wird nicht an Zoho Books gesendet.',
    clientEditZohoReadFailed: 'Kontakt konnte nicht aus Zoho Books gelesen werden — die Werte der Karte werden angezeigt.',
    clientEditFailed: 'Kunde konnte nicht aktualisiert werden. Bitte erneut versuchen.',
    createClient: 'Neuen Kunden anlegen',
    companyName: 'Firmenname',
    firstName: 'Vorname',
    lastName: 'Nachname',
    createClientSubmit: 'Kunde anlegen',
    back: 'Zurück',
    clientNameRequired: 'Gib einen Firmennamen oder Vor- und Nachnamen ein.',
    newClientPersonHint: 'Oder Vor- und Nachname einer Person',
    newClientContactTag: 'Ansprechpartner im Unternehmen',
    newClientContactHint: 'empfohlen — ein Vorname genügt',
    newClientPreviewCompany: 'Firma: {{name}} · Kontakt: {{person}}',
    newClientPreviewCompanyAlone: 'Firma: {{name}} · noch kein Ansprechpartner',
    newClientPreviewIndividual: 'Privatperson: {{name}}',
    clientCreateFailed: 'Der Kunde konnte nicht angelegt werden. Bitte versuche es erneut.',
    clientSyncFailed: 'Projekt erstellt — der Kunde konnte in Zoho nicht aktualisiert werden.',
    ...
    ageAnchorAccepted: 'Angenommen',
    ageDaysShort: '{{days}} T',
    lastActivity: 'Letzte Aktivität',
    recordLabel: 'Datensatz',
    duplicateProject: "Duplizieren",
    duplicateReplaceTitle: "Aktuellen Entwurf ersetzen?",
    duplicateReplaceBody: "Die Schublade für neue Projekte enthält bereits Arbeit, die noch nicht angelegt wurde. Das Duplizieren dieser Karte ersetzt sie.",
    duplicateReplaceConfirm: "Ersetzen",
    ...
    viewingNow: '{{name}} sieht sich dieses Projekt an',
    ...
    editConflict: 'Jemand anderes hat dieses Projekt bearbeitet — das Board wurde aktualisiert, bitte erneut versuchen.',
    tasks: 'Aufgaben',
    addTask: 'Aufgabe hinzufügen',
    taskFallbackName: 'Aufgabe {{n}}',
    track: {
      pageTitle: 'Auftragsverfolgung · Aito 3D',
      title: 'Verfolgen Sie Ihre Bestellung',
      reference: 'Angebot Nr. {{ref}}',
      stepOf: 'Schritt {{n}} von {{total}}',
      stepsAria: 'Schritte',
      showSteps: 'Schritte anzeigen',
      hideSteps: 'Schritte ausblenden',
      stepsList: 'Details der Schritte',
      tasksHeading: 'Ihre Teile',
      showAllParts: 'Alle {{n}} Teile anzeigen',
      eta: 'Voraussichtliche Verfügbarkeit',
      etaSoon: 'Wir teilen Ihnen so bald wie möglich einen Termin mit.',
      etaUpdating: 'Schätzung wird aktualisiert',
      updated: 'Aktualisiert {{when}}',
      updatedToday: 'heute um {{time}}',
      updatedYesterday: 'gestern um {{time}}',
      updatedOn: 'am {{date}} um {{time}}',
      error: 'Die Verfolgung kann derzeit nicht geladen werden.',
      retry: 'Erneut versuchen',
      invalidTitle: 'Dieser Verfolgungslink ist nicht mehr gültig',
      invalidBody: 'Er ist möglicherweise abgelaufen oder wurde ersetzt. Kontaktieren Sie uns, und wir senden Ihnen einen neuen Link.',
      footerQuestion: 'Eine Frage zu Ihrer Bestellung?',
      enterTitle: 'Meine Bestellung verfolgen',
      enterHint: 'Geben Sie den 6-stelligen Code aus Ihrem Angebot oder unserer Nachricht ein.',
      codeLabel: 'Tracking-Code',
      codeChecking: 'Wird geprüft…',
      retrying: 'Erneuter Versuch…',
      codeFound: 'Code erkannt, Ihre Tracking-Seite wird geöffnet.',
      codeNotFound: 'Code nicht gefunden. Bitte prüfen und erneut versuchen.',
      codeTooMany: 'Zu viele Versuche. Bitte eine Minute warten.',
      codeError: 'Der Code kann gerade nicht geprüft werden. Mit Eingabetaste erneut versuchen.',
      ...
      paymentMethods: {
        ...
        referenceUnknown: 'Ihre Angebotsnummer',
        transferDelay: 'Eine Überweisung kann ein bis zwei Tage brauchen, bis sie bei uns ankommt.',
        appTag: '{{app}}-Tag',
        appMessage: 'Nachricht',
        appHint: 'Senden Sie den Angebotsbetrag in der {{app}}-App an diesen Tag.',
        shop: 'Im Laden',
        shopSub: 'Bankkarte, Bargeld oder Scheck.',
        shopAddress: 'Adresse',
      ...
      status: {
        devisTitle: 'Angebot in Vorbereitung',
        ...
        pickedUpTitle: 'Abgeholt',
        pickedUpSub: 'Am {{date}}. Vielen Dank für Ihr Vertrauen!',
        doneTitle: 'Abgeschlossen',
        doneSub: 'Vielen Dank für Ihr Vertrauen!',
      },
      invoice: {
        paidTitle: 'Rechnung bezahlt',
        paidSub: 'Vielen Dank für Ihr Vertrauen.',
        unpaidTitle: 'Rechnung offen',
        unpaidSub: 'Vor der Abholung oder dem Versand zu bezahlen.',
        overdueTitle: 'Rechnung überfällig',
        overdueSub: 'Kontaktieren Sie uns, falls Sie bereits bezahlt haben.',
      },
      payment: {
        unpaidTitle: 'Projekt noch nicht bezahlt',
        unpaidSub: 'Zahlen Sie online, per Überweisung oder im Geschäft.',
        unpaidDepositSub: 'Eine Anzahlung sichert Ihren Auftrag — zahlen Sie online, per Überweisung oder im Geschäft.',
        validateTitle: 'Nehmen Sie Ihr Angebot an',
        validateSub: 'Die Online-Zahlung gilt als Annahme des Angebots.',
        validateDepositSub: 'Eine Anzahlung nimmt Ihr Angebot an und startet die Fertigung.',
        pay: 'Online bezahlen',
        paidTitle: 'Zahlung erhalten',
        depositPaidTitle: 'Anzahlung erhalten',
        paidSub: 'Vielen Dank für Ihr Vertrauen.',
      },
    },
    trackingCopy: 'Tracking-Link kopieren',
    trackingOpen: 'Tracking-Link öffnen',
    ...
    paymentLink: {
      ...
      paid: 'Bezahlt',
      copy: 'Zahlungslink kopieren',
      open: 'Zahlungslink öffnen',
      copied: 'Kopiert',
      expiresIn_one: 'Läuft in {{count}} Tag ab',
      expiresIn_other: 'Läuft in {{count}} Tagen ab',
      expiresToday: 'Läuft heute ab',
      retry: 'Erneut versuchen',
      state: { expired: 'Abgelaufen', cancelled: 'Storniert', failed: 'Abgelehnt' },
    },
    payment: {
      dueQuote: 'Anzahlung fällig',
      dueInvoice: 'Restbetrag fällig',
      cellLink: 'Link',
      cellTerminal: 'Kartenterminal',
      cellManual: 'Manuell',
      cellLinkTitle: 'Zahlungslink',
      cellTerminalTitle: 'Mit Karte am Kartenterminal zahlen',
      cellManualTitle: 'Manuell — Zahlung erfassen',
      terminalOff: 'Heimdall ist nicht konfiguriert',
      stateProcessing: 'Kartenterminal · wartet auf die Karte',
      stateAttention: 'Unbekanntes Ergebnis · Kartenterminal prüfen',
      statePaid: 'Bezahlt {{amount}} · {{channel}} · {{date}}',
      statePaidNoDate: 'Bezahlt {{amount}} · {{channel}}',
      stateBookingFailed: 'Nicht in Zoho Books erfasst — siehe Heimdall',
      stateNoLink: 'Kein Link',
      channelTerminal: 'Kartenterminal',
      channelLink: 'online',
      amountLabel: 'Betrag',
      manualTitle: 'Zahlung erfassen',
      manualIntroQuote: 'Angebot {{number}} · Anzahlung am Schalter erhalten',
      manualIntroInvoice: 'Rechnung {{number}} · Zahlung am Schalter erhalten',
      modeLabel: 'Zahlungsart',
      modeCard: 'Karte',
      modeCheque: 'Scheck',
      modeCash: 'Bargeld',
      referenceLabel: 'Referenz',
      referenceRequired: 'Ein Scheck benötigt seine Nummer',
      manualHintQuote: 'Erstellt eine Anzahlungsrechnung zum Angebot in Zoho Books und erfasst dort die Zahlung.',
      manualHintInvoice: 'Erfasst die Zahlung auf der Rechnung in Zoho Books.',
      manualConfirm: 'Erfassen',
      manualDone: 'Zahlung erfasst',
      amountInvalid: 'Geben Sie einen ganzzahligen Betrag über null ein',
      terminalTitle: 'Mit Karte bezahlen',
      terminalIntro: '{{number}} · am Kartenterminal',
      terminalHintQuote: 'Vorausgefüllt mit der fälligen Anzahlung; bei einem Angebot wird jeder Betrag akzeptiert.',
      terminalHintInvoice: 'Vorausgefüllt mit dem Restbetrag; Heimdall begrenzt ihn auf den Restbetrag.',
      terminalStart: 'Kartenterminal starten',
      terminalWaiting: 'Warte auf die Karte am Kartenterminal…',
      terminalWaitingHint: 'Bis zu 3 Minuten für die PIN.',
      terminalLeave: 'Schließen, ich komme zurück',
      terminalPaid: 'Zahlung akzeptiert',
      terminalBookingPending: 'Wird in Zoho Books erfasst…',
      terminalBookingDone: 'In Zoho Books erfasst',
      terminalBookingFailed: 'Nicht in Zoho Books erfasst — siehe Heimdall',
      terminalFailed: 'Abgelehnt',
      terminalFailedHint: 'Es wurde nichts abgebucht. Sie können es erneut versuchen.',
      terminalRetry: 'Erneut versuchen',
      terminalAttention: 'Unbekanntes Ergebnis',
      terminalAttentionHint: 'Das Kartenterminal hat nicht geantwortet. Prüfen Sie den Papierbeleg, bevor Sie es erneut versuchen.',
      linkTitle: 'Zahlungslink',
      linkCreate: 'Link erstellen',
      linkCreateAgain: 'Neuen Link erstellen',
      linkCancel: 'Link stornieren',
      linkCancelConfirm: 'Diesen Link stornieren?',
      linkExpires: 'Läuft ab',
      linkHintInvoice: 'Vorausgefüllt mit dem Restbetrag. Der Link läuft nach Ablauf der Angebotsgültigkeit ab.',
      linkPending: 'Link wird erstellt…',
      linkDone: 'Zahlungslink erstellt',
      linkCancelled: 'Zahlungslink storniert',
    },
    pastCards_one: '{{count}} frühere Karte',
    pastCards_other: '{{count}} frühere Karten',
    reuseTasks: 'Wiederverwenden',
    rating: {
      good: 'Gut',
      medium: 'Mittel',
      bad: 'Schlecht',
      ...
      pastDue_one: '{{count}} fällig',
      pastDue_other: '{{count}} fällig',
    ...
    taskTitlePlaceholder: 'Titel (optional)',
    taskDescriptionPlaceholder: 'Beschreibung (optional)',
    removeTask: 'Aufgabe entfernen',
    serviceScan3D: 'Scan',
    serviceModelisation3D: 'Modellierung',
    serviceImpression3D: 'Druck',
    serviceUsinage: 'Fräsen',
    serviceMainDoeuvre: 'Arbeitszeit',
    serviceDescriptionRequired: 'Beschreibung (erforderlich)',
    maindoeuvreDescriptionRequired: 'Arbeitszeit benötigt eine Beschreibung',
    serviceCost: 'Kosten',
    serviceUnitCost: 'Stückkosten',
    discount: 'Rabatt',
    serviceTotal: 'Zeilensumme',
    done: 'Erledigt',
    editTask: 'Aufgabe bearbeiten',
    reorderTask: 'Aufgabe neu anordnen',
    taskFinished: 'Aufgabe abgeschlossen',
    noSteps: 'Noch keine Schritte — fügen Sie einem Schritt Kosten hinzu, um ihn zu erstellen',
    importQuote: 'Importieren',
    importTitle: 'Angebot importieren',
    quoteSearchLabel: 'Angebot',
    ...
    quoteNoServiceLines: 'Dieses Angebot enthält keine AITO 3D-Leistungspositionen.',
    quoteAlreadyImported: 'Bereits als Projekt Nr. {{id}} importiert',
    quoteImport: 'Importieren',
    quoteSkipped: 'Nicht importiert',
    quoteTotals: 'Projekt {{project}} · Angebot {{quote}}',
    quoteCurrencyMismatch: 'Dieses Angebot ist in {{code}}; das Board zeigt {{configured}}.',
    quoteOpenInZoho: 'In Zoho Books öffnen',
    changeQuote: 'Ändern',
    quoteRowImported: 'Importiert → Nr. {{id}}',
    beforeImport: 'Vor dem Importieren',
    ruleQuoteLines: 'Angebot enthält AITO-Leistungspositionen',
    ruleQuoteFresh: 'Noch nicht importiert',
    ruleCurrencyOk: 'Währung stimmt mit dem Board überein',
    ruleImportDescription: 'Beschreibung ausgefüllt',
    importTaskCount_one: '{{count}} Aufgabe',
    importTaskCount_other: '{{count}} Aufgaben',
    printer: 'Drucker',
    material: 'Material',
    weightG: 'Gewicht (g)',
    printTime: 'Druckzeit',
    ...
    followCalculator: 'Kalkulation folgen',
    priceManual: 'Manuell',
    priceLinked: 'Kalkulation',
    perPart: 'pro Teil',
    ...
    quotePending: 'Angebot wird erstellt…',
    ...
    syncBlockedLabel: 'Sync blockiert',
    forceSync: 'Sync erzwingen',
    forceSyncHint: 'Angebot in Zoho erneut prüfen und Kosten wieder senden',
    ...
    stats: {
      ...
      leadTime: 'Vom Angebot zur Lieferung',
      median: 'Median {{days}} T',
      productionTime: 'Von der Annahme zur Lieferung',
      daysShort: '{{days}} T',
      activity: 'Aktivität pro Tag',
      rolling7: '7-Tage-Durchschnitt der Abgeschlossenen',
      flow: 'Tage in jeder Phase',
      sent: 'Gesendet',
      ofAccepted: '{{pct}} % der Angenommenen',
      quoted: 'Angenommene Angebote',
      invoiced: 'Abgerechnet',
      outstanding: 'Offen',
      empty: 'In diesem Zeitraum ist nichts passiert',
      vsPrevious: 'Vorheriger Zeitraum: {{value}}',
      weekOf: 'Woche vom {{date}}',
      sales: 'Verkauf',
      time: 'Zeit',
      money: 'Geld',
      clients: 'Kunden',
      asOfToday: 'Stand heute',
      ageDays: '{{range}} Tage',
      winRate: 'Abschlussquote nach Auftragsgröße',
      winRateEmpty: 'Noch nicht genug entschiedene Angebote',
      decisions: '{{count}} entschieden',
      stageTime: 'Dauer je abgeschlossenem Projekt',
      reworkMoves: 'Rückwärtsbewegungen',
      reworkShare: '{{cards}} Karten · {{pct}} % der bewegten Karten',
      overdue: 'Überfällige Rechnungen',
      overdueOldest: 'älteste {{days}} T',
      nothingOverdue: 'Nichts überfällig',
      serviceMix: 'Leistungsmix',
      serviceTasks: '{{count}} Aufgaben',
      clientsNew: 'Neue Kunden',
      clientsReturning: 'Wiederkehrende Kunden',
      returningShare: '{{pct}} % des Umsatzes von wiederkehrenden Kunden',
      arrivals: 'Wann Anfragen eintreffen',
      islands: 'Versand nach Insel',
      pickup: 'Abholung',
      declined: 'Abgelehnt',
      acceptanceRate: '{{pct}} % angenommen',
      ...
      strip: {
        onBoard: '{{amount}} auf dem Board',
        longest: 'am längsten wartet: <who>{{name}}, {{days}}</who> in {{stage}}',
        oldest: 'ältestes {{days}} T',
        noQuote: 'noch kein Angebot',
        dueSoon_one: '{{count}} Lieferung diese Woche fällig',
        dueSoon_other: '{{count}} Lieferungen diese Woche fällig',
      },
      facts: {
        perDay: '{{count}} pro Tag',
        waiting15: 'Seit 15+ Tagen wartend',
        lostWith: 'Verloren mit abgelehnten Angeboten',
        shippingBilled: 'Versand berechnet',
        parcels_one: '{{count}} Paket',
        parcels_other: '{{count}} Pakete',
      ...
      finding: {
        overview: '{{in}}, {{accepted}} und {{done}}.',
        overviewIn_one: '{{count}} Projekt ist eingegangen',
        overviewIn_other: '{{count}} Projekte sind eingegangen',
        overviewAccepted_one: '{{count}} wurde angenommen',
        overviewAccepted_other: '{{count}} wurden angenommen',
        overviewDone_one: '{{count}} wurde geliefert',
        overviewDone_other: '{{count}} wurden geliefert',
        overviewPeakWeek: 'Die Woche mit dem meisten Betrieb war die Woche vom {{date}}.',
        overviewPeakDay: 'Der Tag mit dem meisten Betrieb war der {{date}}.',
        salesWin: 'Sie gewinnen {{pct}} % der Angebote.',
        salesLost_one: '{{count}} Angebot ging verloren, im Wert von {{total}}.',
        salesLost_other: '{{count}} Angebote gingen verloren, zusammen im Wert von {{total}}.',
        salesLostBig: 'Verloren gehen die großen: {{lost}} der {{decided}} über {{min}}, zusammen im Wert von {{total}}.',
        salesNone: 'In diesem Zeitraum wurde kein Angebot entschieden.',
        timeLead: 'Ein Projekt braucht {{days}} vom Angebot bis zur Lieferung.',
        timeSlow: '{{stage}} ist die langsame Phase mit {{days}}.',
        timeRework_one: '{{count}} Bewegung ging rückwärts.',
        timeRework_other: '{{count}} Bewegungen gingen rückwärts, auf {{cards}}.',
        timeNone: 'In diesem Zeitraum wurde kein Projekt geliefert.',
        moneyTotals: '{{accepted}} angenommen und {{invoiced}} abgerechnet.',
        moneyOut: '{{amount}} stehen noch aus, auf {{invoices}}.',
        moneyOverdue_one: '{{count}} davon ist überfällig, um {{days}} Tage.',
        moneyOverdue_other: '{{count}} davon sind überfällig, die älteste um {{days}} Tage.',
        moneyClear: 'Nichts steht aus.',
        clients: '{{new}} und {{returning}}.',
        clientsNew_one: '{{count}} neuer Kunde',
        clientsNew_other: '{{count}} neue Kunden',
        clientsReturning_one: '{{count}} wiederkehrender',
        clientsReturning_other: '{{count}} wiederkehrende',
        clientsPeak: 'Anfragen kommen am {{day}} gegen {{hour}}.',
        clientsParcels_one: '{{count}} Paket ging auf die Inseln.',
        clientsParcels_other: '{{count}} Pakete gingen auf die Inseln.',
        clientsNone: 'Keine neuen Kunden in diesem Zeitraum.',
      },
      brief: {
        chase_one: '{{count}} Angebot nachfassen',
        chase_other: '{{count}} Angebote nachfassen',
        tell_one: '{{count}} Kunden benachrichtigen',
        tell_other: '{{count}} Kunden benachrichtigen',
        collect: '{{amount}} einziehen',
        allClear: 'Nichts nachzufassen, niemand zu benachrichtigen, nichts einzuziehen.',
        due_one: '{{count}} Lieferung ist diese Woche fällig.',
        due_other: '{{count}} Lieferungen sind diese Woche fällig.',
        chaseHeading: 'Nachfassen',
        tellHeading: 'Benachrichtigen',
        collectHeading: 'Einziehen',
        ready: 'Abholbereit',
        late: '{{days}} T überfällig',
    ...
    history: {
      ...
      invoiceDetected: 'hat eine Rechnung in Zoho gefunden',
      ...
      quoteDeclined: 'hat das Angebot abgelehnt',
      quoteExpired: 'Angebot abgelaufen',
      stageChanged: 'hat das Projekt verschoben',
      projectTrashed: 'hat das Projekt in den Papierkorb verschoben',
      projectRestored: 'hat das Projekt wiederhergestellt',
      taskAdded: 'hat eine Aufgabe hinzugefügt',
      taskUpdated: 'hat eine Aufgabe bearbeitet',
      taskRemoved: 'hat eine Aufgabe entfernt',
      taskReordered: 'hat die Aufgaben neu angeordnet',
      taskStepTicked: 'hat einen Schritt abgehakt',
      taskStepUnticked: 'hat das Häkchen bei einem Schritt entfernt',
      projectUpdated: 'hat das Projekt bearbeitet',
      projectUrgentSet: 'Als dringend markiert',
      projectUrgentCleared: 'Dringend aufgehoben',
      projectSavSet: 'Als Rückläufer markiert',
      projectSavCleared: 'Rückläufer aufgehoben',
      projectPauseSet: 'Als pausiert markiert',
      ...
      paymentLinkCreated: 'Zahlungslink erstellt',
      paymentLinkReplaced: 'Zahlungslink ersetzt',
      paymentLinkUpdated: 'Zahlungslink aktualisiert',
      paymentLinkPaid: 'Online bezahlt',
      paymentLinkCancelled: 'Zahlungslink storniert',
      paymentTerminalStarted: 'Kartenzahlung am Kartenterminal gestartet',
      paymentTerminalPaid: 'Per Karte am Kartenterminal bezahlt',
      paymentTerminalFailed: 'Zahlung am Kartenterminal abgelehnt oder abgebrochen',
      paymentTerminalAttention: 'Ergebnis des Kartenterminals unbekannt — Kartenterminal prüfen',
      paymentManualRecorded: 'Zahlung erfasst',
      paymentManualPartial: 'Anzahlungsrechnung erstellt, Zahlung NICHT erfasst — in Zoho Books abschließen',
      noteAdded: 'hat eine Notiz hinzugefügt',
      zohoComment: 'Kommentar in Zoho Books',
      syncQueued: 'Für Zoho vorgemerkt',
      syncPushed: 'An Zoho übertragen',
      syncFailed: 'Übertragung an Zoho fehlgeschlagen',
      syncLocked: 'Angebot in Zoho gesperrt',
      syncConflict: 'Statuskonflikt mit Zoho',
      syncStatusRejected: 'Zoho hat die Statusänderung abgelehnt',
      pollReconciled: 'Mit Zoho abgeglichen',
    },
    // New-project drawer
    workSection: 'Die Arbeit',
    clientSectionTitle: 'Kunde',
    workHintNone: 'noch keine Aufgaben',
    workHintProgress: '{{done}} von {{total}} vollständig',
    addService: '{{service}} hinzufügen',
    removeServiceChip: '{{service}} entfernen',
    taskNeedsSubTask: 'Teilaufgabe hinzufügen',
    railSummary: 'Übersicht',
    summaryTitle: 'Projektzusammenfassung',
    summaryWaiting: 'Wird beim Kundenschritt erzeugt.',
    summaryGeneratedBy: 'Erzeugt von {{model}} — zum Bearbeiten klicken',
    summaryEdited: 'Von Hand bearbeitet — keine automatische Neuerzeugung mehr',
    summaryFallback: 'KI nicht verfügbar — Beschreibung selbst schreiben',
    aiFieldHint: 'Rechtschreibung von der KI korrigiert',
    aiChecking: 'Rechtschreibung wird geprüft…',
    aiUndo: 'Meinen Text wiederherstellen',
    regenerate: 'Neu erzeugen',
    beforeCreate: 'Vor dem Erstellen',
    ruleTasksOk_one: '{{count}} Aufgabe — mindestens eine erforderlich',
    ruleTasksOk_other: '{{count}} Aufgaben — mindestens eine erforderlich',
    ruleNeedTask: 'Ein Projekt braucht mindestens eine Aufgabe — eine hinzufügen',
    ruleSubTasksOk: 'Jede Aufgabe hat eine bepreiste Teilaufgabe',
    ruleSubTaskMissing: '„{{name}}" braucht mindestens eine bepreiste Teilaufgabe',
    ruleSubTasksPending: 'Jede Aufgabe braucht mindestens eine bepreiste Teilaufgabe',
    ruleClientAccount: 'Kundenkonto — {{name}}',
    ruleClientReachable: 'Kunde erreichbar — {{contact}}',
    ruleClientContact: 'Der Kunde braucht Telefon, E-Mail oder ein soziales Netzwerk',
    warnNoEmail: 'Keine E-Mail — das Angebot kann nicht gemailt werden',
    warnNoPhone: 'Keine Telefonnummer — daran denken, sie zu erfragen',
    holdToReset: 'Halten, um den Entwurf zurückzusetzen',
    resetDraft: 'Entwurf zurücksetzen',
    shippingAdd: 'Versand hinzufügen',
    shippingTitle: 'Versand',
    shippingRemove: 'Versand entfernen',
    shippingEdit: 'Versand bearbeiten',
    shippingIsland: 'Zielinsel',
    shippingIslandPlaceholder: 'Insel suchen…',
    shippingNoIslands: 'Keine Insel gefunden',
    shippingFirstName: 'Vorname des Empfängers',
    shippingLastName: 'Nachname des Empfängers',
    shippingPhone: 'Telefon des Empfängers',
    shippingRecipient: 'Empfänger',
    ...
    shippingRateNegative: 'Der Preis darf nicht negativ sein',
    shippingLta: 'LTA-Nummer',
    shippingLtaPlaceholder: 'Luftfrachtbrief-Nummer…',
    shippingUnavailable: 'Versanddienste sind nicht verfügbar, solange Zoho nicht erreichbar ist',
    ruleShippingPending: 'Versand wird ausgefüllt',
    ruleShippingOk: 'Versand nach {{island}} · {{recipient}}',
    ruleShippingMissingIsland: 'Versand: Insel fehlt',
    ruleShippingMissingRecipient: 'Versand: Name des Empfängers fehlt',
    ruleShippingInvalidPhone: 'Versand: ungültige Telefonnummer',
  },
  // Navigation
  nav: {
    aito: 'Aito',
    ...
    installAppSuccess: 'Fenrir wurde installiert',
  },
  ...
  printers: {
    ...
    maintenance: {
      ...
      editFieldHelp: 'Wenn aktiviert, ist dieser Drucker von MQTT, Warteschlangenversand und Benachrichtigungen pausiert — nützlich für Reparaturen, parallele Fenrir-Installationen oder temporäre Außerbetriebnahme.',
    },
    // Chamber light
    ...
    cameraGrid: {
      ...
      streamRejected: 'Stream vom Server abgelehnt (HTTP {{status}})',
      connectionLost: 'Verbindung verloren',
      reconnecting: 'Neuverbindung in {{countdown}}s (Versuch {{attempt}})',
      expand: 'Vergrößern',
    ...
    nozzleSlotEmpty: 'Slot {{slot}} — Leer',
    humidityTooltip: 'Luftfeuchtigkeit: {{value}}% - {{status}}',
    temperatureTooltip: 'Temperatur: {{value}}°C - {{status}}',
    clickForHistory: 'Klicken für Verlauf',
    ...
    clickToDismiss: 'Klicken zum Ausblenden',
    aiDetection: {
      safe: 'Sicher',
      warning: 'Warnung',
      failure: 'Fehldruck',
  ...
  archives: {
    ...
    no3mfBanner: {
      ...
      body: 'Der Slicer hat die .gcode.3mf-Datei nicht auf der SD-Karte des Druckers hinterlegt, daher konnte Fenrir weder Vorschaubild noch Slicer-Metadaten abrufen. Üblicherweise liegt das daran, dass "Gesendete Dateien auf externem Speicher speichern" im Slicer (Geräte-Tab in Bambu Studio / OrcaSlicer) deaktiviert ist.',
    ...
    menu: {
      ...
      openInCalculator: 'Im Rechner öffnen',
      slice: 'Slicen',
    ...
    card: {
      ...
      gcode: 'GCODE',
      source: 'QUELLE',
      unverifiedFile: 'Nicht verifiziert',
      unverifiedFileTooltip: 'Diese Datei wurde nur anhand des Namens zugeordnet — sie ist möglicherweise nicht die tatsächlich gedruckte Datei.',
  ...
  stats: {
    ...
    filamentCostFromCalculator: 'Berechnet aus den Filamentpreisen des Preisrechners',
    ...
    failuresByFilament: 'Fehler nach Filament',
    failuresByPrinter: 'Fehler nach Drucker',
    deltaVsPrevious: 'ggü. vorherigem {{days}}-Tage-Zeitraum',
    utilizationBusy: '{{hours}} h belegt',
    utilizationNoData: 'Keine Drucke mit Zeitdaten in diesem Zeitraum',
    costBreakdown: 'Kostenaufschlüsselung',
    costFilament: 'Filament',
    costEnergy: 'Energie',
    costMachine: 'Maschine',
    costPerPrintHour: 'Pro Druckstunde',
    costPerKg: 'Pro kg',
    costCoverage: '{{priced}} von {{total}} Drucken bepreist',
    costNoData: 'Mit der aktuellen Kalkulator-Konfiguration konnten keine Drucke bepreist werden',
    filamentForecast: 'Filament-Prognose',
    forecastDaysLeft: '≈ noch {{days}} T.',
    forecastNoUsage: 'Kein aktueller Verbrauch',
    forecastNoInventory: 'Keine Spulen im Bestand',
    forecastRemaining: '{{amount}} übrig',
    forecastBasis: 'Hochgerechnet aus dem letzten Verbrauch — Details auf der Bestandsseite',
    maintenanceReliability: 'Wartung & Zuverlässigkeit',
    printsSinceMaintenance: '{{prints}} Drucke · {{failures}} fehlgeschlagen seit {{date}}',
    neverMaintained: 'Keine Wartung erfasst',
    maintenanceDueBadge: '{{n}} fällig',
    maintenanceWarningBadge: '{{n}} bald',
    maintenanceNoData: 'Keine Drucker mit Wartungsverfolgung',
    maintenanceSinceCaption: 'Zählungen beziehen sich auf den gewählten Zeitraum',
    energyWidgetTitle: 'Energieverbrauch',
    aitoPipeline: 'Aito-Pipeline',
    aitoPipelineEmpty: 'Nichts auf dem Aito-Board in diesem Zeitraum',
    pipelineByStage: 'Nach Phase',
    pipelineConversion: 'Angebotsumwandlung',
    pipelineSent: 'Gesendet',
    pipelineAccepted: 'Angenommen',
    pipelineDeclined: 'Abgelehnt',
    pipelineAcceptedRate: '{{pct}} % angenommen',
    pipelineStageDays: 'Tage je Phase',
    pipelineInvoicing: 'Rechnungen',
    pipelineInvoiced: 'Berechnet',
    pipelineOutstanding: 'Offen',
    pipelineTracking: 'Kunden-Tracking',
    pipelineTrackingViews: 'Seitenaufrufe',
    pipelineTrackingCards: 'Angesehene Karten',
    pipelineTrackingLinks: 'Karten mit Link',
    pipelineDays: '{{days}} T',
    pipelineSample_one: '{{count}} Karte',
    pipelineSample_other: '{{count}} Karten',
    energyTotalLabel: 'Gesamt',
    energyCostLabel: 'Kosten',
    energyAvgPerDay: 'Ø pro Tag',
    energyAvgPerPrint: 'Ø pro Druck',
    energyNoPlugs: 'Keine Smart-Plugs mit Energiemessung eingerichtet',
    energyNoData: 'Keine Energiedaten für diesen Zeitraum aufgezeichnet',
  ...
  settings: {
    ...
    ldap: {
      ...
      feature3: 'LDAP-Gruppen werden bei der Anmeldung Fenrir-Gruppen zugeordnet',
      ...
      autoProvisionHint: 'Automatisch ein Fenrir-Konto bei der ersten LDAP-Anmeldung erstellen',
      ...
      groupMappingHint: 'LDAP-Gruppen-DNs Fenrir-Gruppen zuordnen. Verfügbare Gruppen: ',
    ...
    preheatFilamentTargetsHint: 'Fenrir wählt das höchste Ziel über die geladenen AMS-Slots. Ein Druck, dessen Slots alle 0 ergeben – PLA, PETG, TPU, PVA –, überspringt das Vorheizen vollständig und startet sofort.',
    ...
    authDisabledMessage: 'Aktivieren Sie die Authentifizierung, um Benutzerkonten zu erstellen, Berechtigungen zu verwalten und Ihre Fenrir-Instanz zu sichern.',
    ...
    disableAuthenticationMessage: 'Möchten Sie die Authentifizierung wirklich deaktivieren? Dadurch wird Ihre Fenrir-Instanz ohne Anmeldung zugänglich. Alle Benutzer bleiben in der Datenbank, aber die Authentifizierung wird deaktiviert.',
    disableAuthentication: 'Authentifizierung deaktivieren',
    // Additional settings
    configureFenrir: 'Fenrir konfigurieren',
    ...
    cameraQualityLow: 'Niedrig',
    cameraQualityMedium: 'Mittel',
    cameraQualityHigh: 'Hoch',
    cameraQualityAuto: 'Automatisch',
    cameraQualityAutoWithResolved: 'Automatisch ({{resolved}})',
    cameraQualityAutoResolved: 'Automatisch gewählt: {{resolved}} basierend auf Server-Hardware.',
    cameraQualityAutoResolvedDual: 'Automatisch gewählt: {{single}} (Einzelansicht), {{grid}} (Kameraraster) basierend auf Server-Hardware und Streamanzahl.',
    cameraQualityDescription: 'Steuert Stream-FPS und Auflösung. Niedrigere Qualität reduziert die CPU-Auslastung bei mehreren Kameras.',
    cameraGpuAccel: 'GPU-Beschleunigung',
    cameraGpuAccelDescription: 'Hardwarebeschleunigte Videodekodierung für Kamerastreams verwenden. Reduziert die CPU-Auslastung auf Servern mit geeigneten GPUs.',
    cameraGpuAccelUnavailable: 'Keine GPU-Beschleunigung auf diesem Server verfügbar.',
    cameraGpuAccelBackends: 'Verfügbare Backends: {{backends}}',
    cameraEngine: 'Kamera-Engine',
    cameraEngineFFmpeg: 'FFmpeg (MJPEG)',
    cameraEngineGo2rtc: 'go2rtc (WebRTC)',
    cameraEngineFFmpegDescription: 'Transkodiert RTSP zu MJPEG über FFmpeg. Funktioniert mit allen Browsern, benötigt aber mehr CPU.',
    cameraEngineGo2rtcDescription: 'Leitet H.264 direkt per WebRTC an den Browser weiter. Keine Transkodierung, geringere Latenz, Hardware-Dekodierung. Innenkameras (A1/P1) verwenden weiterhin FFmpeg.',
    ...
    updateViaHomeAssistant: 'Updates werden vom Home Assistant Supervisor verwaltet. Öffne Einstellungen → Add-ons → Fenrir in Home Assistant, um die neue Version zu installieren.',
    ...
    externalUrlDescription: 'Die externe URL, unter der Fenrir erreichbar ist. Wird für Benachrichtigungsbilder und externe Integrationen verwendet.',
    ...
    mqttDescription: 'Fenrir-Ereignisse an einen externen MQTT-Broker zur Integration mit Node-RED, Home Assistant und anderen Automatisierungssystemen veröffentlichen.',
    ...
    encryption: {
      ...
      notConfiguredDesc: 'TOTP-Geheimnisse und OIDC-Client-Secrets werden im Klartext gespeichert. Setze MFA_ENCRYPTION_KEY oder starte Fenrir mit beschreibbarem Datenverzeichnis neu, damit ein Schlüssel automatisch erzeugt wird.',
      ...
      migrationErrorWarning: '{{count}} Legacy-Eintrag/Einträge konnten beim Start nicht verschlüsselt werden. Prüfen Sie die Server-Logs und starten Sie Fenrir neu.',
    },
    ...
    openrouterTitle: 'KI-Zusammenfassung (OpenRouter)',
    openrouterApiKey: 'OpenRouter-API-Schlüssel',
    openrouterApiKeyHint: 'Nur Schreiben — leer lassen, um den aktuellen Schlüssel zu behalten',
    openrouterModel: 'Modell',
    openrouterModelHint: 'OpenRouter-Modell-ID für Projektzusammenfassungen (Französisch)',
    ...
    aitoFollowupLinkDays: 'Zahlungslink läuft ab (Tage)',
    aitoFollowupLinkDaysDescription: 'Angebote markieren, deren Zahlungslink innerhalb dieser Tage abläuft',
  },
  ...
  hmsErrors: {
    ...
    runoutSlotUnknown: 'Das Filament ist aufgebraucht und der Druck ist pausiert. Fenrir konnte nicht ermitteln, welchen Slot der Drucker jetzt erwartet — prüfen Sie am Druckerdisplay, welcher Slot angefordert wird.',
    actions: {
  ...
  login: {
    ...
    resetStep1: 'Kontaktieren Sie Ihren Fenrir-Administrator',
    ...
    twoFA: {
      ...
      instructionsTotp: 'Öffnen Sie Ihre Authenticator-App und geben Sie den 6-stelligen Code für Fenrir ein.',
  ...
  // Setup page
  setup: {
    title: 'Fenrir Einrichtung',
    subtitle: 'Konfigurieren Sie die Authentifizierung für Ihre Fenrir-Instanz',
  ...
  users: {
    ...
    subtitle: 'Benutzer und deren Zugriff auf Ihre Fenrir-Instanz verwalten',
    backToSettings: 'Zurück zu Einstellungen',
    createUser: 'Benutzer erstellen',
    noPermission: 'Sie haben keine Berechtigung, auf diese Seite zuzugreifen.',
    admin: 'Admin',
  ...
  profiles: {
    ...
    orcaCloud: {
      ...
      connect: {
        ...
        description: 'Melden Sie sich bei Ihrem Orca Cloud-Konto an, um Ihre Slicer-Profile in Fenrir zu synchronisieren.',
      },
      device: {
        title: 'Fenrir in Orca Cloud genehmigen',
        instruction: 'Öffnen Sie Orca Cloud und genehmigen Sie diesen Code. Fenrir verbindet sich automatisch, sobald Sie genehmigt haben.',
    ...
    login: {
      ...
      captchaBody: 'Bambu fordert für dein Netzwerk eine CAPTCHA-Prüfung, bevor eine Anmeldung akzeptiert wird, und diese Prüfung lässt sich aus Fenrir heraus nicht beantworten. E-Mail und Passwort sind nicht das Problem. Die Sperre hängt an deiner öffentlichen IP-Adresse und löst sich normalerweise innerhalb weniger Stunden von selbst — wiederholte Versuche verlängern sie. Um dich jetzt anzumelden, verwende stattdessen ein Zugriffstoken aus einer Browser-Sitzung.',
  ...
  filamentProfiles: {
    ...
    syncingZoho: 'Preise werden von Zoho synchronisiert…',
    syncToPc: 'Auf PC synchronisieren',
    exportZip: 'ZIP exportieren',
    newPreset: 'Neues Preset',
    // Filters
    searchPlaceholder: 'Presets durchsuchen…',
    ...
    gridSmall: 'Kleines Raster',
    gridMedium: 'Mittleres Raster',
    gridLarge: 'Großes Raster',
    // Grid
    emptyTitle: 'Noch keine Presets',
    emptySubtitle: 'Erstellen Sie ein Preset manuell oder importieren Sie es aus einem Ordner.',
    ...
    deleteBody: '{{name}} wird endgültig gelöscht.',
    cancel: 'Abbrechen',
    deleteConfirm: 'Löschen',
    // Sync-base modal
    baseSyncedTitle: 'Basisprofile synchronisiert',
    baseSyncFailedTitle: 'Synchronisierung fehlgeschlagen',
    filesScanned: '{{n}} Dateien gescannt',
    statNew: 'Neu',
    statUpdated: 'Aktualisiert',
    statUnchanged: 'Unverändert',
    close: 'Schließen',
    // Sync modal
    syncTitle: 'Auf PC synchronisieren',
    syncSubtitle: 'Änderungen werden auf den BambuStudio-Filamentordner angewendet.',
    ...
    // Import
    scanFailed: 'Fehler beim Lesen des BambuStudio-Ordners: {{error}}',
    allImported: '{{n}} Datei(en) gefunden — bereits alle importiert.',
    importing: 'Presets werden importiert… {{current}}/{{total}}',
    ...
    inheritsNotFound: '(nicht gefunden)',
    reload: 'Neu laden',
    serverChangedBanner: 'Dieses Preset wurde auf dem Server geändert, während du es bearbeitet hast.',
    serverChangedReload: 'Vom Server neu laden',
    save: 'Speichern',
    create: 'Erstellen',
    saving: 'Speichern…',
    nameRequiredHint: 'Marke und Material erforderlich',
    deletePreset: 'Löschen',
    invalidJson: 'Ungültiges JSON',
    tabGeneral: 'Allgemein',
    tabTemps: 'Temperaturen',
    tabCooling: 'Kühlung',
    tabExtrusion: 'Extrusion',
    tabRetract: 'Rückzug',
    tabJson: 'JSON',
    // Editor General
    basePresetLabel: 'Basis-Preset',
    basePresetNone: '— Keine (leer beginnen) —',
    basePresetMine: 'Meine Presets',
    basePresetBase: 'Basis-Presets',
    basePresetLoading: 'Wird geladen…',
    brand: 'Marke',
    brandSelect: '— Auswählen —',
    material: 'Material',
    colorLabel: 'Farbbezeichnung',
    colorPlaceholder: 'Weiß, Schwarz…',
    ...
    tempInitial: 'Start',
    tempPrint: 'Druck',
    tempRangeMin: 'Bereich min',
    tempRangeMax: 'Bereich max',
    materialSection: 'Material',
    glassTg: 'Glasübergang Tg',
    chamberSection: 'Kammer',
    chamberTemp: 'Kammer',
    bedPlates: 'Druckplatten',
    plate: 'Platte',
    plateSuperTack: 'SuperTack',
    plateCool: 'Kühlplatte',
    plateEng: 'Technik',
    plateHot: 'Heizplatte',
    plateTextured: 'Strukturiert',
    printCol: 'Druck °C',
    initialCol: 'Erste Schicht °C',
    // Editor Cooling
    partFan: 'Bauteillüfter',
    fanMax: 'Max. Drehzahl',
    fanMin: 'Min. Drehzahl',
    overhangFan: 'Überhang-Drehzahl',
    noFanLayers: 'Kein Lüfter (Bauteil) Schichten',
    noFanAdditional: 'Kein Lüfter (zusätzlich) Schichten',
    initialFan: 'Lüfter erste Schicht',
    minLayerTime: 'Min. Schichtzeit',
    overhangThreshold: 'Überhang-Schwellenwert',
    preStartFan: 'Lüfter-Vorlauf',
    additionalFan: 'Zusatzlüfter',
    overhangBridgeFan: 'Überhang-/Brückenlüfter',
    chamberVent: 'Kammerbelüftung',
    duringPrint: 'Während des Drucks',
    endOfPrint: 'Nach dem Druck',
    nil: 'nil',
    off: 'Aus',
    on: 'An',
    // Editor Extrusion
    flowSection: 'Durchfluss',
    flowRatio: 'Durchflussrate',
    cal: 'Kal.',
    calTitle: 'Durchflussrate um % anpassen',
    apply: 'Anwenden',
    maxVolFlow: 'Max. Volumenstrom',
    primeVolume: 'Einzugsvolumen',
    shrinkage: 'Schrumpfung',
    layerSlowdown: 'Schichtverlangsamung',
    minTimePerLayer: 'Min. Zeit pro Schicht',
    minSpeed: 'Min. Geschwindigkeit',
    gcodeSection: 'G-Code',
    ...
    deretractSpeed: 'Rückholgeschwindigkeit',
    zHop: 'Z-Hop',
    zHopType: 'Z-Hop-Typ',
    zHopNormal: 'Normales Anheben',
    zHopSlope: 'Schräges Anheben',
    zHopSpiral: 'Spiralförmiges Anheben',
    wipeDistance: 'Wischdistanz',
    retractBeforeWipe: 'Rückzug vor dem Wischen',
    options: 'Optionen',
    retractOnLayerChange: 'Rückzug bei Schichtwechsel',
    wipeOnRetract: 'Wischen beim Rückzug',
    // Editor JSON
    jsonCaption: 'Direkte Bearbeitung — andere Tabs aktualisieren sich automatisch',
  },
  ...
  fileManager: {
    ...
    uploading: 'Hochladen...',
    checkingDuplicates: 'Wird geprüft...',
    alreadyInLibrary: 'Bereits in der Bibliothek',
    duplicateIn: 'in {{folder}}',
    duplicatesWillBeSkipped: '{{count}} doppelte Datei(en) gefunden — werden übersprungen',
    uploadAnyway: 'Trotzdem hochladen',
    skipDuplicate: 'Überspringen',
    skippedDuplicate: 'Übersprungen (bereits in der Bibliothek)',
    ...
    tags: {
      ...
      hintSelect: '↵ zum Auswählen von',
      hintDeselect: '↵ zum Abwählen von',
      hintCreate: '↵ zum Erstellen von',
    ...
    fileHistory: {
      menuLabel: 'Verlauf',
      title: 'Verlauf — {{name}}',
      viewHistoryAria: 'Druckverlauf anzeigen',
      noPermission: 'Sie haben keine Berechtigung, den Dateiverlauf anzuzeigen',
      loadFailed: 'Dateiverlauf konnte nicht geladen werden',
      statusPending: 'In Warteschlange',
      addedToLibrary: 'Zur Bibliothek hinzugefügt',
      bySomeone: 'von {{name}}',
      noPrintsYet: 'Diese Datei wurde noch nicht gedruckt.',
      externalUnavailable: 'Für externe Dateien ist kein Druckverlauf verfügbar.',
      openArchive: 'Archiv öffnen',
      viewSource: 'Quellseite öffnen',
      stats: {
        prints: 'Drucke',
        success: 'Erfolg',
        filament: 'Filament',
        lastPrinted: 'Zuletzt gedruckt',
      },
    },
    uploadedBy: 'Hochgeladen von',
    ...
    toast: {
      ...
      moveSkipped: '{{moved}} verschoben, {{skipped}} übersprungen: {{reasons}}',
      moveSkipReason: {
        not_owner: 'nicht der Eigentümer',
        source_readonly: 'Quelle ist schreibgeschützt',
        source_missing: 'Datei nicht mehr vorhanden',
        target_readonly: 'Ziel ist schreibgeschützt',
        target_misconfigured: 'Zielordner falsch konfiguriert',
        target_inaccessible: 'Zielordner nicht erreichbar',
        target_unwritable: 'Zielordner nicht beschreibbar',
        invalid_filename: 'unsicherer Dateiname',
        name_collision: 'Namenskonflikt',
  ...
  sponsors: {
    ...
    tagline: 'Fenrir ist kostenlos und bleibt es, weil Menschen es freiwillig unterstützen. Kein VC, kein Cloud-Zwang.',
    viewSupporters: 'Unterstützer ansehen',
    toastPrints: 'Du hast {{count}} Drucke mit Fenrir abgeschlossen. Fenrir bleibt kostenlos dank seiner Unterstützer.',
    toastCost: 'Du hast {{total}} an Filament mit Fenrir verfolgt. Sieh dir an, wer das Projekt unabhängig hält.',
    toastArchives: '{{count}} Drucke mit Fenrir archiviert. Sieh dir an, wer es unabhängig hält.',
    toastAnniversary: 'Ein Jahr mit Fenrir! Sieh dir an, wer das Projekt unabhängig hält.',
    toastVersionUpdate: 'Aktualisiert auf v{{version}}. Fenrir bleibt kostenlos dank seiner Unterstützer.',
    toastBusiness: 'Sie betreiben Fenrir auf {{count}} Druckern. Für Teams gibt es Support-Pakete – bevorzugte Fehlerbehebung, Rechnungsstellung und einen direkten Draht zum Maintainer.',
    businessCta: 'Fenrir für Unternehmen',
    businessTitle: 'Fenrir für Unternehmen',
  ...
  inventory: {
    ...
    spoolmanMixedContentBody: 'Fenrir wird über HTTPS ausgeliefert (über deinen Reverse-Proxy), aber deine Spoolman-URL ist nach wie vor HTTP. Browser blockieren gemischte Inhalte aus Sicherheitsgründen, daher kann die eingebettete Spoolman-Oberfläche nicht geladen werden. Spoolman muss ebenfalls über HTTPS erreichbar sein.',
    spoolmanMixedContentFixReverseProxy: 'Stelle Spoolman hinter denselben Reverse-Proxy wie Fenrir (Traefik / Nginx / Caddy) mit HTTPS und aktualisiere die Spoolman-URL in den Einstellungen auf die neue HTTPS-Adresse.',
  ...
  // Zoho Books-Integration (Einstellungs-Tab)
  zoho: {
    title: 'Zoho Books',
    subtitle: 'Verbinde Zoho Books, um Aito-Projekte Kunden zuzuordnen und Rechnungen zu synchronisieren.',
    clientId: 'Client-ID',
    clientSecret: 'Client-Secret',
    refreshToken: 'Refresh-Token',
    organizationId: 'Organisations-ID',
    baseUrl: 'API-Basis-URL',
    accountsUrl: 'Konten-URL',
    defaultContactId: 'Standard-Kunden-ID',
    defaultContactName: 'Standard-Kundenname',
    defaultContactHint: 'Im Aito-Dialog „Neues Projekt“ vorausgewählt. Telefon und E-Mail werden nie in diesen Kontakt geschrieben.',
    secretSaved: 'Wert gespeichert — zum Beibehalten leer lassen',
    save: 'Speichern',
    saved: 'Zoho-Einstellungen gespeichert',
    test: 'Verbindung testen',
    testOk: 'Mit Zoho Books verbunden',
    testUnreachable: 'Konfiguriert, aber Zoho Books ist nicht erreichbar',
    testNotConfigured: 'Zoho Books ist nicht konfiguriert',
  },

  heimdall: {
    title: 'Heimdall-Zahlungen',
    subtitle: 'Erstellt über die Heimdall-POS-Brücke für jedes Aito-Angebot einen Online-Zahlungslink. Ein bezahlter Link nimmt das Angebot automatisch an.',
    baseUrl: 'Heimdall-URL',
    token: 'API-Token',
    tokenHint: 'Nur schreibend — leer lassen, um das aktuelle Token zu behalten',
    depositPct: 'Anzahlung (%)',
    depositPctDescription: '0 fordert das komplette Angebot; sonst gilt der Link für diesen Anteil.',
    validityDays: 'Angebotsgültigkeit (Tage)',
    validityDaysDescription: 'Ablaufdatum auf jedem neuen Angebot; der Zahlungslink endet am selben Tag.',
    save: 'Speichern',
    saved: 'Heimdall-Einstellungen gespeichert',
    test: 'Verbindung testen',
    testOk: 'Mit Heimdall verbunden',
    testUnauthorized: 'Heimdall hat das Token abgelehnt',
    ...
    paymentModesTitle: 'Zoho-Zahlungsarten',
    paymentModesHint: 'Bezeichnungen, die Zoho Books für eine über eine Projektkarte erfasste Zahlung verwendet.',
    paymentModeCard: 'Karte',
    paymentModeCheque: 'Scheck',
  ...
  backup: {
    ...
    repoIsPublicWarning: 'Das Repository ist ÖFFENTLICH. Fenrir-Backups enthalten MQTT-Zugangsdaten, Home-Assistant-Tokens, Prometheus-Tokens, Ihre Bambu-Cloud-E-Mail-Adresse und über K-Profile auch Drucker-Zugangscodes. Speichern ist blockiert, bis Sie das Repository in den Einstellungen Ihres Anbieters auf privat stellen.',
    repoVisibilityUnknown: 'Die Sichtbarkeit des Repositories konnte nicht bestimmt werden. Fenrir sichert nur in Repositories, die nachweislich privat sind; Speichern wird blockiert.',
    ...
    appSettingsDescription: 'Fenrir-Konfiguration (komplette Datenbank)',
    ...
    restoreFromGit: {
      ...
      reloadHint: 'Fenrir neu laden, damit die wiederhergestellten Daten überall erscheinen.',
      ...
      notes: {
        ...
        settingsMqttRelayFailed: 'MQTT-Einstellungen wiederhergestellt, aber das Relay konnte nicht neu verbunden werden - Fenrir neu starten',
    ...
    localBackupDescription: 'Erstellen Sie eine vollständige Sicherung Ihrer Fenrir-Daten einschließlich Datenbank, Archive, Uploads und aller Dateien.',
    ...
    backupRestoredRestart: 'Sicherung wiederhergestellt. Bitte starten Sie Fenrir neu.',
    ...
    pathCheck: {
      title: 'Fenrir kann nicht in dieses Verzeichnis schreiben',
      howToFix: 'So beheben Sie das:',
      sandboxed: 'Der Fenrir-Dienst kann nicht nach {{path}} schreiben. Seine systemd-Unit läuft mit ProtectSystem=strict, wodurch jedes Verzeichnis außerhalb der Installations-, Daten- und Log-Verzeichnisse für den Dienst schreibgeschützt ist - auch eines, in das Sie aus Ihrer eigenen Shell schreiben können.',
      read_only: '{{path}} liegt auf einem schreibgeschützten Dateisystem.',
      permission_denied: 'Fenrir darf nicht nach {{path}} schreiben. Prüfen Sie Eigentümer und Rechte des Verzeichnisses.',
      ...
      error: 'Fenrir kann nicht nach {{path}} schreiben.',
      ephemeralTitle: 'Diese Backups überleben einen Container-Neustart nicht',
      container_ephemeral: '{{path}} liegt im Fenrir-Container, nicht auf dem Host. Dort geschriebene Backups gehen verloren, sobald der Container neu erstellt wird. Binden Sie das Verzeichnis vom Host ein:',
    },
  ...
  kProfiles: {
    ...
    modal: {
      ...
      notesHelp: 'Notizen werden in Fenrir gespeichert, nicht auf dem Drucker',
  ...
  virtualPrinter: {
    ...
    enable: {
      ...
      visibleInSlicer: 'Sichtbar als "Fenrir" in der Slicer-Erkennung',
    ...
    remoteInterface: {
      ...
      hint: 'Überschreibt die per SSDP beworbene und im TLS-Zertifikat verwendete IP-Adresse. Nützlich wenn Fenrir mehrere Netzwerkschnittstellen hat.',
    },
    mode: {
      title: 'Modus',
      archive: 'Archivieren',
    ...
    caCert: {
      ...
      description: 'Virtuelle Drucker verwenden ein TLS-Zertifikat, das von der Fenrir-CA signiert ist. Importieren Sie dieses CA-Zertifikat einmalig in den Vertrauensspeicher Ihres Slicers, damit er die Verbindung akzeptiert — kein Abrufen über die Kommandozeile mehr nötig.',
      copy: 'Kopieren',
      copied: 'Kopiert',
      download: 'Herunterladen',
      fingerprint: 'SHA-256',
    ...
    howItWorks: {
      ...
      step2: 'Im Archiv-, Überprüfungs- und Warteschlangen-Modus verwende die "Senden"-Funktion im Slicer, um 3MF-Dateien an Fenrir zu senden. Der Slicer zeigt "Druck erfolgreich" — die Datei wird gespeichert, nicht gedruckt.',
  ...
  locationHaSensors: {
    ...
    autoAdd: {
      ...
      confirmMessage: 'Fenrir hat für diesen Lagerort auch weitere Sensoren gefunden. Wählen Sie aus, welche zusätzlich hinzugefügt werden sollen.',
    ...
    options: {
      ...
      pollIntervalHint: 'Wie oft Fenrir Home Assistant abfragt und die Sensorwerte auf dem Bildschirm aktualisiert. Minimum 60 Sekunden.',
  ...
  notifications: {
    ...
    aitoPaymentReceivedLabel: 'Aito-Zahlung erhalten',
    aitoPaymentReceivedDescription: 'Benachrichtigen, wenn ein Aito-Angebot online oder durch eine deckende Anzahlung bezahlt wird',
    printFailed: 'Druck fehlgeschlagen',
    printStopped: 'Druck gestoppt',
  ...
  time: {
    ...
    today: 'Heute',
    yesterday: 'Gestern',
    daysElapsed_one: 'vor {{count}} Tag',
    daysElapsed_other: 'vor {{count}} Tagen',
    monthsElapsed_one: 'vor {{count}} Monat',
    monthsElapsed_other: 'vor {{count}} Monaten',
    yearsElapsed_one: 'vor {{count}} Jahr',
    yearsElapsed_other: 'vor {{count}} Jahren',
  },
  ...
  diagnostic: {
    ...
    check: {
      ...
      external_storage: {
        ...
        warn_internal_storage: 'Die Option ist aktiviert und ein Speicher ist vorhanden, aber der letzte Druck landete dennoch im internen Speicher des Druckers, den Fenrir nicht lesen kann. Bei der H2-Serie, dem P2S und dem X2D sendet die Schaltfläche "Drucken" in Bambu Studio unabhängig von dieser Option immer dorthin. Drucke werden mit Namen und Zeiten archiviert, aber ohne Vorschaubild und Slicer-Metadaten. Für vollständige Archive den Druck aus Fenrir starten oder in OrcaSlicer slicen — oder in Bambu Studio "Senden" mit "Extern" verwenden und den Druck danach starten.',
        warn_internal_history: 'Die Option ist aktiv und Speicher vorhanden, aber der letzte Druck lief aus einer Datei, die bereits auf dem Drucker lag — ein erneuter Druck über sein Display, ein Start aus Handy oder eine früher gesendete Datei. Diese Bibliothek liegt im internen Speicher, den Fenrir nicht lesen kann, und keine Einstellung ändert das, denn für diesen Druck wurde nichts gesendet. Er wird weiterhin mit Namen und Zeiten archiviert, nur ohne Vorschaubild und Slicer-Metadaten. Für vollständige Archive Drucke aus Fenrir starten oder aus dem Slicer senden.',
      },
      port_rtsps: {
      ...
      macos_local_network: {
        ...
        pass: 'macOS erlaubt Fenrir den Zugriff auf das lokale Netzwerk.',
        warn_unsigned: 'Das Python, das Fenrir ausführt, hat keine Code-Signatur. Damit hat macOS nichts, woran es die Berechtigung „Lokales Netzwerk“ binden könnte, und verwirft jede Verbindung zum Drucker stillschweigend — ohne Fehler und ohne Nachfrage. Führe das Fenrir-Update-Skript (install/update_macos.sh) aus, das die Signatur setzt, und starte Fenrir anschließend neu. Interpreter: {{executable}}',
        warn_permission: 'Wenn der Drucker eingeschaltet und unter dieser Adresse erreichbar ist, öffne Systemeinstellungen > Datenschutz & Sicherheit > Lokales Netzwerk und stelle sicher, dass das Python von Fenrir aktiviert ist. macOS verwirft lokale Verbindungen sonst stillschweigend, und ein Python-Update kann die alte Berechtigung zurücklassen.',
      },
      network_mode: {
        title: 'Container-Netzwerkmodus',
        genericRuntime: 'einem Container',
        pass: 'Läuft in {{runtime}} mit Host-Netzwerk.',
        warn: 'Fenrir läuft in {{runtime}} mit Bridge-Netzwerk. Die Druckererkennung und der virtuelle Drucker benötigen den Host-Netzwerkmodus — erstellen Sie den Container mit Host-Netzwerk neu ("network_mode: host" in docker-compose, "--network=host" bei Podman).',
        skip: 'Läuft nicht in einem Container — nicht zutreffend.',
        skip_unknown: 'Fenrir läuft in {{runtime}}, der Netzwerkmodus konnte jedoch nicht ermittelt werden. Falls die Druckererkennung oder der virtuelle Drucker nicht funktionieren, erstellen Sie den Container mit Host-Netzwerk neu.',
        skip_system_container: 'Fenrir läuft in einem {{runtime}}-Systemcontainer, der wie eine virtuelle Maschine direkt im LAN liegt — nicht zutreffend.',
      },
      subnet: {
        title: 'Netzwerk-Subnetz',
        pass: 'Drucker und Fenrir befinden sich im selben Subnetz.',
        warn: 'Der Drucker ({{printer_ip}}) und Fenrir ({{host_ip}}) befinden sich in unterschiedlichen Subnetzen. Sie können sich möglicherweise nicht erreichen, sofern kein Routing zwischen den Subnetzen konfiguriert ist.',
  ...
  systemHealth: {
    ...
    signature: {
      'ftp-auth-rejected': {
        ...
        fix: 'Kopiere den Zugriffscode erneut vom Druckerbildschirm (LAN-Einstellungen) und aktualisiere ihn in den Druckereinstellungen in Fenrir.',
      },
      'ftp-connection-timeout': {
        name: 'Zeitüberschreitung bei der Dateiübertragung',
        cause: 'Fenrir konnte den Dateiübertragungs-Port des Druckers (FTPS 990) nicht erreichen. Der Port ist blockiert, oder der Drucker ist aus oder in einem anderen Subnetz.',
        fix: 'Stelle sicher, dass Port 990 zwischen Fenrir und dem Drucker nicht blockiert wird und beide im selben Netzwerk sind.',
      },
      'ftp-ssl-error': {
      ...
      'database-locked': {
        ...
        fix: 'Stelle Fenrir auf eine externe PostgreSQL-Datenbank um. Siehe die PostgreSQL-Anleitung in der Dokumentation.',
      },
    },
  },
  ...
  vpDiagnostic: {
    ...
    check: {
      ...
      running: {
        ...
        fail: 'Der virtuelle Drucker ist aktiviert, aber seine Dienste laufen nicht. Prüfen Sie das Fenrir-Protokoll — meist stoppt sie ein Bind-IP-Konflikt oder ein Berechtigungsfehler.',
      },
      bind_interface: {
      ...
      certificate: {
        ...
        pass: 'Zertifikat bereit. Stellen Sie sicher, dass das Fenrir-CA-Zertifikat (oben) in den Vertrauensspeicher Ihres Slicers importiert ist.',
        fail: 'Das TLS-Zertifikat für diesen virtuellen Drucker fehlt. Prüfen Sie, ob das Fenrir-Datenverzeichnis beschreibbar ist.',
      },
    },
  },
  ...
  failureDetection: {
    ...
    externalUrlHint: 'Die ML-API ruft das Kamera-Snapshot per URL ab. Setze die externe URL in den allgemeinen Einstellungen, damit der ML-API-Container Fenrir erreichen kann.',
  ...
  makerworld: {
    title: 'MakerWorld',
    description: 'Füge eine MakerWorld-Modell-URL ein, um es direkt aus Fenrir zu importieren und zu drucken — ohne die Bambu Handy App zu öffnen.',
    ...
    signInExpiredTitle: 'Bambu-Cloud-Anmeldung abgelaufen',
    signInExpiredBody: 'Sie sind weiterhin bei Fenrir angemeldet, aber Bambu Lab akzeptiert das gespeicherte Token nicht mehr, daher schlagen Downloads fehl. Melden Sie sich erneut bei Bambu Cloud an.',
    ...
    disclaimer: 'Die MakerWorld-Integration verwendet von der Community dokumentierte API-Endpunkte. Fenrir ist nicht mit MakerWorld oder Bambu Lab verbunden oder von diesen unterstützt.',
  ...
  libraryPurge: {
    ...
    effect4: 'Dateien in externen (verknüpften) Ordnern werden übersprungen — Fenrir löscht keine Bytes, die ihm nicht gehören.',
  ...
  calculator: {
    ...
    material: 'Material',
    title: 'Rechner',
    subtitle: 'Kosten und Verkaufspreise für 3D-Drucke berechnen',
    easyMode: 'Einfacher Modus',
    reset: 'Zurücksetzen',
    resetConfirmTitle: 'Eingaben zurücksetzen',
    resetConfirmMessage: 'Alle Eingaben des Rechners auf die Standardwerte zurücksetzen? Filamente, Drucker und Standardwerte bleiben erhalten.',
    informations: 'Angaben',
    weight: 'Objektgewicht',
    printingTime: 'Druckzeit (h)',
    printingTimeLabel: 'Druckzeit',
    durationDays: 'Tage',
    durationDaysShort: 'T',
    durationHours: 'Stunden',
    durationHoursShort: 'Std.',
    durationMinutes: 'Minuten',
    durationMinutesShort: 'Min.',
    emptyInputsTitle: 'Gewicht und Druckzeit eingeben',
    emptyInputsMessage: 'Geben Sie Objektgewicht und Druckzeit ein, um einen Preisvorschlag und die Kostenaufschlüsselung zu sehen.',
    targetPrice: 'Zielpreis',
    targetPriceLabel: 'Zielpreis (inkl. Steuer)',
    targetPriceProfit: 'Nettomarge',
    measuredEnergy: 'Gemessene Energie: {{kwh}} kWh (aus dem Archiv)',
    measuredEnergyClear: 'Gemessene Energie entfernen',
    qtyIncrease: 'Menge erhöhen',
    qtyDecrease: 'Menge verringern',
    fixErrors: 'Einige Eingaben sind ungültig — korrigieren Sie die markierten Felder; ungültige Werte werden in den Ergebnissen ignoriert.',
    breakEvenDiscount: 'Break-even-Rabatt: {{pct}} — höhere Rabatte verkaufen unter Kosten.',
    ...
    summaryCopyFailed: 'Kopieren fehlgeschlagen — Zugriff auf die Zwischenablage blockiert',
    easyAssumptions: 'Basiert auf den gespeicherten Sätzen — Standardwerte prüfen',
    quantity: 'Menge',
    filament: 'Filament',
    printer: 'Drucker',
    difficulty: 'Schwierigkeitsfaktor (%)',
    difficultyTooltip: 'Multiplikator für schwierige Drucke: abrasives Filament, hohes Fehlerrisiko, empfindliche Handhabung. 100 % = kein Aufschlag.',
    labor: 'Arbeitszeit',
    modeling: 'Modellierung',
    workingHours: 'Arbeitsstunden',
    basePrice: 'Grundpreis',
    preparation: 'Vorbereitung',
    modelPreparation: 'Modellvorbereitung',
    slicing: 'Slicen',
    transferStart: 'Übertragung & Start',
    postProcessing: 'Nachbearbeitung',
    jobRemoval: 'Entnahme des Drucks',
    supportRemoval: 'Stützen entfernen',
    additionalWork: 'Zusatzarbeiten',
    fulfillment: 'Versand',
    stuff: 'Sonstiges Material',
    amount: 'Betrag',
    markupPct: 'Aufschlag',
    totals: 'Summen',
    machineCost: 'Maschinenkosten',
    machineCostSafety: 'Maschinenkosten mit Puffer',
    ...
    realityCheck: {
      ...
      subtitle: 'Gemessen aus Ihren eigenen Drucken, Einstellungen und dem Bestand.',
      failure: 'Fehlerquote',
    ...
    timeCorrection: {
      ...
      hintScoped: '{{scope}} erreicht im Schnitt {{pct}}% der Slicer-Schätzung',
      apply: 'Korrigierte Zeit übernehmen',
      dismiss: 'Ausblenden',
    },
    waterfall: {
      tax: 'Steuer',
      aria: 'Preisaufbau von den Kosten bis zum Endpreis',
    },
    quote: {
      open: 'Druckbares Angebot öffnen',
      back: 'Zurück zum Rechner',
      print: 'Drucken',
      title: 'Angebot',
      empty: 'Noch kein Auftrag — füllen Sie zuerst den Rechner aus.',
      jobDetails: 'Auftragsdetails',
      footnote: 'Preise inkl. Steuern. Angebot vorbehaltlich Materialverfügbarkeit.',
    },
    marge: 'Gewinnmarge',
    marginPct: 'Marge in %',
    marginGlobal: 'Globale Marge',
    marginFilament: 'Filament-Marge',
    marginStuff: 'Marge sonstiges Material',
    perUnit: 'pro Stück',
    forQuantity: 'Gesamt für {{count}} Stück',
    breakdown: 'Kostenaufstellung',
    costSplit: 'Kostenverteilung',
    costFilament: 'Filament',
    costDepreciation: 'Druckerabschreibung',
    costEnergy: 'Energie',
    costConsumables: 'Verbrauchsmaterial & Verpackung',
    costBaseFee: 'Grundgebühr',
    costRepairs: 'Reparaturen',
    costPrototype: 'Prototyp',
    costFailures: 'Fehldrucke',
    costAds: 'Werbung',
    costModeling: 'Modellierung',
    costPreparation: 'Vorbereitung',
    costPostProcessing: 'Nachbearbeitung',
    costStuff: 'Sonstiges Material',
    groupMachine: 'Maschine',
    groupProvisions: 'Rückstellungen',
    groupOther: 'Sonstiges',
    groupLabor: 'Arbeitszeit',
    splitPrinter: 'Drucker',
    splitAdsConsumables: 'Werbung & Verbrauchsmaterial',
    discountTitle: 'Rabattberechnung',
    discountMachine: 'Maschinenkosten mit Rabatt',
    discountSafety: 'Mit Puffer und Rabatt',
    discountPrice: 'Preis mit Rabatt',
    discountAmount: 'Rabattbetrag',
    potentialProfit: 'Möglicher Gewinn',
    bulkQuantity: 'Stück',
    emptyTitle: 'Rechner einrichten',
    emptyMessage: 'Lege mindestens ein Filament und einen Drucker an, um Preise zu berechnen.',
    ...
    tabPrinters: 'Drucker',
    name: 'Bezeichnung',
    costPerKg: 'Kosten pro kg ({{currency}})',
    printingCostPerKg: 'Druckkosten pro kg ({{currency}})',
    marginOverCost: 'Marge auf Kosten (%)',
    zohoProductSearch: 'Zoho-Produkt',
    zohoProductSearchPlaceholder: 'Filamente in Zoho suchen…',
    zohoNoDealerPrice: 'Kein Händlerpreis',
    zohoNoResults: 'Kein passendes Zoho-Filament gefunden',
    zohoSearchError: 'Zoho war nicht erreichbar',
    zohoLinkedProduct: 'Verbunden mit {{name}}',
    zohoUnlink: 'Verknüpfung aufheben',
    zohoWeightInferred: 'Spulengewicht nicht im Zoho-Namen enthalten; 1 kg angenommen',
    spoolWeightKg: 'Spulengewicht (kg)',
    ...
    addFilament: 'Filament hinzufügen',
    editFilament: 'Filament bearbeiten',
    deleteFilamentTitle: 'Filament löschen',
    deleteFilamentMessage: '„{{name}}“ löschen? Dies kann nicht rückgängig gemacht werden.',
    filamentCreated: 'Filament hinzugefügt',
    filamentUpdated: 'Filament aktualisiert',
    filamentDeleted: 'Filament gelöscht',
    purchasePrice: 'Kaufpreis ({{currency}})',
    lifetimeYears: 'Lebensdauer (Jahre)',
    dailyUsage: 'Tägliche Nutzung (h)',
    powerWatts: 'Leistung (W)',
    repairRate: 'Reparaturen über Lebensdauer (%)',
    lifetimeHours: 'Betriebsstunden gesamt',
    depreciationPerHour: 'Abschreibung / h',
    repairsPerHour: 'Reparaturen / h',
    addPrinter: 'Drucker hinzufügen',
    editPrinter: 'Drucker bearbeiten',
    deletePrinterTitle: 'Drucker löschen',
    deletePrinterMessage: '„{{name}}“ löschen? Dies kann nicht rückgängig gemacht werden.',
    printerCreated: 'Drucker hinzugefügt',
    printerUpdated: 'Drucker aktualisiert',
    printerDeleted: 'Drucker gelöscht',
    inUse: 'Auf der Rechner-Seite ausgewählt',
    electricityTariff: 'Stromtarif ({{currency}}/kWh)',
    laborRate: 'Stundensatz ({{currency}}/h)',
    consumablesFlat: 'Verbrauchsmaterial & Verpackung ({{currency}})',
    baseFee: 'Grundgebühr ({{currency}})',
    marginCurveHint: 'Zwei Kurven bestimmen die globale Marge: eine Größenmarge, die sinkt, je teurer ein Teil ist, und ein Mengenrabatt, der die Marge (nie die Kosten) mit steigender Menge verringert.',
    sizeMarginGroup: 'Größenmarge',
    qtyDiscountGroup: 'Mengenrabatt',
    floorGroup: 'Mindestwert',
    marginMinMult: 'Multiplikator bei sehr großen Teilen (M_MIN)',
    marginMaxMult: 'Multiplikator bei sehr kleinen Teilen (M_MAX)',
    marginK: 'Stückkosten am Wendepunkt (K, {{currency}})',
    qtyMinFactor: 'Erhaltene Marge bei hoher Menge (Q_MIN)',
    qtyK: 'Menge am Wendepunkt (KQ)',
    minTaskPrice: 'Mindestpreis pro Auftrag ({{currency}})',
    marginCurveMaxBelowMin: 'M_MAX muss mindestens M_MIN betragen',
    marginCurvePreviewSize: 'Größenmarge nach Stückkosten',
    marginCurvePreviewQty: 'Mengenfaktor nach Menge',
    exampleTitle: 'Beispielauftrag',
    ...
    formulaAt: 'Bei {{x}} → {{y}}',
    warnFlatSize: 'Die Größenkurve ist flach: Jedes Teil erhält ×{{m}}.',
    warnKFar: 'K liegt weit über Ihren Beispielkosten; die Kurve krümmt sich kaum dort, wo Ihre Aufträge liegen.',
    ...
    multiplier: '×{{value}}',
    multiplierDetail: 'Größe ×{{size}} · Menge {{qty}}',
    floorApplied: 'Mindestpreis angewendet',
    curveTitle: 'Preis nach Menge',
    curveHint: 'Stückpreis (inkl. Steuer) je Menge — einmalige Kosten verteilen sich, und der Mengenrabatt verringert die Marge.',
    curveUnitPrice: 'Stückpreis',
    curveTaskPrice: 'Auftragssumme',
    curveQtyFactor: 'Mengenfaktor',
    curveCurrent: 'aktuell',
    failureRate: 'Fehlerquote (%)',
    prototypeRate: 'Prototypquote (%)',
    adsRate: 'Werbequote (%)',
    filamentMarkup: 'Filament-Aufschlag (%)',
    taxPct: 'Steuer TGC (%)',
    defaultDifficulty: 'Standard-Schwierigkeit (%)',
    defaultMargin: 'Standard-Marge auf Kosten (%)',
    filamentSettings: 'Filament-Einstellungen',
    filamentSettingsHint: 'Vorbelegung für neue Filament-Profile.',
    stuffMarkup: 'Material-Aufschlag (%)',
    ratesTitle: 'Kostensätze',
    ratesHint: 'Was dich ein Auftrag kostet — passe diese Werte vor dem Angebot an deine örtlichen Preise und Währung an.',
    provisionsTitle: 'Rückstellungen & Gemeinkosten',
    provisionsHint: 'Prozentsätze auf die Kosten für Fehldrucke, Prototypen, Werbung und den Verkaufsaufschlag auf Filament und Extras.',
    unsavedChanges_one: '{{count}} ungespeicherte Änderung',
    unsavedChanges_other: '{{count}} ungespeicherte Änderungen',
    fixFields: 'Korrigiere die markierten Felder, um zu speichern.',
