export default {
  ...
  aito: {
    ...
    stats: {
      caption: '{{active}} in Produktion · {{done}} insgesamt abgeschlossen',
      added: 'Hinzugefügt',
      accepted: 'Angenommen',
      completed: 'Abgeschlossen',
      perDay: 'Hinzugefügt pro Tag',
      ...
      quoteAge: 'Angebote ohne Antwort',
      ageDays: '{{range}} Tage',
      ...
      pickup: 'Abholung',
      decisionsHeading: 'Angebote angenommen und abgelehnt',
      declined: 'Abgelehnt',
      ...
      brief: {
        ...
        dueNone: 'Diese Woche ist nichts fällig.',
        finished_one: '{{count}} Projekt in diesem Zeitraum abgeschlossen.',
        finished_other: '{{count}} Projekte in diesem Zeitraum abgeschlossen.',
        more: '{{count}} mehr als im Zeitraum davor.',
        fewer: '{{count}} weniger als im Zeitraum davor.',
        lead: 'Vom Angebot zur Lieferung: {{days}}.',
        chaseHeading: 'Nachfassen',
        tellHeading: 'Benachrichtigen',
        collectHeading: 'Einziehen',
        chaseEmpty: 'Jedes Angebot hat eine Antwort.',
        tellEmpty: 'Jeder Kunde ist informiert.',
        collectEmpty: 'Jede Rechnung ist bezahlt.',
        ready: 'Abholbereit',
        late: '{{days}} T überfällig',
        andMore: 'und {{count}} weitere',
      },
      teaser: {
        sales: '{{pct}} % angenommen · {{lost}} verloren für {{total}}',
        time: '{{lead}} vom Angebot zur Lieferung · {{moves}} Rückwärtsbewegungen',
        money: '{{accepted}} angenommen · {{outstanding}} offen · {{service}} macht {{pct}} % des Umsatzes',
        moneyPlain: '{{accepted}} angenommen · {{outstanding}} offen',
        clients: '{{new}} neu · {{returning}} wiederkehrend',
      },
    },
