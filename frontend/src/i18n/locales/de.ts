export default {
  ...
  calculator: {
    ...
    rush: 'Eilzuschlag',
    rushPct: 'Eilzuschlag (%)',
    rushToggle: 'Eilauftrag',
    rushGroup: 'Eilauftrag',
    rushHint: 'Wird nach dem Minimum auf den Nettopreis aufgeschlagen, nur wenn der Auftrag als Eilauftrag markiert ist.',
