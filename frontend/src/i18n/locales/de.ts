export default {
  ...
  calculator: {
    ...
    defaultsSaved: 'Standardwerte gespeichert',
    saveDefaults: 'Speichern',
    tabPricing: 'Preisgestaltung',
    pricingHint: 'Alles, woraus ein Angebot berechnet wird. Änderungen gelten für neue Angebote, sobald du speicherst.',
