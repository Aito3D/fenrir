export default {
  ...
  aito: {
    ...
    firstName: 'Vorname',
    lastName: 'Nachname',
    displayNamePreview: 'Gespeichert als: {{name}}',
    ...
    payment: {
      ...
      cellManualTitle: 'Zahlung erfassen',
      ...
      linkNone: '{{number}} · noch kein Link',
      linkOpenState: '{{number}} · offen, {{expires}}',
