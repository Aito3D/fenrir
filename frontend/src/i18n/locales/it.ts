export default {
  ...
  calculator: {
    ...
    printingTimeMin: 'Tempo di stampa (min)',
    ...
    tabDefaults: 'Valori predefiniti',
    name: 'Nome',
    ...
    tabMarginCurve: 'Curva del margine',
    ...
    defaultsSaved: 'Valori predefiniti salvati',
    saveDefaults: 'Salva',
    tabPricing: 'Prezzi',
    pricingHint: 'Tutto ciò da cui nasce un preventivo. Le modifiche valgono per i nuovi preventivi appena salvi.',
    ratesTitle: 'Tariffe',
