export default {
  ...
  aito: {
    ...
    descriptionPlaceholder: 'Descrivi il prodotto da progettare e stampare…',
    ...
    sendInvoiceTitle: 'Invia la fattura via e-mail',
    sendInvoiceRecipient: 'Destinatario',
    sendInvoiceSubject: 'Oggetto',
    sendInvoiceMessage: 'Anteprima del messaggio',
    sendInvoiceConfirm: 'Invia',
    sendInvoiceNoRecipients: 'Questo cliente non ha un indirizzo e-mail in Zoho.',
    sendInvoiceLoadFailed: "Impossibile caricare i dettagli dell'e-mail",
    emailPreviewTitle: "Anteprima dell'e-mail",
    invoiceEmailed: 'Fattura inviata a {{email}}',
    invoiceEmailFailed: 'Impossibile inviare la fattura',
    createInvoice: 'Crea fattura',
    createInvoiceTitle: 'Crea la fattura',
    createInvoiceIntro_one: 'Preventivo {{quote}}, {{count}} riga. In Zoho Books viene creata una bozza di fattura — non viene inviata alcuna e-mail.',
    createInvoiceIntro_other: 'Preventivo {{quote}}, {{count}} righe. In Zoho Books viene creata una bozza di fattura — non viene inviata alcuna e-mail.',
    createInvoiceAmount: 'Totale fattura',
    createInvoiceRemaining: 'Ancora da pagare',
    createInvoiceLockWarning: 'Una volta fatturato, questo preventivo non accetta più modifiche alle righe da Fenrir.',
    createInvoiceConfirm: 'Crea',
    createInvoiceLoadFailed: 'Impossibile preparare la fattura',
    createInvoiceDone: 'Fattura {{number}} creata',
    createInvoiceDonePaid: 'Fattura {{number}} creata e saldata con gli acconti',
    createInvoiceDonePartial: 'Fattura {{number}} creata — impossibile applicare {{retainers}}',
    createInvoiceFailed: 'Impossibile creare la fattura',
    acceptQuote: 'Accetta preventivo',
    declineQuote: 'Rifiuta preventivo',
    holdToConfirm: 'Tieni premuto 0,5 s per confermare',
    quoteSent: 'Preventivo segnato come inviato',
    quoteAccepted: 'Preventivo accettato',
    quoteDeclined: 'Preventivo rifiutato',
    quoteUnaccepted: 'Accettazione rimossa — preventivo di nuovo In attesa',
    unacceptLabel: 'Rimuovi l\'accettazione',
    unacceptHint: 'Tieni premuto 1s per rimuovere l\'accettazione',
    quoteConflictAccepted: 'Questo preventivo è già stato accettato da qualcun altro.',
    quoteConflictDeclined: 'Questo preventivo è già stato rifiutato da qualcun altro.',
    zohoNotUpdated: 'Salvato localmente: Zoho non è stato aggiornato',
    progressLabel: '{{done}} di {{total}} passaggi completati',
    trash: 'Cestino',
    trashEmpty: 'Il cestino è vuoto',
    restore: 'Ripristina',
    restored: 'Progetto ripristinato',
    restoreFailed: 'Impossibile ripristinare il progetto.',
    ...
    urgent: 'Urgente',
    markUrgent: 'Segna urgente',
    clearUrgent: 'Rimuovi urgente',
    holdToMarkUrgent: 'Tieni premuto 0,5 s per segnare urgente',
    holdToClearUrgent: 'Tieni premuto 0,5 s per rimuovere urgente',
    sav: 'Reso',
    markSav: 'Segna reso',
    clearSav: 'Rimuovi reso',
    holdToMarkSav: 'Tieni premuto 0,5 s per segnare reso',
    holdToClearSav: 'Tieni premuto 0,5 s per rimuovere reso',
    pause: 'In pausa',
    markPause: 'Metti in pausa',
    clearPause: 'Togli la pausa',
    holdToMarkPause: 'Tieni premuto 0,5 s per mettere in pausa',
    holdToClearPause: 'Tieni premuto 0,5 s per togliere la pausa',
    markFlag: 'Segna',
    flagFailed: 'Impossibile modificare il contrassegno',
    dueDate: 'Data promessa',
    dueDateClear: 'Cancella la data',
    dueDateEmpty: 'Scegli una data',
    dueLateDays: '{{count}} g di ritardo',
    dueBadge: 'Scadenza {{date}}',
    dueDateFailed: 'Impossibile modificare la data',
    datePickerPrev: 'Mese precedente',
    datePickerNext: 'Mese successivo',
    datePickerBackToSelected: 'Torna al mese selezionato',
    datePickerPlusTwoDays: '+2 giorni',
    datePickerPlusOneWeek: '+1 settimana',
    datePickerPlusTwoWeeks: '+2 settimane',
    datePickerSuggested: 'suggerito',
    awaitingContact: 'Da avvisare',
    markContacted: 'Segna il cliente come avvisato',
    holdToMarkContacted: 'Tieni premuto 0,5 s per confermare che il cliente è stato avvisato',
    contacted: 'Avvisato',
    clearContacted: 'Annulla avvisato',
    holdToClearContacted: 'Tieni premuto 0,5 s per annullare avvisato',
    contactedFailed: 'Impossibile registrare il contatto',
    smsPickupShort: 'SMS',
    smsPickup: 'Invia SMS di ritiro',
    smsTitle: 'SMS di ritiro',
    smsMessageLabel: 'Messaggio',
    smsGenerating: 'Redazione del messaggio…',
    smsGenerateFailed: 'Impossibile redigere il messaggio',
    smsRegenerate: 'Rigenera',
    ...
    noResults: 'Nessun cliente corrispondente',
    zohoNotConfigured: 'Zoho Books non è ancora collegato.',
    zohoConfigureLink: 'Collega Zoho Books',
    zohoUnreachable: 'Impossibile contattare Zoho Books. Riprova.',
    resetToDefaultClient: 'Ripristina il cliente predefinito',
    clientPhone: 'Telefono',
    clientEmail: 'Email',
    countryCode: 'Prefisso internazionale',
    phonePlaceholder: '87123456',
    emailPlaceholder: 'cliente@esempio.com',
    revertPhone: 'Annulla la modifica al telefono',
    revertEmail: 'Annulla la modifica all’email',
    socialNetworkMessenger: 'Messenger',
    socialNetworkInstagram: 'Instagram',
    socialNetworkWhatsapp: 'WhatsApp',
    socialNetworkTiktok: 'TikTok',
    socialLabel: 'Social network (opzionale)',
    socialHandleLabel: 'Nome utente',
    socialHandlePlaceholder: 'nome.utente',
    socialRemove: 'Rimuovi il social network',
    contactsLabel: 'Contatti',
    contactsHint: 'Per chi è questo progetto?',
    contactsLoading: 'Lettura dei contatti da Zoho Books…',
    contactsUnavailable: 'Impossibile leggere i contatti da Zoho Books — inserisci un telefono o un’email qui sotto.',
    contactPrimary: 'principale',
    contactAdd: 'Aggiungi contatto',
    contactAddTitle: 'Nuovo contatto',
    contactSaveToZoho: 'Salva su Zoho',
    contactFirstNameRequired: 'Inserisci un nome.',
    contactNeedsPhoneOrEmail: 'È necessario un numero di telefono o un’email per contattarlo.',
    contactAddFailed: 'Impossibile aggiungere il contatto. Riprova.',
    contactOverrideToggle: 'Usa un telefono / un’email diversi per questa scheda',
    contactOverrideHint: 'Resta solo su questa scheda — il contatto in Zoho Books non viene modificato.',
    contactGone: 'Questa persona di contatto non esiste più in Zoho Books — scegline un’altra.',
    clientEditFanOutPerson: 'Si applica a tutte le schede aperte di questa persona di contatto',
    clientEditTitle: 'Dati di contatto',
    clientEditSourceZoho: 'Zoho Books',
    clientEditSourceCard: 'Solo questa scheda',
    clientEditFanOut: 'Si applica a tutte le schede aperte di questo cliente',
    ...
    clientHistoryNoQuote: 'senza preventivo',
    clientHistoryThisCard: 'Questa scheda · {{stage}}',
    clientHistoryDeclined: 'Rifiutato',
    clientHistoryOpenCard: 'Apri il progetto #{{id}}',
    clientHistoryEmpty: 'Nessun progetto per questo cliente, per ora.',
    clientHistoryError: 'Impossibile caricare lo storico del cliente.',
    clientEditLoading: 'Lettura del contatto da Zoho Books…',
    clientEditWalkIn: 'Cliente di passaggio: la modifica resta su questa scheda e non viene inviata a Zoho Books.',
    clientEditZohoReadFailed: 'Impossibile leggere il contatto da Zoho Books — vengono mostrati i valori della scheda.',
    clientEditFailed: 'Impossibile aggiornare il cliente. Riprova.',
    createClient: 'Crea nuovo cliente',
    companyName: 'Ragione sociale',
    firstName: 'Nome',
    lastName: 'Cognome',
    createClientSubmit: 'Crea cliente',
    back: 'Indietro',
    clientNameRequired: 'Inserisci una ragione sociale, oppure nome e cognome.',
    newClientPersonHint: 'Oppure nome e cognome di una persona',
    newClientContactTag: 'Referente in azienda',
    newClientContactHint: 'consigliato — basta il nome',
    newClientPreviewCompany: 'Azienda: {{name}} · referente: {{person}}',
    newClientPreviewCompanyAlone: 'Azienda: {{name}} · nessun referente per ora',
    newClientPreviewIndividual: 'Privato: {{name}}',
    clientCreateFailed: 'Impossibile creare il cliente. Riprova.',
    clientSyncFailed: 'Progetto creato — impossibile aggiornare il cliente in Zoho.',
    invalidEmail: 'Inserisci un indirizzo email valido.',
    invalidPhone: 'Inserisci tra 4 e 14 cifre.',
    invalidCountryCode: 'Inserisci un prefisso internazionale come +689.',
    phoneRequired: 'Il numero di telefono è obbligatorio.',
    dragHandle: 'Trascina per riordinare',
    createdLabel: 'Creato',
    ageAnchorAccepted: 'Accettato',
    ageDaysShort: '{{days}} g',
    lastActivity: 'Ultima attività',
    recordLabel: 'Scheda',
    duplicateProject: "Duplica",
    duplicateReplaceTitle: "Sostituire la bozza in corso?",
    duplicateReplaceBody: "Il pannello Nuovo progetto contiene già del lavoro non ancora creato. Duplicare questa scheda lo sostituirà.",
    duplicateReplaceConfirm: "Sostituisci",
    stageAndWorkLeft: 'Fase e lavoro rimanente',
    panelTabDetails: 'Dettagli',
    billingLabel: 'Fatturazione',
    depositAvailable: 'Acconto disponibile',
    descriptionShowMore: 'Mostra altro',
    descriptionShowLess: 'Mostra meno',
    panelTabAttention: 'Richiede attenzione',
    workLabel: 'Lavoro',
    ...
    editConflict: 'Qualcun altro ha modificato questo progetto — la bacheca è stata aggiornata, riprova.',
    tasks: 'Attività',
    addTask: 'Aggiungi attività',
    taskFallbackName: 'Attività {{n}}',
    track: {
      pageTitle: 'Tracciamento ordine · Aito 3D',
      title: 'Tracciamento del suo ordine',
      reference: 'Preventivo n. {{ref}}',
      stepOf: 'Fase {{n}} di {{total}}',
      stepsAria: 'Fasi',
      showSteps: 'Vedi le fasi',
      hideSteps: 'Nascondi le fasi',
      stepsList: 'Dettaglio delle fasi',
      tasksHeading: 'I suoi pezzi',
      showAllParts: 'Vedi tutti i {{n}} pezzi',
      eta: 'Disponibilità stimata',
      etaSoon: 'Le comunicheremo una data il prima possibile.',
      etaUpdating: 'Stima in aggiornamento',
      updated: 'Aggiornato {{when}}',
      updatedToday: 'oggi alle {{time}}',
      updatedYesterday: 'ieri alle {{time}}',
      updatedOn: 'il {{date}} alle {{time}}',
      error: 'Impossibile caricare il tracciamento al momento.',
      retry: 'Riprova',
      invalidTitle: 'Questo link di tracciamento non è più valido',
      invalidBody: 'Potrebbe essere scaduto o essere stato sostituito. Ci contatti e le invieremo un nuovo link.',
      footerQuestion: 'Una domanda sul suo ordine?',
      enterTitle: 'Segui il mio ordine',
      enterHint: 'Inserisci il codice di 6 caratteri riportato sul preventivo o nel nostro messaggio.',
      codeLabel: 'Codice di tracciamento',
      codeChecking: 'Verifica in corso…',
      retrying: 'Nuovo tentativo…',
      codeFound: 'Codice riconosciuto, apertura del tracciamento.',
      codeNotFound: 'Codice non trovato. Controllalo e riprova.',
      codeTooMany: 'Troppi tentativi. Attendi un minuto.',
      codeError: 'Impossibile verificare il codice al momento. Premi Invio per riprovare.',
      ...
      paymentMethods: {
        ...
        bank: 'Banca',
        transferReference: 'Causale del bonifico',
        referenceUnknown: 'Il numero del suo preventivo',
        transferDelay: 'Un bonifico può impiegare uno o due giorni per arrivarci.',
        appTag: 'Tag {{app}}',
        appMessage: 'Messaggio',
        appHint: "Dall'app {{app}}, invii l'importo del preventivo a questo tag.",
        shop: 'In negozio',
        shopSub: 'Carta bancaria, contanti o assegno.',
      ...
      status: {
        devisTitle: 'Preventivo in preparazione',
        devisSub: 'Lo riceverà via e-mail non appena sarà pronto.',
        waitingTitle: 'In attesa della sua approvazione',
        waitingSub: 'Ci dica se approva il preventivo e avvieremo la produzione.',
        acceptedTitle: 'Preventivo approvato',
        acceptedSub: 'Stiamo pianificando la produzione.',
        workingTitle: 'In produzione',
        ...
        pickedUpTitle: 'Ritirato',
        pickedUpSub: 'Il {{date}}. Grazie per la fiducia!',
        doneTitle: 'Completato',
        doneSub: 'Grazie per la fiducia!',
      },
      invoice: {
        paidTitle: 'Fattura pagata',
        paidSub: 'Grazie per la fiducia.',
        unpaidTitle: 'Fattura da pagare',
        unpaidSub: 'Da pagare prima del ritiro o della spedizione.',
        overdueTitle: 'Fattura scaduta',
        overdueSub: 'Ci contatti se ha già pagato.',
      },
      payment: {
        unpaidTitle: 'Progetto non ancora pagato',
        unpaidSub: 'Paghi online, con bonifico o in negozio.',
        unpaidDepositSub: 'Un acconto conferma il suo ordine — paghi online, con bonifico o in negozio.',
        validateTitle: 'Approvi il suo preventivo',
        validateSub: 'Il pagamento online vale come accettazione del preventivo.',
        validateDepositSub: 'Un acconto approva il preventivo e avvia la produzione.',
        pay: 'Paga online',
        paidTitle: 'Pagamento ricevuto',
        depositPaidTitle: 'Acconto ricevuto',
        paidSub: 'Grazie per la fiducia.',
      },
    },
    trackingCopy: 'Copia link di tracciamento',
    trackingOpen: 'Apri link di tracciamento',
    ...
    paymentLink: {
      ...
      paid: 'Pagato',
      copy: 'Copia il link di pagamento',
      open: 'Apri il link di pagamento',
      copied: 'Copiato',
      expiresIn_one: 'Scade tra {{count}} giorno',
      expiresIn_other: 'Scade tra {{count}} giorni',
      expiresToday: 'Scade oggi',
      retry: 'Riprova',
      state: { expired: 'Scaduto', cancelled: 'Annullato', failed: 'Rifiutato' },
    },
    payment: {
      dueQuote: 'Acconto dovuto',
      dueInvoice: 'Saldo dovuto',
      cellLink: 'Link',
      cellTerminal: 'POS',
      cellManual: 'Manuale',
      cellLinkTitle: 'Link di pagamento',
      cellTerminalTitle: 'Pagare con carta al POS',
      cellManualTitle: 'Manuale — registrare un pagamento',
      terminalOff: 'Heimdall non è configurato',
      stateProcessing: 'POS · in attesa della carta',
      stateAttention: 'Risultato sconosciuto · controllare il POS',
      statePaid: 'Pagato {{amount}} · {{channel}} · {{date}}',
      statePaidNoDate: 'Pagato {{amount}} · {{channel}}',
      stateBookingFailed: 'Non registrato in Zoho Books — vedi Heimdall',
      stateNoLink: 'Nessun link',
      channelTerminal: 'POS',
      channelLink: 'online',
      amountLabel: 'Importo',
      manualTitle: 'Registrare un pagamento',
      manualIntroQuote: 'Preventivo {{number}} · acconto ricevuto al banco',
      manualIntroInvoice: 'Fattura {{number}} · pagamento ricevuto al banco',
      modeLabel: 'Modalità',
      modeCard: 'Carta',
      modeCheque: 'Assegno',
      modeCash: 'Contanti',
      referenceLabel: 'Riferimento',
      referenceRequired: 'Un assegno richiede il suo numero',
      manualHintQuote: 'Crea una fattura di acconto sul preventivo in Zoho Books e vi registra il pagamento.',
      manualHintInvoice: 'Registra il pagamento sulla fattura in Zoho Books.',
      manualConfirm: 'Registra',
      manualDone: 'Pagamento registrato',
      amountInvalid: 'Inserire un importo intero superiore a zero',
      terminalTitle: 'Pagare con carta',
      terminalIntro: '{{number}} · al POS del banco',
      terminalHintQuote: "Precompilato con l'acconto dovuto; su un preventivo è accettato qualsiasi importo.",
      terminalHintInvoice: 'Precompilato con il saldo; Heimdall lo limita al saldo.',
      terminalStart: 'Avviare il POS',
      terminalWaiting: 'In attesa della carta sul POS…',
      terminalWaitingHint: 'Fino a 3 minuti per il PIN.',
      terminalLeave: 'Chiudere, tornerò',
      terminalPaid: 'Pagamento accettato',
      terminalBookingPending: 'Registrazione in Zoho Books…',
      terminalBookingDone: 'Registrato in Zoho Books',
      terminalBookingFailed: 'Non registrato in Zoho Books — vedi Heimdall',
      terminalFailed: 'Rifiutato',
      terminalFailedHint: 'Non è stato addebitato nulla. Si può riprovare.',
      terminalRetry: 'Riprova',
      terminalAttention: 'Risultato sconosciuto',
      terminalAttentionHint: 'Il POS non ha risposto. Controllare lo scontrino cartaceo prima di riprovare.',
      linkTitle: 'Link di pagamento',
      linkCreate: 'Crea il link',
      linkCreateAgain: 'Crea un nuovo link',
      linkCancel: 'Annulla il link',
      linkCancelConfirm: 'Annullare questo link?',
      linkExpires: 'Scade',
      linkHintInvoice: 'Precompilato con il saldo. Il link scade dopo il periodo di validità del preventivo.',
      linkPending: 'Creazione del link…',
      linkDone: 'Link di pagamento creato',
      linkCancelled: 'Link di pagamento annullato',
    },
    pastCards_one: '{{count}} scheda precedente',
    pastCards_other: '{{count}} schede precedenti',
    reuseTasks: 'Riutilizza',
    rating: {
      good: 'Buono',
      medium: 'Medio',
      bad: 'Cattivo',
      new: 'Nuovo',
      ariaLabel: 'Valutazione cliente: {{tier}}. {{reason}}',
      overdue_one: '{{count}} fattura scaduta · peggiore {{days}} giorni, {{number}}',
      overdue_other: '{{count}} fatture scadute · peggiore {{days}} giorni, {{number}}',
      overdueNoNumber_one: '{{count}} fattura scaduta · peggiore {{days}} giorni',
      overdueNoNumber_other: '{{count}} fatture scadute · peggiore {{days}} giorni',
      chronic: 'Paga spesso in ritardo · {{onTime}} su {{settled}} pagate puntualmente',
      punctual: '{{onTime}} fatture su {{settled}} pagate puntualmente',
      mixed: '{{onTime}} su {{settled}} pagate puntualmente',
      pastDue_one: '{{count}} scaduta',
      pastDue_other: '{{count}} scadute',
    ...
    taskDescriptionPlaceholder: 'Descrizione (opzionale)',
    removeTask: 'Rimuovi attività',
    serviceScan3D: 'Scansione',
    serviceModelisation3D: 'Modellazione',
    serviceImpression3D: 'Stampa',
    serviceUsinage: 'Lavorazione',
    serviceMainDoeuvre: 'Manodopera',
    serviceDescriptionRequired: 'Descrizione (obbligatoria)',
    maindoeuvreDescriptionRequired: 'La manodopera richiede una descrizione',
    serviceCost: 'Costo',
    ...
    importQuote: 'Importa',
    importTitle: 'Importa un preventivo',
    quoteSearchLabel: 'Preventivo',
    quoteNumberLabel: 'Numero',
    ...
    quoteNoServiceLines: 'Questo preventivo non contiene righe di servizio AITO 3D.',
    quoteAlreadyImported: 'Già importato come progetto n. {{id}}',
    quoteImport: 'Importa',
    quoteSkipped: 'Non importato',
    quoteTotals: 'Progetto {{project}} · preventivo {{quote}}',
    quoteCurrencyMismatch: 'Questo preventivo è in {{code}}; la bacheca mostra {{configured}}.',
    quoteOpenInZoho: 'Apri in Zoho Books',
    changeQuote: 'Cambia',
    quoteRowImported: 'Importato → n. {{id}}',
    beforeImport: 'Prima di importare',
    ruleQuoteLines: 'Il preventivo contiene righe di servizio AITO',
    ruleQuoteFresh: 'Non ancora importato',
    ruleCurrencyOk: 'La valuta corrisponde alla bacheca',
    ruleImportDescription: 'Descrizione compilata',
    importTaskCount_one: '{{count}} attività',
    importTaskCount_other: '{{count}} attività',
    printer: 'Stampante',
    material: 'Materiale',
    weightG: 'Peso (g)',
    ...
    pricingUnavailable: 'Impossibile caricare i prezzi della calcolatrice. Riprova.',
    computedPrice: 'Prezzo calcolatore',
    followCalculator: 'Segui il calcolatore',
    priceManual: 'Manuale',
    priceLinked: 'Calcolatore',
    perPart: 'a pezzo',
    ...
    quotePending: 'Creazione preventivo…',
    ...
    retrySync: 'Riprova',
    syncBlockedLabel: 'Sincronizzazione bloccata',
    forceSync: 'Forza sincronizzazione',
    forceSyncHint: 'Rileggi il preventivo in Zoho e invia di nuovo i costi',
    ...
    stats: {
      ...
      leadTime: 'Dal preventivo alla consegna',
      median: 'mediana {{days}} g',
      productionTime: 'Dall\'accettazione alla consegna',
      daysShort: '{{days}} g',
      activity: 'Attività per giorno',
      rolling7: 'Media dei completati su 7 giorni',
      flow: 'Giorni in ogni fase',
      sent: 'Inviati',
      ofAccepted: '{{pct}}% degli accettati',
      quoted: 'Preventivi accettati',
      invoiced: 'Fatturato',
      ...
      clients: 'Clienti',
      asOfToday: 'Ad oggi',
      ageDays: '{{range}} giorni',
      winRate: 'Tasso di accettazione per importo',
      winRateEmpty: 'Non ci sono ancora abbastanza preventivi decisi',
      decisions: '{{count}} decisi',
      stageTime: 'Durata per progetto completato',
      reworkMoves: 'Spostamenti all\'indietro',
      reworkShare: '{{cards}} schede · {{pct}}% delle schede spostate',
      overdue: 'Fatture scadute',
      overdueOldest: 'la più vecchia {{days}} g',
      nothingOverdue: 'Nulla in ritardo',
      serviceMix: 'Ripartizione per servizio',
      serviceTasks: '{{count}} attività',
      clientsNew: 'Nuovi clienti',
      clientsReturning: 'Clienti abituali',
      returningShare: '{{pct}}% del fatturato da clienti abituali',
      arrivals: 'Quando arrivano le richieste',
      islands: 'Spedizioni per isola',
      pickup: 'Ritiro',
      declined: 'Rifiutati',
      acceptanceRate: '{{pct}}% accettati',
      ...
      strip: {
        onBoard: '{{amount}} sulla lavagna',
        longest: 'in attesa da più tempo: <who>{{name}}, {{days}}</who> in {{stage}}',
        oldest: 'il più vecchio {{days}} g',
        noQuote: 'ancora nessun preventivo',
        dueSoon_one: '{{count}} consegna prevista questa settimana',
        dueSoon_other: '{{count}} consegne previste questa settimana',
      },
      facts: {
        perDay: '{{count}} al giorno',
        waiting15: 'In attesa da 15+ giorni',
        lostWith: 'Perso con i preventivi rifiutati',
        shippingBilled: 'Spedizioni fatturate',
        parcels_one: '{{count}} pacco',
        parcels_other: '{{count}} pacchi',
        invoices_one: '{{count}} fattura',
        invoices_other: '{{count}} fatture',
        cards_one: '{{count}} scheda',
        cards_other: '{{count}} schede',
        today: 'oggi',
      },
      finding: {
        overview: '{{in}}, {{accepted}} e {{done}}.',
        overviewIn_one: '{{count}} progetto è arrivato',
        overviewIn_other: '{{count}} progetti sono arrivati',
        overviewAccepted_one: '{{count}} è stato accettato',
        overviewAccepted_other: '{{count}} sono stati accettati',
        overviewDone_one: '{{count}} è stato consegnato',
        overviewDone_other: '{{count}} sono stati consegnati',
        overviewPeakWeek: 'La settimana più intensa è stata quella del {{date}}.',
        overviewPeakDay: 'Il giorno più intenso è stato il {{date}}.',
        salesWin: 'Vinci il {{pct}}% dei preventivi.',
        salesLost_one: '{{count}} preventivo è andato perso, per {{total}}.',
        salesLost_other: '{{count}} preventivi sono andati persi, per {{total}} in totale.',
        salesLostBig: 'Quelli che perdi sono i grandi: {{lost}} dei {{decided}} sopra {{min}}, per {{total}} in totale.',
        salesNone: 'Nessun preventivo deciso in questo periodo.',
        timeLead: 'Un progetto richiede {{days}} dal preventivo alla consegna.',
        timeSlow: '{{stage}} è la fase lenta, con {{days}}.',
        timeRework_one: '{{count}} spostamento è andato all\'indietro.',
        timeRework_other: '{{count}} spostamenti sono andati all\'indietro, su {{cards}}.',
        timeNone: 'Nessun progetto consegnato in questo periodo.',
        moneyTotals: '{{accepted}} accettati e {{invoiced}} fatturati.',
        moneyOut: '{{amount}} ancora da incassare su {{invoices}}.',
        moneyOverdue_one: '{{count}} di queste è scaduta, da {{days}} giorni.',
        moneyOverdue_other: '{{count}} di queste sono scadute, la più vecchia da {{days}} giorni.',
        moneyClear: 'Nulla in sospeso.',
        clients: '{{new}} e {{returning}}.',
        clientsNew_one: '{{count}} nuovo cliente',
        clientsNew_other: '{{count}} nuovi clienti',
        clientsReturning_one: '{{count}} abituale',
        clientsReturning_other: '{{count}} abituali',
        clientsPeak: 'Le richieste arrivano di {{day}} verso le {{hour}}.',
        clientsParcels_one: '{{count}} pacco è partito per le isole.',
        clientsParcels_other: '{{count}} pacchi sono partiti per le isole.',
        clientsNone: 'Nessun nuovo cliente in questo periodo.',
      },
      brief: {
        chase_one: '{{count}} preventivo da sollecitare',
        chase_other: '{{count}} preventivi da sollecitare',
        tell_one: '{{count}} cliente da avvisare',
        tell_other: '{{count}} clienti da avvisare',
        collect: '{{amount}} da incassare',
        allClear: 'Niente da sollecitare, nessuno da avvisare, niente da incassare.',
        due_one: '{{count}} consegna prevista questa settimana.',
        due_other: '{{count}} consegne previste questa settimana.',
        chaseHeading: 'Sollecitare',
        tellHeading: 'Avvisare',
        collectHeading: 'Incassare',
        ready: 'Pronto per il ritiro',
        late: '{{days}} g di ritardo',
    ...
    allDone_one: 'Niente in produzione — {{count}} progetto completato si trova in «Mostra completati»',
    allDone_other: 'Niente in produzione — {{count}} progetti completati si trovano in «Mostra completati»',
    columns: {
      devis: 'Preventivo',
      waiting: 'In attesa',
      scan: 'Scansione',
    ...
    history: {
      title: 'Attività',
      empty: 'Ancora nessuna registrazione',
      loadMore: 'Carica altro',
      depthStory: 'Sintesi',
      depthDetail: 'Dettaglio',
      depthEverything: 'Tutto',
      notePlaceholder: 'Aggiungi una nota…',
      noteSubmit: 'Aggiungi nota',
      noteFailed: 'Impossibile salvare la nota',
      changeCount: '{{count}} modifiche',
      automatic: 'automatico',
      fromZoho: 'da Zoho Books',
      projectCreated: 'ha creato il progetto',
      quoteCreated: 'Preventivo creato',
      quoteSent: 'ha contrassegnato il preventivo come inviato',
      ...
      invoiceDetected: 'ha trovato una fattura in Zoho',
      ...
      quoteDeclined: 'ha rifiutato il preventivo',
      quoteExpired: 'Preventivo scaduto',
      stageChanged: 'ha spostato il progetto',
      projectTrashed: 'ha spostato il progetto nel cestino',
      projectRestored: 'ha ripristinato il progetto',
      ...
      projectUrgentSet: 'Segnato urgente',
      projectUrgentCleared: 'Urgenza rimossa',
      projectSavSet: 'Segnato reso',
      projectSavCleared: 'Reso rimosso',
      projectPauseSet: 'Segnato in pausa',
      ...
      paymentLinkCreated: 'Link di pagamento creato',
      paymentLinkReplaced: 'Link di pagamento sostituito',
      paymentLinkUpdated: 'Link di pagamento aggiornato',
      paymentLinkPaid: 'Pagato online',
      paymentLinkCancelled: 'Link di pagamento annullato',
      paymentTerminalStarted: 'Pagamento con carta avviato al POS',
      paymentTerminalPaid: 'Pagato con carta al POS',
      paymentTerminalFailed: 'Pagamento al POS rifiutato o annullato',
      paymentTerminalAttention: 'Risultato del POS sconosciuto — controllare il POS',
      paymentManualRecorded: 'Pagamento registrato',
      paymentManualPartial: 'Fattura di acconto creata, pagamento NON registrato — completare in Zoho Books',
      noteAdded: 'ha aggiunto una nota',
      zohoComment: 'Commento in Zoho Books',
      syncQueued: 'In coda per Zoho',
      syncPushed: 'Inviato a Zoho',
      syncFailed: 'Invio a Zoho non riuscito',
      syncLocked: 'Preventivo bloccato in Zoho',
      syncConflict: 'Conflitto di stato con Zoho',
      syncStatusRejected: 'Zoho ha rifiutato il cambio di stato',
      pollReconciled: 'Verificato con Zoho',
    },
    // New-project drawer
    workSection: 'Il lavoro',
    clientSectionTitle: 'Cliente',
    workHintNone: 'nessuna attività',
    workHintProgress: '{{done}} di {{total}} complete',
    addService: 'Aggiungi {{service}}',
    removeServiceChip: 'Rimuovi {{service}}',
    taskNeedsSubTask: 'aggiungi una sotto-attività',
    railSummary: 'Riepilogo',
    summaryTitle: 'Riassunto del progetto',
    summaryWaiting: 'Generato quando passi al cliente.',
    summaryGeneratedBy: 'Generato da {{model}} — clicca per modificare',
    summaryEdited: 'Modificato a mano — niente più rigenerazione automatica',
    summaryFallback: 'IA non disponibile — scrivi tu la descrizione',
    aiFieldHint: 'Ortografia corretta dall\'IA',
    aiChecking: 'Correzione in corso…',
    aiUndo: 'Ripristina il mio testo',
    regenerate: 'Rigenera',
    beforeCreate: 'Prima di creare',
    ruleTasksOk_one: '{{count}} attività — almeno una richiesta',
    ruleTasksOk_other: '{{count}} attività — almeno una richiesta',
    ruleNeedTask: 'Un progetto richiede almeno una attività — aggiungine una',
    ruleSubTasksOk: 'Ogni attività ha una sotto-attività quotata',
    ruleSubTaskMissing: '"{{name}}" richiede almeno una sotto-attività quotata',
    ruleSubTasksPending: 'Ogni attività richiede almeno una sotto-attività quotata',
    ruleClientAccount: 'Account cliente — {{name}}',
    ruleClientReachable: 'Cliente raggiungibile — {{contact}}',
    ruleClientContact: 'Il cliente deve avere telefono, email o un social network',
    warnNoEmail: 'Nessuna email — il preventivo non potrà essere inviato via mail',
    warnNoPhone: 'Nessun telefono — ricordati di chiederlo',
    holdToReset: 'Tieni premuto per azzerare la bozza',
    resetDraft: 'Azzera bozza',
    shippingAdd: 'Aggiungi spedizione',
    shippingTitle: 'Spedizione',
    shippingRemove: 'Rimuovi spedizione',
    shippingEdit: 'Modifica spedizione',
    shippingIsland: 'Isola di destinazione',
    shippingIslandPlaceholder: 'Cerca un’isola…',
    shippingNoIslands: 'Nessuna isola trovata',
    shippingFirstName: 'Nome del destinatario',
    shippingLastName: 'Cognome del destinatario',
    shippingPhone: 'Telefono del destinatario',
    shippingRecipient: 'Destinatario',
    shippingService: 'Servizio di spedizione',
    shippingRate: 'Tariffa',
    shippingRateFromZoho: 'Tariffa Zoho: {{rate}}',
    ...
    shippingLta: 'Numero LTA',
    shippingLtaPlaceholder: 'Numero della lettera di trasporto aereo…',
    ...
    ruleShippingMissingIsland: 'Spedizione: isola mancante',
    ruleShippingMissingRecipient: 'Spedizione: nome del destinatario mancante',
    ruleShippingInvalidPhone: 'Spedizione: numero di telefono non valido',
  },
  // Navigation
  nav: {
    aito: 'Aito',
    ...
    stats: 'Statistiche',
    profiles: 'Profili',
    filamentProfiles: 'Profili filamento',
    ...
    installAppSuccess: 'Fenrir è stato installato',
  },
  ...
  printers: {
    ...
    maintenance: {
      ...
      editFieldHelp: 'Quando attivata, questa stampante è in pausa da MQTT, dispatch della coda e notifiche — utile per riparazioni, installazioni Fenrir parallele o sospensione temporanea.',
    },
    // Chamber light
    ...
    nozzleWear: 'Usura',
    nozzleSlotEmpty: 'Slot {{slot}} — Vuoto',
    humidityTooltip: 'Umidità: {{value}}% - {{status}}',
    temperatureTooltip: 'Temperatura: {{value}}°C - {{status}}',
    clickForHistory: 'clicca per la cronologia',
    ...
    clickToDismiss: 'Clicca per nascondere',
    aiDetection: {
      safe: 'Sicuro',
      warning: 'Avviso',
      failure: 'Guasto',
  ...
  archives: {
    ...
    menu: {
      ...
      openInCalculator: 'Apri nella calcolatrice',
      slice: 'Slice',
    ...
    card: {
      ...
      gcode: 'GCODE',
      source: 'SOURCE',
      unverifiedFile: 'Non verificato',
      unverifiedFileTooltip: 'Questo file è stato associato solo in base al nome — potrebbe non essere il file effettivamente stampato.',
  ...
  queue: {
    ...
    batchOrders: {
      ...
      strandedPlate: 'Nessuna impostazione da copiare',
      strandedNotice: 'Impossibile accodare {{runs}} delle {{owed}} stampe ancora dovute: per quella piastra non resta alcuna stampa in coda o completata da cui copiare le impostazioni. Accoda la piastra una volta dal file oppure annulla la commessa.',
    ...
    cancelBatchConfirmMessage: 'Chiudere questa commessa? Le stampe ancora in coda vengono annullate e la commessa smette di richiedere ciò che non ha prodotto.',
    batch: {
      defaultName: 'Lotto',
    ...
    toast: {
      ...
      keptForOrder: 'Annullato anziché rimosso: è l\'unica stampa da cui la commessa può riaccodare questa piastra',
      historyKeptForOrders: '{{kept}} conservate perché servono ancora alle commesse.',
  ...
  stats: {
    ...
    filamentCostFromCalculator: 'Calcolato dai prezzi del filamento del calcolatore prezzi',
    ...
    failuresByFilament: 'Guasti per filamento',
    failuresByPrinter: 'Guasti per stampante',
    deltaVsPrevious: 'rispetto al periodo precedente di {{days}} giorni',
    utilizationBusy: '{{hours}} h occupata',
    utilizationNoData: 'Nessuna stampa con dati di durata in questo periodo',
    costBreakdown: 'Ripartizione dei costi',
    costFilament: 'Filamento',
    costEnergy: 'Energia',
    costMachine: 'Macchina',
    costPerPrintHour: 'Per ora di stampa',
    costPerKg: 'Al kg',
    costCoverage: '{{priced}} stampe su {{total}} valorizzate',
    costNoData: 'Nessuna stampa valorizzabile con la configurazione attuale del calcolatore',
    filamentForecast: 'Previsione filamento',
    forecastDaysLeft: '≈ {{days}} g rimanenti',
    forecastNoUsage: 'Nessun consumo recente',
    forecastNoInventory: 'Nessuna bobina in inventario',
    forecastRemaining: '{{amount}} rimanenti',
    forecastBasis: 'Proiezione dal consumo recente — dettagli nella pagina Inventario',
    maintenanceReliability: 'Manutenzione e affidabilità',
    printsSinceMaintenance: '{{prints}} stampe · {{failures}} fallite dal {{date}}',
    neverMaintained: 'Nessuna manutenzione registrata',
    maintenanceDueBadge: '{{n}} da fare',
    maintenanceWarningBadge: '{{n}} a breve',
    maintenanceNoData: 'Nessuna stampante con monitoraggio manutenzione',
    maintenanceSinceCaption: 'I conteggi si riferiscono al periodo selezionato',
    energyWidgetTitle: 'Consumo energetico',
    aitoPipeline: 'Pipeline Aito',
    aitoPipelineEmpty: 'Niente sulla board Aito in questo periodo',
    pipelineByStage: 'Per fase',
    pipelineConversion: 'Conversione preventivi',
    pipelineSent: 'Inviati',
    pipelineAccepted: 'Accettati',
    pipelineDeclined: 'Rifiutati',
    pipelineAcceptedRate: '{{pct}}% accettati',
    pipelineStageDays: 'Giorni per fase',
    pipelineInvoicing: 'Fatturazione',
    pipelineInvoiced: 'Fatturato',
    pipelineOutstanding: 'Da incassare',
    pipelineTracking: 'Tracciamento cliente',
    pipelineTrackingViews: 'Aperture della pagina',
    pipelineTrackingCards: 'Schede consultate',
    pipelineTrackingLinks: 'Schede con link',
    pipelineDays: '{{days}} gg',
    pipelineSample_one: '{{count}} scheda',
    pipelineSample_other: '{{count}} schede',
    energyTotalLabel: 'Totale',
    energyCostLabel: 'Costo',
    energyAvgPerDay: 'Media al giorno',
    energyAvgPerPrint: 'Media per stampa',
    energyNoPlugs: 'Nessuna presa smart con monitoraggio energia configurata',
    energyNoData: 'Nessun dato energetico registrato per questo periodo',
  ...
  settings: {
    ...
    ldap: {
      ...
      feature3: 'I gruppi LDAP vengono mappati ai gruppi Fenrir al login',
      ...
      autoProvisionHint: 'Crea automaticamente un account Fenrir al primo accesso LDAP',
      ...
      groupMappingHint: 'Mappa i DN dei gruppi LDAP ai gruppi Fenrir. Gruppi disponibili: ',
    ...
    preheatFilamentTargetsHint: 'Fenrir sceglie il target più alto tra gli slot AMS caricati. Una stampa i cui slot derivano tutti 0 — PLA, PETG, TPU, PVA — salta del tutto il preriscaldamento e parte subito.',
    ...
    authDisabledMessage: 'Abilita autenticazione per creare account, gestire permessi e proteggere la tua istanza Fenrir.',
    ...
    disableAuthenticationMessage: 'Sei sicuro di voler disabilitare l\'autenticazione? Questo renderà la tua istanza Fenrir accessibile senza login. Tutti gli utenti resteranno nel database ma l\'autenticazione sarà disabilitata.',
    disableAuthentication: 'Disabilita autenticazione',
    // Additional settings
    configureFenrir: 'Configura Fenrir',
    ...
    captureFinishPhotoDescription: 'Scatta una foto dalla fotocamera della stampante al completamento della stampa. Fenrir registra un breve timelapse durante la stampa in modo che la foto possa essere ricavata dal momento precedente all\'abbassamento del piatto; il file del timelapse viene mantenuto se hai abilitato il timelapse per questa stampa, altrimenti viene eliminato automaticamente dopo l\'acquisizione della foto.',
    finishPhotoRestorePlate: 'Solleva il piatto per la foto finale',
    finishPhotoRestorePlateDescription: 'La stampante abbassa il piatto di circa 100 mm al termine di una stampa, lasciando l\'oggetto finito sotto l\'inquadratura della fotocamera. Fenrir lo risolleva fino a poco sopra l\'ultimo strato stampato, scatta la foto e poi lo riabbassa. Ignorato se l\'altezza di stampa è sconosciuta o se un altro lavoro è in coda.',
    ...
    cameraQuality: 'Qualità fotocamera',
    cameraQualityLow: 'Bassa',
    cameraQualityMedium: 'Media',
    cameraQualityHigh: 'Alta',
    cameraQualityAuto: 'Auto',
    cameraQualityAutoWithResolved: 'Auto ({{resolved}})',
    cameraQualityAutoResolved: 'Selezione automatica: {{resolved}} in base all\'hardware del server.',
    cameraQualityAutoResolvedDual: 'Selezione automatica: {{single}} (vista singola), {{grid}} (griglia telecamere) in base all\'hardware del server e al numero di flussi.',
    cameraQualityDescription: 'Controlla FPS e risoluzione dello stream. Una qualità inferiore riduce l\'utilizzo della CPU per configurazioni multi-camera.',
    cameraGpuAccel: 'Accelerazione GPU',
    cameraGpuAccelDescription: 'Usa la decodifica video accelerata dall\'hardware per gli stream delle telecamere. Riduce l\'uso della CPU su server con GPU compatibili.',
    cameraGpuAccelUnavailable: 'Nessun backend di accelerazione GPU rilevato su questo server.',
    cameraGpuAccelBackends: 'Backend disponibili: {{backends}}',
    cameraEngine: 'Motore telecamera',
    cameraEngineFFmpeg: 'FFmpeg (MJPEG)',
    cameraEngineGo2rtc: 'go2rtc (WebRTC)',
    cameraEngineFFmpegDescription: 'Transcodifica RTSP in MJPEG tramite FFmpeg. Funziona con tutti i browser ma utilizza più CPU.',
    cameraEngineGo2rtcDescription: 'Trasmette H.264 direttamente al browser tramite WebRTC. Nessuna transcodifica, latenza inferiore, decodifica hardware. Le telecamere interne (A1/P1) utilizzano ancora FFmpeg.',
    ...
    updateViaHomeAssistant: 'Gli aggiornamenti sono gestiti dal Supervisor di Home Assistant. Apri Impostazioni → Add-on → Fenrir in Home Assistant per installare la nuova versione.',
    ...
    externalUrlDescription: 'L\'URL esterno dove Fenrir è accessibile. Usato per immagini di notifica e integrazioni esterne.',
    fenrirUrl: 'URL Fenrir',
    ...
    mqttDescription: 'Pubblica eventi Fenrir su un broker MQTT esterno per l\'integrazione con Node-RED, Home Assistant e altri sistemi di automazione.',
    ...
    encryption: {
      ...
      notConfiguredDesc: 'I segreti TOTP e i client_secrets OIDC sono memorizzati in chiaro. Imposta MFA_ENCRYPTION_KEY o riavvia Fenrir con una directory dati scrivibile per generarne uno automaticamente.',
      ...
      migrationErrorWarning: "{{count}} riga/righe legacy non sono state ricifrate all'avvio. Controlla i log del server e riavvia Fenrir per riprovare.",
    },
    ...
    openrouterTitle: 'Riassunto IA (OpenRouter)',
    openrouterApiKey: 'Chiave API OpenRouter',
    openrouterApiKeyHint: 'Sola scrittura — lascia vuoto per mantenere la chiave attuale',
    openrouterModel: 'Modello',
    openrouterModelHint: 'ID modello OpenRouter per i riassunti di progetto (francese)',
    ...
    aitoFollowupLinkDays: 'Link di pagamento in scadenza (giorni)',
    aitoFollowupLinkDaysDescription: 'Segnala i preventivi il cui link di pagamento scade entro questi giorni',
  },
  ...
  hmsErrors: {
    ...
    runoutSlotUnknown: 'Il filamento è esaurito e la stampa è in pausa. Fenrir non è riuscito a determinare quale slot la stampante attende ora — controlla lo schermo della stampante per lo slot richiesto.',
    actions: {
  ...
  login: {
    ...
    resetStep1: 'Contatta il tuo amministratore Fenrir',
    ...
    twoFA: {
      ...
      instructionsTotp: "Apri la tua app di autenticazione e inserisci il codice a 6 cifre per Fenrir.",
  ...
  // Setup page
  setup: {
    title: 'Configurazione Fenrir',
    subtitle: 'Configura autenticazione per la tua istanza Fenrir',
  ...
  camera: {
    ...
    expand: 'Espandi',
    minimize: 'Minimizza',
    reconnectingIn: 'Riconnessione tra {{countdown}}s...',
    stream: 'Stream fotocamera',
  ...
  users: {
    ...
    subtitle: 'Gestisci utenti e accesso alla tua istanza Fenrir',
    backToSettings: 'Torna a Impostazioni',
    createUser: 'Crea utente',
    noPermission: 'Non hai il permesso di accedere a questa pagina.',
    admin: 'Amministratore',
  ...
  profiles: {
    ...
    orcaCloud: {
      ...
      connect: {
        ...
        description: 'Accedi al tuo account Orca Cloud per sincronizzare i profili dello slicer in Fenrir.',
      },
      device: {
        title: 'Approva Fenrir in Orca Cloud',
        instruction: 'Apri Orca Cloud e approva questo codice. Fenrir si connette automaticamente non appena approvi.',
  ...
  filamentProfiles: {
    // Page/header
    title: 'Profili filamento',
    subtitle: 'Gestisci e sincronizza i preset filamento dello slicer',
    syncBase: 'Sincronizza base',
    syncingBase: 'Sincronizzazione base…',
    import: 'Importa',
    syncZohoPrices: 'Sincronizza prezzi da Zoho',
    syncingZoho: 'Sincronizzazione prezzi da Zoho…',
    ...
    gridSmall: 'Griglia piccola',
    gridMedium: 'Griglia media',
    gridLarge: 'Griglia grande',
    // Grid
    emptyTitle: 'Ancora nessun preset',
    emptySubtitle: 'Crea un preset manualmente oppure importalo da una cartella.',
    ...
    delete: 'Elimina',
    // Confirm
    deleteTitle: 'Eliminare il preset?',
    deleteBody: '{{name}} verrà eliminato definitivamente.',
    cancel: 'Annulla',
    deleteConfirm: 'Elimina',
    // Sync-base modal
    baseSyncedTitle: 'Profili base sincronizzati',
    baseSyncFailedTitle: 'Sincronizzazione non riuscita',
    filesScanned: '{{n}} file analizzati',
    statNew: 'Nuovi',
    statUpdated: 'Aggiornati',
    statUnchanged: 'Invariati',
    close: 'Chiudi',
    // Sync modal
    syncTitle: 'Sincronizza su PC',
    syncSubtitle: 'Le modifiche verranno applicate alla cartella filamenti di BambuStudio.',
    statRemoved: 'Rimossi',
    ...
    // Import
    scanFailed: 'Errore durante la lettura della cartella BambuStudio: {{error}}',
    allImported: '{{n}} file trovati — già tutti importati.',
    ...
    noServerBase: 'Nessun bundle BambuStudio sul server — scegli i file JSON dei profili di base (o uno ZIP della cartella BBL/filament) da caricare.',
    ...
    // Editor shell
    editorNewTitle: 'Nuovo preset',
    editorEditTitle: 'Modifica preset',
    inheritsNotFound: '(non trovato)',
    reload: 'Ricarica',
    serverChangedBanner: 'Questo preset è cambiato sul server mentre lo stavi modificando.',
    serverChangedReload: 'Ricarica dal server',
    save: 'Salva',
    create: 'Crea',
    saving: 'Salvataggio…',
    nameRequiredHint: 'Marca e materiale obbligatori',
    deletePreset: 'Elimina',
    invalidJson: 'JSON non valido',
    tabGeneral: 'Generale',
    tabTemps: 'Temperature',
    tabCooling: 'Raffreddamento',
    tabExtrusion: 'Estrusione',
    tabRetract: 'Retrazione',
    tabJson: 'JSON',
    // Editor General
    basePresetLabel: 'Preset base',
    basePresetNone: '— Nessuno (inizia da zero) —',
    basePresetMine: 'I miei preset',
    basePresetBase: 'Preset base',
    basePresetLoading: 'Caricamento…',
    brand: 'Marca',
    brandSelect: '— Seleziona —',
    material: 'Materiale',
    colorLabel: 'Etichetta colore',
    colorPlaceholder: 'Bianco, Nero…',
    nozzleSize: 'Diametro ugello',
    paKValue: 'Valore PA K',
    cost: 'Costo',
    density: 'Densità',
    filamentColour: 'Colore filamento',
    extruder: 'Estrusore',
    compatiblePrinters: 'Stampanti compatibili',
    tagHint: 'Invio per aggiungere · Backspace per rimuovere',
    removeTag: 'Rimuovi {{tag}}',
    quickAdd: '+ H2S / H2D / H2C / X2D',
    tagPlaceholder: 'Bambu Lab X1C ugello 0,4…',
    notes: 'Note',
    // Editor Temps
    nozzleSection: 'Ugello',
    tempInitial: 'Iniziale',
    tempPrint: 'Stampa',
    tempRangeMin: 'Intervallo min',
    tempRangeMax: 'Intervallo max',
    materialSection: 'Materiale',
    glassTg: 'Tg vetrosa',
    chamberSection: 'Camera',
    chamberTemp: 'Camera',
    bedPlates: 'Piani di stampa',
    plate: 'Piano',
    plateSuperTack: 'SuperTack',
    plateCool: 'Piano freddo',
    plateEng: 'Ingegneria',
    plateHot: 'Piano caldo',
    plateTextured: 'Testurizzato',
    printCol: 'Stampa °C',
    initialCol: 'Primo strato °C',
    // Editor Cooling
    partFan: 'Ventola parte',
    fanMax: 'Velocità max',
    fanMin: 'Velocità min',
    overhangFan: 'Velocità sbalzi',
    noFanLayers: 'Strati senza ventola (parte)',
    noFanAdditional: 'Strati senza ventola (aggiuntiva)',
    initialFan: 'Ventola primo strato',
    minLayerTime: 'Tempo min per strato',
    overhangThreshold: 'Soglia sbalzo',
    preStartFan: 'Pre-avvio ventola',
    additionalFan: 'Ventola aggiuntiva',
    overhangBridgeFan: 'Ventola sbalzi/ponti',
    chamberVent: 'Ventilazione camera',
    duringPrint: 'Durante la stampa',
    endOfPrint: 'Fine stampa',
    nil: 'nil',
    off: 'Spento',
    on: 'On',
    // Editor Extrusion
    flowSection: 'Flusso',
    flowRatio: 'Rapporto di flusso',
    cal: 'cal',
    calTitle: 'Regola il rapporto di flusso in %',
    apply: 'Applica',
    maxVolFlow: 'Flusso vol. max',
    primeVolume: 'Volume di adescamento',
    shrinkage: 'Ritiro',
    layerSlowdown: 'Rallentamento strato',
    minTimePerLayer: 'Tempo min per strato',
    minSpeed: 'Velocità min',
    gcodeSection: 'G-code',
    startGcode: 'G-code iniziale',
    endGcode: 'G-code finale',
    // Editor Retract
    length: 'Lunghezza',
    speed: 'Velocità',
    deretractSpeed: 'Velocità di derretrazione',
    zHop: 'Sollevamento Z',
    zHopType: 'Tipo di sollevamento Z',
    zHopNormal: 'Sollevamento normale',
    zHopSlope: 'Sollevamento inclinato',
    zHopSpiral: 'Sollevamento a spirale',
    wipeDistance: 'Distanza di pulizia',
    retractBeforeWipe: 'Retrazione prima della pulizia',
    options: 'Opzioni',
    retractOnLayerChange: 'Retrai al cambio strato',
    wipeOnRetract: 'Pulisci in retrazione',
    // Editor JSON
    jsonCaption: 'Modifica diretta — le altre schede si aggiornano automaticamente',
  },
  ...
  fileManager: {
    ...
    uploading: 'Caricamento...',
    checkingDuplicates: 'Verifica...',
    alreadyInLibrary: 'Già nella libreria',
    duplicateIn: 'in {{folder}}',
    duplicatesWillBeSkipped: '{{count}} file duplicati rilevati — verranno saltati',
    uploadAnyway: 'Carica comunque',
    skipDuplicate: 'Salta',
    skippedDuplicate: 'Saltato (già nella libreria)',
    ...
    tags: {
      ...
      hintDeselect: '↵ per deselezionare',
      hintCreate: '↵ per creare',
    ...
    fileHistory: {
      menuLabel: 'Cronologia',
      title: 'Cronologia — {{name}}',
      viewHistoryAria: 'Vedi cronologia di stampa',
      noPermission: 'Non hai il permesso di vedere la cronologia del file',
      loadFailed: 'Impossibile caricare la cronologia del file',
      statusPending: 'In coda',
      addedToLibrary: 'Aggiunto alla libreria',
      bySomeone: 'da {{name}}',
      noPrintsYet: 'Questo file non è ancora stato stampato.',
      externalUnavailable: 'La cronologia di stampa non è disponibile per i file esterni.',
      openArchive: 'Apri archivio',
      viewSource: 'Apri pagina di origine',
      stats: {
        prints: 'Stampe',
        success: 'Successo',
        filament: 'Filamento',
        lastPrinted: 'Ultima stampa',
      },
    },
    uploadedBy: 'Caricato da',
    ...
    toast: {
      ...
      moveSkipped: '{{moved}} spostati, {{skipped}} saltati: {{reasons}}',
      moveSkipReason: {
        not_owner: 'non è il proprietario',
        source_readonly: 'origine di sola lettura',
        source_missing: 'file non più presente sul disco',
        target_readonly: 'destinazione di sola lettura',
        target_misconfigured: 'cartella di destinazione mal configurata',
        target_inaccessible: 'cartella di destinazione non accessibile',
        target_unwritable: 'cartella di destinazione non scrivibile',
        invalid_filename: 'nome file non sicuro',
        name_collision: 'conflitto di nome',
  ...
  sponsors: {
    ...
    tagline: 'Fenrir è gratuito e resta tale perché qualcuno sceglie di sostenerlo. Niente VC, niente lock-in cloud.',
    viewSupporters: 'Vedi i sostenitori',
    toastPrints: 'Hai completato {{count}} stampe con Fenrir. Fenrir resta gratuito grazie a chi lo sostiene.',
    toastCost: 'Hai monitorato {{total}} di filamento con Fenrir. Scopri chi mantiene il progetto indipendente.',
    toastArchives: '{{count}} stampe archiviate con Fenrir. Scopri chi lo mantiene indipendente.',
    toastAnniversary: 'Un anno con Fenrir! Scopri chi mantiene il progetto indipendente.',
    toastVersionUpdate: 'Aggiornato a v{{version}}. Fenrir resta gratuito grazie a chi lo sostiene.',
    toastBusiness: 'Usi Fenrir su {{count}} stampanti? Esiste un piano di supporto per i team: correzioni prioritarie, fatturazione e un contatto diretto con il manutentore.',
    businessCta: 'Fenrir per le aziende',
    businessTitle: 'Fenrir per le aziende',
  ...
  inventory: {
    ...
    spoolmanMixedContentBody: 'Fenrir viene servito tramite HTTPS (dietro il tuo reverse proxy), ma l\'URL di Spoolman è ancora HTTP. I browser bloccano il contenuto misto per motivi di sicurezza, quindi l\'interfaccia Spoolman incorporata non può essere visualizzata. Anche Spoolman deve essere raggiungibile via HTTPS.',
    spoolmanMixedContentFixReverseProxy: 'Metti Spoolman dietro lo stesso reverse proxy di Fenrir (Traefik / Nginx / Caddy) in HTTPS, poi aggiorna l\'URL di Spoolman nelle Impostazioni con il nuovo indirizzo HTTPS.',
  ...
  // Integrazione Zoho Books (scheda impostazioni)
  zoho: {
    title: 'Zoho Books',
    subtitle: 'Collega Zoho Books per attribuire i progetti Aito ai clienti e sincronizzare le fatture.',
    clientId: 'ID client',
    clientSecret: 'Client secret',
    refreshToken: 'Refresh token',
    organizationId: 'ID organizzazione',
    baseUrl: 'URL base API',
    accountsUrl: 'URL account',
    defaultContactId: 'ID cliente predefinito',
    defaultContactName: 'Nome cliente predefinito',
    defaultContactHint: 'Preselezionato nella finestra di nuovo progetto Aito. Telefono ed e-mail non vengono mai scritti su questo contatto.',
    secretSaved: 'Valore salvato — lascia vuoto per mantenerlo',
    save: 'Salva',
    saved: 'Impostazioni Zoho salvate',
    test: 'Test connessione',
    testOk: 'Connesso a Zoho Books',
    testUnreachable: 'Configurato, ma Zoho Books non è raggiungibile',
    testNotConfigured: 'Zoho Books non è configurato',
  },

  heimdall: {
    title: 'Pagamenti Heimdall',
    subtitle: 'Crea un link di pagamento online per ogni preventivo Aito tramite il ponte POS Heimdall. Un link pagato accetta automaticamente il preventivo.',
    baseUrl: 'URL di Heimdall',
    token: 'Token API',
    tokenHint: 'Solo scrittura — lasciare vuoto per mantenere il token attuale',
    depositPct: 'Acconto (%)',
    depositPctDescription: '0 richiede il preventivo intero; altrimenti il link copre questa quota.',
    validityDays: 'Validità del preventivo (giorni)',
    validityDaysDescription: 'Data di scadenza scritta su ogni nuovo preventivo; il link di pagamento termina lo stesso giorno.',
    save: 'Salva',
    saved: 'Impostazioni Heimdall salvate',
    test: 'Prova la connessione',
    testOk: 'Connesso a Heimdall',
    testUnauthorized: 'Heimdall ha rifiutato il token',
    testForbidden: 'Alla chiave manca il permesso payments:read o payments:write',
    testUnreachable: 'Heimdall non è raggiungibile',
    testNotConfigured: 'Heimdall non è configurato',
    offNotice: 'I link di pagamento sono disattivati: nessun preventivo riceve un link finché URL e token non sono salvati.',
    paymentModesTitle: 'Modalità di pagamento Zoho',
    paymentModesHint: 'Nomi usati da Zoho Books per un pagamento registrato da una scheda progetto.',
    paymentModeCard: 'Carta',
    paymentModeCheque: 'Assegno',
  ...
  backup: {
    ...
    repoIsPublicWarning: 'Il repository è PUBBLICO. I backup di Fenrir includono credenziali MQTT, token di Home Assistant, token di Prometheus, la tua e-mail Bambu Cloud e i codici di accesso alle stampanti tramite K-profile. Il salvataggio è bloccato finché non rendi privato il repository nelle impostazioni del tuo provider.',
    repoVisibilityUnknown: 'Impossibile determinare la visibilità del repository. Fenrir rifiuta di eseguire backup su qualsiasi target non confermato come privato; il salvataggio sarà bloccato.',
    ...
    appSettingsDescription: 'Configurazione Fenrir (database completo)',
    ...
    restoreFromGit: {
      ...
      reloadHint: 'Ricarica Fenrir per vedere i dati ripristinati in tutte le sezioni.',
      ...
      notes: {
        ...
        settingsMqttRelayFailed: 'Impostazioni MQTT ripristinate, ma il relay non è stato riconnesso - riavvia Fenrir',
    ...
    localBackupDescription: 'Crea un backup completo dei tuoi dati Fenrir includendo database, archivi, upload e tutti i file.',
    ...
    backupRestoredRestart: 'Backup ripristinato. Riavvia Fenrir.',
    ...
    pathCheck: {
      title: 'Fenrir non riesce a scrivere in questa directory',
      howToFix: 'Come risolvere:',
      sandboxed: 'Il servizio Fenrir non riesce a scrivere in {{path}}. La sua unit systemd usa ProtectSystem=strict, che rende ogni directory al di fuori di quelle di installazione, dati e log di sola lettura per il servizio - anche una in cui puoi scrivere dalla tua shell.',
      read_only: '{{path}} si trova su un filesystem di sola lettura.',
      permission_denied: 'Fenrir non ha il permesso di scrivere in {{path}}. Controlla proprietario e permessi della directory.',
      ...
      error: 'Fenrir non riesce a scrivere in {{path}}.',
      ephemeralTitle: 'Questi backup non sopravvivono alla ricreazione del container',
      container_ephemeral: '{{path}} si trova dentro il container Fenrir, non sull\'host. I backup scritti lì vanno persi quando il container viene ricreato. Monta la directory dall\'host:',
    },
  ...
  kProfiles: {
    ...
    modal: {
      ...
      notesHelp: 'Le note sono salvate in Fenrir, non sulla stampante',
  ...
  virtualPrinter: {
    ...
    enable: {
      ...
      visibleInSlicer: 'Visibile come "Fenrir" nella ricerca slicer',
    ...
    remoteInterface: {
      ...
      hint: 'Sovrascrive l\'indirizzo IP pubblicizzato via SSDP e usato nel certificato TLS. Utile quando Fenrir ha piu interfacce di rete.',
    },
    mode: {
      title: 'Modalita',
      archive: 'Archivio',
    ...
    howItWorks: {
      ...
      step2: 'In modalità Archivio, Revisione e Coda, usa il pulsante "Invia" nel tuo slicer per caricare file 3MF su Fenrir. Lo slicer mostrerà "Stampa riuscita" — il file viene salvato, non stampato.',
    ...
    caCert: {
      ...
      description: 'Le stampanti virtuali usano un certificato TLS firmato dalla CA di Fenrir. Importa questo certificato CA nell\'archivio attendibile del tuo slicer una sola volta affinché accetti la connessione — senza doverlo copiare dalla riga di comando.',
      copy: 'Copia',
      copied: 'Copiato',
      download: 'Scarica',
      fingerprint: 'SHA-256',
  ...
  locationHaSensors: {
    ...
    autoAdd: {
      ...
      confirmMessage: 'Fenrir ha trovato anche altri sensori per questa posizione. Scegli quali aggiungere.',
    ...
    options: {
      ...
      pollIntervalHint: 'Con quale frequenza Fenrir interroga Home Assistant e aggiorna i valori dei sensori a schermo. Minimo 60 secondi.',
  ...
  notifications: {
    ...
    aitoPaymentReceivedLabel: 'Pagamento Aito ricevuto',
    aitoPaymentReceivedDescription: 'Notifica quando un preventivo Aito viene pagato online o con un acconto sufficiente',
    printFailed: 'Stampa fallita',
    printStopped: 'Stampa interrotta',
  ...
  time: {
    ...
    today: 'Oggi',
    yesterday: 'Ieri',
    daysElapsed_one: '{{count}} giorno fa',
    daysElapsed_other: '{{count}} giorni fa',
    monthsElapsed_one: '{{count}} mese fa',
    monthsElapsed_other: '{{count}} mesi fa',
    yearsElapsed_one: '{{count}} anno fa',
    yearsElapsed_other: '{{count}} anni fa',
  },
  ...
  spoolbuddy: {
    ...
    settings: {
      ...
      testNfc: 'Testa lettore',
      testScale: 'Testa precisione',
  ...
  diagnostic: {
    ...
    check: {
      ...
      external_storage: {
        ...
        warn_internal_storage: 'L\'opzione è attiva ed è presente una memoria, ma l\'ultima stampa è comunque finita nella memoria interna della stampante, che Fenrir non può leggere. Sulla serie H2, sulla P2S e sulla X2D il pulsante «Stampa» di Bambu Studio invia sempre lì, a prescindere da questa opzione. Le stampe vengono archiviate con nome e tempi, ma senza miniatura né metadati dello slicer. Per archivi completi, avvia le stampe da Fenrir oppure elabora in OrcaSlicer, oppure in Bambu Studio usa «Invia» con «Esterna» e avvia la stampa dopo.',
        warn_internal_history: 'L\'opzione è attiva e la memoria è presente, ma l\'ultima stampa è partita da un file già presente sulla stampante: una ristampa dal suo schermo, un avvio da Handy o un file inviato prima. Quella libreria si trova nella memoria interna, che Fenrir non può leggere, e nessuna impostazione lo cambia, perché per quella stampa non è stato inviato nulla. Resta archiviata con nome e tempi, ma senza miniatura né metadati dello slicer. Per archivi completi, avvia le stampe da Fenrir o inviale dallo slicer.',
      },
      port_rtsps: {
      ...
      subnet: {
        title: 'Sottorete',
        pass: 'La stampante e Fenrir sono nella stessa sottorete.',
        warn: 'La stampante ({{printer_ip}}) e Fenrir ({{host_ip}}) sono in sottoreti diverse. Potrebbero non raggiungersi a meno che non sia configurato il routing tra le sottoreti.',
      ...
      mqtt_auth: {
        ...
        fail: 'La stampante è raggiungibile ma Fenrir non è connesso ad essa. Il codice di accesso o il numero di serie è molto probabilmente errato — il codice di accesso cambia ogni volta che la modalità Solo LAN o la modalità sviluppatore viene attivata/disattivata, quindi ricopialo dallo schermo della stampante. Una stampante in fase di riavvio, o che ha già raggiunto il limite di connessioni simultanee, appare allo stesso modo.',
        fail_auth_rejected: 'La stampante ha rifiutato le credenziali di Fenrir. Il codice di accesso o il numero di serie è errato — il codice di accesso cambia ogni volta che la modalità Solo LAN o la modalità sviluppatore viene attivata/disattivata. Ricopialo dallo schermo della stampante e salvalo nelle impostazioni della stampante.',
  ...
  systemHealth: {
    ...
    signature: {
      'ftp-auth-rejected': {
        ...
        fix: 'Ricopia il codice di accesso dallo schermo della stampante (impostazioni LAN) e aggiornalo nelle impostazioni della stampante in Fenrir.',
      },
      'ftp-connection-timeout': {
        name: 'Timeout della connessione di trasferimento file',
        cause: 'Fenrir non è riuscito a raggiungere la porta di trasferimento file della stampante (FTPS 990). La porta è bloccata, oppure la stampante è spenta o in un\'altra sottorete.',
        fix: 'Assicurati che nulla blocchi la porta 990 tra Fenrir e la stampante e che entrambi siano sulla stessa rete.',
      },
      'ftp-ssl-error': {
      ...
      'database-locked': {
        ...
        fix: 'Passa Fenrir a un database PostgreSQL esterno. Consulta la guida PostgreSQL nella documentazione.',
      },
    },
  },
  ...
  vpDiagnostic: {
    ...
    check: {
      ...
      running: {
        ...
        fail: 'La stampante virtuale è abilitata ma i suoi servizi non sono in esecuzione. Controlla il log di Fenrir — di solito li ferma un conflitto di IP di binding o un errore di permessi.',
      },
      bind_interface: {
      ...
      certificate: {
        ...
        pass: 'Certificato pronto. Assicurati che il certificato CA di Fenrir (sopra) sia importato nell\'archivio attendibile del tuo slicer.',
        fail: 'Il certificato TLS per questa stampante virtuale è mancante. Verifica che la directory dei dati di Fenrir sia scrivibile.',
      },
    },
  },
  ...
  failureDetection: {
    ...
    externalUrlHint: 'L\'API ML recupera l\'istantanea della telecamera tramite URL. Imposta l\'URL esterno nelle impostazioni generali in modo che il container API ML possa raggiungere Fenrir.',
  ...
  makerworld: {
    title: 'MakerWorld',
    description: 'Incolla un URL di un modello MakerWorld per importarlo e stamparlo direttamente da Fenrir — senza passare dall\'app Bambu Handy.',
    ...
    signInExpiredTitle: 'Accesso a Bambu Cloud scaduto',
    signInExpiredBody: 'Hai ancora effettuato l\'accesso a Fenrir, ma Bambu Lab non accetta più il token salvato, quindi i download non riusciranno. Accedi di nuovo a Bambu Cloud.',
    ...
    disclaimer: 'L\'integrazione MakerWorld utilizza endpoint API documentati dalla community. Fenrir non è affiliato né approvato da MakerWorld o Bambu Lab.',
  ...
  libraryPurge: {
    ...
    effect4: 'I file in cartelle esterne (collegate) vengono saltati — Fenrir non elimina mai dati che non possiede.',    previewLoading: 'Verifica quanti file corrispondono…',
  ...
  calculator: {
    ...
    material: 'Materiale',
    title: 'Calcolatrice',
    subtitle: 'Stima costi e prezzi di vendita delle tue stampe 3D',
    easyMode: 'Modalità semplice',
    reset: 'Reimposta',
    resetConfirmTitle: 'Reimposta i campi',
    resetConfirmMessage: 'Reimpostare tutti i campi della calcolatrice ai valori predefiniti? Filamenti, stampanti e valori predefiniti vengono conservati.',
    informations: 'Informazioni',
    weight: 'Peso del pezzo',
    printingTime: 'Tempo di stampa (h)',
    printingTimeLabel: 'Tempo di stampa',
    durationDays: 'Giorni',
    durationDaysShort: 'g',
    durationHours: 'Ore',
    ...
    emptyInputsTitle: 'Inserisci peso e tempo di stampa',
    emptyInputsMessage: "Inserisci il peso dell'oggetto e il tempo di stampa per vedere un prezzo suggerito e la ripartizione dei costi.",
    targetPrice: 'Prezzo obiettivo',
    targetPriceLabel: 'Prezzo obiettivo (tasse incl.)',
    targetPriceProfit: 'Margine netto',
    measuredEnergy: "Energia misurata: {{kwh}} kWh (dall'archivio)",
    measuredEnergyClear: 'Cancella energia misurata',
    qtyIncrease: 'Aumenta quantità',
    qtyDecrease: 'Riduci quantità',
    fixErrors: 'Alcuni valori non sono validi: correggi i campi evidenziati; i valori non validi vengono ignorati nei risultati.',
    breakEvenDiscount: 'Sconto di pareggio: {{pct}} — oltre questo sconto vendi sotto costo.',
    ...
    summaryCopyFailed: "Copia non riuscita — l'accesso agli appunti è bloccato",
    easyAssumptions: 'Basato sulle tariffe salvate — rivedi i valori predefiniti',
    quantity: 'Quantità',
    filament: 'Filamento',
    printer: 'Stampante',
    difficulty: 'Fattore di difficoltà (%)',
    difficultyTooltip: 'Moltiplicatore per stampe difficili: filamento abrasivo, alto rischio di fallimento, manipolazione delicata. 100% = nessuna maggiorazione.',
    labor: 'Manodopera',
    modeling: 'Modellazione',
    workingHours: 'Ore di lavoro',
    basePrice: 'Prezzo base',
    preparation: 'Preparazione',
    modelPreparation: 'Preparazione del modello',
    slicing: 'Slicing',
    transferStart: 'Trasferimento e avvio',
    postProcessing: 'Post-produzione',
    jobRemoval: 'Rimozione del pezzo',
    supportRemoval: 'Rimozione supporti',
    additionalWork: 'Lavoro aggiuntivo',
    fulfillment: 'Spedizione',
    stuff: 'Forniture varie',
    amount: 'Importo',
    markupPct: 'Ricarico',
    totals: 'Totali',
    machineCost: 'Costo macchina',
    machineCostSafety: 'Costo macchina con sicurezza',
    ...
    realityCheck: {
      title: 'Verifica realtà',
      subtitle: 'Misurato dalle tue stampe, impostazioni e inventario.',
      failure: 'Tasso di errore',
      failureScoped: 'Tasso di errore ({{scope}})',
      tariff: 'Prezzo dell\'elettricità',
      spoolCost: 'Costo del filamento ({{material}})',
      spoolCostBrand: 'Costo del filamento ({{brand}} {{material}})',
      time: 'Tempo di stampa (corretto)',
      timeScoped: 'Tempo di stampa ({{scope}})',
      power: 'Potenza assorbita',
      powerScoped: 'Potenza assorbita ({{scope}})',
      dailyHours: 'Utilizzo giornaliero',
      dailyHoursScoped: 'Utilizzo giornaliero ({{scope}})',
      apply: 'Applica',
      applyAll: 'Applica tutto',
      applied: 'Applicato',
      revert: 'Ripristina',
      dismiss: 'Ignora',
      restore: 'Ripristina {{count}} ignorati',
      allClear: 'Le ipotesi corrispondono ai tuoi dati misurati',
      deltaUnit: '{{amount}}/unità',
      sourcePrints: 'Basato su {{count}} stampe negli ultimi {{days}} giorni',
      sourcePrintsFleet: 'Media su {{printers}} stampanti corrispondenti a questo profilo — {{count}} stampe negli ultimi {{days}} giorni',
      sourceSetting: 'Dall\'impostazione del prezzo dell\'elettricità dell\'app',
      sourceSpools: 'Media di {{count}} bobine nel tuo inventario',
      sourceUsage: 'Basato su {{count}} stampe in {{days}} giorni osservati — un utilizzo reale inferiore aumenta l\'ammortamento orario',
      sourceUsageFleet: 'Media per macchina su {{printers}} stampanti corrispondenti a questo profilo ({{count}} stampe, {{days}} giorni osservati) — un utilizzo reale inferiore aumenta l\'ammortamento orario',
      saveDefault: 'Salva come predefinito',
      savedDefault: 'Predefinito aggiornato',
      updateProfile: 'Aggiorna profilo',
      updateProfileHint: 'Imposta il costo di acquisto di questo profilo filamento sulla media misurata',
      profileUpdated: 'Profilo filamento aggiornato',
      updatePrinter: 'Aggiorna profilo',
      updatePrinterHint: 'Imposta questo profilo stampante sul valore misurato',
      printerUpdated: 'Profilo stampante aggiornato',
    },
    timeCorrection: {
      hint: 'Le tue stampanti raggiungono in media il {{pct}}% delle stime dello slicer',
      hintScoped: '{{scope}} raggiunge in media il {{pct}}% delle stime dello slicer',
      apply: 'Applica tempo corretto',
      dismiss: 'Ignora',
    },
    waterfall: {
      tax: 'Tasse',
      aria: 'Costruzione del prezzo, dai costi al prezzo finale',
    },
    quote: {
      open: 'Apri preventivo stampabile',
      back: 'Torna al calcolatore',
      print: 'Stampa',
      title: 'Preventivo',
      empty: 'Nessun lavoro da quotare — compila prima il calcolatore.',
      jobDetails: 'Dettagli del lavoro',
      footnote: 'Prezzi IVA inclusa. Preventivo soggetto alla disponibilità dei materiali.',
    },
    marge: 'Margine',
    marginPct: 'Margine in %',
    marginGlobal: 'Margine globale',
    marginFilament: 'Margine filamento',
    marginStuff: 'Margine forniture',
    perUnit: 'per unità',
    forQuantity: 'Totale per {{count}} unità',
    breakdown: 'Dettaglio dei costi',
    costSplit: 'Ripartizione dei costi',
    costFilament: 'Filamento',
    costDepreciation: 'Ammortamento stampante',
    costEnergy: 'Energia',
    costConsumables: 'Consumabili e imballaggio',
    costBaseFee: 'Tariffa base',
    costRepairs: 'Riparazioni',
    costPrototype: 'Prototipo',
    costFailures: 'Fallimenti',
    costAds: 'Pubblicità',
    costModeling: 'Modellazione',
    costPreparation: 'Preparazione',
    costPostProcessing: 'Post-produzione',
    costStuff: 'Forniture',
    groupMachine: 'Macchina',
    groupProvisions: 'Accantonamenti',
    groupOther: 'Altro',
    groupLabor: 'Manodopera',
    splitPrinter: 'Stampante',
    splitAdsConsumables: 'Pubblicità e consumabili',
    discountTitle: 'Calcolo sconti',
    discountMachine: 'Costo macchina scontato',
    discountSafety: 'Con sicurezza e sconto',
    discountPrice: 'Prezzo scontato',
    discountAmount: 'Importo dello sconto',
    potentialProfit: 'Profitto potenziale',
    bulkQuantity: 'Qtà',
    emptyTitle: 'Configura la calcolatrice',
    emptyMessage: 'Aggiungi almeno un filamento e una stampante per iniziare a calcolare i prezzi.',
    ...
    allBrands: 'Tutte le marche',
    noMatches: 'Nessuna corrispondenza',
    tabFilaments: 'Filamenti',
    tabPrinters: 'Stampanti',
    name: 'Nome',
    costPerKg: 'Costo per kg ({{currency}})',
    printingCostPerKg: 'Costo di stampa per kg ({{currency}})',
    marginOverCost: 'Margine sul costo (%)',
    zohoProductSearch: 'Prodotto Zoho',
    zohoProductSearchPlaceholder: 'Cerca filamenti in Zoho…',
    zohoNoDealerPrice: 'Nessun prezzo rivenditore',
    zohoNoResults: 'Nessun filamento Zoho corrispondente',
    zohoSearchError: 'Impossibile contattare Zoho',
    zohoLinkedProduct: 'Collegato a {{name}}',
    zohoUnlink: 'Scollega',
    zohoWeightInferred: 'Peso bobina non presente nel nome Zoho; si presume 1 kg',
    spoolWeightKg: 'Peso bobina (kg)',
    syncZohoPrices: 'Sincronizza prezzi',
    syncProgress: '{{done}} / {{total}}',
    syncSummary:
      '{{updated}} aggiornati · {{unchanged}} invariati · {{skipped}} senza prezzo rivenditore · {{missing}} mancanti in Zoho · {{unpriced}} senza prezzo (peso sconosciuto)',
    ...
    addFilament: 'Aggiungi filamento',
    editFilament: 'Modifica filamento',
    deleteFilamentTitle: 'Elimina filamento',
    deleteFilamentMessage: 'Eliminare «{{name}}»? Questa azione è irreversibile.',
    filamentCreated: 'Filamento aggiunto',
    filamentUpdated: 'Filamento aggiornato',
    filamentDeleted: 'Filamento eliminato',
    purchasePrice: 'Prezzo di acquisto ({{currency}})',
    lifetimeYears: 'Durata (anni)',
    dailyUsage: 'Utilizzo giornaliero (h)',
    powerWatts: 'Potenza (W)',
    repairRate: 'Riparazioni nel ciclo di vita (%)',
    lifetimeHours: 'Ore di vita',
    depreciationPerHour: 'Ammortamento / h',
    repairsPerHour: 'Riparazioni / h',
    addPrinter: 'Aggiungi stampante',
    editPrinter: 'Modifica stampante',
    deletePrinterTitle: 'Elimina stampante',
    deletePrinterMessage: 'Eliminare «{{name}}»? Questa azione è irreversibile.',
    printerCreated: 'Stampante aggiunta',
    printerUpdated: 'Stampante aggiornata',
    printerDeleted: 'Stampante eliminata',
    inUse: 'Selezionato nella pagina calcolatrice',
    electricityTariff: 'Tariffa elettrica ({{currency}}/kWh)',
    laborRate: 'Tariffa oraria ({{currency}}/h)',
    consumablesFlat: 'Consumabili e imballaggio ({{currency}})',
    baseFee: 'Tariffa base ({{currency}})',
    marginCurveHint: 'Due curve definiscono il margine globale: un margine di dimensione che diminuisce quando il pezzo costa di più, e uno sconto quantità che riduce il margine (mai il costo) all\'aumentare della quantità.',
    sizeMarginGroup: 'Margine di dimensione',
    qtyDiscountGroup: 'Sconto quantità',
    floorGroup: 'Minimo',
    marginMinMult: 'Moltiplicatore sui pezzi molto grandi (M_MIN)',
    marginMaxMult: 'Moltiplicatore sui pezzi molto piccoli (M_MAX)',
    marginK: 'Costo unitario a metà curva (K, {{currency}})',
    qtyMinFactor: 'Margine mantenuto ad alta quantità (Q_MIN)',
    qtyK: 'Quantità a metà curva (KQ)',
    minTaskPrice: 'Prezzo minimo per attività ({{currency}})',
    marginCurveMaxBelowMin: 'M_MAX deve essere almeno pari a M_MIN',
    marginCurvePreviewSize: 'Margine di dimensione in base al costo unitario',
    marginCurvePreviewQty: 'Fattore quantità in base alla quantità',
    exampleTitle: 'Lavoro di esempio',
    ...
    formulaAt: 'A {{x}} → {{y}}',
    warnFlatSize: 'La curva delle dimensioni è piatta: ogni pezzo riceve ×{{m}}.',
    warnKFar: 'K è molto superiore al costo del tuo esempio; la curva si piega a malapena dove si trovano i tuoi lavori.',
    warnKNear: 'K è molto inferiore al costo del tuo esempio; ogni lavoro si trova vicino a M_MIN.',
    warnNoQtyDiscount: 'Nessuno sconto quantità: Q_MIN è 1.',
    warnFloorDominates: 'Il prezzo minimo supera il prezzo del tuo esempio; le curve non si applicano mai al di sotto.',
    kHint: 'Costo unitario mediano delle tue ultime {{count}} stampe: {{median}}',
    kHintUse: 'Usalo',
    exampleFromCalculator: 'Precompilato dall\'ultimo lavoro del calcolatore',
    multiplier: '×{{value}}',
    multiplierDetail: 'dimensione ×{{size}} · qtà {{qty}}',
    floorApplied: 'Prezzo minimo applicato',
    curveTitle: 'Prezzo in base alla quantità',
    curveHint: 'Prezzo unitario (tasse incl.) per ogni quantità — i costi fissi si ammortizzano e lo sconto quantità riduce il margine.',
    curveUnitPrice: 'Prezzo unitario',
    curveTaskPrice: 'Totale attività',
    curveQtyFactor: 'Fattore quantità',
    curveCurrent: 'attuale',
    failureRate: 'Tasso di fallimento (%)',
    prototypeRate: 'Tasso prototipo (%)',
    adsRate: 'Tasso pubblicità (%)',
    filamentMarkup: 'Ricarico filamento (%)',
    taxPct: 'Imposta TGC (%)',
    defaultDifficulty: 'Difficoltà predefinita (%)',
    defaultMargin: 'Margine predefinito sul costo (%)',
    filamentSettings: 'Impostazioni filamento',
    filamentSettingsHint: 'Valori iniziali per i nuovi profili filamento.',
    stuffMarkup: 'Ricarico forniture (%)',
    ratesTitle: 'Tariffe',
    ratesHint: 'Quanto ti costa un lavoro: allinea questi valori ai tuoi prezzi e alla tua valuta prima di preventivare.',
    provisionsTitle: 'Accantonamenti e spese generali',
    provisionsHint: 'Percentuali aggiunte al costo per coprire stampe fallite, prototipi, pubblicità e il ricarico di rivendita su filamento ed extra.',
    unsavedChanges_one: '{{count}} modifica non salvata',
    unsavedChanges_other: '{{count}} modifiche non salvate',
    fixFields: 'Correggi i campi evidenziati per salvare.',
