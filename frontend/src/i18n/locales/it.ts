export default {
  ...
  calculator: {
    ...
    basePrice: 'Prezzo base ({{currency}})',
    preparation: 'Preparazione',
    modelPreparation: 'Preparazione del modello (min)',
    slicing: 'Slicing (min)',
    transferStart: 'Trasferimento e avvio (min)',
    postProcessing: 'Post-produzione',
    jobRemoval: 'Rimozione del pezzo (min)',
    supportRemoval: 'Rimozione supporti (min)',
    additionalWork: 'Lavoro aggiuntivo (min)',
    fulfillment: 'Spedizione (min)',
