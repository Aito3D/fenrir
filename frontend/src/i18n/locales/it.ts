export default {
  ...
  aito: {
    ...
    track: {
      ...
      paymentMethods: {
        referenceKnown: 'Indichi il numero di preventivo {{ref}} come causale del pagamento.',
        referenceUnknown: 'Indichi il numero del suo preventivo come causale del pagamento.',
        transfer: 'Bonifico bancario',
        beneficiary: 'Beneficiario',
        bank: 'Banca',
        transferDelay: 'Un bonifico può impiegare uno o due giorni per arrivarci.',
        appTransfer: 'Bonifico {{app}}',
        tag: 'Beneficiario (tag)',
        shop: 'In negozio',
        shopSub: 'Carta bancaria o contanti.',
        copy: 'Copia',
        copied: 'Copiato',
        copyIban: "Copia l'IBAN",
        copyTag: 'Copia il tag {{app}}',
        question: 'Risponda al nostro messaggio per qualsiasi domanda.',
      },
      stages: {
        devis: 'Preventivo',
