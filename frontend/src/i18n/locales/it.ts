export default {
  ...
  calculator: {
    ...
    rush: 'Supplemento urgenza',
    rushPct: 'Supplemento urgenza (%)',
    rushToggle: 'Lavoro urgente',
    rushGroup: 'Urgenza',
    rushHint: 'Aggiunto al prezzo netto dopo il minimo, solo quando il lavoro è segnato come urgente.',
