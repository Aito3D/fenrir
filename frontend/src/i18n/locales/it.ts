export default {
  ...
  aito: {
    ...
    clientHistorySummary_one: '{{count}} progetto · {{total}} · dal {{date}}',
    clientHistorySummary_other: '{{count}} progetti · {{total}} · dal {{date}}',
    ...
    track: {
      ...
      status: {
        ...
        devisPaySub: 'Può già approvarlo pagando online qui sotto.',
