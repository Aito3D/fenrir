export default {
  ...
  aito: {
    ...
    firstName: 'Nome',
    lastName: 'Cognome',
    displayNamePreview: 'Salvato come: {{name}}',
    ...
    payment: {
      ...
      cellManualTitle: 'Registrare un pagamento',
      ...
      linkNone: '{{number}} · nessun link ancora',
      linkOpenState: '{{number}} · aperto, {{expires}}',
