export default {
  ...
  aito: {
    ...
    stats: {
      caption: '{{active}} in produzione · {{done}} completati in totale',
      added: 'Aggiunti',
      accepted: 'Accettati',
      completed: 'Completati',
      perDay: 'Aggiunti al giorno',
      perWeek: '≈ {{count}} a settimana',
      ...
      asOfToday: 'Ad oggi',
      lost: 'Persi: {{count}} · {{total}}',
      quoteAge: 'Preventivi in attesa di risposta',
      ...
      pickup: 'Ritiro',
      decisionsHeading: 'Preventivi accettati e rifiutati',
      declined: 'Rifiutati',
      ...
      brief: {
        ...
        dueNone: 'Niente in scadenza questa settimana.',
        finished_one: '{{count}} progetto completato nel periodo.',
        finished_other: '{{count}} progetti completati nel periodo.',
        more: '{{count}} in più rispetto al periodo precedente.',
        fewer: '{{count}} in meno rispetto al periodo precedente.',
        lead: 'Dal preventivo alla consegna: {{days}}.',
        chaseHeading: 'Sollecitare',
        tellHeading: 'Avvisare',
        collectHeading: 'Incassare',
        chaseEmpty: 'Ogni preventivo ha una risposta.',
        tellEmpty: 'Ogni cliente è stato avvisato.',
        collectEmpty: 'Ogni fattura è pagata.',
        ready: 'Pronto per il ritiro',
        late: '{{days}} g di ritardo',
        andMore: 'e altri {{count}}',
      },
      teaser: {
        sales: '{{pct}}% accettati · {{lost}} persi per {{total}}',
        time: '{{lead}} dal preventivo alla consegna · {{moves}} spostamenti all\'indietro',
        money: '{{accepted}} accettati · {{outstanding}} in sospeso · {{service}} è il {{pct}}% del fatturato',
        moneyPlain: '{{accepted}} accettati · {{outstanding}} in sospeso',
        clients: '{{new}} nuovi · {{returning}} abituali',
      },
    },
