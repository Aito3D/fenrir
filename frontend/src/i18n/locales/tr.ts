  ...
  diagnostic: {
    ...
    check: {
      ...
      network_mode: {
        ...
        warn: 'Fenrir, Docker köprü ağı kullanılarak çalışıyor. Yazıcı keşfi ve Sanal Yazıcı, ana bilgisayar ağ modu gerektirir — konteyneri "network_mode: host" ile yeniden oluşturun.',
