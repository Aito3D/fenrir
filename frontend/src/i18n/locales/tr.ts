export default {
  ...
  calculator: {
    ...
    basePrice: 'Taban fiyat ({{currency}})',
    preparation: 'Hazırlık',
    modelPreparation: 'Model hazırlığı (dk)',
    slicing: 'Dilimleme (dk)',
    transferStart: 'Aktarım ve başlatma (dk)',
    postProcessing: 'Son işlem',
    jobRemoval: 'Parçanın çıkarılması (dk)',
    supportRemoval: 'Destek temizliği (dk)',
    additionalWork: 'Ek işler (dk)',
    fulfillment: 'Gönderim (dk)',
