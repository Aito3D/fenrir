export default {
  ...
  aito: {
    ...
    descriptionPlaceholder: 'Tasarlanacak ve basılacak ürünü açıklayın…',
    ...
    sendInvoiceTitle: 'Faturayı e-posta ile gönder',
    sendInvoiceRecipient: 'Alıcı',
    sendInvoiceSubject: 'Konu',
    sendInvoiceMessage: 'Mesaj önizlemesi',
    ...
    createInvoiceTitle: 'Faturayı oluştur',
    createInvoiceIntro_one: 'Teklif {{quote}}, {{count}} satır. Zoho Books içinde bir fatura taslağı oluşturulur — e-posta gönderilmez.',
    createInvoiceIntro_other: 'Teklif {{quote}}, {{count}} satır. Zoho Books içinde bir fatura taslağı oluşturulur — e-posta gönderilmez.',
    createInvoiceAmount: 'Fatura tutarı',
    createInvoiceRemaining: 'Kalan ödeme',
    createInvoiceLockWarning: 'Faturalandıktan sonra bu teklif Fenrir üzerinden satır değişikliği kabul etmez.',
    createInvoiceConfirm: 'Oluştur',
    createInvoiceLoadFailed: 'Fatura hazırlanamadı',
    createInvoiceDone: '{{number}} numaralı fatura oluşturuldu',
    createInvoiceDonePaid: '{{number}} numaralı fatura oluşturuldu ve avanslarla kapatıldı',
    createInvoiceDonePartial: '{{number}} numaralı fatura oluşturuldu — {{retainers}} uygulanamadı',
    createInvoiceFailed: 'Fatura oluşturulamadı',
    acceptQuote: 'Teklifi kabul et',
    declineQuote: 'Teklifi reddet',
    holdToConfirm: 'Onaylamak için 0,5 sn basılı tutun',
    quoteSent: 'Teklif gönderildi olarak işaretlendi',
    quoteAccepted: 'Teklif kabul edildi',
    quoteDeclined: 'Teklif reddedildi',
    quoteUnaccepted: 'Kabul kaldırıldı — teklif yeniden Beklemede',
    unacceptLabel: 'Kabulü kaldır',
    unacceptHint: 'Kabulü kaldırmak için 1sn basılı tutun',
    quoteConflictAccepted: 'Bu teklif zaten başka biri tarafından kabul edildi.',
    quoteConflictDeclined: 'Bu teklif zaten başka biri tarafından reddedildi.',
    zohoNotUpdated: 'Yerel olarak kaydedildi — Zoho güncellenmedi',
    progressLabel: '{{total}} adımdan {{done}} tanesi tamamlandı',
    trash: 'Çöp Kutusu',
    trashEmpty: 'Çöp kutusu boş',
    restore: 'Geri yükle',
    restored: 'Proje geri yüklendi',
    restoreFailed: 'Proje geri yüklenemedi.',
    ...
    clearUrgent: 'Acili kaldır',
    holdToMarkUrgent: 'Acil işaretlemek için 0,5 sn basılı tutun',
    holdToClearUrgent: 'Acili kaldırmak için 0,5 sn basılı tutun',
    sav: 'İade',
    markSav: 'İade işaretle',
    clearSav: 'İadeyi kaldır',
    holdToMarkSav: 'İade işaretlemek için 0,5 sn basılı tutun',
    holdToClearSav: 'İadeyi kaldırmak için 0,5 sn basılı tutun',
    pause: 'Duraklatıldı',
    markPause: 'Duraklat',
    clearPause: 'Duraklatmayı kaldır',
    holdToMarkPause: 'Duraklatmak için 0,5 sn basılı tutun',
    holdToClearPause: 'Duraklatmayı kaldırmak için 0,5 sn basılı tutun',
    markFlag: 'İşaretle',
    flagFailed: 'İşaret değiştirilemedi',
    dueDate: 'Söz verilen tarih',
    dueDateClear: 'Tarihi temizle',
    dueDateEmpty: 'Tarih seç',
    dueLateDays: '{{count}} g gecikme',
    dueBadge: 'Son tarih {{date}}',
    dueDateFailed: 'Tarih değiştirilemedi',
    datePickerPrev: 'Önceki ay',
    datePickerNext: 'Sonraki ay',
    datePickerBackToSelected: 'Seçili aya dön',
    datePickerPlusTwoDays: '+2 gün',
    datePickerPlusOneWeek: '+1 hafta',
    datePickerPlusTwoWeeks: '+2 hafta',
    datePickerSuggested: 'önerilen',
    awaitingContact: 'Bilgilendirilecek',
    markContacted: 'Müşteri bilgilendirildi olarak işaretle',
    holdToMarkContacted: 'Müşterinin bilgilendirildiğini onaylamak için 0,5 sn basılı tutun',
    contacted: 'Bilgilendirildi',
    clearContacted: 'Bilgilendirildiyi geri al',
    holdToClearContacted: 'Bilgilendirildiyi geri almak için 0,5 sn basılı tutun',
    contactedFailed: 'İletişim kaydedilemedi',
    smsPickupShort: 'SMS',
    smsPickup: 'Teslim SMS’i gönder',
    smsTitle: 'Teslim SMS’i',
    smsMessageLabel: 'Mesaj',
    smsGenerating: 'Mesaj hazırlanıyor…',
    smsGenerateFailed: 'Mesaj hazırlanamadı',
    smsRegenerate: 'Yeniden oluştur',
    ...
    zohoNotConfigured: 'Zoho Books henüz bağlı değil.',
    zohoConfigureLink: "Zoho Books'u bağla",
    zohoUnreachable: "Zoho Books'a ulaşılamadı. Lütfen tekrar deneyin.",
    resetToDefaultClient: 'Varsayılan müşteriye sıfırla',
    clientPhone: 'Telefon',
    clientEmail: 'E-posta',
    countryCode: 'Ülke kodu',
    phonePlaceholder: '87123456',
    emailPlaceholder: 'musteri@example.com',
    revertPhone: 'Telefon değişikliğini geri al',
    revertEmail: 'E-posta değişikliğini geri al',
    socialNetworkMessenger: 'Messenger',
    socialNetworkInstagram: 'Instagram',
    socialNetworkWhatsapp: 'WhatsApp',
    socialNetworkTiktok: 'TikTok',
    socialLabel: 'Sosyal ağ (isteğe bağlı)',
    socialHandleLabel: 'Kullanıcı adı',
    socialHandlePlaceholder: 'kullaniciadi',
    socialRemove: 'Sosyal ağı kaldır',
    contactsLabel: 'Kişiler',
    contactsHint: 'Bu proje kimin için?',
    contactsLoading: 'Kişiler Zoho Books’tan okunuyor…',
    contactsUnavailable: 'Kişiler Zoho Books’tan okunamadı — aşağıya bir telefon veya e-posta girin.',
    contactPrimary: 'birincil',
    contactAdd: 'Kişi ekle',
    contactAddTitle: 'Yeni kişi',
    contactSaveToZoho: 'Zoho’ya kaydet',
    contactFirstNameRequired: 'Bir ad girin.',
    contactNeedsPhoneOrEmail: 'Bu kişiye ulaşmak için bir telefon numarası veya e-posta gerekir.',
    contactAddFailed: 'Kişi eklenemedi. Lütfen tekrar deneyin.',
    contactOverrideToggle: 'Bu kart için farklı bir telefon / e-posta kullan',
    contactOverrideHint: 'Yalnızca bu kart için geçerlidir — Zoho Books’taki kişi değişmez.',
    contactGone: 'Bu kişi artık Zoho Books’ta yok — başka birini seçin.',
    clientEditFanOutPerson: 'Bu kişinin tüm açık kartlarına uygulanır',
    clientEditTitle: 'İletişim bilgileri',
    clientEditSourceZoho: 'Zoho Books',
    clientEditSourceCard: 'Yalnızca bu kart',
    clientEditFanOut: 'Bu müşterinin tüm açık kartlarına uygulanır',
    ...
    clientHistoryNoQuote: 'teklif yok',
    clientHistoryThisCard: 'Bu kart · {{stage}}',
    clientHistoryDeclined: 'Reddedildi',
    clientHistoryOpenCard: '#{{id}} projesini aç',
    clientHistoryEmpty: 'Bu müşteri için henüz proje yok.',
    clientHistoryError: 'Müşteri geçmişi yüklenemedi.',
    clientEditLoading: 'Kişi Zoho Books’tan okunuyor…',
    clientEditWalkIn: 'Geçici müşteri: değişiklik bu kartta kalır ve Zoho Books’a gönderilmez.',
    clientEditZohoReadFailed: 'Kişi Zoho Books’tan okunamadı — kartın değerleri gösteriliyor.',
    clientEditFailed: 'Müşteri güncellenemedi. Lütfen tekrar deneyin.',
    createClient: 'Yeni müşteri oluştur',
    companyName: 'Şirket adı',
    firstName: 'Ad',
    lastName: 'Soyad',
    createClientSubmit: 'Müşteri oluştur',
    back: 'Geri',
    clientNameRequired: 'Bir şirket adı veya ad ve soyad girin.',
    newClientPersonHint: 'Veya bir kişinin adı ve soyadı',
    newClientContactTag: 'Şirketteki irtibat kişisi',
    newClientContactHint: 'önerilir — ad yeterli',
    newClientPreviewCompany: 'Şirket: {{name}} · irtibat: {{person}}',
    newClientPreviewCompanyAlone: 'Şirket: {{name}} · henüz irtibat kişisi yok',
    newClientPreviewIndividual: 'Bireysel: {{name}}',
    clientCreateFailed: 'Müşteri oluşturulamadı. Lütfen tekrar deneyin.',
    clientSyncFailed: "Proje oluşturuldu — müşteri Zoho'da güncellenemedi.",
    ...
    recordLabel: 'Kayıt',
    duplicateProject: "Çoğalt",
    duplicateReplaceTitle: "Devam eden taslak değiştirilsin mi?",
    duplicateReplaceBody: "Yeni proje panelinde henüz oluşturulmamış bir çalışma var. Bu kartı çoğaltmak onu değiştirir.",
    duplicateReplaceConfirm: "Değiştir",
    ...
    editConflict: 'Bu projeyi başka biri düzenledi — pano yenilendi, lütfen tekrar deneyin.',
    tasks: 'Görevler',
    addTask: 'Görev ekle',
    taskFallbackName: 'Görev {{n}}',
    track: {
      pageTitle: 'Sipariş takibi · Aito 3D',
      title: 'Siparişinizi takip edin',
      reference: 'Teklif No. {{ref}}',
      stepOf: 'Adım {{n}} / {{total}}',
      stepsAria: 'Adımlar',
      showSteps: 'Adımları gör',
      hideSteps: 'Adımları gizle',
      stepsList: 'Adım ayrıntıları',
      tasksHeading: 'Parçalarınız',
      showAllParts: '{{n}} parçanın tümünü gör',
      eta: 'Tahmini teslim',
      etaSoon: 'En kısa sürede bir tarih bildireceğiz.',
      etaUpdating: 'Tahmin güncelleniyor',
      updated: 'Güncellendi: {{when}}',
      updatedToday: 'bugün {{time}}',
      updatedYesterday: 'dün {{time}}',
      updatedOn: '{{date}} {{time}}',
      error: 'Takip bilgisi şu anda yüklenemiyor.',
      retry: 'Yeniden dene',
      invalidTitle: 'Bu takip bağlantısı artık geçerli değil',
      invalidBody: 'Süresi dolmuş veya değiştirilmiş olabilir. Bize ulaşın, size yeni bir bağlantı gönderelim.',
      footerQuestion: 'Siparişinizle ilgili bir sorunuz mu var?',
      enterTitle: 'Siparişimi takip et',
      enterHint: 'Teklifinizdeki veya mesajımızdaki 6 karakterli kodu girin.',
      codeLabel: 'Takip kodu',
      codeChecking: 'Kontrol ediliyor…',
      retrying: 'Yeniden deneniyor…',
      codeFound: 'Kod tanındı, takip sayfanız açılıyor.',
      codeNotFound: 'Kod bulunamadı. Kontrol edip tekrar deneyin.',
      codeTooMany: 'Çok fazla deneme. Lütfen bir dakika bekleyin.',
      codeError: 'Kod şu anda kontrol edilemiyor. Tekrar denemek için Enter tuşuna basın.',
      ...
      paymentMethods: {
        ...
        beneficiary: 'Alıcı',
        bank: 'Banka',
        transferReference: 'Havale açıklaması',
        referenceUnknown: 'Teklif numaranız',
        transferDelay: 'Bir havalenin bize ulaşması bir iki gün sürebilir.',
        appTag: '{{app}} etiketi',
        appMessage: 'Mesaj',
        appHint: '{{app}} uygulamasından teklif tutarını bu etikete gönderin.',
        shop: 'Mağazada',
        shopSub: 'Banka kartı, nakit veya çek.',
        shopAddress: 'Adres',
      ...
      status: {
        devisTitle: 'Teklif hazırlanıyor',
        ...
        pickedUpTitle: 'Teslim alındı',
        pickedUpSub: '{{date}}. Güveniniz için teşekkürler!',
        doneTitle: 'Tamamlandı',
        doneSub: 'Güveniniz için teşekkürler!',
      },
      invoice: {
        paidTitle: 'Fatura ödendi',
        paidSub: 'Güveniniz için teşekkürler.',
        unpaidTitle: 'Ödenecek fatura',
        unpaidSub: 'Teslim alma veya gönderimden önce ödenmelidir.',
        overdueTitle: 'Vadesi geçmiş fatura',
        overdueSub: 'Zaten ödediyseniz bize ulaşın.',
      },
      payment: {
        unpaidTitle: 'Proje henüz ödenmedi',
        unpaidSub: 'Çevrimiçi, havale ile veya mağazada ödeyebilirsiniz.',
        unpaidDepositSub: 'Kapora siparişinizi kesinleştirir — çevrimiçi, havale ile veya mağazada ödeyebilirsiniz.',
        validateTitle: 'Teklifinizi onaylayın',
        validateSub: 'Çevrimiçi ödeme, teklifin kabulü anlamına gelir.',
        validateDepositSub: 'Kapora, teklifinizi onaylar ve üretimi başlatır.',
        pay: 'Çevrimiçi öde',
        paidTitle: 'Ödeme alındı',
        depositPaidTitle: 'Kapora alındı',
        paidSub: 'Güveniniz için teşekkürler.',
      },
    },
    trackingCopy: 'Takip bağlantısını kopyala',
    trackingOpen: 'Takip bağlantısını aç',
    ...
    paymentLink: {
      label: 'Çevrimiçi ödeme',
      paid: 'Ödendi',
      copy: 'Ödeme bağlantısını kopyala',
      open: 'Ödeme bağlantısını aç',
      copied: 'Kopyalandı',
      expiresIn_one: '{{count}} gün içinde sona erer',
      expiresIn_other: '{{count}} gün içinde sona erer',
      expiresToday: 'Bugün sona erer',
      retry: 'Yeniden dene',
      state: { expired: 'Süresi doldu', cancelled: 'İptal edildi', failed: 'Reddedildi' },
    },
    payment: {
      dueQuote: 'Kapora tutarı',
      dueInvoice: 'Kalan bakiye',
      cellLink: 'Bağlantı',
      cellTerminal: 'POS cihazı',
      cellManual: 'Manuel',
      cellLinkTitle: 'Ödeme bağlantısı',
      cellTerminalTitle: 'POS cihazında kartla öde',
      cellManualTitle: 'Manuel — ödeme kaydet',
      terminalOff: 'Heimdall yapılandırılmamış',
      stateProcessing: 'POS cihazı · kart bekleniyor',
      stateAttention: 'Sonuç bilinmiyor · POS cihazını kontrol edin',
      statePaid: '{{amount}} ödendi · {{channel}} · {{date}}',
      statePaidNoDate: '{{amount}} ödendi · {{channel}}',
      stateBookingFailed: 'Zoho Books’a kaydedilmedi — Heimdall’a bakın',
      stateNoLink: 'Bağlantı yok',
      channelTerminal: 'POS cihazı',
      channelLink: 'çevrimiçi',
      amountLabel: 'Tutar',
      manualTitle: 'Ödeme kaydet',
      manualIntroQuote: 'Teklif {{number}} · kapora tezgahta alındı',
      manualIntroInvoice: 'Fatura {{number}} · ödeme tezgahta alındı',
      modeLabel: 'Yöntem',
      modeCard: 'Kart',
      modeCheque: 'Çek',
      modeCash: 'Nakit',
      referenceLabel: 'Referans',
      referenceRequired: 'Bir çekin numarası gerekir',
      manualHintQuote: 'Zoho Books’ta teklif üzerinde bir kapora faturası oluşturur ve ödemeyi buna kaydeder.',
      manualHintInvoice: 'Ödemeyi Zoho Books’taki faturaya kaydeder.',
      manualConfirm: 'Kaydet',
      manualDone: 'Ödeme kaydedildi',
      amountInvalid: 'Sıfırdan büyük bir tam tutar girin',
      terminalTitle: 'Kartla öde',
      terminalIntro: '{{number}} · tezgahtaki POS cihazında',
      terminalHintQuote: 'Kapora tutarıyla dolduruldu; teklifte herhangi bir tutar kabul edilir.',
      terminalHintInvoice: 'Bakiyeyle dolduruldu; Heimdall tutarı bakiyeyle sınırlar.',
      terminalStart: 'POS cihazını başlat',
      terminalWaiting: 'POS cihazında kart bekleniyor…',
      terminalWaitingHint: 'PIN için 3 dakikaya kadar sürebilir.',
      terminalLeave: 'Kapat, daha sonra dönerim',
      terminalPaid: 'Ödeme kabul edildi',
      terminalBookingPending: 'Zoho Books’a kaydediliyor…',
      terminalBookingDone: 'Zoho Books’a kaydedildi',
      terminalBookingFailed: 'Zoho Books’a kaydedilmedi — Heimdall’a bakın',
      terminalFailed: 'Reddedildi',
      terminalFailedHint: 'Herhangi bir tutar tahsil edilmedi. Tekrar deneyebilirsiniz.',
      terminalRetry: 'Yeniden dene',
      terminalAttention: 'Sonuç bilinmiyor',
      terminalAttentionHint: 'POS cihazı yanıt vermedi. Tekrar denemeden önce kağıt fişi kontrol edin.',
      linkTitle: 'Ödeme bağlantısı',
      linkCreate: 'Bağlantı oluştur',
      linkCreateAgain: 'Yeni bir bağlantı oluştur',
      linkCancel: 'Bağlantıyı iptal et',
      linkCancelConfirm: 'Bu bağlantı iptal edilsin mi?',
      linkExpires: 'Sona erme',
      linkHintInvoice: 'Bakiyeyle dolduruldu. Bağlantı, teklifin geçerlilik süresinin sonunda sona erer.',
      linkPending: 'Bağlantı oluşturuluyor…',
      linkDone: 'Ödeme bağlantısı oluşturuldu',
      linkCancelled: 'Ödeme bağlantısı iptal edildi',
    },
    pastCards_one: '{{count}} geçmiş kart',
    pastCards_other: '{{count}} geçmiş kart',
    reuseTasks: 'Yeniden kullan',
    rating: {
      good: 'İyi',
      medium: 'Orta',
      bad: 'Kötü',
      ...
      pastDue_one: '{{count}} vadesi geçmiş',
      pastDue_other: '{{count}} vadesi geçmiş',
    ...
    taskDescriptionPlaceholder: 'Açıklama (isteğe bağlı)',
    removeTask: 'Görevi kaldır',
    serviceScan3D: 'Tarama',
    serviceModelisation3D: 'Modelleme',
    serviceImpression3D: 'Baskı',
    serviceUsinage: 'İşleme',
    serviceMainDoeuvre: 'İşçilik',
    serviceDescriptionRequired: 'Açıklama (zorunlu)',
    maindoeuvreDescriptionRequired: 'İşçilik için bir açıklama gerekli',
    serviceCost: 'Maliyet',
    ...
    importTitle: 'Teklif içe aktar',
    quoteSearchLabel: 'Teklif',
    quoteNumberLabel: 'Numara',
    ...
    quoteNoServiceLines: 'Bu teklifte AITO 3D hizmet satırı yok.',
    quoteAlreadyImported: 'Proje #{{id}} olarak zaten içe aktarıldı',
    quoteImport: 'İçe aktar',
    quoteSkipped: 'İçe aktarılmadı',
    quoteTotals: 'Proje {{project}} · teklif {{quote}}',
    quoteCurrencyMismatch: 'Bu teklif {{code}} para biriminde; pano {{configured}} gösteriyor.',
    quoteOpenInZoho: "Zoho Books'ta aç",
    changeQuote: 'Değiştir',
    quoteRowImported: 'İçe aktarıldı → #{{id}}',
    beforeImport: 'İçe aktarmadan önce',
    ruleQuoteLines: 'Teklifte AITO hizmet satırları var',
    ruleQuoteFresh: 'Daha önce içe aktarılmadı',
    ruleCurrencyOk: 'Para birimi panoyla eşleşiyor',
    ruleImportDescription: 'Açıklama dolduruldu',
    importTaskCount_one: '{{count}} görev',
    importTaskCount_other: '{{count}} görev',
    printer: 'Yazıcı',
    material: 'Malzeme',
    weightG: 'Ağırlık (g)',
    ...
    followCalculator: 'Hesaplayıcıyı izle',
    priceManual: 'Manuel',
    priceLinked: 'Hesaplayıcı',
    ...
    quotePending: 'Teklif oluşturuluyor…',
    sync: 'Senkronizasyon',
    ...
    syncBlockedLabel: 'Eşitleme engellendi',
    forceSync: 'Eşitlemeyi zorla',
    forceSyncHint: 'Teklifi Zoho’da yeniden okuyup maliyetleri tekrar gönder',
    ...
    stats: {
      ...
      leadTime: 'Tekliften teslimata',
      median: 'medyan {{days}} g',
      productionTime: 'Kabulden teslimata',
      daysShort: '{{days}} g',
      activity: 'Günlük etkinlik',
      rolling7: 'Tamamlananların 7 günlük ortalaması',
      flow: 'Her aşamada geçen gün',
      sent: 'Gönderilen',
      ofAccepted: 'kabul edilenlerin %{{pct}}\'i',
      quoted: 'Kabul edilen teklifler',
      ...
      ageDays: '{{range}} gün',
      winRate: 'Tutara göre kabul oranı',
      winRateEmpty: 'Henüz yeterince karara bağlanmış teklif yok',
      decisions: '{{count}} karar',
      stageTime: 'Tamamlanan proje başına süre',
      reworkMoves: 'Geri adımlar',
      reworkShare: '{{cards}} kart · taşınan kartların %{{pct}}\'i',
      overdue: 'Vadesi geçmiş faturalar',
      overdueOldest: 'en eski {{days}} g',
      nothingOverdue: 'Vadesi geçen yok',
      serviceMix: 'Hizmet dağılımı',
      serviceTasks: '{{count}} görev',
      clientsNew: 'Yeni müşteriler',
      clientsReturning: 'Tekrar gelen müşteriler',
      returningShare: 'Gelirin %{{pct}}\'i tekrar gelen müşterilerden',
      arrivals: 'Talepler ne zaman geliyor',
      islands: 'Adaya göre gönderim',
      pickup: 'Yerinde teslim',
      declined: 'Reddedilen',
      acceptanceRate: '%{{pct}} kabul',
      ...
      strip: {
        onBoard: 'panoda {{amount}}',
        longest: 'en uzun süredir bekleyen: {{stage}} aşamasında <who>{{name}}, {{days}}</who>',
        oldest: 'en eski {{days}} g',
        noQuote: 'henüz teklif yok',
        dueSoon_one: 'bu hafta {{count}} teslimat var',
        dueSoon_other: 'bu hafta {{count}} teslimat var',
      },
      facts: {
        perDay: 'günde {{count}}',
        waiting15: '15+ gündür bekleyen',
        lostWith: 'Reddedilen tekliflerle kaybedilen',
        shippingBilled: 'Faturalanan gönderim',
        parcels_one: '{{count}} koli',
        parcels_other: '{{count}} koli',
        invoices_one: '{{count}} fatura',
        invoices_other: '{{count}} fatura',
        cards_one: '{{count}} kart',
        cards_other: '{{count}} kart',
        today: 'bugün',
      },
      finding: {
        overview: '{{in}}, {{accepted}} ve {{done}}.',
        overviewIn_one: '{{count}} proje geldi',
        overviewIn_other: '{{count}} proje geldi',
        overviewAccepted_one: '{{count}} tanesi kabul edildi',
        overviewAccepted_other: '{{count}} tanesi kabul edildi',
        overviewDone_one: '{{count}} tanesi teslim edildi',
        overviewDone_other: '{{count}} tanesi teslim edildi',
        overviewPeakWeek: 'En yoğun hafta {{date}} haftasıydı.',
        overviewPeakDay: 'En yoğun gün {{date}} idi.',
        salesWin: 'Tekliflerin %{{pct}}\'ini kazanıyorsunuz.',
        salesLost_one: '{{count}} teklif kaybedildi, tutarı {{total}}.',
        salesLost_other: '{{count}} teklif kaybedildi, toplam tutarı {{total}}.',
        salesLostBig: 'Kaybettikleriniz büyük olanlar: {{min}} üzerindeki {{decided}} teklifin {{lost}} tanesi, toplam {{total}}.',
        salesNone: 'Bu dönemde karara bağlanan teklif yok.',
        timeLead: 'Bir proje tekliften teslimata {{days}} sürüyor.',
        timeSlow: 'Yavaş aşama {{days}} ile {{stage}}.',
        timeRework_one: '{{count}} adım geriye gitti.',
        timeRework_other: '{{cards}} üzerinde {{count}} adım geriye gitti.',
        timeNone: 'Bu dönemde teslim edilen proje yok.',
        moneyTotals: '{{accepted}} kabul edildi ve {{invoiced}} faturalandı.',
        moneyOut: '{{invoices}} üzerinde {{amount}} hâlâ bekliyor.',
        moneyOverdue_one: 'Bunlardan {{count}} tanesinin vadesi {{days}} gün geçmiş.',
        moneyOverdue_other: 'Bunlardan {{count}} tanesinin vadesi geçmiş, en eskisi {{days}} gün.',
        moneyClear: 'Bekleyen bir şey yok.',
        clients: '{{new}} ve {{returning}}.',
        clientsNew_one: '{{count}} yeni müşteri',
        clientsNew_other: '{{count}} yeni müşteri',
        clientsReturning_one: '{{count}} tekrar gelen',
        clientsReturning_other: '{{count}} tekrar gelen',
        clientsPeak: 'Talepler {{day}} günü {{hour}} civarında geliyor.',
        clientsParcels_one: '{{count}} koli adalara gitti.',
        clientsParcels_other: '{{count}} koli adalara gitti.',
        clientsNone: 'Bu dönemde yeni müşteri yok.',
      },
      brief: {
        chase_one: 'takip edilecek {{count}} teklif',
        chase_other: 'takip edilecek {{count}} teklif',
        tell_one: 'haber verilecek {{count}} müşteri',
        tell_other: 'haber verilecek {{count}} müşteri',
        collect: 'tahsil edilecek {{amount}}',
        allClear: 'Takip edilecek, haber verilecek ya da tahsil edilecek bir şey yok.',
        due_one: 'Bu hafta {{count}} teslimat var.',
        due_other: 'Bu hafta {{count}} teslimat var.',
        chaseHeading: 'Takip et',
        tellHeading: 'Haber ver',
        collectHeading: 'Tahsil et',
        ready: 'Teslime hazır',
        late: '{{days}} g gecikmiş',
    ...
    followups: {
      ...
      unpaid: 'Ödenmedi',
      linkExpiring: 'Bağlantı sona eriyor',
      longest: '{{days}} gün',
    ...
    history: {
      title: 'Etkinlik',
      empty: 'Henüz bir kayıt yok',
      loadMore: 'Daha fazla yükle',
      depthStory: 'Özet',
      depthDetail: 'Detay',
      depthEverything: 'Her şey',
      notePlaceholder: 'Not ekle…',
      noteSubmit: 'Notu ekle',
      noteFailed: 'Not kaydedilemedi',
      changeCount: '{{count}} değişiklik',
      automatic: 'otomatik',
      fromZoho: 'Zoho Books’tan',
      projectCreated: 'projeyi oluşturdu',
      quoteCreated: 'Teklif oluşturuldu',
      quoteSent: 'teklifi gönderildi olarak işaretledi',
      ...
      quoteUnaccepted: 'teklifin kabulünü kaldırdı',
      quoteDeclined: 'teklifi reddetti',
      quoteExpired: 'Teklifin süresi doldu',
      stageChanged: 'projeyi taşıdı',
      projectTrashed: 'projeyi çöp kutusuna taşıdı',
      projectRestored: 'projeyi geri yükledi',
      ...
      projectUrgentSet: 'Acil olarak işaretlendi',
      projectUrgentCleared: 'Acil kaldırıldı',
      projectSavSet: 'İade olarak işaretlendi',
      projectSavCleared: 'İade kaldırıldı',
      projectPauseSet: 'Duraklatma olarak işaretlendi',
      ...
      paymentTerminalStarted: 'POS cihazında kartla ödeme başlatıldı',
      paymentTerminalPaid: 'POS cihazında kartla ödendi',
      paymentTerminalFailed: 'POS cihazındaki ödeme reddedildi veya iptal edildi',
      paymentTerminalAttention: 'POS cihazının sonucu bilinmiyor — POS cihazını kontrol edin',
      paymentManualRecorded: 'Ödeme kaydedildi',
      paymentManualPartial: 'Kapora faturası oluşturuldu, ödeme KAYDEDİLMEDİ — Zoho Books’ta tamamlayın',
      noteAdded: 'bir not ekledi',
      zohoComment: 'Zoho Books’ta yorum',
      syncQueued: 'Zoho’ya gönderim için sırada',
      syncPushed: 'Zoho’ya gönderildi',
      syncFailed: 'Zoho’ya gönderim başarısız oldu',
      syncLocked: 'Teklif Zoho’da kilitli',
      syncConflict: 'Zoho ile durum çakışması',
      syncStatusRejected: 'Zoho durum değişikliğini reddetti',
      pollReconciled: 'Zoho ile karşılaştırıldı',
    },
    // New-project drawer
    workSection: 'Yapılacak iş',
    clientSectionTitle: 'Müşteri',
    workHintNone: 'henüz görev yok',
    workHintProgress: '{{total}} görevden {{done}} tamamlandı',
    addService: '{{service}} ekle',
    removeServiceChip: '{{service}} kaldır',
    taskNeedsSubTask: 'alt görev ekleyin',
    railSummary: 'Özet',
    summaryTitle: 'Proje özeti',
    summaryWaiting: 'Müşteri adımına geçince oluşturulur.',
    summaryGeneratedBy: '{{model}} tarafından oluşturuldu — düzenlemek için tıklayın',
    summaryEdited: 'Elle düzenlendi — artık otomatik yenilenmez',
    summaryFallback: 'YZ kullanılamıyor — açıklamayı kendiniz yazın',
    aiFieldHint: 'Yazım yapay zekâ tarafından düzeltildi',
    aiChecking: 'Yazım denetleniyor…',
    aiUndo: 'Kendi metnimi geri yükle',
    regenerate: 'Yeniden oluştur',
    beforeCreate: 'Oluşturmadan önce',
    ruleTasksOk_one: '{{count}} görev — en az bir tane gerekli',
    ruleTasksOk_other: '{{count}} görev — en az bir tane gerekli',
    ruleNeedTask: 'Bir projede en az bir görev olmalı — bir tane ekleyin',
    ruleSubTasksOk: 'Her görevin fiyatlandırılmış bir alt görevi var',
    ruleSubTaskMissing: '"{{name}}" için en az bir fiyatlandırılmış alt görev gerekli',
    ruleSubTasksPending: 'Her görev için en az bir fiyatlandırılmış alt görev gerekli',
    ruleClientAccount: 'Müşteri hesabı — {{name}}',
    ruleClientReachable: 'Müşteriye ulaşılabilir — {{contact}}',
    ruleClientContact: 'Müşterinin telefonu, e-postası veya sosyal ağı olmalı',
    warnNoEmail: 'E-posta yok — teklif e-postayla gönderilemez',
    warnNoPhone: 'Telefon yok — istemeyi unutmayın',
    holdToReset: 'Taslağı sıfırlamak için basılı tutun',
    resetDraft: 'Taslağı sıfırla',
    shippingAdd: 'Kargo ekle',
    shippingTitle: 'Kargo',
    shippingRemove: 'Kargoyu kaldır',
    shippingEdit: 'Kargoyu düzenle',
    shippingIsland: 'Varış adası',
    shippingIslandPlaceholder: 'Ada ara…',
    shippingNoIslands: 'Ada bulunamadı',
    shippingFirstName: 'Alıcının adı',
    shippingLastName: 'Alıcının soyadı',
    shippingPhone: 'Alıcının telefonu',
    shippingRecipient: 'Alıcı',
    shippingService: 'Kargo hizmeti',
    shippingRate: 'Ücret',
    shippingRateFromZoho: 'Zoho ücreti: {{rate}}',
    ...
    shippingLta: 'LTA numarası',
    shippingLtaPlaceholder: 'Hava konşimento numarası…',
    ...
    ruleShippingMissingIsland: 'Kargo: ada eksik',
    ruleShippingMissingRecipient: 'Kargo: alıcı adı eksik',
    ruleShippingInvalidPhone: 'Kargo: geçersiz telefon numarası',
  },
  // Navigasyon
  nav: {
    aito: 'Aito',
    ...
    stats: 'İstatistikler',
    profiles: 'Profiller',
    filamentProfiles: 'Filament Profilleri',
    maintenance: 'Bakım',
    projects: 'Projeler',
    inventory: 'Filament',
    finance: 'Finans',
    ...
    installAppSuccess: 'Fenrir yüklendi',
  },
  ...
  printers: {
    ...
    maintenance: {
      ...
      editFieldHelp: 'Etkinleştirildiğinde, bu yazıcı MQTT, kuyruk gönderimi ve bildirimlerden duraklatılır — tamir, paralel Fenrir kurulumları veya geçici askıya alma için kullanışlıdır.',
    },
    // Hazne ışığı
    ...
    nozzleWear: 'Aşınma',
    nozzleSlotEmpty: 'Yuva {{slot}} — Boş',
    humidityTooltip: 'Nem: {{value}}% - {{status}}',
    temperatureTooltip: 'Sıcaklık: {{value}}°C - {{status}}',
    clickForHistory: 'geçmiş için tıklayın',
    ...
    clickToDismiss: 'Kapatmak için tıklayın',
    aiDetection: {
      safe: 'Güvenli',
      warning: 'Uyarı',
  ...
  archives: {
    ...
    no3mfBanner: {
      ...
      body: 'Dilimleyici yazıcının SD kartına .gcode.3mf dosyasını bırakmadı, bu nedenle Fenrir küçük resmi veya dilimleyici meta verilerini alamadı. Bu genellikle dilimleyicide (Bambu Studio / OrcaSlicer\'in Cihaz sekmesi) "Gönderilen dosyaları harici depolamada sakla" seçeneğinin kapalı olmasından kaynaklanır.',
      ...
      bodyInternalStorage: 'Bambu Studio dilimlenmiş dosyayı karta değil yazıcının dahili depolamasına yazdı, bu yüzden Fenrir\'nin FTP üzerinden okuyacağı bir şey yoktu. H2 serisi, P2S ve X2D\'de «Yazdır» düğmesi bunu her zaman yapar; seçim yalnızca «Gönder» ile mümkündür ve orada da varsayılan «Önbellek»tir. Bu baskılar adları ve süreleriyle yine arşivlenir, yalnızca küçük resim ve dilimleyici meta verileri olmadan. Eksiksiz arşivler için baskıyı Fenrir üzerinden başlatın ya da OrcaSlicer ile dilimleyin; Bambu Studio kullanacaksanız «Gönder» ile «Harici» seçip baskıyı sonrasında başlatın. Hepsi yazıcıda kart ya da bellek gerektirir.',
      titleNoExternalStorage: 'Bazı son baskılar arşivlenemedi — yazıcıda depolama yok',
      bodyNoExternalStorage: 'Yazıcı yuvasında kart veya bellek bildirmiyor, bu yüzden dilimlenmiş dosyanın ineceği bir yer ve Fenrir\'nin okuyacağı bir şey yoktu. Bir tane takın, sonraki baskı eksiksiz arşivlenecek.',
      titleInternalHistory: 'Bazı son baskılar yazıcıda zaten bulunan bir dosyadan başlatıldı',
      bodyInternalHistory: 'Bu baskılar yazıcının kendi kitaplığından çalıştı — ekranından yeniden baskı, Handy üzerinden başlatma ya da daha önce gönderilip sonra basılan bir dosya. Fenrir baskı dosyalarını FTP üzerinden okur, FTP ise yalnızca kartı veya belleği sunar; yazıcı bu kitaplığı FTP\'nin ulaşamadığı bir alanda tutar, dolayısıyla okunacak bir 3MF yoktu. Hiçbir dilimleyici ayarı bunu değiştirmez, çünkü bu baskılar için hiçbir şey gönderilmedi. Adları ve süreleriyle arşivlenmeye devam ederler ve "Arşivi Düzenle" ile kullanılan filamenti elle girebilirsiniz. Eksiksiz bir arşiv için baskıyı Fenrir\'den ya da dilimleyicinizden başlatın.',
      titleFtpsCooloff: 'Bazı son baskılar arşivlenemedi — yazıcı dosya bağlantısını reddetti',
      bodyFtpsCooloff: 'Fenrir yazıcının dosya aktarım portunu (FTPS 990) açtı ve yazıcı TLS olmayan bir şeyle yanıt verdi, bu yüzden ondan hiçbir şey okunamadı. O baskılar adları ve süreleriyle yine arşivlenir, yalnızca küçük resim ve dilimleyici meta verileri olmadan. Bu bir dilimleyici ayarı değil ve sizin değiştirdiğiniz bir şey de değil — aynı modeller ve aynı ürün yazılımları başka kurulumlarda sorunsuz çalışıyor ve etkilenen bir yazıcı genellikle bir süre sonra kendiliğinden yeniden çalışıyor. Böyle bir hatadan sonra Fenrir o yazıcıya yapılan aktarımları beş dakika duraklatır ve duraklama bitince dosyayı yeniden almaya gelir; kısa bir kesinti böylece kendiliğinden düzelir, hâlâ boş duran bir kart ise reddin yeniden denemeden daha uzun sürdüğü anlamına gelir. Buna neyin yol açtığı henüz bilinmiyor. Tekrarlıyorsa Sistem sayfasından hata ayıklama günlüğünü açın ve bildiriminize bir destek paketi ekleyin.',
      titleFtpTransferFailed: 'Bazı son baskılar arşivlenemedi — dosya aktarımı süreye sığmadı',
      bodyFtpTransferFailed: 'Dilimlenmiş dosya yazıcının kartındaydı ve yazıcı dosyayı gerçekten sunuyordu, ancak aktarım izin verilen sürede tamamlanmadı. Baskı başlarken yazıcı aynı anda kamerasıyla, durum mesajlarıyla ve iş yüklemesiyle de ilgilenir; büyük bir 3MF bunların arasından her zaman geçemez. Bu baskılar adı ve süreleriyle hâlâ arşivde, yalnızca küçük resim ve dilimleyici verileri eksik. Bu bir dilimleyici ayarı değil ve sizin değiştirdiğiniz bir şeyden kaynaklanmıyor. Fenrir sonraki on dakika içinde dosyayı üç kez daha almaya gider, bu yüzden çoğu kendiliğinden tamamlanır; hâlâ boş duran bir kart, o denemelerin de süreye sığmadığı anlamına gelir. Sık sık oluyorsa Ayarlar > Ağ > FTP Yeniden Deneme altındaki Bağlantı Zaman Aşımı değerini artırın.',
    ...
    card: {
      ...
      gcode: 'GCODE',
      source: 'KAYNAK',
      unverifiedFile: 'Doğrulanmamış',
      unverifiedFileTooltip: 'Bu dosya yalnızca ada göre eşleştirildi — gerçekte yazdırılan dosya olmayabilir.',
      project: 'Proje: {{name}}',
  ...
  queue: {
    ...
    batchOrders: {
      ...
      strandedPlate: 'Ayarların kopyalanacağı çalışma yok',
      strandedNotice: 'Hâlâ beklenen {{owed}} çalışmadan {{runs}} tanesi kuyruğa alınamıyor: o plaka için ayarların kopyalanabileceği kuyrukta veya tamamlanmış bir çalışma kalmadı. Plakayı dosyadan bir kez kuyruğa alın veya siparişi iptal edin.',
    ...
    cancelBatchConfirmMessage: 'Bu sipariş kapatılsın mı? Kuyrukta kalan çalışmalar iptal edilir ve sipariş üretmediklerini artık istemez.',
    batch: {
      defaultName: 'Yığın',
      label: '{{count}} öğe',
    ...
    toast: {
      ...
      keptForOrder: 'Kaldırılmak yerine iptal edildi: yığın siparişinin bu plakayı yeniden kuyruğa alabileceği tek çalışma bu',
      historyKeptForOrders: 'Yığın siparişlerinin hâlâ ihtiyaç duyduğu {{kept}} tanesi korundu.',
  ...
  stats: {
    ...
    failuresByFilament: 'Filamente Göre Başarısızlıklar',
    failuresByPrinter: 'Yazıcıya Göre Başarısızlıklar',
    deltaVsPrevious: 'önceki {{days}} günlük döneme göre',
    utilizationBusy: '{{hours}} sa meşgul',
    utilizationNoData: 'Bu dönemde süre verisi olan baskı yok',
    costBreakdown: 'Maliyet Dağılımı',
    costFilament: 'Filament',
    costEnergy: 'Enerji',
    costMachine: 'Makine',
    costPerPrintHour: 'Baskı saati başına',
    costPerKg: 'Kg başına',
    costCoverage: '{{total}} baskıdan {{priced}} tanesi fiyatlandırıldı',
    costNoData: 'Mevcut hesaplayıcı ayarlarıyla hiçbir baskı fiyatlandırılamadı',
    filamentForecast: 'Filament Tahmini',
    forecastDaysLeft: '≈ {{days}} gün kaldı',
    forecastNoUsage: 'Yakın zamanda kullanım yok',
    forecastNoInventory: 'Envanterde makara yok',
    forecastRemaining: '{{amount}} kaldı',
    forecastBasis: 'Son kullanımdan öngörülmüştür — ayrıntılar Envanter sayfasında',
    maintenanceReliability: 'Bakım ve Güvenilirlik',
    printsSinceMaintenance: '{{date}} tarihinden beri {{prints}} baskı · {{failures}} başarısız',
    neverMaintained: 'Kayıtlı bakım yok',
    maintenanceDueBadge: '{{n}} gecikmiş',
    maintenanceWarningBadge: '{{n}} yakında',
    maintenanceNoData: 'Bakım takibi olan yazıcı yok',
    maintenanceSinceCaption: 'Sayımlar seçilen zaman aralığına aittir',
    energyWidgetTitle: 'Enerji Tüketimi',
    aitoPipeline: 'Aito hattı',
    aitoPipelineEmpty: 'Bu dönemde Aito panosunda bir şey yok',
    pipelineByStage: 'Aşamaya göre',
    pipelineConversion: 'Teklif dönüşümü',
    pipelineSent: 'Gönderildi',
    pipelineAccepted: 'Kabul edildi',
    pipelineDeclined: 'Reddedildi',
    pipelineAcceptedRate: '%{{pct}} kabul',
    pipelineStageDays: 'Aşama başına gün',
    pipelineInvoicing: 'Faturalama',
    pipelineInvoiced: 'Faturalandı',
    pipelineOutstanding: 'Tahsil edilmemiş',
    pipelineTracking: 'Müşteri takibi',
    pipelineTrackingViews: 'Sayfa açılışı',
    pipelineTrackingCards: 'Görüntülenen kart',
    pipelineTrackingLinks: 'Bağlantılı kart',
    pipelineDays: '{{days}} gün',
    pipelineSample_one: '{{count}} kart',
    pipelineSample_other: '{{count}} kart',
    energyTotalLabel: 'Toplam',
    energyCostLabel: 'Maliyet',
    energyAvgPerDay: 'Günlük ort.',
    energyAvgPerPrint: 'Baskı başına ort.',
    energyNoPlugs: 'Enerji izleme özellikli akıllı priz yapılandırılmamış',
    energyNoData: 'Bu dönem için kayıtlı enerji verisi yok',
  ...
  settings: {
    ...
    ldap: {
      ...
      feature3: 'LDAP grupları giriş sırasında Fenrir gruplarına eşlenir',
      ...
      autoProvisionHint: 'İlk LDAP girişinde otomatik olarak Fenrir hesabı oluştur',
      ...
      groupMappingHint: 'LDAP grup DN\'lerini Fenrir gruplarına eşle. Kullanılabilir gruplar: ',
    ...
    concurrentUploadsDescription: 'Kuyruğun aynı anda kaç yazıcıya dosya gönderebileceği. Yazıcılar dosyaları yavaş alır (büyük bir baskı birkaç dakika sürebilir) ve her biri sırasını bekler; bu nedenle büyük bir filoda bu değeri artırmak, bir gruptaki son yazıcının kendisinden önceki tüm aktarımları beklemesini önler. Ağınız veya Fenrir sunucunuz paralel aktarımlarda zorlanıyorsa değeri düşürün.',
    ...
    preheatFilamentTargetsHint: 'Fenrir yüklü AMS yuvaları arasındaki en yüksek hedefi seçer. Tüm yuvaları 0 türeten baskılar — PLA, PETG, TPU, PVA — ön ısıtmayı tamamen atlar ve hemen başlar.',
    ...
    authDisabledMessage: 'Kullanıcı hesapları oluşturmak, izinleri yönetmek ve Fenrir örneğinizi güvende tutmak için kimlik doğrulamayı etkinleştirin.',
    ...
    disableAuthenticationMessage: 'Kimlik doğrulamayı devre dışı bırakmak istediğinizden emin misiniz? Bu, Fenrir örneğinizi giriş yapmadan erişilebilir hale getirecek. Tüm kullanıcılar veritabanında kalacak ancak kimlik doğrulama devre dışı bırakılacak.',
    disableAuthentication: 'Kimlik Doğrulamayı Devre Dışı Bırak',
    // Ek ayarlar
    configureFenrir: 'Fenrir\'yi Yapılandır',
    ...
    captureFinishPhotoDescription: 'Baskı tamamlandığında yazıcı kamerasından bir fotoğraf çek. Fenrir, baskı sırasında kısa bir zaman atlamalı kayıt yapar, böylece fotoğraf tabla inmeden önceki andan alınabilir. Bu baskı için zaman atlamalı kaydı etkinleştirdiyseniz dosya saklanır, aksi takdirde fotoğraf çekildikten sonra otomatik olarak silinir.',
    finishPhotoRestorePlate: 'Bitiş fotoğrafı için tablayı yükselt',
    finishPhotoRestorePlateDescription: 'Yazıcı, baskı bittiğinde tablayı yaklaşık 100 mm aşağı indirir ve tamamlanmış baskı kameranın çerçevesinin altında kalır. Fenrir tablayı son basılan katmanın hemen üzerine geri kaldırır, fotoğrafı çeker ve ardından tekrar indirir. Baskı yüksekliği bilinmiyorsa veya kuyrukta başka bir iş varsa atlanır.',
    ...
    cameraQualityLow: 'Düşük',
    cameraQualityMedium: 'Orta',
    cameraQualityHigh: 'Yüksek',
    cameraQualityAuto: 'Otomatik',
    cameraQualityAutoWithResolved: 'Otomatik ({{resolved}})',
    cameraQualityAutoResolved: 'Sunucu donanımına göre otomatik seçildi: {{resolved}}.',
    cameraQualityAutoResolvedDual: 'Sunucu donanımına ve akış sayısına göre otomatik seçildi: {{single}} (tekli görünüm), {{grid}} (kamera ızgarası).',
    cameraQualityDescription: 'Akış FPS ve çözünürlüğünü kontrol eder. Düşük kalite, çoklu kamera kurulumlarında CPU kullanımını azaltır.',
    cameraGpuAccel: 'GPU Hızlandırma',
    cameraGpuAccelDescription: 'Kamera akışları için donanım hızlandırmalı video kod çözme kullanır. Uyumlu GPU bulunan sunucularda CPU kullanımını azaltır.',
    cameraGpuAccelUnavailable: 'Bu sunucuda GPU hızlandırma arka ucu bulunamadı.',
    cameraGpuAccelBackends: 'Kullanılabilir arka uçlar: {{backends}}',
    cameraEngine: 'Kamera Motoru',
    cameraEngineFFmpeg: 'FFmpeg (MJPEG)',
    cameraEngineGo2rtc: 'go2rtc (WebRTC)',
    cameraEngineFFmpegDescription: 'RTSP akışını FFmpeg ile MJPEG formatına dönüştürür. Tüm tarayıcılarla çalışır ancak daha fazla CPU kullanır.',
    cameraEngineGo2rtcDescription: 'H.264 akışını WebRTC ile doğrudan tarayıcıya iletir. Dönüştürme yok, daha düşük gecikme, donanım kod çözme. Kabin kameraları (A1/P1) FFmpeg kullanmaya devam eder.',
    ...
    fenrirSoftware: 'Fenrir Yazılımı',
    ...
    updateViaHomeAssistant: "Güncellemeler Home Assistant Supervisor tarafından yönetilir. Yeni sürümü yüklemek için Home Assistant'ta Ayarlar → Eklentiler → Fenrir'ye gidin.",
    ...
    externalUrlDescription: 'Fenrir\'nin erişilebildiği harici URL. Bildirim görüntüleri ve harici entegrasyonlar için kullanılır.',
    ...
    mqttDescription: 'Node-RED, Home Assistant ve diğer otomasyon sistemleriyle entegrasyon için Fenrir olaylarını harici bir MQTT brokerına yayınla.',
    ...
    encryption: {
      ...
      notConfiguredDesc: 'TOTP gizli anahtarları ve OIDC client_secrets düz metin olarak saklanır. MFA_ENCRYPTION_KEY ayarlayın veya Fenrir\'yi otomatik olarak oluşturmak için yazılabilir bir veri dizini ile yeniden başlatın.',
      ...
      migrationErrorWarning: 'Başlangıçta {{count}} eski satır yeniden şifrelenemedi. Sunucu günlüklerini kontrol edin ve yeniden denemek için Fenrir\'yi yeniden başlatın.',
    },
    ...
    aitoFollowupLinkDays: 'Ödeme bağlantısı sona eriyor (gün)',
    aitoFollowupLinkDaysDescription: 'Ödeme bağlantısı bu gün sayısı içinde sona eren teklifleri işaretler',
  },
  ...
  hmsErrors: {
    ...
    runoutSlotUnknown: 'Filament bitti ve baskı duraklatıldı. Fenrir yazıcının şu anda hangi slotu beklediğini belirleyemedi — istenen slot için yazıcının ekranını kontrol edin.',
    actions: {
  ...
  login: {
    ...
    resetStep1: 'Fenrir yöneticinizle iletişime geçin',
    ...
    twoFA: {
      ...
      instructionsTotp: 'Doğrulayıcı uygulamanızı açın ve Fenrir için 6 haneli kodu girin.',
  ...
  // Kurulum sayfası
  setup: {
    title: 'Fenrir Kurulumu',
    subtitle: 'Fenrir örneğiniz için kimlik doğrulamayı yapılandırın',
  ...
  camera: {
    ...
    expand: 'Genişlet',
    minimize: 'Küçült',
    reconnectingIn: '{{countdown}} sn içinde yeniden bağlanılıyor...',
    stream: 'Kamera akışı',
    resize: 'Boyutlandırmak için sürükleyin',
  ...
  users: {
    ...
    subtitle: 'Kullanıcıları ve Fenrir örneğinize erişimlerini yönetin',
    backToSettings: 'Ayarlara Dön',
    createUser: 'Kullanıcı Oluştur',
    noPermission: 'Bu sayfaya erişim izniniz yok.',
    admin: 'Yönetici',
  ...
  profiles: {
    ...
    orcaCloud: {
      ...
      connect: {
        ...
        description: 'Dilimleyici profillerinizi Fenrir ile senkronize etmek için Orca Cloud hesabınıza giriş yapın.',
      },
      device: {
        title: 'Orca Cloud\'da Fenrir\'yi onayla',
        instruction: 'Orca Cloud\'u açın ve bu kodu onaylayın. Onayladığınızda Fenrir otomatik olarak bağlanır.',
    ...
    login: {
      ...
      captchaBody: 'Bambu, oturum açmayı kabul etmeden önce ağınızdan CAPTCHA doğrulaması istiyor ve bu doğrulama Fenrir üzerinden yanıtlanamaz. Sorun e-postanız veya parolanız değil. Engel genel IP adresinize bağlıdır ve genellikle birkaç saat içinde kendiliğinden kalkar; sürekli yeniden denemek süreyi uzatır. Şimdi oturum açmak için tarayıcı oturumundan alınan bir erişim belirteci kullanın.',
  ...
  filamentProfiles: {
    ...
    syncingZoho: "Zoho'dan fiyatlar senkronize ediliyor…",
    syncToPc: "PC'ye senkronize et",
    exportZip: 'ZIP olarak dışa aktar',
    newPreset: 'Yeni ön ayar',
    // Filters
    searchPlaceholder: 'Ön ayarları ara…',
    sortPrefix: 'Sırala:',
    sortName: 'Ad',
    sortBrand: 'Marka',
    sortMaterial: 'Malzeme',
    sortColor: 'Renk',
    allBrands: 'Tüm markalar',
    countOne: '{{n}} ön ayar',
    countOther: '{{n}} ön ayar',
    countFiltered: '{{filtered}} / {{total}}',
    gridSmall: 'Küçük ızgara',
    gridMedium: 'Orta ızgara',
    gridLarge: 'Büyük ızgara',
    // Grid
    emptyTitle: 'Henüz ön ayar yok',
    emptySubtitle: 'Bir ön ayarı elle oluşturun veya bir klasörden içe aktarın.',
    ...
    delete: 'Sil',
    // Confirm
    deleteTitle: 'Ön ayar silinsin mi?',
    deleteBody: '{{name}} kalıcı olarak silinecek.',
    cancel: 'İptal',
    deleteConfirm: 'Sil',
    // Sync-base modal
    baseSyncedTitle: 'Temel profiller senkronize edildi',
    baseSyncFailedTitle: 'Senkronizasyon başarısız',
    filesScanned: '{{n}} dosya tarandı',
    statNew: 'Yeni',
    statUpdated: 'Güncellendi',
    statUnchanged: 'Değişmedi',
    close: 'Kapat',
    // Sync modal
    syncTitle: "PC'ye senkronize et",
    syncSubtitle: 'Değişiklikler BambuStudio filament klasörüne uygulanacak.',
    ...
    // Import
    scanFailed: 'BambuStudio klasörü okunurken hata oluştu: {{error}}',
    allImported: '{{n}} dosya bulundu — hepsi zaten içe aktarılmış.',
    ...
    inheritsNotFound: '(bulunamadı)',
    reload: 'Yeniden yükle',
    serverChangedBanner: 'Bu ön ayar siz düzenlerken sunucuda değişti.',
    serverChangedReload: 'Sunucudan yeniden yükle',
    save: 'Kaydet',
    create: 'Oluştur',
    saving: 'Kaydediliyor…',
    nameRequiredHint: 'Marka ve malzeme gerekli',
    deletePreset: 'Sil',
    invalidJson: 'Geçersiz JSON',
    tabGeneral: 'Genel',
    tabTemps: 'Sıcaklıklar',
    tabCooling: 'Soğutma',
    tabExtrusion: 'Ekstrüzyon',
    tabRetract: 'Geri çekme',
    tabJson: 'JSON',
    // Editor General
    basePresetLabel: 'Temel ön ayar',
    basePresetNone: '— Yok (boş başla) —',
    basePresetMine: 'Ön ayarlarım',
    basePresetBase: 'Temel ön ayarlar',
    basePresetLoading: 'Yükleniyor…',
    brand: 'Marka',
    brandSelect: '— Seç —',
    material: 'Malzeme',
    colorLabel: 'Renk etiketi',
    colorPlaceholder: 'Beyaz, Siyah…',
    nozzleSize: 'Nozül boyutu',
    paKValue: 'PA K değeri',
    cost: 'Maliyet',
    density: 'Yoğunluk',
    ...
    // Editor Temps
    nozzleSection: 'Nozül',
    tempInitial: 'İlk katman',
    tempPrint: 'Baskı',
    tempRangeMin: 'Aralık min',
    tempRangeMax: 'Aralık maks',
    materialSection: 'Malzeme',
    glassTg: 'Cam geçişi Tg',
    chamberSection: 'Hazne',
    chamberTemp: 'Hazne',
    bedPlates: 'Tabla plakaları',
    plate: 'Plaka',
    plateSuperTack: 'SuperTack',
    plateCool: 'Soğuk Plaka',
    plateEng: 'Mühendislik',
    plateHot: 'Sıcak Plaka',
    plateTextured: 'Dokulu',
    printCol: 'Baskı °C',
    initialCol: 'İlk katman °C',
    // Editor Cooling
    partFan: 'Parça soğutma fanı',
    fanMax: 'Maks. hız',
    fanMin: 'Min. hız',
    overhangFan: 'Çıkıntı hızı',
    noFanLayers: 'Fansız (parça) katmanlar',
    noFanAdditional: 'Fansız (ek) katmanlar',
    initialFan: 'İlk katman fanı',
    minLayerTime: 'Min. katman süresi',
    overhangThreshold: 'Çıkıntı eşiği',
    preStartFan: 'Ön başlatma fanı',
    additionalFan: 'Ek fan',
    overhangBridgeFan: 'Çıkıntı/köprü fanı',
    chamberVent: 'Hazne havalandırması',
    duringPrint: 'Baskı sırasında',
    endOfPrint: 'Baskı sonunda',
    nil: 'nil',
    off: 'Kapalı',
    on: 'Açık',
    // Editor Extrusion
    flowSection: 'Akış',
    flowRatio: 'Akış oranı',
    cal: 'kal',
    calTitle: 'Akış oranını % olarak ayarla',
    apply: 'Uygula',
    maxVolFlow: 'Maks. hacimsel akış',
    primeVolume: 'Astar hacmi',
    shrinkage: 'Büzülme',
    layerSlowdown: 'Katman yavaşlatma',
    minTimePerLayer: 'Katman başına min. süre',
    minSpeed: 'Min. hız',
    gcodeSection: 'G-code',
    startGcode: 'Başlangıç G-code',
    endGcode: 'Bitiş G-code',
    // Editor Retract
    length: 'Uzunluk',
    speed: 'Hız',
    deretractSpeed: 'Geri itme hızı',
    zHop: 'Z-hop',
    zHopType: 'Z-hop türü',
    zHopNormal: 'Normal Kaldırma',
    zHopSlope: 'Eğimli Kaldırma',
    zHopSpiral: 'Sarmal Kaldırma',
    wipeDistance: 'Silme mesafesi',
    retractBeforeWipe: 'Silmeden önce geri çekme',
    options: 'Seçenekler',
    retractOnLayerChange: 'Katman değişiminde geri çek',
    wipeOnRetract: 'Geri çekmede sil',
    // Editor JSON
    jsonCaption: 'Doğrudan düzenleme — diğer sekmeler otomatik olarak güncellenir',
  },
  ...
  fileManager: {
    ...
    uploading: 'Yükleniyor...',
    checkingDuplicates: 'Kontrol ediliyor...',
    alreadyInLibrary: 'Zaten kütüphanede',
    duplicateIn: '{{folder}} içinde',
    duplicatesWillBeSkipped: '{{count}} yinelenen dosya tespit edildi — atlanacak',
    uploadAnyway: 'Yine de yükle',
    skipDuplicate: 'Atla',
    skippedDuplicate: 'Atlandı (zaten kütüphanede)',
    ...
    tags: {
      ...
      creating: 'Oluşturuluyor…',
      hintSelect: '↵ ile seç:',
      hintDeselect: '↵ ile seçimi kaldır:',
      hintCreate: '↵ ile oluştur:',
    ...
    fileHistory: {
      menuLabel: 'Geçmiş',
      title: 'Geçmiş — {{name}}',
      viewHistoryAria: 'Yazdırma geçmişini görüntüle',
      noPermission: 'Dosya geçmişini görüntüleme izniniz yok',
      loadFailed: 'Dosya geçmişi yüklenemedi',
      statusPending: 'Kuyrukta',
      addedToLibrary: 'Kitaplığa eklendi',
      bySomeone: '{{name}} tarafından',
      noPrintsYet: 'Bu dosya henüz yazdırılmadı.',
      externalUnavailable: 'Harici dosyalar için yazdırma geçmişi mevcut değil.',
      openArchive: 'Arşivi aç',
      viewSource: 'Kaynak sayfasını aç',
      stats: {
        prints: 'Yazdırmalar',
        success: 'Başarı',
        filament: 'Filament',
        lastPrinted: 'Son yazdırma',
      },
    },
    uploadedBy: 'Yükleyen',
    ...
    toast: {
      ...
      moveSkipped: '{{moved}} taşındı, {{skipped}} atlandı: {{reasons}}',
      moveSkipReason: {
        not_owner: 'sahibi değil',
        source_readonly: 'kaynak salt okunur',
        source_missing: 'dosya artık diskte yok',
        target_readonly: 'hedef salt okunur',
        target_misconfigured: 'hedef klasör yanlış yapılandırılmış',
        target_inaccessible: 'hedef klasöre erişilemiyor',
        target_unwritable: 'hedef klasöre yazılamıyor',
        invalid_filename: 'güvenli olmayan dosya adı',
        name_collision: 'ad çakışması',
  ...
  sponsors: {
    ...
    tagline: 'Fenrir ücretsizdir ve böyle kalır çünkü insanlar onu desteklemeyi seçer. VC yok, bulut bağımlılığı yok.',
    viewSupporters: 'Destekçileri görüntüle',
    toastPrints: 'Fenrir ile {{count}} baskı tamamladın. Fenrir, destekçileri sayesinde ücretsiz kalıyor.',
    toastCost: 'Fenrir ile {{total}} kadar filament takip ettin. Projeyi bağımsız tutanları gör.',
    toastArchives: '{{count}} baskı Fenrir ile arşivlendi. Bağımsız kalmasını sağlayanları gör.',
    toastAnniversary: 'Fenrir ile bir yılı doldurdun! Projeyi bağımsız tutanları gör.',
    toastVersionUpdate: 'v{{version}} sürümüne güncellendi. Fenrir, destekçileri sayesinde ücretsiz kalıyor.',
    toastBusiness: "Fenrir'yi {{count}} yazıcıda mı çalıştırıyorsunuz? Ekipler için bir destek planı var: öncelikli düzeltmeler, faturalandırma ve geliştiriciye doğrudan erişim.",
    businessCta: 'Kurumsal Fenrir',
    businessTitle: 'Kurumsal Fenrir',
  ...
  inventory: {
    ...
    spoolmanMixedContentBody: 'Fenrir HTTPS üzerinden sunuluyor (ters proxy\'niz aracılığıyla), ancak Spoolman URL\'niz hâlâ düz HTTP. Tarayıcılar güvenlik için karışık içeriği engeller, bu nedenle gömülü Spoolman arayüzü oluşturulamaz. Bunun çalışması için Spoolman\'in HTTPS üzerinden erişilebilir olması gerekiyor.',
    spoolmanMixedContentFixReverseProxy: "Spoolman'i Fenrir ile aynı ters proxy'nin (Traefik / Nginx / Caddy) arkasına HTTPS ile koyun, ardından Ayarlardaki Spoolman URL'sini yeni HTTPS adresine güncelleyin.",
  ...
  // Zoho Books entegrasyonu (ayarlar sekmesi)
  zoho: {
    title: 'Zoho Books',
    subtitle: "Aito projelerini müşterilere bağlamak ve faturaları senkronize etmek için Zoho Books'u bağlayın.",
    clientId: 'İstemci Kimliği',
    clientSecret: 'İstemci Gizli Anahtarı',
    refreshToken: 'Yenileme Belirteci',
    organizationId: 'Kuruluş Kimliği',
    baseUrl: "API Temel URL'si",
    accountsUrl: "Hesaplar URL'si",
    defaultContactId: 'Varsayılan müşteri kimliği',
    defaultContactName: 'Varsayılan müşteri adı',
    defaultContactHint: 'Aito yeni proje penceresinde önceden seçilir. Telefon ve e-posta bu kişiye asla yazılmaz.',
    secretSaved: 'Değer kaydedildi — korumak için boş bırakın',
    save: 'Kaydet',
    saved: 'Zoho ayarları kaydedildi',
    test: 'Bağlantıyı Test Et',
    testOk: "Zoho Books'a bağlanıldı",
    testUnreachable: "Yapılandırıldı, ancak Zoho Books'a ulaşılamıyor",
    testNotConfigured: 'Zoho Books yapılandırılmamış',
  },

  heimdall: {
    title: 'Heimdall ödemeleri',
    subtitle: 'Heimdall POS köprüsü üzerinden her Aito teklifi için çevrimiçi bir ödeme bağlantısı oluşturur. Ödenen bağlantı teklifi otomatik olarak kabul eder.',
    baseUrl: 'Heimdall adresi',
    token: 'API belirteci',
    tokenHint: 'Yalnızca yazma — mevcut belirteci korumak için boş bırakın',
    depositPct: 'Kapora (%)',
    depositPctDescription: '0 teklifin tamamını ister; aksi halde bağlantı bu oranı kapsar.',
    validityDays: 'Teklif geçerliliği (gün)',
    validityDaysDescription: 'Her yeni teklife yazılan son geçerlilik tarihi; ödeme bağlantısı da aynı gün sona erer.',
    save: 'Kaydet',
    saved: 'Heimdall ayarları kaydedildi',
    test: 'Bağlantıyı test et',
    testOk: 'Heimdall bağlantısı kuruldu',
    testUnauthorized: 'Heimdall belirteci reddetti',
    ...
    paymentModesTitle: 'Zoho ödeme yöntemleri',
    paymentModesHint: 'Zoho Books’un bir proje kartından kaydedilen ödeme için kullandığı adlar.',
    paymentModeCard: 'Kart',
    paymentModeCheque: 'Çek',
  ...
  backup: {
    ...
    repoIsPublicWarning: "Depo HERKESE AÇIK. Fenrir yedekleri MQTT kimlik bilgilerini, Home Assistant belirteçlerini, Prometheus belirteçlerini, Bambu Cloud e-postanızı ve K-profilleri aracılığıyla yazıcı erişim kodlarını içerir. Sağlayıcınızın ayarlarında depoyu özel hale getirene kadar kaydetme engellenir.",
    repoVisibilityUnknown: 'Depo görünürlüğü belirlenemedi. Fenrir, özel olarak onaylanmamış hiçbir şeye yedekleme yapmayı reddeder; kaydetme engellenecek.',
    ...
    appSettingsDescription: 'Fenrir yapılandırması (tam veritabanı)',
    ...
    restoreFromGit: {
      ...
      reloadHint: 'Geri yüklenen verilerin her yerde görünmesi için Fenrir\'yi yeniden yükleyin.',
      ...
      notes: {
        ...
        settingsMqttRelayFailed: 'MQTT ayarları geri yüklendi ancak röle yeniden bağlanamadı - Fenrir\'yi yeniden başlatın',
    ...
    localBackupDescription: 'Veritabanı, arşivler, yüklemeler ve tüm dosyalar dahil Fenrir verilerinizin tam bir yedeğini oluşturun.',
    ...
    backupRestoredRestart: 'Yedek geri yüklendi. Lütfen Fenrir\'yi yeniden başlatın.',
    ...
    pathCheck: {
      title: 'Fenrir bu dizine yazamıyor',
      howToFix: 'Nasıl düzeltilir:',
      sandboxed: 'Fenrir servisi {{path}} dizinine yazamıyor. systemd birimi ProtectSystem=strict ile çalıştığı için kurulum, veri ve günlük dizinleri dışındaki her dizin servis açısından salt okunurdur - kendi kabuğunuzdan yazabildiğiniz bir dizin olsa bile.',
      read_only: '{{path}} salt okunur bir dosya sisteminde.',
      permission_denied: 'Fenrir\'nin {{path}} dizinine yazma izni yok. Dizinin sahibini ve izinlerini kontrol edin.',
      ...
      error: 'Fenrir {{path}} dizinine yazamıyor.',
      ephemeralTitle: 'Bu yedekler kapsayıcı yeniden oluşturulduğunda kaybolur',
      container_ephemeral: '{{path}} ana makinede değil, Fenrir kapsayıcısının içinde. Oraya yazılan yedekler kapsayıcı yeniden oluşturulduğunda kaybolur. Dizini ana makineden bağlayın:',
    },
  ...
  kProfiles: {
    ...
    modal: {
      ...
      notesHelp: 'Notlar yazıcıda değil, Fenrir\'de kaydedilir',
  ...
  virtualPrinter: {
    ...
    enable: {
      ...
      visibleInSlicer: 'Dilimleyici keşfinde "Fenrir" olarak görünür',
    ...
    remoteInterface: {
      ...
      hint: 'SSDP üzerinden tanıtılan ve TLS sertifikasında kullanılan IP adresini geçersiz kıl. Fenrir birden fazla ağ arayüzüne sahip olduğunda kullanışlıdır.',
    },
    mode: {
      title: 'Mod',
      archive: 'Arşiv',
    ...
    caCert: {
      ...
      description: "Sanal yazıcılar Fenrir CA tarafından imzalanmış bir TLS sertifikası kullanır. Bağlantıyı kabul etmesi için bu CA sertifikasını dilimleyicinizin güven deposuna bir kez içe aktarın — komut satırından kopyalamaya gerek yok.",
      copy: 'Kopyala',
      copied: 'Kopyalandı',
      download: 'İndir',
      fingerprint: 'SHA-256',
    ...
    howItWorks: {
      ...
      step2: '3MF dosyalarını Fenrir\'ye yüklemek için Arşiv, İnceleme ve Kuyruk modlarında dilimleyicinizdeki "Gönder" düğmesini kullanın. Dilimleyici "Baskı başarılı" gösterecek — dosya saklanır, yazdırılmaz.',
  ...
  locationHaSensors: {
    ...
    autoAdd: {
      ...
      confirmMessage: 'Fenrir bu konum için başka sensörler de buldu. Eklemek istediklerinizi seçin.',
    ...
    options: {
      ...
      pollIntervalHint: "Fenrir'nin Home Assistant'ı ne sıklıkla sorgulayıp ekrandaki sensör değerlerini güncellediği. Minimum 60 saniye.",
  ...
  notifications: {
    ...
    aitoPaymentReceivedLabel: 'Aito ödemesi alındı',
    aitoPaymentReceivedDescription: 'Bir Aito teklifi çevrimiçi olarak veya yeterli bir kapora ile ödendiğinde bildir',
    printFailed: 'Baskı Başarısız',
    printStopped: 'Baskı Durduruldu',
  ...
  time: {
    ...
    today: 'Bugün',
    yesterday: 'Dün',
    daysElapsed_one: '{{count}} gün önce',
    daysElapsed_other: '{{count}} gün önce',
    monthsElapsed_one: '{{count}} ay önce',
    monthsElapsed_other: '{{count}} ay önce',
    yearsElapsed_one: '{{count}} yıl önce',
    yearsElapsed_other: '{{count}} yıl önce',
  },
  ...
  spoolbuddy: {
    ...
    settings: {
      ...
      backendUrl: 'Fenrir Arka Uç URL\'si',
  ...
  diagnostic: {
    ...
    check: {
      ...
      external_storage: {
        ...
        warn_internal_storage: 'Seçenek açık ve depolama takılı, ancak son baskı yine de Fenrir\'nin okuyamadığı dahili depolamaya gitti. H2 serisi, P2S ve X2D\'de Bambu Studio\'nun «Yazdır» düğmesi bu ayardan bağımsız olarak her zaman oraya gönderir. Baskılar adları ve süreleriyle arşivlenir, ancak küçük resim ve dilimleyici meta verileri olmadan. Eksiksiz arşivler için baskıları Fenrir üzerinden başlatın, OrcaSlicer ile dilimleyin ya da Bambu Studio\'da «Gönder» ile «Harici» seçip baskıyı sonrasında başlatın.',
        warn_internal_history: 'Seçenek açık ve depolama takılı, ancak son baskı yazıcıda zaten bulunan bir dosyadan çalıştı — ekranından yeniden baskı, Handy üzerinden başlatma ya da daha önce gönderilmiş bir dosya. Bu kitaplık, Fenrir\'nin okuyamadığı dahili depolamada durur ve o baskı için hiçbir şey gönderilmediğinden hiçbir ayar bunu değiştirmez. Adı ve süreleriyle yine arşivlenir, ama küçük resim ve dilimleyici meta verileri olmadan. Eksiksiz arşivler için baskıları Fenrir\'den başlatın ya da dilimleyiciden gönderin.',
      },
      port_rtsps: {
      ...
      macos_local_network: {
        ...
        pass: 'macOS, Fenrir’nin yerel ağa erişmesine izin veriyor.',
        warn_unsigned: 'Fenrir’yi çalıştıran Python’un kod imzası yok; bu yüzden macOS Yerel Ağ iznini bağlayacak bir kimlik bulamıyor ve yazıcıya giden tüm bağlantıları hata vermeden, sormadan sessizce düşürüyor. İmzalamayı yapan Fenrir güncelleme betiğini (install/update_macos.sh) çalıştırın, ardından Fenrir’yi yeniden başlatın. Yorumlayıcı: {{executable}}',
        warn_permission: 'Yazıcı açıksa ve bu adresten erişilebiliyorsa Sistem Ayarları > Gizlilik ve Güvenlik > Yerel Ağ bölümünü açıp Fenrir’nin Python’unun etkin olduğundan emin olun. Etkin değilse macOS yerel bağlantıları sessizce düşürür; ayrıca Python güncellemesi eski izni geride bırakabilir.',
      },
      network_mode: {
        title: 'Konteyner ağ modu',
        genericRuntime: 'bir konteyner',
        pass: '{{runtime}} içinde ana bilgisayar ağıyla çalışıyor.',
        warn: 'Fenrir, {{runtime}} içinde köprü ağıyla çalışıyor. Yazıcı keşfi ve Sanal Yazıcı ana bilgisayar ağı gerektirir — konteyneri ana bilgisayar ağıyla yeniden oluşturun (docker-compose için "network_mode: host", Podman için "--network=host").',
        skip: 'Bir konteyner içinde çalışmıyor — uygulanamaz.',
        skip_unknown: 'Fenrir {{runtime}} içinde çalışıyor ancak ağ modu belirlenemedi. Yazıcı keşfi veya Sanal Yazıcı çalışmıyorsa konteyneri ana bilgisayar ağıyla yeniden oluşturun.',
        skip_system_container: 'Fenrir, sanal makine gibi doğrudan yerel ağda bulunan bir {{runtime}} sistem konteyneri içinde çalışıyor — uygulanamaz.',
      },
      subnet: {
        title: 'Ağ alt ağı',
        pass: 'Yazıcı ve Fenrir aynı alt ağda.',
        warn: 'Yazıcı ({{printer_ip}}) ve Fenrir ({{host_ip}}) farklı alt ağlarda. Alt ağlar arasında yönlendirme yapılandırılmazsa birbirlerine erişemeyebilirler.',
        skip: 'Alt ağ belirlenemedi — atlandı.',
      },
      mqtt_auth: {
        title: 'Yazıcı kimlik bilgileri',
        pass: 'Yazıcı bağlantıyı kabul etti.',
        fail: 'Yazıcıya erişilebiliyor ancak Fenrir ona bağlı değil. Büyük olasılıkla erişim kodu veya seri numarası yanlış — erişim kodu, Yalnızca LAN veya Geliştirici Modu her açılıp kapatıldığında değişir, bu yüzden yazıcı ekranından yeniden kopyalayın. Yeniden başlamakta olan veya eşzamanlı bağlantı sınırına ulaşmış bir yazıcı da aynı görünür.',
        fail_auth_rejected: 'Yazıcı, Fenrir\'nin kimlik bilgilerini reddetti. Erişim kodu veya seri numarası yanlış — erişim kodu, Yalnızca LAN veya Geliştirici Modu her açılıp kapatıldığında değişir. Yazıcı ekranından yeniden kopyalayın ve yazıcı ayarlarına kaydedin.',
  ...
  systemHealth: {
    ...
    signature: {
      'ftp-auth-rejected': {
        ...
        fix: 'Erişim kodunu yazıcı ekranından (LAN ayarları) yeniden kopyalayın ve Fenrir\'deki yazıcının ayarlarında güncelleyin.',
      },
      'ftp-connection-timeout': {
        name: 'Dosya aktarım bağlantısı zaman aşımına uğradı',
        cause: 'Fenrir yazıcının dosya aktarım portuna (FTPS 990) erişemedi. Port engellendi veya yazıcı kapalı ya da başka bir alt ağda.',
        fix: 'Fenrir ile yazıcı arasında hiçbir şeyin port 990\'ı engellemediğinden ve her ikisinin de aynı ağda olduğundan emin olun.',
      },
      'ftp-ssl-error': {
      ...
      'database-locked': {
        ...
        fix: 'Fenrir\'yi harici bir PostgreSQL veritabanına geçirin. Dokümantasyondaki PostgreSQL kılavuzuna bakın.',
      },
    },
  },
  ...
  vpDiagnostic: {
    ...
    check: {
      ...
      running: {
        ...
        fail: 'Sanal yazıcı etkin ancak servisleri çalışmıyor. Fenrir günlüğünü kontrol edin — bir bind IP çakışması veya bir izin hatası genellikle onları durdurur.',
      },
      bind_interface: {
      ...
      certificate: {
        ...
        pass: 'Sertifika hazır. Fenrir CA sertifikasının (yukarıda) dilimleyicinizin güven deposuna içe aktarıldığından emin olun.',
        fail: 'Bu sanal yazıcı için TLS sertifikası eksik. Fenrir veri dizininin yazılabilir olduğunu kontrol edin.',
      },
    },
  },
  ...
  failureDetection: {
    ...
    externalUrlHint: 'ML API, kamera anlık görüntüsünü URL üzerinden alır. ML API konteyneri Fenrir\'ye erişebilsin diye Genel ayarlarda Harici URL\'yi ayarlayın.',
  ...
  makerworld: {
    title: 'MakerWorld',
    description: 'Bambu Handy uygulamasına gitmeden — doğrudan Fenrir\'den içe aktarmak ve yazdırmak için bir MakerWorld model URL\'si yapıştırın.',
    ...
    signInExpiredTitle: 'Bambu Cloud oturumu sona erdi',
    signInExpiredBody: 'Fenrir oturumunuz açık kalmaya devam ediyor, ancak Bambu Lab kayıtlı belirteci artık kabul etmediği için indirmeler başarısız olacak. Bambu Cloud oturumunu yeniden açın.',
    ...
    disclaimer: 'MakerWorld entegrasyonu topluluk tarafından belgelenen API uç noktalarını kullanır. Fenrir, MakerWorld veya Bambu Lab ile ilişkili veya onaylı değildir.',
  ...
  libraryPurge: {
    ...
    effect4: 'Harici (bağlı) klasörlerdeki dosyalar atlanır — Fenrir asla sahibi olmadığı bayt\'ları silmez.',
  ...
  calculator: {
    ...
    material: 'Malzeme',
    title: 'Hesaplayıcı',
    subtitle: '3D baskı maliyetlerini ve satış fiyatlarını hesaplayın',
    easyMode: 'Basit mod',
    reset: 'Sıfırla',
    resetConfirmTitle: 'Girdileri sıfırla',
    resetConfirmMessage: 'Hesaplayıcının tüm girdileri varsayılanlara sıfırlansın mı? Filamentler, yazıcılar ve varsayılanlar korunur.',
    informations: 'Bilgiler',
    weight: 'Parça ağırlığı',
    printingTime: 'Baskı süresi (sa)',
    printingTimeLabel: 'Baskı süresi',
    durationDays: 'Gün',
    durationDaysShort: 'g',
    durationHours: 'Saat',
    durationHoursShort: 'sa',
    durationMinutes: 'Dakika',
    durationMinutesShort: 'dk',
    emptyInputsTitle: 'Ağırlık ve baskı süresini girin',
    emptyInputsMessage: 'Önerilen fiyatı ve maliyet dökümünü görmek için nesne ağırlığını ve baskı süresini girin.',
    targetPrice: 'Hedef fiyat',
    targetPriceLabel: 'Hedef fiyat (vergi dahil)',
    targetPriceProfit: 'Net kâr marjı',
    measuredEnergy: 'Ölçülen enerji: {{kwh}} kWh (arşivden)',
    measuredEnergyClear: 'Ölçülen enerjiyi temizle',
    qtyIncrease: 'Miktarı artır',
    qtyDecrease: 'Miktarı azalt',
    fixErrors: 'Bazı girişler geçersiz — vurgulanan alanları düzeltin; geçersiz değerler sonuçlarda dikkate alınmaz.',
    breakEvenDiscount: 'Başabaş indirimi: {{pct}} — daha yüksek indirimler maliyetin altında satış demektir.',
    ...
    summaryCopyFailed: 'Kopyalanamadı — panoya erişim engellendi',
    easyAssumptions: 'Kayıtlı oranlara göre — varsayılanları gözden geçir',
    quantity: 'Adet',
    filament: 'Filament',
    printer: 'Yazıcı',
    difficulty: 'Zorluk katsayısı (%)',
    difficultyTooltip: 'Zor baskılar için çarpan: aşındırıcı filament, yüksek hata riski, hassas işlem. %100 = ek ücret yok.',
    labor: 'İşçilik',
    modeling: 'Modelleme',
    workingHours: 'Çalışma saatleri',
    basePrice: 'Taban fiyat',
    preparation: 'Hazırlık',
    modelPreparation: 'Model hazırlığı',
    slicing: 'Dilimleme',
    transferStart: 'Aktarım ve başlatma',
    postProcessing: 'Son işlem',
    jobRemoval: 'Parçanın çıkarılması',
    supportRemoval: 'Destek temizliği',
    additionalWork: 'Ek işler',
    fulfillment: 'Gönderim',
    stuff: 'Çeşitli malzemeler',
    amount: 'Tutar',
    markupPct: 'Kâr payı',
    totals: 'Toplamlar',
    machineCost: 'Makine maliyeti',
    machineCostSafety: 'Güvenlikli makine maliyeti',
    ...
    realityCheck: {
      ...
      subtitle: 'Kendi baskılarınızdan, ayarlarınızdan ve envanterinizden ölçülmüştür.',
      failure: 'Başarısızlık oranı',
    ...
    timeCorrection: {
      ...
      hintScoped: '{{scope}}, dilimleyici tahminlerinin ortalama %{{pct}} kadarını gerçekleştiriyor',
      apply: 'Düzeltilmiş süreyi uygula',
      dismiss: 'Kapat',
    },
    waterfall: {
      tax: 'Vergi',
      aria: 'Maliyetlerden nihai fiyata fiyat oluşumu',
    },
    quote: {
      open: 'Yazdırılabilir teklifi aç',
      back: 'Hesaplayıcıya dön',
      print: 'Yazdır',
      title: 'Teklif',
      empty: 'Henüz teklif verilecek iş yok — önce hesaplayıcıyı doldurun.',
      jobDetails: 'İş ayrıntıları',
      footnote: 'Fiyatlara vergi dahildir. Teklif malzeme mevcudiyetine tabidir.',
    },
    marge: 'Marj',
    marginPct: 'Marj oranı',
    marginGlobal: 'Genel marj',
    marginFilament: 'Filament marjı',
    marginStuff: 'Malzeme marjı',
    perUnit: 'adet başına',
    forQuantity: '{{count}} adet için toplam',
    breakdown: 'Maliyet dökümü',
    costSplit: 'Maliyet dağılımı',
    costFilament: 'Filament',
    costDepreciation: 'Yazıcı amortismanı',
    costEnergy: 'Enerji',
    costConsumables: 'Sarf malzemeleri ve ambalaj',
    costBaseFee: 'Temel ücret',
    costRepairs: 'Onarımlar',
    costPrototype: 'Prototip',
    costFailures: 'Başarısız baskılar',
    costAds: 'Reklam',
    costModeling: 'Modelleme',
    costPreparation: 'Hazırlık',
    costPostProcessing: 'Son işlem',
    costStuff: 'Malzemeler',
    groupMachine: 'Makine',
    groupProvisions: 'Karşılıklar',
    groupOther: 'Diğer',
    groupLabor: 'İşçilik',
    splitPrinter: 'Yazıcı',
    splitAdsConsumables: 'Reklam ve sarf malzemeleri',
    discountTitle: 'İndirim hesabı',
    discountMachine: 'İndirimli makine maliyeti',
    discountSafety: 'İndirimli güvenlikli maliyet',
    discountPrice: 'İndirimli fiyat',
    discountAmount: 'İndirim tutarı',
    potentialProfit: 'Olası kâr',
    bulkQuantity: 'Adet',
    emptyTitle: 'Hesaplayıcıyı kurun',
    emptyMessage: 'Fiyat hesaplamaya başlamak için en az bir filament ve bir yazıcı ekleyin.',
    ...
    name: 'Ad',
    costPerKg: 'Kg başına maliyet ({{currency}})',
    printingCostPerKg: 'Kg başına baskı maliyeti ({{currency}})',
    marginOverCost: 'Maliyet üzerine marj (%)',
    zohoProductSearch: 'Zoho ürünü',
    zohoProductSearchPlaceholder: 'Zoho\'da filament ara…',
    zohoNoDealerPrice: 'Bayi fiyatı yok',
    zohoNoResults: 'Eşleşen Zoho filamenti yok',
    zohoSearchError: 'Zoho\'ya ulaşılamadı',
    zohoLinkedProduct: '{{name}} ile bağlantılı',
    zohoUnlink: 'Bağlantıyı Kaldır',
    zohoWeightInferred: 'Makara ağırlığı Zoho adında belirtilmemiş; 1 kg varsayıldı',
    spoolWeightKg: 'Makara ağırlığı (kg)',
    ...
    addFilament: 'Filament ekle',
    editFilament: 'Filamenti düzenle',
    deleteFilamentTitle: 'Filamenti sil',
    deleteFilamentMessage: '"{{name}}" silinsin mi? Bu işlem geri alınamaz.',
    filamentCreated: 'Filament eklendi',
    filamentUpdated: 'Filament güncellendi',
    filamentDeleted: 'Filament silindi',
    purchasePrice: 'Satın alma fiyatı ({{currency}})',
    lifetimeYears: 'Ömür (yıl)',
    dailyUsage: 'Günlük kullanım (sa)',
    powerWatts: 'Güç (W)',
    repairRate: 'Ömür boyu onarım (%)',
    lifetimeHours: 'Ömür (saat)',
    depreciationPerHour: 'Amortisman / sa',
    repairsPerHour: 'Onarım / sa',
    addPrinter: 'Yazıcı ekle',
    editPrinter: 'Yazıcıyı düzenle',
    deletePrinterTitle: 'Yazıcıyı sil',
    deletePrinterMessage: '"{{name}}" silinsin mi? Bu işlem geri alınamaz.',
    printerCreated: 'Yazıcı eklendi',
    printerUpdated: 'Yazıcı güncellendi',
    printerDeleted: 'Yazıcı silindi',
    inUse: 'Hesaplayıcı sayfasında seçili',
    electricityTariff: 'Elektrik tarifesi ({{currency}}/kWh)',
    laborRate: 'Saatlik ücret ({{currency}}/sa)',
    consumablesFlat: 'Sarf malzemeleri ve ambalaj ({{currency}})',
    baseFee: 'Temel ücret ({{currency}})',
    marginCurveHint: 'İki eğri genel marjı belirler: parça maliyeti arttıkça küçülen bir boyut marjı ve miktar arttıkça marjı (asla maliyeti değil) azaltan bir miktar indirimi.',
    sizeMarginGroup: 'Boyut marjı',
    qtyDiscountGroup: 'Miktar indirimi',
    floorGroup: 'Asgari',
    marginMinMult: 'Çok büyük parçalarda çarpan (M_MIN)',
    marginMaxMult: 'Çok küçük parçalarda çarpan (M_MAX)',
    marginK: 'Orta nokta birim maliyeti (K, {{currency}})',
    qtyMinFactor: 'Yüksek miktarda korunan marj (Q_MIN)',
    qtyK: 'Orta nokta miktarı (KQ)',
    minTaskPrice: 'Görev başına asgari fiyat ({{currency}})',
    marginCurveMaxBelowMin: 'M_MAX en az M_MIN olmalıdır',
    marginCurvePreviewSize: 'Birim maliyete göre boyut marjı',
    marginCurvePreviewQty: 'Miktara göre miktar faktörü',
    exampleTitle: 'Örnek iş',
    ...
    formulaAt: '{{x}} noktasında → {{y}}',
    warnFlatSize: 'Boyut eğrisi düz: her parça ×{{m}} alır.',
    warnKFar: 'K, örnek maliyetinizin çok üzerinde; eğri, işlerinizin bulunduğu yerde neredeyse hiç kıvrılmıyor.',
    ...
    multiplier: '×{{value}}',
    multiplierDetail: 'boyut ×{{size}} · miktar {{qty}}',
    floorApplied: 'Asgari fiyat uygulandı',
    curveTitle: 'Miktara göre fiyat',
    curveHint: 'Her miktardaki birim fiyat (vergi dahil) — tek seferlik maliyetler yayılır ve miktar indirimi marjı azaltır.',
    curveUnitPrice: 'Birim fiyat',
    curveTaskPrice: 'Görev toplamı',
    curveQtyFactor: 'Miktar faktörü',
    curveCurrent: 'güncel',
    failureRate: 'Hata oranı (%)',
    prototypeRate: 'Prototip oranı (%)',
    adsRate: 'Reklam oranı (%)',
    filamentMarkup: 'Filament kâr payı (%)',
    taxPct: 'Vergi TGC (%)',
    defaultDifficulty: 'Varsayılan zorluk (%)',
    defaultMargin: 'Varsayılan maliyet marjı (%)',
    filamentSettings: 'Filament ayarları',
    filamentSettingsHint: 'Yeni filament profilleri için başlangıç değerleri.',
    stuffMarkup: 'Malzeme kâr payı (%)',
    ratesTitle: 'Ücretler',
    ratesHint: 'Bir işin size maliyeti — teklif vermeden önce bu değerleri yerel fiyatlarınıza ve para biriminize göre ayarlayın.',
    provisionsTitle: 'Karşılıklar ve genel giderler',
    provisionsHint: 'Başarısız baskıları, prototipleri, reklamı ve filament ile ek kalemlerdeki yeniden satış payını karşılamak için maliyete eklenen yüzdeler.',
    unsavedChanges_one: '{{count}} kaydedilmemiş değişiklik',
    unsavedChanges_other: '{{count}} kaydedilmemiş değişiklik',
    fixFields: 'Kaydetmek için vurgulanan alanları düzeltin.',
