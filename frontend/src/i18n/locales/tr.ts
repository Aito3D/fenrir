export default {
  ...
  aito: {
    ...
    stats: {
      caption: '{{active}} üretimde · toplam {{done}} tamamlandı',
      added: 'Eklenen',
      accepted: 'Kabul edilen',
      completed: 'Tamamlanan',
      perDay: 'Günlük eklenen',
      ...
      lost: 'Kaybedilen: {{count}} · {{total}}',
      quoteAge: 'Yanıt bekleyen teklifler',
      ageDays: '{{range}} gün',
      ...
      decisionsHeading: 'Kabul ve ret edilen teklifler',
      declined: 'Reddedilen',
      ...
      brief: {
        ...
        dueNone: 'Bu hafta teslimat yok.',
        finished_one: 'Bu dönemde {{count}} proje tamamlandı.',
        finished_other: 'Bu dönemde {{count}} proje tamamlandı.',
        more: 'Önceki dönemden {{count}} fazla.',
        fewer: 'Önceki dönemden {{count}} az.',
        lead: 'Tekliften teslimata: {{days}}.',
        chaseHeading: 'Takip et',
        tellHeading: 'Haber ver',
        collectHeading: 'Tahsil et',
        chaseEmpty: 'Her teklifin bir yanıtı var.',
        tellEmpty: 'Her müşteriye haber verildi.',
        collectEmpty: 'Her fatura ödendi.',
        ready: 'Teslime hazır',
        late: '{{days}} g gecikmiş',
        andMore: 've {{count}} tane daha',
      },
      teaser: {
        sales: '%{{pct}} kabul · {{lost}} kayıp, {{total}}',
        time: 'tekliften teslimata {{lead}} · {{moves}} geri adım',
        money: '{{accepted}} kabul · {{outstanding}} bekleyen · gelirin %{{pct}}\'i {{service}}',
        moneyPlain: '{{accepted}} kabul · {{outstanding}} bekleyen',
        clients: '{{new}} yeni · {{returning}} tekrar gelen',
      },
    },
