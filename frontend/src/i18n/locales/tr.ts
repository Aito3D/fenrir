export default {
  ...
  aito: {
    ...
    lockQuote: 'Teklifin kabul edilmesi bekleniyor.',
    lockWaiting: 'Müşteride.',
  ...
  calculator: {
    ...
    printingTimeMin: 'Baskı süresi (dk)',
    ...
    pricingHint: 'Bir teklifi oluşturan her şey. Değişiklikler kaydettiğiniz anda yeni tekliflere uygulanır.',
    ratesTitle: 'Ücretler',
