export default {
  ...
  aito: {
    ...
    firstName: 'Ad',
    lastName: 'Soyad',
    displayNamePreview: 'Kaydedilecek ad: {{name}}',
    ...
    payment: {
      ...
      linkNone: '{{number}} · henüz bağlantı yok',
      linkOpenState: '{{number}} · açık, {{expires}}',
