export default {
  ...
  aito: {
    ...
    track: {
      ...
      paymentMethods: {
        referenceKnown: 'Ödemenizin açıklamasına {{ref}} teklif numarasını yazın.',
        referenceUnknown: 'Ödemenizin açıklamasına teklif numaranızı yazın.',
        transfer: 'Banka havalesi',
        beneficiary: 'Alıcı',
        bank: 'Banka',
        transferDelay: 'Bir havalenin bize ulaşması bir iki gün sürebilir.',
        appTransfer: '{{app}} havalesi',
        tag: 'Alıcı (etiket)',
        shop: 'Mağazada',
        shopSub: 'Banka kartı veya nakit.',
        copy: 'Kopyala',
        copied: 'Kopyalandı',
        copyIban: "IBAN'ı kopyala",
        copyTag: '{{app}} etiketini kopyala',
        question: 'Sorularınız için mesajımızı yanıtlayın.',
      },
      stages: {
        devis: 'Teklif',
        waiting: 'Onay',
