export default {
  ...
  aito: {
    ...
    stats: {
      caption: '{{active}} en production · {{done}} terminés au total',
      added: 'Ajoutés',
      accepted: 'Acceptés',
      completed: 'Terminés',
      perDay: 'Ajoutés par jour',
      perWeek: '≈ {{count}} par semaine',
      ...
      asOfToday: 'À ce jour',
      lost: 'Perdus : {{count}} · {{total}}',
      quoteAge: 'Devis en attente de réponse',
      ageDays: '{{range}} jours',
      ...
      decisionsHeading: 'Devis acceptés et refusés',
      declined: 'Refusés',
      ...
      brief: {
        ...
        dueNone: 'Rien n\'est prévu cette semaine.',
        finished_one: '{{count}} projet terminé sur la période.',
        finished_other: '{{count}} projets terminés sur la période.',
        more: '{{count}} de plus que la période précédente.',
        fewer: '{{count}} de moins que la période précédente.',
        lead: 'Du devis à la livraison : {{days}}.',
        chaseHeading: 'Relancer',
        tellHeading: 'Prévenir',
        collectHeading: 'Encaisser',
        chaseEmpty: 'Tous les devis ont une réponse.',
        tellEmpty: 'Tous les clients sont prévenus.',
        collectEmpty: 'Toutes les factures sont réglées.',
        ready: 'Prêt à retirer',
        late: '{{days}} j de retard',
        andMore: 'et {{count}} de plus',
      },
      teaser: {
        sales: '{{pct}} % acceptés · {{lost}} perdus pour {{total}}',
        time: '{{lead}} du devis à la livraison · {{moves}} retours en arrière',
        money: '{{accepted}} acceptés · {{outstanding}} en attente · {{service}} fait {{pct}} % du chiffre',
        moneyPlain: '{{accepted}} acceptés · {{outstanding}} en attente',
        clients: '{{new}} nouveaux · {{returning}} fidèles',
      },
    },
