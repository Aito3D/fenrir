export default {
  ...
  calculator: {
    ...
    printingTimeMin: "Temps d'impression (min)",
    ...
    tabMarginCurve: 'Courbe de marge',
    ...
    saveDefaults: 'Enregistrer',
    tabPricing: 'Tarification',
    pricingHint: 'Tout ce qui compose un devis. Les modifications s’appliquent aux nouveaux devis dès l’enregistrement.',
    ratesTitle: 'Tarifs',
