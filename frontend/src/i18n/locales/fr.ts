export default {
  ...
  calculator: {
    ...
    rush: 'Majoration express',
    rushPct: 'Majoration express (%)',
    rushToggle: 'Commande express',
    rushGroup: 'Express',
    rushHint: 'Ajoutée au prix HT après le minimum, uniquement quand la commande est marquée express.',
