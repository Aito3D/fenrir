export default {
  ...
  aito: {
    ...
    track: {
      ...
      paymentMethods: {
        referenceKnown: 'Indiquez le numéro de devis {{ref}} en référence de votre règlement.',
        referenceUnknown: 'Indiquez le numéro de votre devis en référence de votre règlement.',
        transfer: 'Virement bancaire',
        beneficiary: 'Bénéficiaire',
        bank: 'Banque',
        transferDelay: 'Un virement peut mettre un jour ou deux à nous parvenir.',
        appTransfer: 'Virement {{app}}',
        tag: 'Bénéficiaire (tag)',
        shop: 'Au magasin',
        shopSub: 'Carte bancaire ou espèces.',
        copy: 'Copier',
        copied: 'Copié',
        copyIban: "Copier l'IBAN",
        copyTag: 'Copier le tag {{app}}',
        question: 'Répondez à notre message pour toute question.',
      },
      stages: {
        devis: 'Devis',
        waiting: 'Accord',
