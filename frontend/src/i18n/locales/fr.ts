export default {
  ...
  calculator: {
    ...
    modelPreparation: 'Préparation du modèle (min)',
    slicing: 'Découpe (min)',
    transferStart: 'Transfert et lancement (min)',
    postProcessing: 'Post-traitement',
    jobRemoval: 'Retrait de la pièce (min)',
    supportRemoval: 'Retrait des supports (min)',
    additionalWork: 'Travaux supplémentaires (min)',
    fulfillment: 'Expédition (min)',
