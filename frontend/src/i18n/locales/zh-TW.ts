export default {
  ...
  aito: {
    ...
    descriptionPlaceholder: '描述要設計與列印的產品…',
    create: '建立專案',
    created: '建立於 {{date}}',
    updated: '更新於 {{date}}',
    emptyTitle: '尚無專案',
    ...
    sendInvoice: '寄送發票',
    sendInvoiceTitle: '以電子郵件寄送發票',
    sendInvoiceRecipient: '收件者',
    sendInvoiceSubject: '主旨',
    sendInvoiceMessage: '郵件預覽',
    ...
    createInvoiceIntro_one: '報價單 {{quote}}，{{count}} 行。將在 Zoho Books 中建立發票草稿 — 不會寄送郵件。',
    createInvoiceIntro_other: '報價單 {{quote}}，{{count}} 行。將在 Zoho Books 中建立發票草稿 — 不會寄送郵件。',
    createInvoiceAmount: '發票金額',
    createInvoiceRemaining: '尚需支付',
    createInvoiceLockWarning: '開立發票後，此報價單將不再接受來自 Fenrir 的行項目修改。',
    createInvoiceConfirm: '建立',
    createInvoiceLoadFailed: '無法準備發票',
    createInvoiceDone: '發票 {{number}} 已建立',
    createInvoiceDonePaid: '發票 {{number}} 已建立並以預付款結清',
    createInvoiceDonePartial: '發票 {{number}} 已建立 — {{retainers}} 無法沖抵',
    createInvoiceFailed: '無法建立發票',
    acceptQuote: '接受報價單',
    declineQuote: '拒絕報價單',
    holdToConfirm: '長按 0.5 秒確認',
    quoteSent: '報價單已標記為已傳送',
    quoteAccepted: '報價單已接受',
    quoteDeclined: '報價單已拒絕',
    quoteUnaccepted: '已撤銷接受 — 報價單已回到等待中',
    unacceptLabel: '撤銷接受',
    unacceptHint: '長按1秒撤銷接受',
    quoteConflictAccepted: '此報價已被其他人接受。',
    quoteConflictDeclined: '此報價已被其他人拒絕。',
    zohoNotUpdated: '已在本機儲存 — Zoho 尚未更新',
    progressLabel: '已完成 {{total}} 個步驟中的 {{done}} 個',
    trash: '垃圾桶',
    trashEmpty: '垃圾桶是空的',
    restore: '還原',
    restored: '專案已還原',
    restoreFailed: '無法還原專案。',
    deletedOn: '刪除於 {{date}}',
    moveFailed: '無法移動專案，請再試一次。',
    createFailed: '無法建立專案，請再試一次。',
    deleteFailed: '無法刪除此專案',
    client: '客戶',
    noClient: '無客戶',
    urgent: '緊急',
    markUrgent: '標記為緊急',
    clearUrgent: '取消緊急',
    holdToMarkUrgent: '長按 0.5 秒標記為緊急',
    holdToClearUrgent: '長按 0.5 秒取消緊急',
    sav: '返修',
    markSav: '標記為返修',
    clearSav: '取消返修',
    holdToMarkSav: '長按 0.5 秒標記為返修',
    holdToClearSav: '長按 0.5 秒取消返修',
    pause: '已暫停',
    markPause: '標記為暫停',
    clearPause: '取消暫停',
    holdToMarkPause: '長按 0.5 秒標記為暫停',
    holdToClearPause: '長按 0.5 秒取消暫停',
    markFlag: '標記',
    flagFailed: '無法變更標記',
    dueDate: '承諾日期',
    dueDateClear: '清除日期',
    dueDateEmpty: '設定日期',
    dueLateDays: '逾期 {{count}} 天',
    dueBadge: '截止 {{date}}',
    dueDateFailed: '無法變更日期',
    datePickerPrev: '上個月',
    datePickerNext: '下個月',
    datePickerBackToSelected: '回到所選月份',
    datePickerPlusTwoDays: '+2天',
    datePickerPlusOneWeek: '+1週',
    datePickerPlusTwoWeeks: '+2週',
    datePickerSuggested: '建議',
    awaitingContact: '待通知',
    markContacted: '標記客戶已通知',
    holdToMarkContacted: '長按 0.5 秒確認已通知客戶',
    contacted: '已通知',
    clearContacted: '撤銷已通知',
    holdToClearContacted: '長按 0.5 秒撤銷已通知',
    contactedFailed: '無法記錄通知',
    smsPickupShort: 'SMS',
    smsPickup: '傳送取件簡訊',
    smsTitle: '取件簡訊',
    smsMessageLabel: '訊息',
    smsGenerating: '正在草擬訊息…',
    smsGenerateFailed: '無法草擬訊息',
    smsRegenerate: '重新產生',
    smsSend: '傳送到手機',
    ...
    searching: '搜尋中…',
    noResults: '找不到符合的客戶',
    zohoNotConfigured: '尚未連接 Zoho Books。',
    zohoConfigureLink: '連接 Zoho Books',
    zohoUnreachable: '無法連接 Zoho Books，請再試一次。',
    resetToDefaultClient: '重設為預設客戶',
    clientPhone: '電話',
    clientEmail: '信箱',
    countryCode: '國碼',
    ...
    socialLabel: '社群網路（選填）',
    socialHandleLabel: '使用者名稱',
    socialHandlePlaceholder: 'username',
    socialRemove: '移除社群網路',
    contactsLabel: '聯絡人',
    contactsHint: '這個專案是給誰的？',
    contactsLoading: '正在從 Zoho Books 讀取聯絡人…',
    contactsUnavailable: '無法從 Zoho Books 讀取聯絡人 — 請在下方輸入電話或電子郵件。',
    contactPrimary: '主要',
    contactAdd: '新增聯絡人',
    contactAddTitle: '新聯絡人',
    contactSaveToZoho: '儲存到 Zoho',
    contactFirstNameRequired: '請輸入名字。',
    contactNeedsPhoneOrEmail: '需要電話或電子郵件才能聯絡對方。',
    contactAddFailed: '無法新增聯絡人，請再試一次。',
    contactOverrideToggle: '為此卡片使用其他電話 / 電子郵件',
    contactOverrideHint: '僅適用於此卡片 — Zoho Books 中的聯絡人不會變更。',
    contactGone: '此聯絡人在 Zoho Books 中已不存在 — 請選擇另一位。',
    clientEditFanOutPerson: '適用於此聯絡人的所有未完成卡片',
    clientEditTitle: '聯絡方式',
    clientEditSourceZoho: 'Zoho Books',
    clientEditSourceCard: '僅此卡片',
    clientEditFanOut: '套用至此客戶的所有未完成卡片',
    ...
    clientHistoryNoQuote: '無報價',
    clientHistoryThisCard: '此卡片 · {{stage}}',
    clientHistoryDeclined: '已拒絕',
    clientHistoryOpenCard: '開啟專案 #{{id}}',
    clientHistoryEmpty: '此客戶尚無專案。',
    clientHistoryError: '無法載入客戶歷史。',
    clientEditLoading: '正在從 Zoho Books 讀取聯絡人…',
    clientEditWalkIn: '散客：變更僅保留在此卡片上，不會傳送至 Zoho Books。',
    clientEditZohoReadFailed: '無法從 Zoho Books 讀取聯絡人 — 顯示卡片上的值。',
    clientEditFailed: '無法更新客戶。請再試一次。',
    createClient: '建立新客戶',
    companyName: '公司名稱',
    firstName: '名字',
    lastName: '姓氏',
    createClientSubmit: '建立客戶',
    back: '返回',
    clientNameRequired: '請輸入公司名稱，或名字和姓氏。',
    newClientPersonHint: '或填寫聯絡人的名字和姓氏',
    newClientContactTag: '公司聯絡人',
    newClientContactHint: '建議填寫 — 只填名字即可',
    newClientPreviewCompany: '公司：{{name}} · 聯絡人：{{person}}',
    newClientPreviewCompanyAlone: '公司：{{name}} · 尚無聯絡人',
    newClientPreviewIndividual: '個人：{{name}}',
    clientCreateFailed: '無法建立客戶，請再試一次。',
    clientSyncFailed: '專案已建立 — 客戶資訊未能在 Zoho 中更新。',
    ...
    recordLabel: '紀錄',
    duplicateProject: "複製",
    duplicateReplaceTitle: "取代編輯中的草稿？",
    duplicateReplaceBody: "新增專案面板中已有尚未建立的內容。複製此卡片會將其取代。",
    duplicateReplaceConfirm: "取代",
    stageAndWorkLeft: '階段與剩餘工作',
    panelTabDetails: '詳細',
    billingLabel: '帳單',
    depositAvailable: '可用訂金',
    descriptionShowMore: '展開',
    descriptionShowLess: '收合',
    panelTabAttention: '需要注意',
    workLabel: '工作',
    moveToTrash: '移至垃圾桶',
    stepsCount: '{{done}}/{{total}} 個步驟',
    amountDone: '已完成 {{amount}}',
    viewingNow: '{{name}} 正在檢視此專案',
    paidOnline: '已線上付款',
    ...
    editConflict: '其他人已編輯此專案 — 看板已重新整理，請重試。',
    tasks: '任務',
    addTask: '新增任務',
    taskFallbackName: '任務 {{n}}',
    track: {
      pageTitle: '訂單追蹤 · Aito 3D',
      title: '追蹤您的訂單',
      reference: '報價單號 {{ref}}',
      ...
      stepsList: '步驟詳情',
      tasksHeading: '您的零件',
      showAllParts: '查看全部 {{n}} 個零件',
      eta: '預計可取時間',
      etaSoon: '我們會盡快告知您日期。',
      etaUpdating: '預計時間更新中',
      updated: '更新於{{when}}',
      updatedToday: '今天 {{time}}',
      updatedYesterday: '昨天 {{time}}',
      updatedOn: '{{date}} {{time}}',
      error: '目前無法載入追蹤資訊。',
      retry: '重試',
      invalidTitle: '此追蹤連結已失效',
      invalidBody: '連結可能已過期或被取代。請聯絡我們，我們將傳送新連結。',
      footerQuestion: '對訂單有疑問？',
      enterTitle: '追蹤我的訂單',
      enterHint: '請輸入報價單或訊息中的 6 位代碼。',
      codeLabel: '追蹤代碼',
      codeChecking: '驗證中…',
      retrying: '正在重試…',
      codeFound: '代碼已辨識，正在開啟追蹤頁面。',
      codeNotFound: '找不到該代碼，請檢查後重試。',
      codeTooMany: '嘗試次數過多，請稍候一分鐘。',
      codeError: '目前無法驗證代碼，請按 Enter 鍵重試。',
      invalidEnterCode: '輸入追蹤代碼',
      language: '語言',
      ...
      paymentMethods: {
        ...
        beneficiary: '收款人',
        bank: '銀行',
        transferReference: '轉帳備註',
        referenceUnknown: '您的報價單號',
        transferDelay: '轉帳可能需要一兩天才能入帳。',
        appTag: '{{app}} 標籤',
        appMessage: '留言',
        appHint: '在 {{app}} 應用程式中，將報價金額傳送到此標籤。',
        shop: '到店',
        shopSub: '銀行卡、現金或支票。',
        shopAddress: '地址',
        shopHint: '取貨時在工作室付款。',
        copied: '已複製',
        copyFailed: '複製失敗——請選取文字',
        copyIban: '複製 IBAN',
        copyBeneficiary: '複製收款人',
        copyBic: '複製 BIC',
        copyReference: '複製備註',
        copyRib: '複製 RIB',
        copyTag: '複製 {{app}} 標籤',
      ...
      invoice: {
        ...
        paidSub: '感謝您的信任。',
        unpaidTitle: '發票待付款',
        unpaidSub: '請在取貨或出貨前付款。',
        overdueTitle: '發票已逾期',
        overdueSub: '如已付款，請聯絡我們。',
      },
      payment: {
        unpaidTitle: '專案尚未付款',
        unpaidSub: '可線上付款，也可透過轉帳或到店付款。',
        unpaidDepositSub: '支付訂金即可確認訂單——可線上付款，也可透過轉帳或到店付款。',
        validateTitle: '請接受您的報價',
        validateSub: '線上付款即視為接受報價。',
        validateDepositSub: '支付訂金即接受報價並開始製作。',
        pay: '線上付款',
        paidTitle: '已收到付款',
        depositPaidTitle: '已收到訂金',
        paidSub: '感謝您的信任。',
      },
    },
    trackingCopy: '複製追蹤連結',
    ...
    paymentLink: {
      ...
      open: '開啟付款連結',
      copied: '已複製',
      expiresIn_one: '{{count}} 天後到期',
      expiresIn_other: '{{count}} 天後到期',
      expiresToday: '今天到期',
      retry: '重試',
      state: { expired: '已過期', cancelled: '已取消', failed: '已拒絕' },
    },
    payment: {
      dueQuote: '訂金待付',
      dueInvoice: '未付餘額',
      ...
      cellManual: '手動',
      cellLinkTitle: '付款連結',
      cellTerminalTitle: '在刷卡機上刷卡付款',
      cellManualTitle: '手動：記錄付款',
      terminalOff: 'Heimdall 尚未設定',
      stateProcessing: '刷卡機 · 等待刷卡',
      stateAttention: '結果不明 · 請檢查刷卡機',
      statePaid: '已付 {{amount}} · {{channel}} · {{date}}',
      statePaidNoDate: '已付 {{amount}} · {{channel}}',
      stateBookingFailed: '尚未記錄到 Zoho Books — 請查看 Heimdall',
      stateNoLink: '無連結',
      channelTerminal: '刷卡機',
      channelLink: '線上',
      amountLabel: '金額',
      manualTitle: '記錄付款',
      manualIntroQuote: '報價單 {{number}} · 於櫃檯收取訂金',
      manualIntroInvoice: '發票 {{number}} · 於櫃檯收取付款',
      modeLabel: '方式',
      modeCard: '刷卡',
      modeCheque: '支票',
      modeCash: '現金',
      referenceLabel: '參考編號',
      referenceRequired: '支票需要填寫票號',
      manualHintQuote: '會在 Zoho Books 的報價單上建立一張訂金發票，並記錄這筆付款。',
      manualHintInvoice: '會在 Zoho Books 的發票上記錄這筆付款。',
      manualConfirm: '記錄',
      manualDone: '付款已記錄',
      amountInvalid: '請輸入大於零的整數金額',
      terminalTitle: '刷卡付款',
      terminalIntro: '{{number}} · 於櫃檯刷卡機上',
      terminalHintQuote: '已預填訂金金額；報價單可接受任意金額。',
      terminalHintInvoice: '已預填餘額；Heimdall 會以餘額為上限。',
      terminalStart: '啟動刷卡機',
      terminalWaiting: '正在刷卡機上等待刷卡…',
      terminalWaitingHint: '輸入密碼最長需要 3 分鐘。',
      terminalLeave: '關閉，稍後再回來',
      terminalPaid: '付款已受理',
      terminalBookingPending: '正在記錄到 Zoho Books…',
      terminalBookingDone: '已記錄到 Zoho Books',
      terminalBookingFailed: '尚未記錄到 Zoho Books — 請查看 Heimdall',
      terminalFailed: '已拒絕',
      terminalFailedHint: '尚未產生任何扣款，您可以重試。',
      terminalRetry: '重試',
      terminalAttention: '結果不明',
      terminalAttentionHint: '刷卡機沒有回應。請先檢查紙本收據，再重試。',
      linkTitle: '付款連結',
      linkCreate: '建立連結',
      linkCreateAgain: '建立新連結',
      linkCancel: '取消連結',
      linkCancelConfirm: '確定要取消這個連結嗎？',
      linkExpires: '到期',
      linkHintInvoice: '已預填餘額。連結將於報價單有效期結束後失效。',
      linkPending: '正在建立連結…',
      linkDone: '付款連結已建立',
      linkCancelled: '付款連結已取消',
    },
    pastCards_one: '{{count}} 張歷史卡片',
    pastCards_other: '{{count}} 張歷史卡片',
    reuseTasks: '重複使用',
    rating: {
      good: '良好',
      medium: '普通',
      bad: '較差',
      new: '新客戶',
      ariaLabel: '客戶評級：{{tier}}。{{reason}}',
      overdue_one: '{{count}} 張發票逾期 · 最長 {{days}} 天，{{number}}',
      overdue_other: '{{count}} 張發票逾期 · 最長 {{days}} 天，{{number}}',
      overdueNoNumber_one: '{{count}} 張發票逾期 · 最長 {{days}} 天',
      overdueNoNumber_other: '{{count}} 張發票逾期 · 最長 {{days}} 天',
      chronic: '經常延遲付款 · {{settled}} 張中 {{onTime}} 張準時付款',
      punctual: '{{settled}} 張發票中 {{onTime}} 張準時付款',
      mixed: '{{settled}} 張中 {{onTime}} 張準時付款',
      pastDue_one: '{{count}} 張已到期',
      pastDue_other: '{{count}} 張已到期',
      newTip: '尚無已結清的發票',
      checked: '{{ago}} 檢查',
      stale: 'Books 無法連線 — 最近一次已知評級',
      companyTerms: '按企業評級',
    },
    tasksReused_one: '已新增 {{count}} 個任務',
    tasksReused_other: '已新增 {{count}} 個任務',
    taskTitlePlaceholder: '標題（可選）',
    taskDescriptionPlaceholder: '描述（可選）',
    removeTask: '移除任務',
    serviceScan3D: '掃描',
    serviceModelisation3D: '建模',
    serviceImpression3D: '列印',
    serviceUsinage: '加工',
    serviceMainDoeuvre: '人工',
    serviceDescriptionRequired: '說明（必填）',
    maindoeuvreDescriptionRequired: '人工需要填寫說明',
    serviceCost: '成本',
    serviceUnitCost: '單價',
    discount: '折扣',
    serviceTotal: '行合計',
    ...
    quoteNoServiceLines: '此報價沒有 AITO 3D 服務項目。',
    quoteAlreadyImported: '已匯入為專案 #{{id}}',
    quoteImport: '匯入',
    quoteSkipped: '未匯入',
    quoteTotals: '專案 {{project}} · 報價 {{quote}}',
    quoteCurrencyMismatch: '此報價使用 {{code}}，看板顯示 {{configured}}。',
    quoteOpenInZoho: '在 Zoho Books 中開啟',
    changeQuote: '變更',
    quoteRowImported: '已匯入 → #{{id}}',
    beforeImport: '匯入前檢查',
    ruleQuoteLines: '報價包含 AITO 服務項目',
    ruleQuoteFresh: '先前未匯入過',
    ruleCurrencyOk: '幣別與看板一致',
    ruleImportDescription: '已填寫描述',
    importTaskCount_one: '{{count}} 個任務',
    importTaskCount_other: '{{count}} 個任務',
    printer: '印表機',
    material: '材料',
    weightG: '重量 (g)',
    printTime: '列印時間',
    ...
    retrySync: '重試',
    syncBlockedLabel: '同步已封鎖',
    forceSync: '強制同步',
    forceSyncHint: '重新讀取 Zoho 中的報價單並再次推送費用',
    showDone: '檢視已完成',
    backToBoard: '返回看板',
    statistics: '統計',
    stats: {
      ...
      leadTime: '從報價到交付',
      median: '中位數 {{days}} 天',
      productionTime: '從接受到交付',
      daysShort: '{{days}} 天',
      activity: '每日活動',
      rolling7: '完成數 7 日平均',
      flow: '各階段耗時（天）',
      sent: '已傳送',
      ofAccepted: '佔已接受的 {{pct}}%',
      quoted: '已接受的報價',
      invoiced: '已開立發票',
      outstanding: '待收款',
      empty: '此期間沒有任何動態',
      ...
      ageDays: '{{range}} 天',
      winRate: '依金額區間的成交率',
      winRateEmpty: '已決定的報價還不夠',
      decisions: '{{count}} 個已決定',
      stageTime: '每個已完成專案的耗時',
      reworkMoves: '回退移動',
      reworkShare: '{{cards}} 張卡片 · 佔移動卡片的 {{pct}}%',
      overdue: '逾期發票',
      overdueOldest: '最久 {{days}} 天',
      nothingOverdue: '沒有逾期',
      serviceMix: '服務構成',
      serviceTasks: '{{count}} 個任務',
      clientsNew: '新客戶',
      clientsReturning: '回頭客',
      returningShare: '{{pct}}% 的收入來自回頭客',
      arrivals: '需求到達的時段',
      islands: '依島嶼出貨',
      pickup: '到店自取',
      declined: '已拒絕',
      acceptanceRate: '{{pct}}% 接受',
      ...
      strip: {
        onBoard: '看板上 {{amount}}',
        longest: '等待最久的是 <who>{{name}}，{{days}}</who>，在{{stage}}階段',
        oldest: '最久 {{days}} 天',
        noQuote: '尚無報價',
        dueSoon_one: '本週有 {{count}} 件交付',
        dueSoon_other: '本週有 {{count}} 件交付',
      },
      facts: {
        perDay: '每天 {{count}} 個',
        waiting15: '等待 15 天以上',
        lostWith: '因報價被拒而流失',
        shippingBilled: '已開立發票的運費',
        parcels_one: '{{count}} 個包裹',
        parcels_other: '{{count}} 個包裹',
        invoices_one: '{{count}} 張發票',
        invoices_other: '{{count}} 張發票',
        cards_one: '{{count}} 張卡片',
        cards_other: '{{count}} 張卡片',
        today: '今天',
      },
      finding: {
        overview: '{{in}}，{{accepted}}，{{done}}。',
        overviewIn_one: '新進 {{count}} 個專案',
        overviewIn_other: '新進 {{count}} 個專案',
        overviewAccepted_one: '{{count}} 個被接受',
        overviewAccepted_other: '{{count}} 個被接受',
        overviewDone_one: '{{count}} 個已交付',
        overviewDone_other: '{{count}} 個已交付',
        overviewPeakWeek: '最忙的一週是 {{date}} 當週。',
        overviewPeakDay: '最忙的一天是 {{date}}。',
        salesWin: '你的報價成交率為 {{pct}} %。',
        salesLost_one: '流失 {{count}} 份報價，金額 {{total}}。',
        salesLost_other: '流失 {{count}} 份報價，合計 {{total}}。',
        salesLostBig: '流失的都是大單：{{min}} 以上的 {{decided}} 份中有 {{lost}} 份，合計 {{total}}。',
        salesNone: '此期間沒有已決定的報價。',
        timeLead: '一個專案從報價到交付需要 {{days}}。',
        timeSlow: '{{stage}} 是最慢的階段，耗時 {{days}}。',
        timeRework_one: '有 {{count}} 次回退移動。',
        timeRework_other: '{{cards}} 上有 {{count}} 次回退移動。',
        timeNone: '此期間沒有交付任何專案。',
        moneyTotals: '接受 {{accepted}}，已開立發票 {{invoiced}}。',
        moneyOut: '{{invoices}} 尚有 {{amount}} 未收。',
        moneyOverdue_one: '其中 {{count}} 張已逾期 {{days}} 天。',
        moneyOverdue_other: '其中 {{count}} 張已逾期，最久 {{days}} 天。',
        moneyClear: '沒有未收款項。',
        clients: '{{new}}，{{returning}}。',
        clientsNew_one: '{{count}} 位新客戶',
        clientsNew_other: '{{count}} 位新客戶',
        clientsReturning_one: '{{count}} 位回頭客',
        clientsReturning_other: '{{count}} 位回頭客',
        clientsPeak: '需求多在 {{day}} {{hour}} 左右到達。',
        clientsParcels_one: '{{count}} 個包裹寄往外島。',
        clientsParcels_other: '{{count}} 個包裹寄往外島。',
        clientsNone: '此期間沒有新客戶。',
      },
      brief: {
        chase_one: '{{count}} 份報價待追蹤',
        chase_other: '{{count}} 份報價待追蹤',
        tell_one: '{{count}} 位客戶待通知',
        tell_other: '{{count}} 位客戶待通知',
        collect: '{{amount}} 待收款',
        allClear: '今天沒有需要追蹤、通知或收款的事項。',
        due_one: '本週有 {{count}} 件交付。',
        due_other: '本週有 {{count}} 件交付。',
        chaseHeading: '追蹤',
        tellHeading: '通知',
        collectHeading: '收款',
        ready: '可以取貨',
    ...
    history: {
      ...
      projectUrgentSet: '標記為緊急',
      projectUrgentCleared: '已取消緊急',
      projectSavSet: '標記為返修',
      projectSavCleared: '已取消返修',
      projectPauseSet: '標記為暫停',
      ...
      paymentTerminalStarted: '已在刷卡機上開始刷卡付款',
      paymentTerminalPaid: '已在刷卡機上刷卡付款',
      paymentTerminalFailed: '刷卡機付款被拒絕或已取消',
      paymentTerminalAttention: '刷卡機結果不明 — 請檢查刷卡機',
      paymentManualRecorded: '付款已記錄',
      paymentManualPartial: '已建立訂金發票，但付款尚未記錄 — 請在 Zoho Books 中完成',
      noteAdded: '新增了備註',
      zohoComment: 'Zoho Books 中的留言',
      syncQueued: '已加入 Zoho 推送佇列',
      syncPushed: '已推送至 Zoho',
      syncFailed: '推送至 Zoho 失敗',
      syncLocked: '報價單已在 Zoho 中鎖定',
      syncConflict: '與 Zoho 的狀態衝突',
      syncStatusRejected: 'Zoho 拒絕了狀態變更',
      pollReconciled: '已與 Zoho 核對',
    },
    // New-project drawer
    workSection: '工作內容',
    clientSectionTitle: '客戶',
    workHintNone: '尚無任務',
    workHintProgress: '已完成 {{done}}/{{total}}',
    addService: '新增{{service}}',
    removeServiceChip: '移除{{service}}',
    taskNeedsSubTask: '新增子任務',
    railSummary: '摘要',
    summaryTitle: '專案摘要',
    summaryWaiting: '進入客戶步驟時自動產生。',
    summaryGeneratedBy: '由 {{model}} 產生 — 點擊編輯',
    summaryEdited: '已手動編輯 — 不再自動重新產生',
    summaryFallback: 'AI 無法使用 — 請自行填寫描述',
    aiFieldHint: 'AI 已校正拼字',
    aiChecking: '正在校對拼字…',
    aiUndo: '還原我的文字',
    regenerate: '重新產生',
    beforeCreate: '建立前檢查',
    ruleTasksOk_one: '{{count}} 個任務 — 至少需要一個',
    ruleTasksOk_other: '{{count}} 個任務 — 至少需要一個',
    ruleNeedTask: '專案至少需要一個任務 — 請新增',
    ruleSubTasksOk: '每個任務都有已定價的子任務',
    ruleSubTaskMissing: '「{{name}}」至少需要一個已定價的子任務',
    ruleSubTasksPending: '每個任務至少需要一個已定價的子任務',
    ruleClientAccount: '客戶帳戶 — {{name}}',
    ruleClientReachable: '客戶可聯繫 — {{contact}}',
    ruleClientContact: '客戶需要電話、電子郵件或社群網路',
    warnNoEmail: '沒有電子郵件 — 報價單無法以郵件寄送',
    warnNoPhone: '沒有電話 — 記得詢問',
    holdToReset: '長按以重設草稿',
    resetDraft: '重設草稿',
    shippingAdd: '新增運送',
    shippingTitle: '運送',
    shippingRemove: '移除運送',
    shippingEdit: '編輯運送',
    shippingIsland: '目的地島嶼',
    shippingIslandPlaceholder: '搜尋島嶼…',
    shippingNoIslands: '找不到島嶼',
    shippingFirstName: '收件人名字',
    shippingLastName: '收件人姓氏',
    shippingPhone: '收件人電話',
    shippingRecipient: '收件人',
    shippingService: '運送服務',
    shippingRate: '運費',
    shippingRateFromZoho: 'Zoho 運費：{{rate}}',
    shippingRateEdited: '已編輯',
    shippingRateReset: '恢復為 Zoho 運費',
    shippingNoRate: 'Zoho 未提供運費 — 請輸入',
    shippingRateNegative: '運費不能為負數',
    shippingLta: 'LTA 編號',
    shippingLtaPlaceholder: '航空貨運單號…',
    shippingUnavailable: '在無法連線 Zoho 期間，運送服務無法使用',
    ruleShippingPending: '運送資訊填寫中',
    ruleShippingOk: '運送至 {{island}} · {{recipient}}',
    ruleShippingMissingIsland: '運送：缺少島嶼',
    ruleShippingMissingRecipient: '運送：缺少收件人姓名',
    ruleShippingInvalidPhone: '運送：電話號碼無效',
  },
  // Navigation
  nav: {
    aito: 'Aito',
  ...
  printers: {
    ...
    maintenance: {
      ...
      editFieldLabel: '維護模式',
      editFieldHelp: '啟用後，此印表機將從 MQTT、佇列調度和通知中暫停 — 適用於維修、並行 Fenrir 安裝或暫時停用。',
    },
    // Chamber light
    ...
    nozzleFilament: '耗材',
    nozzleWear: '磨損',
    nozzleSlotEmpty: '槽位 {{slot}} — 空',
    humidityTooltip: '濕度：{{value}}% - {{status}}',
    temperatureTooltip: '溫度：{{value}}°C - {{status}}',
    clickForHistory: '點擊檢視歷史記錄',
    nozzleMaxTemp: '最高溫度',
    nozzleSerial: '序列號',
  ...
  archives: {
    ...
    no3mfBanner: {
      ...
      body: '切片機沒有在印表機的 SD 卡上留下 .gcode.3mf 檔案，因此 Fenrir 無法取得縮圖或切片機中繼資料。這通常是因為切片機 (Bambu Studio / OrcaSlicer 的裝置分頁) 中「將傳送的檔案儲存在外部儲存中」已關閉。',
      docsLink: '檢視安裝步驟 4',
      docsLinkInternalStorage: '為什麼會這樣',
      titleInternalStorage: '最近有些列印留在了印表機的內部儲存中',
      bodyInternalStorage: 'Bambu Studio 把切片檔案儲存到了印表機的內部儲存而不是記憶卡上，因此 Fenrir 透過 FTP 讀不到任何東西。在 H2 系列、P2S 與 X2D 上，「列印」按鈕總是這樣做，只有「傳送」才提供選擇，而它的預設值也是「快取」。這些列印仍會帶著名稱與時間歸檔，只是沒有縮圖與切片中繼資料。要取得完整歸檔，請從 Fenrir 啟動列印，或改用 OrcaSlicer 切片；若要繼續用 Bambu Studio，請用「傳送」並選擇「外部儲存」，之後再啟動列印。以上都需要印表機中插有記憶卡或 USB 隨身碟。',
      titleNoExternalStorage: '最近有些列印無法歸檔 — 印表機中沒有儲存媒體',
      bodyNoExternalStorage: '印表機的插槽中未偵測到記憶卡或隨身碟，切片檔案無處存放，Fenrir 也無從讀取。插入一個，下次列印就會完整歸檔。',
      titleInternalHistory: '最近有些列印是從印表機裡既有的檔案啟動的',
      bodyInternalHistory: '這些列印來自印表機自己的檔案庫 — 從它的螢幕重新列印、從 Handy 啟動，或是先前傳送、稍後才列印的檔案。Fenrir 透過 FTP 讀取列印檔案，而 FTP 只提供記憶卡或隨身碟，印表機卻把這個檔案庫放在 FTP 搆不到的區域，因此沒有 3MF 可讀。切片軟體的任何設定都改變不了這一點，因為這些列印根本沒有傳送過檔案。它們仍會帶著名稱與時間歸檔，並且可以在「編輯歸檔」中手動填入已用耗材。要獲得完整歸檔，請從 Fenrir 或你的切片軟體啟動列印。',
      titleFtpsCooloff: '最近有些列印無法歸檔 — 印表機拒絕了檔案連線',
      bodyFtpsCooloff: 'Fenrir 開啟了印表機的檔案傳輸連接埠 (FTPS 990)，而印表機回應的內容並不是 TLS，因此無法從它讀取任何東西。這些列印仍會帶著名稱和時間歸檔，只是沒有縮圖和切片中繼資料。這不是切片軟體的設定，也不是你改動了什麼 —— 相同型號、相同韌體在其他安裝上運作正常，受影響的印表機通常過一陣子會自行恢復。出現這種失敗後，Fenrir 會暫停對該印表機的傳輸五分鐘，暫停結束後再回來取檔案，所以短暫的一次會自行補齊；卡片仍然是空的，表示拒絕持續得比重試更久。觸發原因目前尚不清楚。如果反覆出現，請在系統頁面開啟除錯記錄，並把支援套件附在你的報告裡。',
      titleFtpTransferFailed: '部分近期列印未能封存 — 檔案傳輸逾時',
      bodyFtpTransferFailed: '切片檔就在印表機的記憶卡上，印表機也確實開始傳輸了，但傳輸未能在允許的時間內完成。列印開始時，印表機還要同時處理攝影機、狀態訊息與工作上傳，較大的 3MF 檔未必能在這種情況下傳完。這些列印仍保留名稱與時間，只是缺少縮圖與切片資料。這不是切片軟體的設定問題，也不是你更動造成的。Fenrir 會在接下來的十分鐘內再取三次檔案，因此多數情況會自行補齊；如果卡片仍是空的，代表那幾次嘗試同樣逾時了。若經常發生，請在 設定 > 網路 > FTP 重試 中調高 連線逾時。',
      dismissLabel: '關閉此通知',
    },
    ...
    card: {
      ...
      source: '原始檔',
      unverifiedFile: '未驗證',
      unverifiedFileTooltip: '此檔案僅依名稱比對，可能不是實際列印的檔案。',
      project: '專案：{{name}}',
      runsBadge: '{{count}} 次列印',
  ...
  queue: {
    ...
    batchOrders: {
      ...
      strandedPlate: '沒有可複製設定的記錄',
      strandedNotice: '仍欠的 {{owed}} 次列印中有 {{runs}} 次無法加入佇列：該板已沒有可複製設定的佇列中或已完成的列印。請從檔案中將該板加入佇列一次，或取消該訂單。',
    ...
    cancelBatchConfirmMessage: '結束此訂單？仍在佇列中的列印將被取消，訂單也不再要求尚未產出的部分。',
    batch: {
      defaultName: '批次',
      label: '{{count}} 項',
    ...
    toast: {
      ...
      cancelFailed: '取消項目失敗',
      removed: '佇列項目已移除',
      keptForOrder: '已取消而非移除：這是批次訂單可以重新排入該板的唯一一次列印',
      historyKeptForOrders: '保留了批次訂單仍需要的 {{kept}} 項。',
      removeFailed: '移除項目失敗',
      stopped: '列印已停止',
      stopFailed: '停止列印失敗',
      released: '列印已加入佇列',
  ...
  stats: {
    ...
    filamentUsed: '耗材用量',
    filamentCost: '耗材成本',
    filamentCostFromCalculator: '根據價格計算器的耗材價格計算',
    totalCost: '總成本',
    energyUsed: '能耗',
    energyCost: '能源成本',
    ...
    failuresByFilament: '按耗材統計失敗',
    failuresByPrinter: '按印表機統計失敗',
    deltaVsPrevious: '與前一個{{days}}天週期相比',
    utilizationBusy: '運作{{hours}}小時',
    utilizationNoData: '此期間內沒有含時間資料的列印',
    costBreakdown: '成本明細',
    costFilament: '耗材',
    costEnergy: '電力',
    costMachine: '機器',
    costPerPrintHour: '每列印小時',
    costPerKg: '每公斤',
    costCoverage: '{{total}}個列印中已核算{{priced}}個',
    costNoData: '目前計算器設定下沒有可核算成本的列印',
    filamentForecast: '耗材預測',
    forecastDaysLeft: '約剩{{days}}天',
    forecastNoUsage: '近期無使用',
    forecastNoInventory: '庫存中沒有料捲',
    forecastRemaining: '剩餘{{amount}}',
    forecastBasis: '根據近期用量推算 — 詳情見庫存頁面',
    maintenanceReliability: '維護與可靠性',
    printsSinceMaintenance: '自{{date}}以來 {{prints}}次列印 · {{failures}}次失敗',
    neverMaintained: '尚無維護紀錄',
    maintenanceDueBadge: '{{n}}項到期',
    maintenanceWarningBadge: '{{n}}項將到期',
    maintenanceNoData: '沒有啟用維護追蹤的印表機',
    maintenanceSinceCaption: '計數以所選期間為準',
    energyWidgetTitle: '能耗',
    aitoPipeline: 'Aito 流程',
    aitoPipelineEmpty: '此期間 Aito 看板上沒有內容',
    pipelineByStage: '依階段',
    pipelineConversion: '報價轉換',
    pipelineSent: '已發送',
    pipelineAccepted: '已接受',
    pipelineDeclined: '已拒絕',
    pipelineAcceptedRate: '接受率 {{pct}}%',
    pipelineStageDays: '各階段天數',
    pipelineInvoicing: '開立發票',
    pipelineInvoiced: '已開立',
    pipelineOutstanding: '待收款',
    pipelineTracking: '客戶追蹤',
    pipelineTrackingViews: '頁面開啟次數',
    pipelineTrackingCards: '被查看的卡片',
    pipelineTrackingLinks: '有連結的卡片',
    pipelineDays: '{{days}} 天',
    pipelineSample_one: '{{count}} 張',
    pipelineSample_other: '{{count}} 張',
    energyTotalLabel: '總計',
    energyCostLabel: '成本',
    energyAvgPerDay: '日均',
    energyAvgPerPrint: '每次列印平均',
    energyNoPlugs: '未設定具電量監測的智慧插座',
    energyNoData: '此期間內沒有記錄的能耗資料',
  ...
  settings: {
    ...
    ldap: {
      ...
      feature3: '登入時 LDAP 群組對應到 Fenrir 群組',
    ...
    manageArchivesDescription: '編輯和刪除列印封存，包括移除舊的列印及其統計資料貢獻。適用於精簡列印歷史的自動化。',
    manageProjects: '管理專案',
    ...
    concurrentUploadsDescription: '佇列可同時向多少台印表機傳送檔案。印表機接收檔案的速度很慢（大型列印可能需要數分鐘），而且每台都得排隊等候——因此在印表機較多時，調高此值可避免批次中最後一台印表機等完前面所有傳輸。若網路或 Fenrir 主機難以負荷並行傳輸，請調低此值。',
    ...
    preheatFilamentTargetsHint: 'Fenrir 在已裝入的 AMS 槽位中挑選最高目標；所有槽位都推導為 0 的列印（PLA、PETG、TPU、PVA）會完全跳過預熱並立即開始。',
    ...
    authDisabledMessage: '啟用身份驗證以建立使用者帳戶、管理權限並保護您的 Fenrir 實例。',
    ...
    disableAuthenticationMessage: '確定要停用身份驗證嗎？這將使您的 Fenrir 實例無需登入即可存取。所有使用者將保留在資料庫中但身份驗證將被停用。',
    disableAuthentication: '停用身份驗證',
    // Additional settings
    configureFenrir: '設定 Fenrir',
    systemDefault: '系統預設',
    ...
    captureFinishPhotoDescription: '列印完成時從印表機攝影機拍照。Fenrir 會在列印期間錄製一段短縮時攝影，以便從熱床下降前的瞬間取得照片；如果您為本次列印啟用了縮時攝影，檔案將保留，否則會在拍照完成後自動刪除。',
    finishPhotoRestorePlate: '為完成照片抬升熱床',
    finishPhotoRestorePlateDescription: '列印結束時印表機會將熱床下降約 100 mm，使完成的模型落在相機取景範圍之下。Fenrir 會將熱床抬回到最後一層列印高度略上方，拍攝照片後再次下降。若列印高度未知或佇列中還有其他任務，則跳過此步驟。',
    ...
    cameraQualityAutoResolved: '已根據伺服器硬體自動選擇：{{resolved}}。',
    cameraQualityAutoResolvedDual: '已根據伺服器硬體與串流數量自動選擇：{{single}}（單一檢視）、{{grid}}（相機格狀檢視）。',
    cameraQualityDescription: '控制串流的 FPS 與解析度。較低畫質可在多相機環境下減少 CPU 使用量。',
    cameraGpuAccel: 'GPU 加速',
    cameraGpuAccelDescription: '對相機串流使用硬體加速視訊解碼。在具備相容 GPU 的伺服器上可減少 CPU 使用量。',
    cameraGpuAccelUnavailable: '此伺服器上未偵測到 GPU 加速後端。',
    cameraGpuAccelBackends: '可用後端：{{backends}}',
    cameraEngine: '相機引擎',
    cameraEngineFFmpeg: 'FFmpeg (MJPEG)',
    cameraEngineGo2rtc: 'go2rtc (WebRTC)',
    cameraEngineFFmpegDescription: '透過 FFmpeg 將 RTSP 轉碼為 MJPEG。相容所有瀏覽器，但 CPU 使用量較高。',
    cameraEngineGo2rtcDescription: '透過 WebRTC 將 H.264 直接傳送到瀏覽器。無需轉碼、延遲更低、硬體解碼。艙內相機（A1/P1）仍使用 FFmpeg。',
    notInstalled: '未安裝',
    test: '測試',
    connected: '已連線',
    disconnected: '未連線',
    ...
    updateViaHomeAssistant: '更新由 Home Assistant Supervisor 管理。請在 Home Assistant 中開啟 設定 → 附加元件 → Fenrir 以安裝新版本。',
    ...
    goToBackup: '前往備份',
    externalUrl: '外部URL',
    externalUrlDescription: 'Fenrir可存取的外部URL。用於通知影像和外部整合。',
    ...
    mqttDescription: '將Fenrir事件發布到外部MQTT代理，用於與Node-RED、Home Assistant和其他自動化系統整合。',
    ...
    encryption: {
      ...
      notConfiguredDesc: 'TOTP 機密和 OIDC client_secrets 以明文儲存。請設定 MFA_ENCRYPTION_KEY 或使用可寫資料目錄重新啟動 Fenrir 以自動產生。',
      ...
      migrationErrorWarning: '{{count}} 行舊資料在啟動時未能重新加密。請檢查伺服器日誌並重新啟動 Fenrir 以重試。',
    },
    ...
    openrouterApiKeyHint: '唯寫 — 留空以保留目前金鑰',
    openrouterModel: '模型',
    openrouterModelHint: '用於專案摘要的 OpenRouter 模型 ID（法語）',
    ...
    aitoFollowupLinkDays: '付款連結即將到期（天）',
    aitoFollowupLinkDaysDescription: '標記付款連結將在此天數內到期的報價單',
  },
  ...
  hmsErrors: {
    ...
    runoutSlotUnknown: '耗材已用盡，列印已暫停。Fenrir 無法確定印表機現在需要哪個料槽——請在印表機螢幕上查看所請求的料槽。',
    actions: {
  ...
  login: {
    ...
    twoFA: {
      ...
      methodEmail: '信箱驗證碼',
      methodBackup: '備用恢復碼',
      instructionsTotp: '請開啟您的身份驗證器 App，輸入 Fenrir 的 6 位驗證碼。',
  ...
  camera: {
    title: '攝影機檢視',
    refreshStream: '重新整理串流',
    expand: '展開',
    minimize: '最小化',
    reconnectingIn: '{{countdown}} 秒後重新連線...',
    stream: '相機串流',
    resize: '拖曳以調整大小',
  ...
  users: {
    title: '使用者管理',
    subtitle: '管理使用者及其對 Fenrir 實例的存取',
    backToSettings: '返回設定',
    createUser: '建立使用者',
    noPermission: '您沒有存取此頁面的權限。',
    admin: '管理員',
  ...
  profiles: {
    ...
    orcaCloud: {
      ...
      connect: {
        ...
        description: '登入您的 Orca Cloud 帳號,將切片機設定檔同步到 Fenrir。',
      },
      device: {
        title: '在 Orca Cloud 中核准 Fenrir',
        instruction: '開啟 Orca Cloud 並核准此代碼。核准後 Fenrir 會自動連接。',
        codeLabel: '您的配對代碼',
    ...
    login: {
      ...
      captchaBody: 'Bambu 在接受登入之前要求你的網路通過 CAPTCHA 驗證，而該驗證無法在 Fenrir 中完成。這與你的電子郵件和密碼無關。限制與你的公開 IP 位址綁定，通常幾小時後會自動解除；反覆重試只會延長限制。若要立即登入，請改用從瀏覽器工作階段取得的存取權杖。',
      useEmail: '改用信箱登入',
      toast: {
        loggedIn: '登入成功',
  ...
  filamentProfiles: {
    ...
    syncingBase: '正在同步基礎庫…',
    import: '匯入',
    syncZohoPrices: '從 Zoho 同步價格',
    syncingZoho: '正在從 Zoho 同步價格…',
    syncToPc: '同步到電腦',
    exportZip: '匯出 ZIP',
    newPreset: '新增預設',
    // Filters
    ...
    // Confirm
    deleteTitle: '刪除預設？',
    deleteBody: '{{name}} 將被永久刪除。',
    cancel: '取消',
    deleteConfirm: '刪除',
    // Sync-base modal
    baseSyncedTitle: '基礎設定檔已同步',
    baseSyncFailedTitle: '同步失敗',
    filesScanned: '已掃描 {{n}} 個檔案',
    statNew: '新增',
    statUpdated: '已更新',
    statUnchanged: '未變更',
    close: '關閉',
    // Sync modal
    syncTitle: '同步到電腦',
    syncSubtitle: '變更將套用到 BambuStudio 的耗材資料夾。',
    statRemoved: '已移除',
    upToDate: '一切都已是最新狀態。',
    syncConfirm: '同步',
    ...
    // Import
    scanFailed: '讀取 BambuStudio 資料夾時發生錯誤：{{error}}',
    allImported: '找到 {{n}} 個檔案，皆已匯入。',
    importing: '正在匯入預設… {{current}}/{{total}}',
    imported: '已匯入 {{n}} 個預設',
    ...
    inheritsNotFound: '（找不到）',
    reload: '重新載入',
    serverChangedBanner: '您編輯此預設時，它在伺服器上已變更。',
    serverChangedReload: '從伺服器重新載入',
    save: '儲存',
    create: '建立',
    saving: '儲存中…',
    nameRequiredHint: '需要品牌與材質',
    deletePreset: '刪除',
    ...
    tabJson: 'JSON',
    // Editor General
    basePresetLabel: '基礎預設',
    basePresetNone: '— 無（從空白開始） —',
    basePresetMine: '我的預設',
    basePresetBase: '基礎預設',
    basePresetLoading: '載入中…',
    brand: '品牌',
    brandSelect: '— 選擇 —',
    material: '材質',
    colorLabel: '顏色標籤',
    colorPlaceholder: '白色、黑色…',
    nozzleSize: '噴嘴尺寸',
    paKValue: 'PA K 值',
    cost: '成本',
    density: '密度',
    ...
    fanMin: '最小速度',
    overhangFan: '懸空速度',
    noFanLayers: '無風扇（零件）層數',
    noFanAdditional: '無風扇（附加）層數',
    initialFan: '首層風扇',
    minLayerTime: '最短層時間',
    overhangThreshold: '懸空閾值',
    preStartFan: '風扇預啟動',
    additionalFan: '附加風扇',
    overhangBridgeFan: '懸空/橋接風扇',
    chamberVent: '腔體通風',
    duringPrint: '列印期間',
    endOfPrint: '列印結束時',
    nil: 'nil',
    ...
    zHopSpiral: '螺旋抬升',
    wipeDistance: '擦拭距離',
    retractBeforeWipe: '擦拭前回抽',
    options: '選項',
    retractOnLayerChange: '換層時回抽',
    wipeOnRetract: '回抽時擦拭',
    // Editor JSON
    jsonCaption: '直接編輯 — 其他分頁會自動更新',
  },
  ...
  fileManager: {
    ...
    uploading: '上傳中...',
    checkingDuplicates: '檢查中...',
    alreadyInLibrary: '已在檔案庫中',
    duplicateIn: '位於 {{folder}}',
    duplicatesWillBeSkipped: '偵測到 {{count}} 個重複檔案 — 將被略過',
    uploadAnyway: '仍要上傳',
    skipDuplicate: '略過',
    skippedDuplicate: '已略過（已在檔案庫中）',
    changeLink: '更改連結...',
    linkTo: '連結到...',
    ...
    fileHistory: {
      menuLabel: '歷史記錄',
      title: '歷史記錄 — {{name}}',
      viewHistoryAria: '檢視列印歷史',
      noPermission: '您沒有檢視檔案歷史的權限',
      loadFailed: '載入檔案歷史失敗',
      statusPending: '佇列中',
      addedToLibrary: '已加入檔案庫',
      bySomeone: '由 {{name}}',
      noPrintsYet: '此檔案尚未列印。',
      externalUnavailable: '外部檔案無法使用列印歷史。',
      openArchive: '開啟歸檔',
      viewSource: '開啟來源頁面',
      stats: {
        prints: '列印次數',
    ...
    toast: {
      ...
      filesDeleted: '已刪除 {{count}} 個檔案',
      filesMoved: '檔案已移動',
      moveSkipped: '已移動 {{moved}} 個，跳過 {{skipped}} 個：{{reasons}}',
      moveSkipReason: {
        not_owner: '不是擁有者',
        source_readonly: '來源為唯讀',
        source_missing: '磁碟上找不到該檔案',
        target_readonly: '目標為唯讀',
        target_misconfigured: '目標資料夾設定錯誤',
        target_inaccessible: '目標資料夾無法存取',
        target_unwritable: '目標資料夾無法寫入',
        invalid_filename: '檔案名稱不安全',
        name_collision: '檔案名稱衝突',
        copy_failed: '複製失敗',
      },
      folderLinked: '資料夾已連結',
  ...
  sponsors: {
    ...
    tagline: 'Fenrir 完全免費，並將持續免費——感謝主動支持的使用者。沒有創投，也沒有雲端綁定。',
    viewSupporters: '查看支持者',
    toastPrints: '你已經用 Fenrir 完成了 {{count}} 次列印。Fenrir 之所以免費，要感謝支持者。',
    toastCost: '你已經用 Fenrir 追蹤了 {{total}} 的耗材。看看是誰讓專案保持獨立。',
    toastArchives: '用 Fenrir 封存了 {{count}} 次列印。看看是誰讓它保持獨立。',
    toastAnniversary: '與 Fenrir 相伴一年了！看看是誰讓專案保持獨立。',
    toastVersionUpdate: '已更新至 v{{version}}。Fenrir 之所以免費，要感謝支持者。',
    toastBusiness: '您正在 {{count}} 台印表機上執行 Fenrir？我們為團隊提供支援方案：優先修復、開立發票，以及與維護者的直接聯繫管道。',
    businessCta: 'Fenrir 商業版',
    businessTitle: 'Fenrir 商業版',
  ...
  inventory: {
    ...
    spoolmanMixedContentBody: 'Fenrir 透過您的反向代理以 HTTPS 提供服務，但您的 Spoolman 位址仍為 HTTP。基於安全考量，瀏覽器會封鎖混合內容，因此內嵌的 Spoolman 介面無法載入。Spoolman 也必須可透過 HTTPS 存取。',
    spoolmanMixedContentFixReverseProxy: '請將 Spoolman 置於與 Fenrir 相同的反向代理（Traefik / Nginx / Caddy）之後並啟用 HTTPS，然後在設定中將 Spoolman URL 更新為新的 HTTPS 位址。',
  ...
  printModal: {
    ...
    insufficientFilamentLinePooled: '{{printer}} - {{slot}}：需要 {{required}}g，相符料卷共剩餘 {{remaining}}g（AMS 備用料盤）',
    printAnyway: '仍然列印',
  ...
  zoho: {
    title: 'Zoho Books',
    subtitle: '連接 Zoho Books，將 Aito 專案關聯到客戶並同步發票。',
    clientId: '用戶端 ID',
    clientSecret: '用戶端密鑰',
    refreshToken: '重新整理權杖',
    ...
    baseUrl: 'API 基礎 URL',
    accountsUrl: '帳戶 URL',
    defaultContactId: '預設客戶 ID',
    defaultContactName: '預設客戶名稱',
    defaultContactHint: '在 Aito 新增專案視窗中預先選取。電話和電子郵件永遠不會寫入此聯絡人。',
    secretSaved: '值已儲存 — 留空以保留',
    save: '儲存',
    saved: 'Zoho 設定已儲存',
    test: '測試連線',
    testOk: '已連接到 Zoho Books',
    testUnreachable: '已設定，但無法連接 Zoho Books',
    testNotConfigured: 'Zoho Books 未設定',
  },

  heimdall: {
    title: 'Heimdall 付款',
    subtitle: '透過 Heimdall POS 橋接為每份 Aito 報價單產生線上付款連結。連結付款後會自動接受該報價單。',
    baseUrl: 'Heimdall 網址',
    token: 'API 權杖',
    tokenHint: '僅寫入——留空則保留目前的權杖',
    depositPct: '訂金（%）',
    depositPctDescription: '填 0 表示收取報價單全額；否則連結只收取該比例。',
    validityDays: '報價單有效期（天）',
    validityDaysDescription: '寫入每份新報價單的到期日期；付款連結在同一天失效。',
    save: '儲存',
    saved: 'Heimdall 設定已儲存',
    test: '測試連線',
    testOk: '已連線到 Heimdall',
    testUnauthorized: 'Heimdall 拒絕了該權杖',
    ...
    paymentModesTitle: 'Zoho 付款方式名稱',
    paymentModesHint: 'Zoho Books 用於記錄專案卡片付款的名稱。',
    paymentModeCard: '刷卡',
    paymentModeCheque: '支票',
    paymentModeCash: '現金',
  },
  ...
  backup: {
    ...
    repoIsPublicWarning: '儲存庫為公開（PUBLIC）。Fenrir 備份包含 MQTT 認證、Home Assistant 權杖、Prometheus 權杖、您的 Bambu Cloud 電子郵件，以及透過 K-profile 暴露的印表機存取碼。在您於服務商設定中將儲存庫改為私有之前，儲存將被阻擋。',
    repoVisibilityUnknown: '無法確認儲存庫的可見性。Fenrir 拒絕向任何未確認為私有的目標進行備份；儲存將被阻擋。',
    ...
    appSettings: '應用程式設定',
    appSettingsDescription: 'Fenrir 設定（完整資料庫）',
    spoolInventory: '耗材庫存',
    ...
    restoreFromGit: {
      ...
      reloadHint: '請重新載入 Fenrir，讓還原的資料在各處生效。',
      ...
      notes: {
        ...
        settingsMqttRelayFailed: 'MQTT 設定已還原，但中繼無法重新連線 - 請重新啟動 Fenrir',
    ...
    // Local Backup
    localBackup: '本機備份',
    localBackupDescription: '建立 Fenrir 資料的完整備份，包括資料庫、檔案、上傳和所有檔案。',
    ...
    backupRestoredRestart: '備份已恢復。請重新啟動 Fenrir。',
    ...
    pathCheck: {
      title: 'Fenrir 無法寫入此目錄',
      howToFix: '解決方法：',
      sandboxed: 'Fenrir 服務無法寫入 {{path}}。其 systemd unit 以 ProtectSystem=strict 執行，因此安裝、資料與記錄目錄以外的所有目錄對服務而言都是唯讀的，即使你自己的 shell 可以寫入也一樣。',
      read_only: '{{path}} 位於唯讀檔案系統上。',
      permission_denied: 'Fenrir 沒有寫入 {{path}} 的權限。請檢查該目錄的擁有者與權限。',
      no_space: '{{path}} 所在的檔案系統已滿。',
      not_a_directory: '{{path}} 存在，但不是目錄。',
      missing: '{{path}} 不存在且無法建立。',
      error: 'Fenrir 無法寫入 {{path}}。',
      ephemeralTitle: '這些備份在容器重建後會遺失',
      container_ephemeral: '{{path}} 位於 Fenrir 容器內，而非主機上。寫入其中的備份會在容器重建時遺失。請從主機掛載該目錄：',
    },
  ...
  kProfiles: {
    ...
    modal: {
      ...
      notesHelp: '備註儲存在 Fenrir 中，不在印表機上',
      syncing: '與印表機同步中...',
  ...
  virtualPrinter: {
    ...
    enable: {
      title: '啟用虛擬印表機',
      visibleInSlicer: '在切片軟體發現中顯示為"Fenrir"',
      proxyingTo: '代理到 {{name}}',
      notActive: '未啟用',
    },
    model: {
    ...
    remoteInterface: {
      ...
      placeholder: '自動檢測（預設）...',
      hint: '覆蓋透過 SSDP 廣播並在 TLS 憑證中使用的 IP 位址。在 Fenrir 有多個網路介面時很有用。',
    },
    mode: {
      title: '模式',
      archive: '歸檔',
    ...
    caCert: {
      title: '切片軟體憑證',
      description: '虛擬印表機使用由 Fenrir CA 簽發的 TLS 憑證。將此 CA 憑證匯入切片軟體的信任庫一次，切片軟體即可接受連線 — 無需再透過命令列取得。',
      copy: '複製',
      copied: '已複製',
      download: '下載',
      fingerprint: 'SHA-256',
    ...
    howItWorks: {
      ...
      step2: '在歸檔、審核和佇列模式下，使用切片軟體中的"傳送"按鈕將 3MF 檔案上傳到 Fenrir。切片軟體會顯示"列印成功"— 檔案已儲存，未列印。',
  ...
  locationHaSensors: {
    ...
    autoAdd: {
      ...
      confirmMessage: 'Fenrir 也為此位置找到了其他感測器。請選擇要一併新增的感測器。',
      added: '已同時新增：{{names}}',
    ...
    options: {
      ...
      pollInterval: '更新間隔（秒）',
      pollIntervalHint: 'Fenrir 輪詢 Home Assistant 並刷新畫面上感測器數值的頻率。最少 60 秒。',
  ...
  smartPlugs: {
    ...
    restEnergyTotalHint:
      '許多插座（包括所有 Shelly）只提供永不歸零的累計計數值。該值應填在此處，而非上方欄位：若當作今日用量讀取，它在午夜不會歸零，而「昨日」與「總計」會一直是空的。Fenrir 會據此推算「今日」與「昨日」，這需要一至兩天的取樣資料。Shelly 以瓦時為單位，因此倍數請填 0.001。',
  ...
  notifications: {
    ...
    aitoPaymentReceivedLabel: '收到 Aito 付款',
    aitoPaymentReceivedDescription: '當 Aito 報價單線上付款或收到足額訂金時通知',
    printFailed: '列印失敗',
    printStopped: '列印已停止',
  ...
  time: {
    ...
    today: '今天',
    yesterday: '昨天',
    daysElapsed_one: '{{count}} 天前',
    daysElapsed_other: '{{count}} 天前',
    monthsElapsed_one: '{{count}} 個月前',
    monthsElapsed_other: '{{count}} 個月前',
  ...
  diagnostic: {
    ...
    check: {
      ...
      external_storage: {
        ...
        warn_internal_storage: '該選項已開啟且儲存媒體在位，但上一次列印仍進入了 Fenrir 無法讀取的印表機內部儲存。在 H2 系列、P2S 與 X2D 上，無論此選項如何設定，Bambu Studio 的「列印」按鈕總是傳送到那裡。列印會帶著名稱與時間歸檔，但沒有縮圖與切片中繼資料。要取得完整歸檔，請從 Fenrir 啟動列印、改用 OrcaSlicer 切片，或在 Bambu Studio 中用「傳送」選擇「外部儲存」後再啟動列印。',
        warn_internal_history: '該選項已開啟，儲存媒體也在，但最近一次列印來自印表機裡既有的檔案 — 從它的螢幕重新列印、從 Handy 啟動，或是先前傳送過的檔案。這個檔案庫位於 Fenrir 讀不到的內部儲存中，而且任何設定都改變不了，因為那次列印根本沒有傳送過檔案。它仍會帶著名稱與時間歸檔，但沒有縮圖與切片中繼資料。要獲得完整歸檔，請從 Fenrir 啟動列印，或從切片軟體傳送。',
      },
      port_rtsps: {
      ...
      subnet: {
        title: '網路子網路',
        pass: '印表機與 Fenrir 位於同一子網路。',
        warn: '印表機（{{printer_ip}}）與 Fenrir（{{host_ip}}）位於不同的子網路。除非設定了子網路之間的路由，否則它們可能無法互相連線。',
        skip: '無法判定子網路 — 已略過。',
      },
      mqtt_auth: {
        title: '印表機認證資訊',
        pass: '印表機已接受連線。',
        fail: '印表機可達，但 Fenrir 未與其建立連線。存取碼或序號很可能有誤 — 每次切換僅區域網路模式或開發者模式時存取碼都會變更，請從印表機螢幕重新複製。正在重新啟動或已達到同時連線數上限的印表機看起來也是這樣。',
        fail_auth_rejected: '印表機拒絕了 Fenrir 的認證資訊。存取碼或序號有誤 — 每次切換僅區域網路模式或開發者模式時存取碼都會變更。請從印表機螢幕重新複製，並儲存到印表機設定中。',
        skip: '未檢查 — 無法連線到印表機。',
      },
      developer_mode: {
        title: 'LAN 開發者模式',
  ...
  systemHealth: {
    ...
    signature: {
      'ftp-auth-rejected': {
        ...
        fix: '從印表機螢幕（區域網路設定）重新複製存取碼，並在 Fenrir 的印表機設定中更新。',
      },
      'ftp-connection-timeout': {
        name: '檔案傳輸連線逾時',
        cause: 'Fenrir 無法連線印表機的檔案傳輸連接埠（FTPS 990）。該連接埠被封鎖，或印表機已關機或位於其他子網路。',
        fix: '請確認 Fenrir 與印表機之間的 990 連接埠未被封鎖，且兩者位於同一網路。',
      },
      'ftp-ssl-error': {
        name: '安全檔案傳輸交握失敗',
      ...
      'database-locked': {
        ...
        fix: '請將 Fenrir 切換到外部 PostgreSQL 資料庫。參見文件中的 PostgreSQL 指南。',
      },
    },
  },
  ...
  vpDiagnostic: {
    ...
    check: {
      ...
      running: {
        title: '服務正在執行',
        fail: '虛擬印表機已啟用，但其服務未執行。請檢查 Fenrir 記錄 — 通常是繫結 IP 衝突或權限錯誤使其停止。',
      },
      bind_interface: {
        title: '繫結網路介面',
      ...
      certificate: {
        title: 'TLS 憑證',
        pass: '憑證已就緒。請確保已將 Fenrir CA 憑證（上方）匯入切片軟體的信任庫。',
        fail: '此虛擬印表機的 TLS 憑證遺失。請檢查 Fenrir 資料目錄是否可寫入。',
      },
    },
  },
  ...
  failureDetection: {
    ...
    externalUrlHint: 'ML API 透過 URL 擷取攝影機快照。請在一般設定中設定外部 URL，讓 ML API 容器可以連線到 Fenrir。',
  ...
  makerworld: {
    title: 'MakerWorld',
    description: '貼上 MakerWorld 模型連結，即可直接在 Fenrir 中匯入並列印 —— 無需切換至 Bambu Handy 應用程式。',
    ...
    signInExpiredTitle: 'Bambu Cloud 登入已過期',
    signInExpiredBody: '您仍處於 Fenrir 的登入狀態，但 Bambu Lab 已不再接受已儲存的權杖，因此下載會失敗。請重新登入 Bambu Cloud。',
    ...
    disclaimer: 'MakerWorld 整合使用由社群記錄的 API 介面。Fenrir 與 MakerWorld 或 Bambu Lab 無從屬或認可關係。',
  ...
  libraryPurge: {
    ...
    effect4: '外部（連結）資料夾中的檔案將被略過 — Fenrir 從不刪除不屬於自己的位元組。',    previewLoading: '正在檢查符合的檔案數量…',
  ...
  calculator: {
    ...
    material: '材料',
    title: '計算器',
    subtitle: '估算3D列印成本與銷售價格',
    easyMode: '簡易模式',
    reset: '重設',
    resetConfirmTitle: '重設輸入',
    resetConfirmMessage: '將計算器的所有輸入重設為預設值？線材、印表機與預設參數將保留。',
    informations: '基本資訊',
    weight: '物件重量',
    printingTime: '列印時間 (h)',
    printingTimeLabel: '列印時間',
    durationDays: '天',
    durationDaysShort: '天',
    durationHours: '小時',
    ...
    emptyInputsTitle: '請輸入重量與列印時間',
    emptyInputsMessage: '填寫物件重量與列印時間即可查看建議價格與成本明細。',
    targetPrice: '目標價格',
    targetPriceLabel: '目標價格（含稅）',
    targetPriceProfit: '淨利率',
    measuredEnergy: '實測能耗：{{kwh}} kWh（來自封存）',
    measuredEnergyClear: '清除實測能耗',
    qtyIncrease: '增加數量',
    qtyDecrease: '減少數量',
    fixErrors: '部分輸入無效 — 請修正標示的欄位；無效值不會計入結果。',
    breakEvenDiscount: '損益兩平折扣：{{pct}} — 超過此折扣將低於成本銷售。',
    laborAmortized: '建模與準備為一次性成本，分攤至 {{count}} 件。',
    copySummary: '複製摘要',
    summaryCopied: '摘要已複製到剪貼簿',
    summaryCopyFailed: '複製失敗 — 剪貼簿存取遭封鎖',
    easyAssumptions: '基於已儲存的費率 — 查看預設參數',
    quantity: '數量',
    filament: '線材',
    printer: '印表機',
    difficulty: '難度係數 (%)',
    difficultyTooltip: '用於棘手列印的乘數：磨損性線材、高失敗風險、精細處理等。100% = 無附加費。',
    labor: '人工',
    modeling: '建模',
    workingHours: '工作時數',
    basePrice: '基本價格',
    preparation: '準備',
    modelPreparation: '模型準備',
    slicing: '切片',
    transferStart: '傳輸與啟動',
    postProcessing: '後處理',
    jobRemoval: '取件',
    supportRemoval: '移除支撐',
    additionalWork: '額外工作（分鐘）',
    fulfillment: '出貨',
    stuff: '雜項用品',
    amount: '金額',
    markupPct: '加價率',
    ...
    timeCorrection: {
      ...
      hintScoped: '{{scope}} 平均達到切片預估的 {{pct}}%',
      apply: '套用校正時間',
      dismiss: '關閉',
    },
    waterfall: {
    ...
    quote: {
      ...
      print: '列印',
      title: '報價單',
      empty: '尚無可報價的工作——請先填寫計算器。',
      jobDetails: '工作詳情',
      footnote: '價格含稅。報價視材料供應情況而定。',
    },
    marge: '利潤',
    marginPct: '利潤率',
    marginGlobal: '整體利潤',
    ...
    marginStuff: '雜項利潤',
    perUnit: '每件',
    forQuantity: '{{count}}件合計',
    breakdown: '成本明細',
    costSplit: '成本組成',
    costFilament: '線材',
    costDepreciation: '印表機折舊',
    costEnergy: '電力',
    costConsumables: '消耗品與包裝',
    costBaseFee: '基本費用',
    costRepairs: '維修',
    costPrototype: '原型',
    costFailures: '列印失敗',
    ...
    groupLabor: '人工',
    splitPrinter: '印表機',
    splitAdsConsumables: '廣告與消耗品',
    discountTitle: '折扣計算',
    discountMachine: '折後機器成本',
    discountSafety: '折後安全成本',
    discountPrice: '折後價格',
    discountAmount: '折扣金額',
    potentialProfit: '潛在利潤',
    bulkQuantity: '數量',
    emptyTitle: '設定您的計算器',
    emptyMessage: '至少新增一種線材與一台印表機即可開始計算價格。',
    ...
    tabPrinters: '印表機',
    name: '名稱',
    costPerKg: '每公斤成本 ({{currency}})',
    printingCostPerKg: '每公斤列印成本 ({{currency}})',
    marginOverCost: '成本利潤率 (%)',
    zohoProductSearch: 'Zoho 產品',
    zohoProductSearchPlaceholder: '在 Zoho 中搜尋線材…',
    zohoNoDealerPrice: '無經銷商價格',
    zohoNoResults: '沒有相符的 Zoho 線材',
    zohoSearchError: '無法連接 Zoho',
    zohoLinkedProduct: '已連結到 {{name}}',
    zohoUnlink: '取消連結',
    zohoWeightInferred: 'Zoho 名稱中未包含線軸重量，已假定為 1 公斤',
    spoolWeightKg: '線軸重量 (kg)',
    syncZohoPrices: '同步價格',
    syncProgress: '{{done}} / {{total}}',
    syncSummary:
      '已更新 {{updated}} 個 · 未變化 {{unchanged}} 個 · {{skipped}} 個無經銷商價格 · {{missing}} 個 Zoho 中缺失 · {{unpriced}} 個未定價（重量不明）',
    syncFailed: '同步已停止：{{error}}',
    syncTimedOut: '同步已逾時；部分批次可能仍已套用',
    zohoDuplicateWarning: '{{name}} 的線材已存在',
    addFilament: '新增線材',
    editFilament: '編輯線材',
    deleteFilamentTitle: '刪除線材',
    deleteFilamentMessage: '刪除「{{name}}」？此操作無法復原。',
    filamentCreated: '線材已新增',
    filamentUpdated: '線材已更新',
    filamentDeleted: '線材已刪除',
    purchasePrice: '購買價格 ({{currency}})',
    lifetimeYears: '使用壽命（年）',
    dailyUsage: '每日使用（小時）',
    powerWatts: '功率 (W)',
    repairRate: '壽命內維修費 (%)',
    lifetimeHours: '壽命小時數',
    depreciationPerHour: '每小時折舊',
    repairsPerHour: '每小時維修費',
    addPrinter: '新增印表機',
    editPrinter: '編輯印表機',
    deletePrinterTitle: '刪除印表機',
    deletePrinterMessage: '刪除「{{name}}」？此操作無法復原。',
    printerCreated: '印表機已新增',
    printerUpdated: '印表機已更新',
    printerDeleted: '印表機已刪除',
    inUse: '已在計算器頁面選取',
    electricityTariff: '電價 ({{currency}}/kWh)',
    laborRate: '人工費率 ({{currency}}/h)',
    consumablesFlat: '消耗品與包裝 ({{currency}})',
    baseFee: '基本費用 ({{currency}})',
    marginCurveHint: '兩條曲線共同決定整體利潤率:隨著單件成本上升而縮小的尺寸利潤率,以及隨著數量增加而削減利潤率(而非成本)的數量折扣。',
    sizeMarginGroup: '尺寸利潤率',
    qtyDiscountGroup: '數量折扣',
    floorGroup: '最低限額',
    marginMinMult: '超大零件的倍數 (M_MIN)',
    marginMaxMult: '超小零件的倍數 (M_MAX)',
    marginK: '中點單位成本 (K,{{currency}})',
    qtyMinFactor: '大量時保留的利潤率 (Q_MIN)',
    qtyK: '中點數量 (KQ)',
    minTaskPrice: '每個任務的最低價格 ({{currency}})',
    marginCurveMaxBelowMin: 'M_MAX 必須不小於 M_MIN',
    marginCurvePreviewSize: '依單位成本劃分的尺寸利潤率',
    marginCurvePreviewQty: '依數量劃分的數量係數',
    exampleTitle: '範例訂單',
    ...
    formulaAt: '在 {{x}} → {{y}}',
    warnFlatSize: '尺寸曲線是平的：每個部件都得到 ×{{m}}。',
    warnKFar: 'K 遠高於您的範例成本；曲線在您的工作所在之處幾乎不彎曲。',
    warnKNear: 'K 遠低於您的範例成本；每個工作都接近 M_MIN。',
    warnNoQtyDiscount: '沒有數量折扣：Q_MIN 為 1。',
    warnFloorDominates: '最低價格超過了您範例的價格；曲線永遠不會在其以下生效。',
    kHint: '您最近 {{count}} 次列印的單位成本中位數：{{median}}',
    kHintUse: '套用',
    exampleFromCalculator: '已根據上次計算機作業預先帶入',
    multiplier: '×{{value}}',
    multiplierDetail: '尺寸 ×{{size}} · 數量 {{qty}}',
    floorApplied: '已套用最低價格',
    curveTitle: '依數量定價',
    curveHint: '每個數量下的單價(含稅)——一次性成本會攤銷,數量折扣會削減利潤率。',
    curveUnitPrice: '單價',
    curveTaskPrice: '任務總價',
    curveQtyFactor: '數量係數',
    curveCurrent: '目前',
    ...
    prototypeRate: '原型率 (%)',
    adsRate: '廣告率 (%)',
    filamentMarkup: '線材加價率 (%)',
    taxPct: '稅 TGC (%)',
    defaultDifficulty: '預設難度 (%)',
    defaultMargin: '預設成本利潤率 (%)',
    filamentSettings: '線材設定',
    filamentSettingsHint: '新線材設定檔的初始值。',
    stuffMarkup: '雜項加價率 (%)',
    ratesTitle: '費率',
    ratesHint: '一項工作的實際成本——報價前請依當地價格與貨幣調整這些數值。',
    provisionsTitle: '預留與管理費',
    provisionsHint: '在成本之上加收的百分比，用於涵蓋列印失敗、樣品、廣告，以及線材與附加項目的轉售加價。',
    unsavedChanges_one: '{{count}} 項未儲存的變更',
    unsavedChanges_other: '{{count}} 項未儲存的變更',
    fixFields: '請先修正標示的欄位再儲存。',
    discardChanges: '放棄',
    tabSettings: '設定',
    marginCurvesTitle: '利潤率曲線',
    saveSettings: '儲存設定',
    settingsSaved: '設定已儲存',
  },
};
