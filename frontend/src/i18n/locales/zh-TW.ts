export default {
  ...
  aito: {
    ...
    statistics: '統計',
    stats: {
      caption: '{{active}} 個進行中 · 累計完成 {{done}} 個',
      added: '新增',
      accepted: '已接受',
      completed: '已完成',
      perDay: '每日新增',
      ...
      brief: {
        ...
        dueNone: '本週沒有交付安排。',
        finished_one: '本期完成 {{count}} 個專案。',
        finished_other: '本期完成 {{count}} 個專案。',
        more: '比上期多 {{count}} 個。',
        fewer: '比上期少 {{count}} 個。',
        lead: '從報價到交付：{{days}}。',
        chaseHeading: '追蹤',
        tellHeading: '通知',
        collectHeading: '收款',
        chaseEmpty: '所有報價都已有答覆。',
        tellEmpty: '所有客戶都已通知。',
        collectEmpty: '所有發票都已付清。',
        ready: '可以取貨',
        late: '逾期 {{days}} 天',
        andMore: '還有 {{count}} 個',
      },
      teaser: {
        sales: '接受 {{pct}}% · 流失 {{lost}} 個，{{total}}',
        time: '從報價到交付 {{lead}} · 回退 {{moves}} 次',
        money: '接受 {{accepted}} · 待收 {{outstanding}} · {{service}} 佔收入 {{pct}}%',
        moneyPlain: '接受 {{accepted}} · 待收 {{outstanding}}',
        clients: '新客 {{new}} · 回頭客 {{returning}}',
      },
    },
    doneEmpty: '尚無已完成的專案',
