export default {
  ...
  aito: {
    ...
    firstName: 'Nome',
    lastName: 'Sobrenome',
    displayNamePreview: 'Salvo como: {{name}}',
    ...
    payment: {
      ...
      cellManualTitle: 'Registrar um pagamento',
