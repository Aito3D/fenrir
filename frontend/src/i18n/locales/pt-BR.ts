export default {
  ...
  aito: {
    ...
    track: {
      ...
      paymentMethods: {
        referenceKnown: 'Informe o número do orçamento {{ref}} como referência do seu pagamento.',
        referenceUnknown: 'Informe o número do seu orçamento como referência do seu pagamento.',
        transfer: 'Transferência bancária',
        beneficiary: 'Beneficiário',
        bank: 'Banco',
        transferDelay: 'Uma transferência pode levar um ou dois dias para chegar até nós.',
        appTransfer: 'Transferência {{app}}',
        tag: 'Beneficiário (tag)',
        shop: 'Na loja',
        shopSub: 'Cartão bancário ou dinheiro.',
        copy: 'Copiar',
        copied: 'Copiado',
        copyIban: 'Copiar o IBAN',
        copyTag: 'Copiar a tag {{app}}',
        question: 'Responda à nossa mensagem em caso de dúvida.',
      },
      stages: {
        devis: 'Orçamento',
        waiting: 'Aprovação',
