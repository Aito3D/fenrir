export default {
  ...
  aito: {
    ...
    stats: {
      caption: '{{active}} em produção · {{done}} concluídos no total',
      added: 'Adicionados',
      accepted: 'Aceitos',
      completed: 'Concluídos',
      perDay: 'Adicionados por dia',
      ...
      quoteAge: 'Orçamentos sem resposta',
      ageDays: '{{range}} dias',
      ...
      pickup: 'Retirada',
      decisionsHeading: 'Orçamentos aceitos e recusados',
      declined: 'Recusados',
      ...
      brief: {
        ...
        finished_one: '{{count}} projeto concluído neste período.',
        finished_other: '{{count}} projetos concluídos neste período.',
        more: '{{count}} a mais que o período anterior.',
        fewer: '{{count}} a menos que o período anterior.',
        lead: 'Do orçamento à entrega: {{days}}.',
        chaseHeading: 'Cobrar resposta',
        tellHeading: 'Avisar',
        collectHeading: 'Receber',
        chaseEmpty: 'Todo orçamento tem resposta.',
        tellEmpty: 'Todo cliente foi avisado.',
        collectEmpty: 'Toda fatura está paga.',
        ready: 'Pronto para retirada',
        late: '{{days}} d de atraso',
        andMore: 'e mais {{count}}',
      },
      teaser: {
        sales: '{{pct}}% aceitos · {{lost}} perdidos por {{total}}',
        time: '{{lead}} do orçamento à entrega · {{moves}} movimentos para trás',
        money: '{{accepted}} aceitos · {{outstanding}} em aberto · {{service}} é {{pct}}% da receita',
        moneyPlain: '{{accepted}} aceitos · {{outstanding}} em aberto',
        clients: '{{new}} novos · {{returning}} recorrentes',
      },
    },
