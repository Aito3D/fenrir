export default {
  ...
  calculator: {
    ...
    printingTimeMin: 'Tempo de impressão (min)',
    ...
    tabMarginCurve: 'Curva de margem',
    ...
    saveMarginCurve: 'Salvar curva de margem',
    marginCurveSaved: 'Curva de margem salva',
    multiplier: '×{{value}}',
    ...
    pricingHint: 'Tudo o que compõe um orçamento. As alterações valem para novos orçamentos assim que você salvar.',
    ratesTitle: 'Tarifas',
    ...
    pricingSaved: 'Precificação salva',
