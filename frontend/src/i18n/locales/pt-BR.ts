export default {
  ...
  aito: {
    ...
    clientHistorySummary_one: '{{count}} projeto · {{total}} · desde {{date}}',
    clientHistorySummary_other: '{{count}} projetos · {{total}} · desde {{date}}',
    ...
    track: {
      ...
      status: {
        ...
        devisPaySub: 'Você já pode aprová-lo pagando online abaixo.',
