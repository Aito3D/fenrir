export default {
  ...
  calculator: {
    ...
    basePrice: 'Preço base ({{currency}})',
    preparation: 'Preparação',
    modelPreparation: 'Preparação do modelo (min)',
    slicing: 'Fatiamento (min)',
    transferStart: 'Transferência e início (min)',
    postProcessing: 'Pós-processamento',
    jobRemoval: 'Remoção da peça (min)',
    supportRemoval: 'Remoção de suportes (min)',
    additionalWork: 'Trabalho adicional (min)',
    fulfillment: 'Envio (min)',
