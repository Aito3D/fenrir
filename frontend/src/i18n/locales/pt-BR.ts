export default {
  ...
  aito: {
    ...
    descriptionPlaceholder: 'Descreva o produto a ser projetado e impresso…',
    ...
    sendQuoteSubject: 'Assunto',
    sendQuoteMessage: 'Pré-visualização da mensagem',
    ...
    sendInvoiceTitle: 'Enviar fatura por e-mail',
    sendInvoiceRecipient: 'Destinatário',
    sendInvoiceSubject: 'Assunto',
    sendInvoiceMessage: 'Prévia da mensagem',
    sendInvoiceConfirm: 'Enviar',
    sendInvoiceNoRecipients: 'Este cliente não tem endereço de e-mail no Zoho.',
    sendInvoiceLoadFailed: 'Não foi possível carregar os detalhes do e-mail',
    emailPreviewTitle: 'Prévia do e-mail',
    invoiceEmailed: 'Fatura enviada para {{email}}',
    invoiceEmailFailed: 'Não foi possível enviar a fatura',
    createInvoice: 'Criar fatura',
    createInvoiceTitle: 'Criar a fatura',
    createInvoiceIntro_one: 'Orçamento {{quote}}, {{count}} linha. Um rascunho de fatura é criado no Zoho Books — nada é enviado por e-mail.',
    createInvoiceIntro_other: 'Orçamento {{quote}}, {{count}} linhas. Um rascunho de fatura é criado no Zoho Books — nada é enviado por e-mail.',
    createInvoiceAmount: 'Total da fatura',
    createInvoiceRemaining: 'Falta pagar',
    createInvoiceLockWarning: 'Depois de faturado, este orçamento não aceita mais alterações de linhas pelo Fenrir.',
    createInvoiceConfirm: 'Criar',
    createInvoiceLoadFailed: 'Não foi possível preparar a fatura',
    createInvoiceDone: 'Fatura {{number}} criada',
    createInvoiceDonePaid: 'Fatura {{number}} criada e quitada pelos sinais',
    createInvoiceDonePartial: 'Fatura {{number}} criada — não foi possível aplicar {{retainers}}',
    createInvoiceFailed: 'Não foi possível criar a fatura',
    acceptQuote: 'Aceitar orçamento',
    declineQuote: 'Recusar orçamento',
    holdToConfirm: 'Mantenha pressionado por 0,5 s para confirmar',
    quoteSent: 'Orçamento marcado como enviado',
    quoteAccepted: 'Orçamento aceito',
    quoteDeclined: 'Orçamento recusado',
    quoteUnaccepted: 'Aceitação removida — orçamento de volta em Aguardando',
    unacceptLabel: 'Remover aceitação',
    unacceptHint: 'Segure 1s para remover a aceitação',
    quoteConflictAccepted: 'Este orçamento já foi aceito por outra pessoa.',
    quoteConflictDeclined: 'Este orçamento já foi recusado por outra pessoa.',
    zohoNotUpdated: 'Salvo localmente — o Zoho não foi atualizado',
    progressLabel: '{{done}} de {{total}} etapas concluídas',
    trash: 'Lixeira',
    trashEmpty: 'A lixeira está vazia',
    restore: 'Restaurar',
    restored: 'Projeto restaurado',
    restoreFailed: 'Não foi possível restaurar o projeto.',
    deletedOn: 'Excluído em {{date}}',
    moveFailed: 'Não foi possível mover o projeto. Tente novamente.',
    createFailed: 'Não foi possível criar o projeto. Tente novamente.',
    deleteFailed: 'Não foi possível excluir este projeto',
    client: 'Cliente',
    noClient: 'Sem cliente',
    urgent: 'Urgente',
    markUrgent: 'Marcar como urgente',
    clearUrgent: 'Remover urgente',
    holdToMarkUrgent: 'Mantenha pressionado por 0,5 s para marcar como urgente',
    holdToClearUrgent: 'Mantenha pressionado por 0,5 s para remover urgente',
    sav: 'Devolução',
    markSav: 'Marcar como devolução',
    clearSav: 'Remover devolução',
    holdToMarkSav: 'Mantenha pressionado por 0,5 s para marcar como devolução',
    holdToClearSav: 'Mantenha pressionado por 0,5 s para remover devolução',
    pause: 'Pausado',
    markPause: 'Marcar como pausado',
    clearPause: 'Remover pausa',
    holdToMarkPause: 'Mantenha pressionado por 0,5 s para marcar como pausado',
    holdToClearPause: 'Mantenha pressionado por 0,5 s para remover pausa',
    markFlag: 'Marcar',
    flagFailed: 'Não foi possível alterar a marcação',
    dueDate: 'Data prometida',
    dueDateClear: 'Limpar a data',
    dueDateEmpty: 'Definir uma data',
    dueLateDays: '{{count}} d de atraso',
    dueBadge: 'Prazo {{date}}',
    dueDateFailed: 'Não foi possível alterar a data',
    datePickerPrev: 'Mês anterior',
    datePickerNext: 'Próximo mês',
    datePickerBackToSelected: 'Voltar ao mês selecionado',
    datePickerPlusTwoDays: '+2 dias',
    datePickerPlusOneWeek: '+1 semana',
    datePickerPlusTwoWeeks: '+2 semanas',
    datePickerSuggested: 'sugerido',
    awaitingContact: 'A avisar',
    markContacted: 'Marcar cliente como avisado',
    holdToMarkContacted: 'Segure 0,5 s para confirmar que o cliente foi avisado',
    contacted: 'Avisado',
    clearContacted: 'Desfazer avisado',
    holdToClearContacted: 'Segure 0,5 s para desfazer avisado',
    contactedFailed: 'Não foi possível registrar o contato',
    smsPickupShort: 'SMS',
    smsPickup: 'Enviar SMS de retirada',
    smsTitle: 'SMS de retirada',
    smsMessageLabel: 'Mensagem',
    smsGenerating: 'Redigindo a mensagem…',
    smsGenerateFailed: 'Não foi possível redigir a mensagem',
    ...
    zohoNotConfigured: 'O Zoho Books ainda não está conectado.',
    zohoConfigureLink: 'Conectar o Zoho Books',
    zohoUnreachable: 'Não foi possível conectar ao Zoho Books. Tente novamente.',
    resetToDefaultClient: 'Redefinir para o cliente padrão',
    clientPhone: 'Telefone',
    clientEmail: 'Email',
    countryCode: 'DDI',
    phonePlaceholder: '87123456',
    emailPlaceholder: 'cliente@exemplo.com',
    revertPhone: 'Reverter telefone',
    revertEmail: 'Reverter email',
    socialNetworkMessenger: 'Messenger',
    socialNetworkInstagram: 'Instagram',
    socialNetworkWhatsapp: 'WhatsApp',
    socialNetworkTiktok: 'TikTok',
    socialLabel: 'Rede social (opcional)',
    socialHandleLabel: 'Nome de usuário',
    socialHandlePlaceholder: 'nome.usuario',
    socialRemove: 'Remover a rede social',
    contactsLabel: 'Contatos',
    contactsHint: 'Para quem é este projeto?',
    contactsLoading: 'Lendo os contatos do Zoho Books…',
    contactsUnavailable: 'Não foi possível ler os contatos do Zoho Books — informe um telefone ou e-mail abaixo.',
    contactPrimary: 'principal',
    contactAdd: 'Adicionar contato',
    contactAddTitle: 'Novo contato',
    contactSaveToZoho: 'Salvar no Zoho',
    contactFirstNameRequired: 'Informe um nome.',
    contactNeedsPhoneOrEmail: 'É necessário um telefone ou e-mail para falar com essa pessoa.',
    contactAddFailed: 'Não foi possível adicionar o contato. Tente novamente.',
    contactOverrideToggle: 'Usar um telefone / e-mail diferente para este cartão',
    contactOverrideHint: 'Vale só para este cartão — o contato no Zoho Books não é alterado.',
    contactGone: 'Essa pessoa de contato não existe mais no Zoho Books — escolha outra.',
    clientEditFanOutPerson: 'Vale para todos os cartões abertos desta pessoa de contato',
    clientEditTitle: 'Dados de contato',
    clientEditSourceZoho: 'Zoho Books',
    clientEditSourceCard: 'Só este cartão',
    clientEditFanOut: 'Vale para todos os cartões abertos deste cliente',
    ...
    clientHistoryNoQuote: 'sem orçamento',
    clientHistoryThisCard: 'Este cartão · {{stage}}',
    clientHistoryDeclined: 'Recusado',
    clientHistoryOpenCard: 'Abrir o projeto #{{id}}',
    clientHistoryEmpty: 'Ainda não há projetos para este cliente.',
    clientHistoryError: 'Não foi possível carregar o histórico do cliente.',
    clientEditLoading: 'Lendo o contato no Zoho Books…',
    clientEditWalkIn: 'Cliente de passagem: a alteração fica só neste cartão e não é enviada ao Zoho Books.',
    clientEditZohoReadFailed: 'Não foi possível ler o contato no Zoho Books — mostrando os valores do cartão.',
    clientEditFailed: 'Não foi possível atualizar o cliente. Tente novamente.',
    createClient: 'Criar novo cliente',
    companyName: 'Razão social',
    firstName: 'Nome',
    lastName: 'Sobrenome',
    createClientSubmit: 'Criar cliente',
    back: 'Voltar',
    clientNameRequired: 'Digite uma razão social, ou um nome e sobrenome.',
    newClientPersonHint: 'Ou o nome e sobrenome de uma pessoa',
    newClientContactTag: 'Pessoa de contato na empresa',
    newClientContactHint: 'recomendado — basta o primeiro nome',
    newClientPreviewCompany: 'Empresa: {{name}} · contato: {{person}}',
    newClientPreviewCompanyAlone: 'Empresa: {{name}} · ainda sem pessoa de contato',
    newClientPreviewIndividual: 'Pessoa física: {{name}}',
    clientCreateFailed: 'Não foi possível criar o cliente. Tente novamente.',
    clientSyncFailed: 'Projeto criado — não foi possível atualizar o cliente no Zoho.',
    ...
    duplicateReplaceTitle: "Substituir o rascunho em andamento?",
    duplicateReplaceBody: "O painel de novo projeto já contém trabalho que ainda não foi criado. Duplicar esta ficha irá substituí-lo.",
    duplicateReplaceConfirm: "Substituir",
    stageAndWorkLeft: 'Etapa e trabalho restante',
    panelTabDetails: 'Detalhes',
    billingLabel: 'Faturamento',
    depositAvailable: 'Sinal disponível',
    descriptionShowMore: 'Ver mais',
    descriptionShowLess: 'Ver menos',
    panelTabAttention: 'Requer atenção',
    workLabel: 'Trabalho',
    moveToTrash: 'Mover para a lixeira',
    stepsCount: '{{done}}/{{total}} etapas',
    amountDone: '{{amount}} concluído',
    viewingNow: '{{name}} está visualizando este projeto',
    ...
    phoneLabel: 'Telefone',
    emailLabel: 'E-mail',
    projectRef: 'Projeto nº {{id}}',
    editDescription: 'Editar descrição',
    saved: 'Salvo',
    saveFailed: 'Não foi possível salvar suas alterações. Tente novamente.',
    editConflict: 'Outra pessoa editou este projeto — o quadro foi atualizado, tente novamente.',
    tasks: 'Tarefas',
    addTask: 'Adicionar tarefa',
    taskFallbackName: 'Tarefa {{n}}',
    track: {
      pageTitle: 'Acompanhamento do pedido · Aito 3D',
      title: 'Acompanhe seu pedido',
      reference: 'Orçamento nº {{ref}}',
      stepOf: 'Etapa {{n}} de {{total}}',
      stepsAria: 'Etapas',
      showSteps: 'Ver as etapas',
      hideSteps: 'Ocultar as etapas',
      stepsList: 'Detalhes das etapas',
      tasksHeading: 'Suas peças',
      showAllParts: 'Ver todas as {{n}} peças',
      eta: 'Disponibilidade estimada',
      etaSoon: 'Informaremos uma data o mais breve possível.',
      etaUpdating: 'Estimativa em atualização',
      updated: 'Atualizado {{when}}',
      updatedToday: 'hoje às {{time}}',
      updatedYesterday: 'ontem às {{time}}',
      updatedOn: 'em {{date}} às {{time}}',
      error: 'Não foi possível carregar o acompanhamento no momento.',
      retry: 'Tentar novamente',
      invalidTitle: 'Este link de acompanhamento não é mais válido',
      invalidBody: 'Ele pode ter expirado ou sido substituído. Entre em contato e enviaremos um novo link.',
      footerQuestion: 'Alguma dúvida sobre seu pedido?',
      enterTitle: 'Acompanhar meu pedido',
      enterHint: 'Digite o código de 6 caracteres do seu orçamento ou da nossa mensagem.',
      codeLabel: 'Código de rastreamento',
      codeChecking: 'Verificando…',
      retrying: 'Tentando novamente…',
      codeFound: 'Código reconhecido, abrindo seu acompanhamento.',
      codeNotFound: 'Código não encontrado. Confira e tente novamente.',
      codeTooMany: 'Muitas tentativas. Aguarde um minuto.',
      codeError: 'Não foi possível verificar o código agora. Pressione Enter para tentar de novo.',
      ...
      paymentMethods: {
        ...
        referenceUnknown: 'O número do seu orçamento',
        transferDelay: 'Uma transferência pode levar um ou dois dias para chegar até nós.',
        appTag: 'Tag {{app}}',
        appMessage: 'Mensagem',
        appHint: 'No aplicativo {{app}}, envie o valor do orçamento para esta tag.',
        shop: 'Na loja',
        shopSub: 'Cartão bancário, dinheiro ou cheque.',
      ...
      status: {
        devisTitle: 'Orçamento em preparação',
        devisSub: 'Você o receberá por e-mail assim que estiver pronto.',
        waitingTitle: 'Aguardando sua aprovação',
        waitingSub: 'Avise-nos se aprova o orçamento e iniciaremos a fabricação.',
        acceptedTitle: 'Orçamento aprovado',
        acceptedSub: 'Estamos planejando a fabricação.',
        workingTitle: 'Em fabricação',
        ...
        pickedUpTitle: 'Retirado',
        pickedUpSub: 'Em {{date}}. Obrigado pela confiança!',
        doneTitle: 'Concluído',
        doneSub: 'Obrigado pela confiança!',
      },
      invoice: {
        paidTitle: 'Fatura paga',
        paidSub: 'Obrigado pela confiança.',
        unpaidTitle: 'Fatura a pagar',
        unpaidSub: 'A pagar antes da retirada ou do envio.',
        overdueTitle: 'Fatura em atraso',
        overdueSub: 'Entre em contato se já pagou.',
      },
      payment: {
        unpaidTitle: 'Projeto ainda não pago',
        unpaidSub: 'Pague online, por transferência ou na loja.',
        unpaidDepositSub: 'Um sinal garante o seu pedido — pague online, por transferência ou na loja.',
        validateTitle: 'Aprove seu orçamento',
        validateSub: 'O pagamento online vale como aceite do orçamento.',
        validateDepositSub: 'Um sinal aprova seu orçamento e inicia a fabricação.',
        pay: 'Pagar online',
        paidTitle: 'Pagamento recebido',
        depositPaidTitle: 'Sinal recebido',
        paidSub: 'Obrigado pela confiança.',
      },
    },
    trackingCopy: 'Copiar link de acompanhamento',
    trackingOpen: 'Abrir link de acompanhamento',
    ...
    paymentLink: {
      ...
      paid: 'Pago',
      copy: 'Copiar o link de pagamento',
      ...
      retry: 'Tentar novamente',
      state: { expired: 'Expirado', cancelled: 'Cancelado', failed: 'Recusado' },
    },
    payment: {
      dueQuote: 'Sinal devido',
      dueInvoice: 'Saldo devido',
      cellLink: 'Link',
      cellTerminal: 'Maquininha',
      cellManual: 'Manual',
      cellLinkTitle: 'Link de pagamento',
      cellTerminalTitle: 'Pagar com cartão na maquininha',
      cellManualTitle: 'Manual — registrar um pagamento',
      terminalOff: 'O Heimdall não está configurado',
      stateProcessing: 'Maquininha · aguardando o cartão',
      stateAttention: 'Resultado desconhecido · verifique a maquininha',
      statePaid: 'Pago {{amount}} · {{channel}} · {{date}}',
      statePaidNoDate: 'Pago {{amount}} · {{channel}}',
      stateBookingFailed: 'Não registrado no Zoho Books — veja o Heimdall',
      stateNoLink: 'Nenhum link',
      channelTerminal: 'maquininha',
      channelLink: 'on-line',
      amountLabel: 'Valor',
      manualTitle: 'Registrar um pagamento',
      manualIntroQuote: 'Orçamento {{number}} · sinal recebido no balcão',
      manualIntroInvoice: 'Fatura {{number}} · pagamento recebido no balcão',
      modeLabel: 'Modo',
      modeCard: 'Cartão',
      modeCheque: 'Cheque',
      modeCash: 'Dinheiro',
      referenceLabel: 'Referência',
      referenceRequired: 'Um cheque precisa do número',
      manualHintQuote: 'Cria uma fatura de sinal no orçamento no Zoho Books e registra o pagamento nela.',
      manualHintInvoice: 'Registra o pagamento na fatura no Zoho Books.',
      manualConfirm: 'Registrar',
      manualDone: 'Pagamento registrado',
      amountInvalid: 'Informe um valor inteiro acima de zero',
      terminalTitle: 'Pagar com cartão',
      terminalIntro: '{{number}} · na maquininha do balcão',
      terminalHintQuote: 'Preenchido com o sinal devido; qualquer valor é aceito em um orçamento.',
      terminalHintInvoice: 'Preenchido com o saldo; o Heimdall o limita ao saldo.',
      terminalStart: 'Iniciar a maquininha',
      terminalWaiting: 'Aguardando o cartão na maquininha…',
      terminalWaitingHint: 'Até 3 minutos para a senha.',
      terminalLeave: 'Fechar, eu volto depois',
      terminalPaid: 'Pagamento aceito',
      terminalBookingPending: 'Registrando no Zoho Books…',
      terminalBookingDone: 'Registrado no Zoho Books',
      terminalBookingFailed: 'Não registrado no Zoho Books — veja o Heimdall',
      terminalFailed: 'Recusado',
      terminalFailedHint: 'Nada foi cobrado. Você pode tentar novamente.',
      terminalRetry: 'Tentar novamente',
      terminalAttention: 'Resultado desconhecido',
      terminalAttentionHint: 'A maquininha não respondeu. Verifique o comprovante em papel antes de tentar novamente.',
      linkTitle: 'Link de pagamento',
      linkCreate: 'Criar o link',
      linkCreateAgain: 'Criar um novo link',
      linkCancel: 'Cancelar o link',
      linkCancelConfirm: 'Cancelar este link?',
      linkExpires: 'Expira',
      linkHintInvoice: 'Preenchido com o saldo. O link expira após o período de validade do orçamento.',
      linkPending: 'Criando o link…',
      linkDone: 'Link de pagamento criado',
      linkCancelled: 'Link de pagamento cancelado',
    },
    pastCards_one: '{{count}} cartão anterior',
    pastCards_other: '{{count}} cartões anteriores',
    ...
    taskDescriptionPlaceholder: 'Descrição (opcional)',
    removeTask: 'Remover tarefa',
    serviceScan3D: 'Digitalização',
    serviceModelisation3D: 'Modelagem',
    serviceImpression3D: 'Impressão',
    serviceUsinage: 'Usinagem',
    serviceMainDoeuvre: 'Mão de obra',
    serviceDescriptionRequired: 'Descrição (obrigatória)',
    maindoeuvreDescriptionRequired: 'A mão de obra precisa de uma descrição',
    serviceCost: 'Custo',
    serviceUnitCost: 'Custo unitário',
    discount: 'Desconto',
    serviceTotal: 'Total da linha',
    done: 'Concluído',
    editTask: 'Editar tarefa',
    reorderTask: 'Reordenar tarefa',
    taskFinished: 'Tarefa concluída',
    noSteps: 'Ainda não há etapas — adicione um custo a uma etapa para criá-la',
    importQuote: 'Importar',
    importTitle: 'Importar um orçamento',
    quoteSearchLabel: 'Orçamento',
    ...
    quoteNoServiceLines: 'Este orçamento não tem itens de serviço AITO 3D.',
    quoteAlreadyImported: 'Já importado como projeto nº {{id}}',
    quoteImport: 'Importar',
    quoteSkipped: 'Não importado',
    quoteTotals: 'Projeto {{project}} · orçamento {{quote}}',
    quoteCurrencyMismatch: 'Este orçamento está em {{code}}; o quadro exibe {{configured}}.',
    quoteOpenInZoho: 'Abrir no Zoho Books',
    changeQuote: 'Alterar',
    quoteRowImported: 'Importado → nº {{id}}',
    beforeImport: 'Antes de importar',
    ruleQuoteLines: 'O orçamento tem itens de serviço AITO',
    ruleQuoteFresh: 'Ainda não importado',
    ruleCurrencyOk: 'A moeda corresponde ao quadro',
    ruleImportDescription: 'Descrição preenchida',
    importTaskCount_one: '{{count}} tarefa',
    importTaskCount_other: '{{count}} tarefas',
    printer: 'Impressora',
    material: 'Material',
    weightG: 'Peso (g)',
    ...
    pricingUnavailable: 'Não foi possível carregar os preços da calculadora. Tente novamente.',
    computedPrice: 'Preço da calculadora',
    followCalculator: 'Seguir a calculadora',
    priceManual: 'Manual',
    ...
    printShippingLabel: 'Imprimir etiqueta de envio',
    shippingLabelPrintFailed: 'Não foi possível preparar a etiqueta de envio',
    invoiceStatus: {
      draft: 'Rascunho',
      sent: 'Enviada',
      unpaid: 'Não paga',
    ...
    quotePending: 'Criando orçamento…',
    sync: 'Sincronização',
    ...
    syncBlockedLabel: 'Sincronização bloqueada',
    forceSync: 'Forçar sincronização',
    forceSyncHint: 'Reler o orçamento no Zoho e enviar os custos novamente',
    ...
    stats: {
      ...
      leadTime: 'Do orçamento à entrega',
      median: 'mediana {{days}} d',
      productionTime: 'Da aceitação à entrega',
      daysShort: '{{days}} d',
      activity: 'Atividade por dia',
      rolling7: 'Média de concluídos em 7 dias',
      flow: 'Dias em cada etapa',
      sent: 'Enviados',
      ofAccepted: '{{pct}}% dos aceitos',
      quoted: 'Orçamentos aceitos',
      invoiced: 'Faturado',
      outstanding: 'Em aberto',
      empty: 'Nada aconteceu neste período',
      vsPrevious: 'Período anterior: {{value}}',
      ...
      asOfToday: 'Até hoje',
      ageDays: '{{range}} dias',
      winRate: 'Taxa de aceitação por valor',
      winRateEmpty: 'Ainda não há orçamentos decididos suficientes',
      decisions: '{{count}} decididos',
      stageTime: 'Duração por projeto concluído',
      reworkMoves: 'Movimentos para trás',
      reworkShare: '{{cards}} cartões · {{pct}}% dos cartões movidos',
      overdue: 'Faturas vencidas',
      overdueOldest: 'mais antiga {{days}} d',
      nothingOverdue: 'Nada vencido',
      serviceMix: 'Distribuição por serviço',
      serviceTasks: '{{count}} tarefas',
      clientsNew: 'Clientes novos',
      clientsReturning: 'Clientes recorrentes',
      returningShare: '{{pct}}% da receita vem de clientes recorrentes',
      arrivals: 'Quando os pedidos chegam',
      islands: 'Envios por ilha',
      pickup: 'Retirada',
      declined: 'Recusados',
      acceptanceRate: '{{pct}}% aceitos',
      noDecisions: 'Nenhum orçamento decidido neste período',
      decisionsPerWeek: 'Decisões por semana',
      decisionsPerDay: 'Decisões por dia',
      thisPeriod: 'Este período',
      funnel: 'Do orçamento à entrega',
      clientsHeading: 'Novos e recorrentes',
      timings: 'Quanto tempo leva',
      totals: 'Totais',
      activityWeekly: 'Atividade por semana',
      range: 'de {{from}} a {{to}}',
      screen: {
        overview: 'Visão geral',
      },
      strip: {
        onBoard: '{{amount}} no quadro',
        longest: 'o que espera há mais tempo: <who>{{name}}, {{days}}</who> em {{stage}}',
        oldest: 'mais antigo {{days}} d',
        noQuote: 'ainda sem orçamento',
        dueSoon_one: '{{count}} entrega vence esta semana',
        dueSoon_other: '{{count}} entregas vencem esta semana',
      },
      facts: {
        perDay: '{{count}} por dia',
        waiting15: 'Esperando há 15+ dias',
        lostWith: 'Perdido com orçamentos recusados',
        shippingBilled: 'Envios faturados',
        parcels_one: '{{count}} pacote',
        parcels_other: '{{count}} pacotes',
      ...
      finding: {
        overview: '{{in}}, {{accepted}} e {{done}}.',
        overviewIn_one: '{{count}} projeto chegou',
        overviewIn_other: '{{count}} projetos chegaram',
        overviewAccepted_one: '{{count}} foi aceito',
        overviewAccepted_other: '{{count}} foram aceitos',
        overviewDone_one: '{{count}} foi entregue',
        overviewDone_other: '{{count}} foram entregues',
        overviewPeakWeek: 'A semana mais movimentada foi a de {{date}}.',
        overviewPeakDay: 'O dia mais movimentado foi {{date}}.',
        salesWin: 'Você ganha {{pct}}% dos orçamentos.',
        salesLost_one: '{{count}} orçamento foi perdido, no valor de {{total}}.',
        salesLost_other: '{{count}} orçamentos foram perdidos, somando {{total}}.',
        salesLostBig: 'Os que você perde são os grandes: {{lost}} dos {{decided}} acima de {{min}}, somando {{total}}.',
        salesNone: 'Nenhum orçamento decidido neste período.',
        timeLead: 'Um projeto leva {{days}} do orçamento à entrega.',
        timeSlow: '{{stage}} é a etapa lenta, com {{days}}.',
        timeRework_one: '{{count}} movimento foi para trás.',
        timeRework_other: '{{count}} movimentos foram para trás, em {{cards}}.',
        timeNone: 'Nenhum projeto entregue neste período.',
        moneyTotals: '{{accepted}} aceitos e {{invoiced}} faturados.',
        moneyOut: '{{amount}} ainda em aberto em {{invoices}}.',
        moneyOverdue_one: '{{count}} delas está vencida, há {{days}} dias.',
        moneyOverdue_other: '{{count}} delas estão vencidas, a mais antiga há {{days}} dias.',
        moneyClear: 'Nada em aberto.',
        clients: '{{new}} e {{returning}}.',
        clientsNew_one: '{{count}} cliente novo',
        clientsNew_other: '{{count}} clientes novos',
        clientsReturning_one: '{{count}} recorrente',
        clientsReturning_other: '{{count}} recorrentes',
        clientsPeak: 'Os pedidos costumam chegar em {{day}}, por volta das {{hour}}.',
        clientsParcels_one: '{{count}} pacote foi para as ilhas.',
        clientsParcels_other: '{{count}} pacotes foram para as ilhas.',
        clientsNone: 'Nenhum cliente novo neste período.',
      },
      brief: {
        chase_one: '{{count}} orçamento para cobrar resposta',
        chase_other: '{{count}} orçamentos para cobrar resposta',
        tell_one: '{{count}} cliente para avisar',
        tell_other: '{{count}} clientes para avisar',
        collect: '{{amount}} a receber',
        allClear: 'Nada a cobrar resposta, ninguém para avisar, nada a receber.',
        due_one: '{{count}} entrega vence esta semana.',
        due_other: '{{count}} entregas vencem esta semana.',
        chaseHeading: 'Cobrar resposta',
        tellHeading: 'Avisar',
        collectHeading: 'Receber',
        ready: 'Pronto para retirada',
        late: '{{days}} d de atraso',
    ...
    history: {
      ...
      fromZoho: 'do Zoho Books',
      projectCreated: 'criou o projeto',
      quoteCreated: 'Orçamento criado',
      quoteSent: 'marcou o orçamento como enviado',
      ...
      quoteDeclined: 'recusou o orçamento',
      quoteExpired: 'Orçamento expirado',
      stageChanged: 'moveu o projeto',
      projectTrashed: 'moveu o projeto para a lixeira',
      projectRestored: 'restaurou o projeto',
      taskAdded: 'adicionou uma tarefa',
      taskUpdated: 'editou uma tarefa',
      taskRemoved: 'removeu uma tarefa',
      taskReordered: 'reordenou as tarefas',
      taskStepTicked: 'marcou uma etapa',
      taskStepUnticked: 'desmarcou uma etapa',
      projectUpdated: 'editou o projeto',
      projectUrgentSet: 'Marcado como urgente',
      projectUrgentCleared: 'Urgente removido',
      projectSavSet: 'Marcado como devolução',
      projectSavCleared: 'Devolução removida',
      projectPauseSet: 'Marcado como pausado',
      ...
      paymentTerminalStarted: 'Pagamento por cartão iniciado na maquininha',
      paymentTerminalPaid: 'Pago por cartão na maquininha',
      paymentTerminalFailed: 'Pagamento na maquininha recusado ou cancelado',
      paymentTerminalAttention: 'Resultado da maquininha desconhecido — verifique a maquininha',
      paymentManualRecorded: 'Pagamento registrado',
      paymentManualPartial: 'Fatura de sinal criada, pagamento NÃO registrado — finalize no Zoho Books',
      noteAdded: 'adicionou uma nota',
      zohoComment: 'Comentário no Zoho Books',
      syncQueued: 'Na fila para o Zoho',
      syncPushed: 'Enviado ao Zoho',
      syncFailed: 'Falha ao enviar ao Zoho',
      syncLocked: 'Orçamento bloqueado no Zoho',
      syncConflict: 'Conflito de status com o Zoho',
      syncStatusRejected: 'O Zoho rejeitou a mudança de status',
      pollReconciled: 'Verificado com o Zoho',
    },
    // New-project drawer
    workSection: 'O trabalho',
    clientSectionTitle: 'Cliente',
    workHintNone: 'nenhuma tarefa',
    workHintProgress: '{{done}} de {{total}} completas',
    addService: 'Adicionar {{service}}',
    removeServiceChip: 'Remover {{service}}',
    taskNeedsSubTask: 'adicionar uma subtarefa',
    railSummary: 'Resumo',
    summaryTitle: 'Resumo do projeto',
    summaryWaiting: 'Gerado quando você chega à etapa do cliente.',
    summaryGeneratedBy: 'Gerado por {{model}} — clique para editar',
    summaryEdited: 'Editado à mão — sem regeneração automática',
    summaryFallback: 'IA indisponível — escreva a descrição você mesmo',
    aiFieldHint: 'Ortografia corrigida pela IA',
    aiChecking: 'Corrigindo a ortografia…',
    aiUndo: 'Restaurar meu texto',
    regenerate: 'Regenerar',
    beforeCreate: 'Antes de criar',
    ruleTasksOk_one: '{{count}} tarefa — pelo menos uma obrigatória',
    ruleTasksOk_other: '{{count}} tarefas — pelo menos uma obrigatória',
    ruleNeedTask: 'Um projeto precisa de pelo menos uma tarefa — adicione uma',
    ruleSubTasksOk: 'Toda tarefa tem uma subtarefa precificada',
    ruleSubTaskMissing: '"{{name}}" precisa de pelo menos uma subtarefa precificada',
    ruleSubTasksPending: 'Cada tarefa precisa de pelo menos uma subtarefa precificada',
    ruleClientAccount: 'Conta do cliente — {{name}}',
    ruleClientReachable: 'Cliente contactável — {{contact}}',
    ruleClientContact: 'O cliente precisa de telefone, e-mail ou rede social',
    warnNoEmail: 'Sem e-mail — o orçamento não poderá ser enviado por e-mail',
    warnNoPhone: 'Sem telefone — lembre-se de pedir',
    holdToReset: 'Segure para redefinir o rascunho',
    resetDraft: 'Redefinir rascunho',
    shippingAdd: 'Adicionar envio',
    shippingTitle: 'Envio',
    shippingRemove: 'Remover envio',
    shippingEdit: 'Editar envio',
    shippingIsland: 'Ilha de destino',
    shippingIslandPlaceholder: 'Buscar uma ilha…',
    shippingNoIslands: 'Nenhuma ilha encontrada',
    shippingFirstName: 'Nome do destinatário',
    shippingLastName: 'Sobrenome do destinatário',
    shippingPhone: 'Telefone do destinatário',
    shippingRecipient: 'Destinatário',
    shippingService: 'Serviço de envio',
    shippingRate: 'Tarifa',
    shippingRateFromZoho: 'Tarifa do Zoho: {{rate}}',
    shippingRateEdited: 'editada',
    shippingRateReset: 'Voltar à tarifa do Zoho',
    shippingNoRate: 'Nenhuma tarifa do Zoho — informe uma',
    shippingRateNegative: 'A tarifa não pode ser negativa',
    shippingLta: 'Número LTA',
    shippingLtaPlaceholder: 'Número do conhecimento aéreo…',
    ...
    ruleShippingMissingRecipient: 'Envio: falta o nome do destinatário',
    ruleShippingInvalidPhone: 'Envio: número de telefone inválido',
  },
  // Navigation
  nav: {
    aito: 'Aito',
    ...
    stats: 'Estatísticas',
    profiles: 'Perfis',
    filamentProfiles: 'Perfis de filamento',
    ...
    installAppSuccess: 'Fenrir foi instalado',
  },
  ...
  printers: {
    ...
    maintenance: {
      ...
      editFieldHelp: 'Quando ativado, esta impressora é pausada do MQTT, despacho de fila e notificações — útil para reparos, instalações paralelas do Fenrir ou suspensão temporária.',
    },
    // Chamber light
    ...
    cameraGrid: {
      quality: 'Qualidade',
      qualityGlobalHint: 'aplica-se a todos os usuários',
      auto: 'Auto',
      low: 'Baixa',
      medium: 'Méd',
      high: 'Alta',
      cameraUnavailable: 'Câmera indisponível',
      streamRejected: 'Transmissão rejeitada pelo servidor (HTTP {{status}})',
      connectionLost: 'Conexão perdida',
      reconnecting: 'Reconectando em {{countdown}}s (tentativa {{attempt}})',
      expand: 'Expandir',
    ...
    nozzleWear: 'Desgaste',
    nozzleSlotEmpty: 'Slot {{slot}} — Vazio',
    humidityTooltip: 'Umidade: {{value}}% - {{status}}',
    temperatureTooltip: 'Temperatura: {{value}}°C - {{status}}',
    clickForHistory: 'clique para histórico',
    ...
    clickToDismiss: 'Clique para dispensar',
    aiDetection: {
      safe: 'Seguro',
      warning: 'Aviso',
      failure: 'Falha',
  ...
  archives: {
    ...
    card: {
      ...
      gcode: 'GCODE',
      source: 'SOURCE',
      unverifiedFile: 'Não verificado',
      unverifiedFileTooltip: 'Este arquivo foi associado apenas pelo nome — pode não ser o arquivo que foi realmente impresso.',
      ...
      suggestedPriceTooltip: 'Preço de venda sugerido pela calculadora (sem mão de obra)\nFilamento: {{filament}}\nImpressora: {{printer}}\nCusto unitário {{unitCost}} → ×{{sizeMargin}} margem de tamanho',
      suggestedPriceFloor: 'Preço mínimo por tarefa aplicado',
      suggestedPriceNoFilamentMatch: 'Nenhum perfil da calculadora corresponde a {{material}} — preço calculado com {{filament}}',
  ...
  queue: {
    ...
    batchOrders: {
      ...
      strandedPlate: 'Nada de onde copiar as configurações',
      strandedNotice: 'Não é possível enfileirar {{runs}} das {{owed}} impressões ainda devidas: essa placa não tem mais nenhuma impressão na fila ou concluída de onde copiar as configurações. Enfileire a placa uma vez a partir do arquivo ou cancele o pedido.',
    ...
    cancelBatchConfirmMessage: 'Encerrar este pedido? As impressões ainda na fila são canceladas e ele para de cobrar o que não produziu.',
    batch: {
      defaultName: 'Lote',
      label: '{{count}} item',
    ...
    toast: {
      ...
      keptForOrder: 'Cancelado em vez de removido: é a única impressão de onde o pedido pode reenfileirar esta placa',
      historyKeptForOrders: '{{kept}} mantidas porque pedidos ainda precisam delas.',
  ...
  stats: {
    ...
    filamentCostFromCalculator: 'Calculado a partir dos preços de filamento da calculadora de preços',
    ...
    failuresByFilament: 'Falhas por Filamento',
    failuresByPrinter: 'Falhas por Impressora',
    deltaVsPrevious: 'vs. período anterior de {{days}} dias',
    utilizationBusy: '{{hours}}h ocupada',
    utilizationNoData: 'Nenhuma impressão com dados de tempo neste período',
    costBreakdown: 'Detalhamento de Custos',
    costFilament: 'Filamento',
    costEnergy: 'Energia',
    costMachine: 'Máquina',
    costPerPrintHour: 'Por hora de impressão',
    costPerKg: 'Por kg',
    costCoverage: '{{priced}} de {{total}} impressões precificadas',
    costNoData: 'Nenhuma impressão pôde ser precificada com a configuração atual da calculadora',
    filamentForecast: 'Previsão de Filamento',
    forecastDaysLeft: '≈ {{days}}d restantes',
    forecastNoUsage: 'Sem uso recente',
    forecastNoInventory: 'Nenhum carretel no inventário',
    forecastRemaining: '{{amount}} restante',
    forecastBasis: 'Projetado a partir do uso recente — detalhes na página de Inventário',
    maintenanceReliability: 'Manutenção e Confiabilidade',
    printsSinceMaintenance: '{{prints}} impressões · {{failures}} falharam desde {{date}}',
    neverMaintained: 'Nenhuma manutenção registrada',
    maintenanceDueBadge: '{{n}} vencida(s)',
    maintenanceWarningBadge: '{{n}} em breve',
    maintenanceNoData: 'Nenhuma impressora com controle de manutenção',
    maintenanceSinceCaption: 'As contagens são do período selecionado',
    energyWidgetTitle: 'Consumo de Energia',
    aitoPipeline: 'Pipeline Aito',
    aitoPipelineEmpty: 'Nada no quadro Aito neste período',
    pipelineByStage: 'Por etapa',
    pipelineConversion: 'Conversão de orçamentos',
    pipelineSent: 'Enviados',
    pipelineAccepted: 'Aceitos',
    pipelineDeclined: 'Recusados',
    pipelineAcceptedRate: '{{pct}}% aceitos',
    pipelineStageDays: 'Dias por etapa',
    pipelineInvoicing: 'Faturamento',
    pipelineInvoiced: 'Faturado',
    pipelineOutstanding: 'Em aberto',
    pipelineTracking: 'Acompanhamento do cliente',
    pipelineTrackingViews: 'Aberturas da página',
    pipelineTrackingCards: 'Cartões consultados',
    pipelineTrackingLinks: 'Cartões com link',
    pipelineDays: '{{days}} dias',
    pipelineSample_one: '{{count}} cartão',
    pipelineSample_other: '{{count}} cartões',
    energyTotalLabel: 'Total',
    energyCostLabel: 'Custo',
    energyAvgPerDay: 'Média por dia',
    energyAvgPerPrint: 'Média por impressão',
    energyNoPlugs: 'Nenhuma tomada inteligente com monitoramento de energia configurada',
    energyNoData: 'Nenhum dado de energia registrado neste período',
  ...
  settings: {
    ...
    ldap: {
      ...
      feature3: 'Grupos LDAP são mapeados para grupos Fenrir no login',
      ...
      autoProvisionHint: 'Criar automaticamente uma conta Fenrir no primeiro login LDAP',
      ...
      groupMappingHint: 'Mapear DNs de grupos LDAP para grupos Fenrir. Grupos disponíveis: ',
    ...
    concurrentUploadsDescription: 'Quantas impressoras a fila pode abastecer com arquivos ao mesmo tempo. As impressoras recebem os arquivos lentamente (uma impressão grande pode levar vários minutos) e cada uma espera sua vez — portanto, em um parque maior, aumentar este valor evita que a última impressora de um lote tenha de esperar todas as transferências anteriores. Reduza-o se a sua rede ou o host do Fenrir tiver dificuldade com transferências paralelas.',
    ...
    preheatFilamentTargetsHint: 'Fenrir escolhe o alvo mais alto entre os slots AMS carregados. Uma impressão cujos slots derivam todos 0 — PLA, PETG, TPU, PVA — pula o preaquecimento por completo e começa imediatamente.',
    ...
    dryingNoAutoStop: 'Nunca parar a secagem automaticamente',
    dryingNoAutoStopDescription: 'A secagem automática apenas inicia a secagem — nunca a interrompe. A secagem termina apenas quando o temporizador de secagem do AMS expira ou quando é parada manualmente. Útil quando o filamento está úmido mesmo com a umidade do AMS abaixo do limite. Observação: impressões na fila aguardam o término da secagem, a menos que "Continuar secagem durante a impressão" esteja ativado em hardware compatível — nesse caso as impressões iniciam enquanto a secagem continua.',
    ...
    authDisabledMessage: 'Ative a autenticação para criar contas de usuário, gerenciar permissões e proteger sua instância do Fenrir.',
    ...
    disableAuthenticationMessage: 'Tem certeza de que deseja desativar a autenticação? Isso tornará sua instância do Fenrir acessível sem login. Todos os usuários permanecerão no banco de dados, mas a autenticação será desativada.',
    ...
    captureFinishPhotoDescription: 'Tirar foto da câmera da impressora quando a impressão for concluída. Fenrir grava um timelapse curto durante a impressão para que a foto possa ser obtida do momento antes da mesa descer; o arquivo do timelapse é mantido se você habilitou o timelapse para esta impressão, caso contrário ele é excluído automaticamente após a captura da foto.',
    finishPhotoRestorePlate: 'Elevar a mesa para a foto final',
    finishPhotoRestorePlateDescription: 'A impressora baixa a mesa cerca de 100 mm ao fim de uma impressão, deixando a peça pronta abaixo do enquadramento da câmera. O Fenrir a eleva novamente até logo acima da última camada impressa, tira a foto e depois a baixa de novo. Ignorado quando a altura da impressão é desconhecida ou há outro trabalho na fila.',
    ...
    cameraQualityLow: 'Baixa',
    cameraQualityMedium: 'Média',
    cameraQualityHigh: 'Alta',
    cameraQualityAuto: 'Automático',
    cameraQualityAutoWithResolved: 'Automático ({{resolved}})',
    cameraQualityAutoResolved: 'Selecionado automaticamente: {{resolved}} com base no hardware do servidor.',
    cameraQualityAutoResolvedDual: 'Selecionado automaticamente: {{single}} (visualização individual), {{grid}} (grade de câmeras) com base no hardware do servidor e número de streams.',
    cameraQualityDescription: 'Controla o FPS e a resolução do stream. Qualidade inferior reduz o uso de CPU em configurações com múltiplas câmeras.',
    cameraGpuAccel: 'Aceleração GPU',
    cameraGpuAccelDescription: 'Usar decodificação de vídeo acelerada por hardware para streams de câmera. Reduz o uso de CPU em servidores com GPUs compatíveis.',
    cameraGpuAccelUnavailable: 'Nenhum backend de aceleração GPU detectado neste servidor.',
    cameraGpuAccelBackends: 'Backends disponíveis: {{backends}}',
    cameraEngine: 'Motor de câmera',
    cameraEngineFFmpeg: 'FFmpeg (MJPEG)',
    cameraEngineGo2rtc: 'go2rtc (WebRTC)',
    cameraEngineFFmpegDescription: 'Transcodifica RTSP para MJPEG via FFmpeg. Funciona com todos os navegadores, mas consome mais CPU.',
    cameraEngineGo2rtcDescription: 'Transmite H.264 diretamente ao navegador via WebRTC. Sem transcodificação, menor latência, decodificação por hardware. Câmeras internas (A1/P1) ainda usam FFmpeg.',
    ...
    fenrirSoftware: 'Software Fenrir',
    ...
    updateViaHomeAssistant: 'As atualizações são gerenciadas pelo Supervisor do Home Assistant. Abra Configurações → Complementos → Fenrir no Home Assistant para instalar a nova versão.',
    ...
    externalUrlDescription: 'A URL externa onde o Fenrir está acessível. Usada para imagens de notificação e integrações externas.',
    fenrirUrl: 'URL do Fenrir',
    ...
    mqttDescription: 'Publique eventos do Fenrir para um broker MQTT externo para integração com Node-RED, Home Assistant e outros sistemas de automação.',
    ...
    encryption: {
      ...
      notConfiguredDesc: 'Os segredos TOTP e client_secrets OIDC são armazenados em texto plano. Defina MFA_ENCRYPTION_KEY ou reinicie o Fenrir com um diretório de dados gravável para gerar automaticamente.',
      ...
      migrationErrorWarning: '{{count}} linha(s) antiga(s) não puderam ser recriptografadas na inicialização. Verifique os logs do servidor e reinicie o Fenrir para tentar novamente.',
    },
    ...
    openrouterTitle: 'Resumo de IA (OpenRouter)',
    openrouterApiKey: 'Chave de API OpenRouter',
    openrouterApiKeyHint: 'Somente escrita — deixe em branco para manter a chave atual',
    openrouterModel: 'Modelo',
    openrouterModelHint: 'ID do modelo OpenRouter para resumos de projeto (francês)',
    ...
    aitoFollowupLinkDays: 'Link de pagamento expirando (dias)',
    aitoFollowupLinkDaysDescription: 'Sinaliza orçamentos cujo link de pagamento expira dentro deste número de dias',
  },
  ...
  hmsErrors: {
    ...
    runoutSlotUnknown: 'O filamento acabou e a impressão está pausada. O Fenrir não conseguiu determinar qual slot a impressora agora espera — verifique a tela da impressora para o slot solicitado.',
    actions: {
  ...
  login: {
    ...
    resetStep1: 'Entre em contato com o administrador do Fenrir',
    ...
    twoFA: {
      ...
      instructionsTotp: 'Abra seu aplicativo autenticador e insira o código de 6 dígitos gerado para o Fenrir.',
  ...
  // Setup page
  setup: {
    title: 'Fenrir Configuração',
    subtitle: 'Configure a autenticação para sua instância do Fenrir',
  ...
  users: {
    ...
    subtitle: 'Gerenciar usuários e seu acesso à sua instância do Fenrir',
    backToSettings: 'Voltar para Configurações',
    createUser: 'Criar Usuário',
    noPermission: 'Você não tem permissão para acessar esta página.',
    admin: 'Administrador',
  ...
  profiles: {
    ...
    orcaCloud: {
      ...
      connect: {
        ...
        description: 'Entre na sua conta Orca Cloud para sincronizar seus perfis de slicer no Fenrir.',
      },
      device: {
        title: 'Aprovar o Fenrir no Orca Cloud',
        instruction: 'Abra o Orca Cloud e aprove este código. O Fenrir se conecta automaticamente assim que você aprovar.',
  ...
  filamentProfiles: {
    ...
    import: 'Importar',
    syncZohoPrices: 'Sincronizar preços do Zoho',
    syncingZoho: 'Sincronizando preços do Zoho…',
    syncToPc: 'Sincronizar com o PC',
    ...
    gridSmall: 'Grade pequena',
    gridMedium: 'Grade média',
    gridLarge: 'Grade grande',
    // Grid
    emptyTitle: 'Ainda não há presets',
    emptySubtitle: 'Crie um preset manualmente ou importe de uma pasta.',
    ...
    deleteBody: '{{name}} será excluído permanentemente.',
    cancel: 'Cancelar',
    deleteConfirm: 'Excluir',
    // Sync-base modal
    baseSyncedTitle: 'Perfis base sincronizados',
    baseSyncFailedTitle: 'Falha na sincronização',
    filesScanned: '{{n}} arquivos verificados',
    statNew: 'Novos',
    statUpdated: 'Atualizados',
    statUnchanged: 'Inalterados',
    close: 'Fechar',
    // Sync modal
    syncTitle: 'Sincronizar com o PC',
    syncSubtitle: 'As alterações serão aplicadas à pasta de filamentos do BambuStudio.',
    ...
    // Import
    scanFailed: 'Erro ao ler a pasta do BambuStudio: {{error}}',
    allImported: '{{n}} arquivo(s) encontrado(s) — todos já importados.',
    importing: 'Importando presets… {{current}}/{{total}}',
    imported: '{{n}} preset(s) importado(s)',
    importPartial: '{{ok}} com sucesso, {{failed}} com falha',
    noServerPresets: 'Nenhuma pasta do BambuStudio no servidor — escolha arquivos JSON de perfis (ou um ZIP exportado) para importar.',
    noJsonInSelection: 'Nenhum arquivo JSON de perfil na seleção.',
    noServerBase: 'Nenhum pacote do BambuStudio no servidor — escolha os arquivos JSON de perfis base (ou um ZIP da pasta BBL/filament) para enviar.',
    exportEmpty: 'Nenhum preset com conteúdo JSON para exportar.',
    // Sincronização de preços do Zoho
    syncZohoDone: '{{priced}} precificados, {{unchanged}} inalterados',
    syncZohoAttention: '{{count}} precisam de atenção',
    ...
    // Editor shell
    editorNewTitle: 'Novo preset',
    editorEditTitle: 'Editar preset',
    inheritsNotFound: '(não encontrado)',
    reload: 'Recarregar',
    serverChangedBanner: 'Este perfil foi alterado no servidor enquanto você o editava.',
    serverChangedReload: 'Recarregar do servidor',
    save: 'Salvar',
    create: 'Criar',
    saving: 'Salvando…',
    nameRequiredHint: 'Marca e material são obrigatórios',
    deletePreset: 'Excluir',
    invalidJson: 'JSON inválido',
    tabGeneral: 'Geral',
    tabTemps: 'Temperaturas',
    tabCooling: 'Resfriamento',
    tabExtrusion: 'Extrusão',
    tabRetract: 'Retração',
    tabJson: 'JSON',
    // Editor General
    basePresetLabel: 'Preset base',
    basePresetNone: '— Nenhum (começar em branco) —',
    basePresetMine: 'Meus presets',
    basePresetBase: 'Presets base',
    basePresetLoading: 'Carregando…',
    brand: 'Marca',
    brandSelect: '— Selecionar —',
    material: 'Material',
    colorLabel: 'Rótulo de cor',
    colorPlaceholder: 'Branco, Preto…',
    ...
    extruder: 'Extrusora',
    compatiblePrinters: 'Impressoras compatíveis',
    tagHint: 'Enter para adicionar · Backspace para remover',
    removeTag: 'Remover {{tag}}',
    quickAdd: '+ H2S / H2D / H2C / X2D',
    tagPlaceholder: 'Bambu Lab X1C bico 0,4…',
    notes: 'Notas',
    // Editor Temps
    nozzleSection: 'Bico',
    tempInitial: 'Inicial',
    tempPrint: 'Impressão',
    tempRangeMin: 'Faixa mín.',
    tempRangeMax: 'Faixa máx.',
    materialSection: 'Material',
    glassTg: 'Tg vítrea',
    chamberSection: 'Câmara',
    chamberTemp: 'Câmara',
    bedPlates: 'Placas da mesa',
    plate: 'Placa',
    plateSuperTack: 'SuperTack',
    plateCool: 'Placa fria',
    plateEng: 'Engenharia',
    plateHot: 'Placa quente',
    plateTextured: 'Texturizada',
    printCol: 'Impressão °C',
    initialCol: 'Primeira camada °C',
    // Editor Cooling
    partFan: 'Ventoinha da peça',
    fanMax: 'Velocidade máx.',
    fanMin: 'Velocidade mín.',
    overhangFan: 'Velocidade em balanços',
    noFanLayers: 'Camadas sem ventoinha (peça)',
    noFanAdditional: 'Camadas sem ventoinha (adicional)',
    initialFan: 'Ventoinha da primeira camada',
    minLayerTime: 'Tempo mín. por camada',
    overhangThreshold: 'Limite de balanço',
    preStartFan: 'Ventoinha pré-início',
    additionalFan: 'Ventoinha adicional',
    overhangBridgeFan: 'Ventoinha de balanço/ponte',
    chamberVent: 'Ventilação da câmara',
    duringPrint: 'Durante a impressão',
    endOfPrint: 'Ao final da impressão',
    nil: 'nil',
    off: 'Desligado',
    on: 'Ligado',
    // Editor Extrusion
    flowSection: 'Fluxo',
    flowRatio: 'Taxa de fluxo',
    cal: 'cal',
    calTitle: 'Ajustar a taxa de fluxo em %',
    apply: 'Aplicar',
    maxVolFlow: 'Fluxo vol. máx.',
    primeVolume: 'Volume de purga',
    shrinkage: 'Encolhimento',
    layerSlowdown: 'Desaceleração de camada',
    minTimePerLayer: 'Tempo mín. por camada',
    minSpeed: 'Velocidade mín.',
    gcodeSection: 'G-code',
    ...
    length: 'Comprimento',
    speed: 'Velocidade',
    deretractSpeed: 'Velocidade de retorno da retração',
    zHop: 'Salto em Z',
    zHopType: 'Tipo de salto em Z',
    zHopNormal: 'Elevação normal',
    zHopSlope: 'Elevação em rampa',
    zHopSpiral: 'Elevação em espiral',
    wipeDistance: 'Distância de limpeza',
    retractBeforeWipe: 'Retração antes da limpeza',
    options: 'Opções',
    retractOnLayerChange: 'Retrair ao mudar de camada',
    wipeOnRetract: 'Limpar ao retrair',
    // Editor JSON
    jsonCaption: 'Edição direta — as outras abas são atualizadas automaticamente',
  },
  ...
  fileManager: {
    ...
    alreadyInLibrary: 'Já está na biblioteca',
    duplicateIn: 'em {{folder}}',
    duplicatesWillBeSkipped: '{{count}} arquivo(s) duplicado(s) detectado(s) — serão ignorados',
    uploadAnyway: 'Enviar mesmo assim',
    skipDuplicate: 'Ignorar',
    skippedDuplicate: 'Ignorado (já está na biblioteca)',
    ...
    tags: {
      ...
      creating: 'Criando…',
      hintSelect: '↵ para selecionar',
      hintDeselect: '↵ para desmarcar',
      hintCreate: '↵ para criar',
    ...
    fileHistory: {
      ...
      viewHistoryAria: 'Ver histórico de impressão',
      noPermission: 'Você não tem permissão para ver o histórico do arquivo',
      loadFailed: 'Falha ao carregar o histórico do arquivo',
      statusPending: 'Na fila',
      addedToLibrary: 'Adicionado à biblioteca',
      bySomeone: 'por {{name}}',
      noPrintsYet: 'Este arquivo ainda não foi impresso.',
      externalUnavailable: 'O histórico de impressão não está disponível para arquivos externos.',
      openArchive: 'Abrir arquivo de impressão',
      viewSource: 'Abrir página de origem',
      stats: {
        prints: 'Impressões',
        success: 'Sucesso',
        filament: 'Filamento',
    ...
    toast: {
      ...
      moveSkipped: '{{moved}} movidos, {{skipped}} ignorados: {{reasons}}',
      moveSkipReason: {
        not_owner: 'não é o proprietário',
        source_readonly: 'origem é somente leitura',
        source_missing: 'arquivo não existe mais no disco',
        target_readonly: 'destino é somente leitura',
        target_misconfigured: 'pasta de destino mal configurada',
        target_inaccessible: 'pasta de destino inacessível',
        target_unwritable: 'sem permissão de escrita na pasta de destino',
        invalid_filename: 'nome de arquivo inseguro',
        name_collision: 'conflito de nome',
  ...
  sponsors: {
    ...
    tagline: 'O Fenrir é gratuito e continua assim porque há quem escolha apoiá-lo. Sem VC, sem dependência de nuvem.',
    viewSupporters: 'Ver apoiadores',
    toastPrints: 'Você concluiu {{count}} impressões com o Fenrir. O Fenrir continua gratuito graças a quem o apoia.',
    toastCost: 'Você acompanhou {{total}} de filamento com o Fenrir. Veja quem mantém o projeto independente.',
    toastArchives: '{{count}} impressões arquivadas com o Fenrir. Veja quem o mantém independente.',
    toastAnniversary: 'Um ano com o Fenrir! Veja quem mantém o projeto independente.',
    toastVersionUpdate: 'Atualizado para v{{version}}. O Fenrir continua gratuito graças a quem o apoia.',
    toastBusiness: 'Você usa o Fenrir em {{count}} impressoras? Existe um plano de suporte para equipes: correções prioritárias, emissão de nota fiscal e contato direto com o mantenedor.',
  ...
  inventory: {
    ...
    spoolmanMixedContentBody: 'O Fenrir é servido via HTTPS (pelo seu reverse proxy), mas a URL do Spoolman ainda é HTTP. Os navegadores bloqueiam conteúdo misto por segurança, então a interface embutida do Spoolman não consegue carregar. O Spoolman também precisa estar acessível via HTTPS.',
    spoolmanMixedContentFixReverseProxy: 'Coloque o Spoolman atrás do mesmo reverse proxy do Fenrir (Traefik / Nginx / Caddy) com HTTPS e atualize a URL do Spoolman em Configurações com o novo endereço HTTPS.',
  ...
  // Integração com o Zoho Books (aba de configurações)
  zoho: {
    title: 'Zoho Books',
    subtitle: 'Conecte o Zoho Books para atribuir projetos do Aito a clientes e sincronizar faturas.',
    clientId: 'ID do cliente',
    clientSecret: 'Segredo do cliente',
    refreshToken: 'Token de atualização',
    organizationId: 'ID da organização',
    baseUrl: 'URL base da API',
    accountsUrl: 'URL de contas',
    defaultContactId: 'ID do cliente padrão',
    defaultContactName: 'Nome do cliente padrão',
    defaultContactHint: 'Pré-selecionado na janela de novo projeto do Aito. O telefone e o e-mail nunca são gravados nesse contato.',
    secretSaved: 'Valor salvo — deixe em branco para manter',
    save: 'Salvar',
    saved: 'Configurações do Zoho salvas',
    test: 'Testar conexão',
    testOk: 'Conectado ao Zoho Books',
    testUnreachable: 'Configurado, mas o Zoho Books está inacessível',
    testNotConfigured: 'O Zoho Books não está configurado',
  },

  heimdall: {
    title: 'Pagamentos Heimdall',
    subtitle: 'Cria um link de pagamento online para cada orçamento do Aito pela ponte de PDV Heimdall. Um link pago aceita o orçamento automaticamente.',
    baseUrl: 'URL do Heimdall',
    token: 'Token de API',
    tokenHint: 'Somente escrita — deixe em branco para manter o token atual',
    depositPct: 'Sinal (%)',
    depositPctDescription: '0 cobra o orçamento inteiro; caso contrário, o link cobre essa parte.',
    validityDays: 'Validade do orçamento (dias)',
    validityDaysDescription: 'Data de expiração escrita em cada novo orçamento; o link de pagamento termina no mesmo dia.',
    save: 'Salvar',
    saved: 'Configurações do Heimdall salvas',
    test: 'Testar a conexão',
    testOk: 'Conectado ao Heimdall',
    testUnauthorized: 'O Heimdall recusou o token',
    testForbidden: 'A chave não tem a permissão payments:read ou payments:write',
    testUnreachable: 'O Heimdall está inacessível',
    testNotConfigured: 'O Heimdall não está configurado',
    offNotice: 'Os links de pagamento estão desativados: nenhum orçamento recebe um link até que a URL e o token sejam salvos.',
    paymentModesTitle: 'Modos de pagamento do Zoho',
    paymentModesHint: 'Nomes que o Zoho Books usa para um pagamento registrado a partir de uma ficha de projeto.',
  ...
  backup: {
    ...
    repoIsPublicWarning: 'O repositório está PÚBLICO. Os backups do Fenrir incluem credenciais MQTT, tokens do Home Assistant, tokens do Prometheus, seu e-mail do Bambu Cloud e os códigos de acesso das impressoras via K-profiles. Salvar está bloqueado até que você torne o repositório privado nas configurações do seu provedor.',
    repoVisibilityUnknown: 'Não foi possível determinar a visibilidade do repositório. O Fenrir se recusa a fazer backup em qualquer destino não confirmado como privado; salvar será bloqueado.',
    ...
    appSettingsDescription: 'Configuração do Fenrir (banco de dados completo)',
    ...
    restoreFromGit: {
      ...
      reloadHint: 'Recarregue o Fenrir para que os dados restaurados apareçam em todos os lugares.',
      ...
      notes: {
        ...
        settingsMqttRelayFailed: 'Configurações MQTT restauradas, mas o relay não pôde ser reconectado - reinicie o Fenrir',
    ...
    localBackupDescription: 'Crie um backup completo dos seus dados do Fenrir incluindo banco de dados, arquivos, uploads e todos os ficheiros.',
    ...
    backupRestoredRestart: 'Backup restaurado. Por favor, reinicie o Fenrir.',
    ...
    pathCheck: {
      title: 'O Fenrir não consegue gravar neste diretório',
      howToFix: 'Como corrigir:',
      sandboxed: 'O serviço do Fenrir não consegue gravar em {{path}}. Sua unit do systemd roda com ProtectSystem=strict, o que torna todo diretório fora dos diretórios de instalação, dados e logs somente leitura para o serviço - mesmo um em que você consegue gravar pelo seu próprio shell.',
      read_only: '{{path}} está em um sistema de arquivos somente leitura.',
      permission_denied: 'O Fenrir não tem permissão para gravar em {{path}}. Verifique o dono e as permissões do diretório.',
      ...
      error: 'O Fenrir não consegue gravar em {{path}}.',
      ephemeralTitle: 'Estes backups não sobrevivem à recriação do contêiner',
      container_ephemeral: '{{path}} está dentro do contêiner do Fenrir, não no host. Backups gravados ali são perdidos quando o contêiner é recriado. Monte o diretório do host:',
    },
  ...
  kProfiles: {
    ...
    modal: {
      ...
      notesHelp: 'As notas são salvas no Fenrir, não na impressora',
  ...
  virtualPrinter: {
    ...
    enable: {
      ...
      visibleInSlicer: 'Visível como "Fenrir" na descoberta do slicer',
    ...
    remoteInterface: {
      ...
      hint: 'Substitua o endereço IP anunciado via SSDP e usado no certificado TLS. Útil quando o Fenrir possui várias interfaces de rede.',
    },
    mode: {
      title: 'Modo',
      archive: 'Arquivar',
    ...
    caCert: {
      ...
      description: 'As impressoras virtuais usam um certificado TLS assinado pela CA do Fenrir. Importe este certificado CA para o armazenamento de confiança do seu slicer uma única vez para que ele aceite a conexão — sem precisar copiá-lo pela linha de comando.',
      copy: 'Copiar',
      copied: 'Copiado',
      download: 'Baixar',
      fingerprint: 'SHA-256',
  ...
  locationHaSensors: {
    ...
    autoAdd: {
      ...
      confirmMessage: 'O Fenrir também encontrou outros sensores para este local. Escolha quais adicionar também.',
    ...
    options: {
      ...
      pollIntervalHint: 'Com que frequência o Fenrir consulta o Home Assistant e atualiza os valores dos sensores na tela. Mínimo de 60 segundos.',
  ...
  notifications: {
    ...
    aitoPaymentReceivedLabel: 'Pagamento do Aito recebido',
    aitoPaymentReceivedDescription: 'Notificar quando um orçamento do Aito for pago online ou por um sinal suficiente',
  ...
  time: {
    ...
    today: 'Hoje',
    yesterday: 'Ontem',
    daysElapsed_one: 'Há {{count}} dia',
    daysElapsed_other: 'Há {{count}} dias',
    monthsElapsed_one: 'Há {{count}} mês',
    monthsElapsed_other: 'Há {{count}} meses',
    yearsElapsed_one: 'Há {{count}} ano',
    yearsElapsed_other: 'Há {{count}} anos',
  },
  ...
  spoolbuddy: {
    ...
    settings: {
      ...
      hostname: 'Host',
      uptime: 'Tempo de atividade',
      systemConfig: 'Backend e Auth',
      backendUrl: 'URL do backend Fenrir',
      apiToken: 'Token API',
      apiTokenPlaceholder: 'Inserir token API',
      ...
      testReadTag: 'Ler tag',
      systemFieldsRequired: 'A URL do backend é obrigatória.',
      // Display tab
      brightness: 'Brilho',
      saved: 'Salvo',
  ...
  diagnostic: {
    ...
    check: {
      ...
      external_storage: {
        ...
        warn_internal_storage: 'A opção está ligada e há armazenamento presente, mas a última impressão ainda assim foi para o armazenamento interno da impressora, que o Fenrir não consegue ler. Na série H2, na P2S e na X2D o botão «Imprimir» do Bambu Studio sempre envia para lá, independentemente desta opção. As impressões são arquivadas com nome e tempos, mas sem miniatura nem metadados do fatiador. Para arquivos completos, inicie as impressões pelo Fenrir ou fatie no OrcaSlicer, ou então no Bambu Studio use «Enviar» com «Externo» e inicie a impressão depois.',
        warn_internal_history: 'A opção está ligada e há armazenamento, mas a última impressão saiu de um arquivo que já estava na impressora: uma reimpressão pela tela dela, um início pelo Handy ou um arquivo enviado antes. Essa biblioteca fica no armazenamento interno, que o Fenrir não consegue ler, e nenhuma opção muda isso, porque nada foi enviado para essa impressão. Ela continua arquivada com nome e tempos, mas sem miniatura nem metadados do fatiador. Para arquivos completos, inicie as impressões pelo Fenrir ou envie-as pelo fatiador.',
      },
      port_rtsps: {
      ...
      macos_local_network: {
        ...
        pass: 'O macOS está permitindo que o Fenrir alcance a rede local.',
        warn_unsigned: 'O Python que executa o Fenrir não tem assinatura de código, então o macOS não tem a que vincular a permissão de rede local e descarta silenciosamente todas as conexões com a impressora — sem erro e sem solicitação. Execute o atualizador do Fenrir (install/update_macos.sh), que faz a assinatura, e reinicie o Fenrir. Interpretador: {{executable}}',
        warn_permission: 'Se a impressora estiver ligada e acessível neste endereço, abra Ajustes do Sistema > Privacidade e Segurança > Rede Local e verifique se o Python do Fenrir está ativado. Caso contrário, o macOS descarta conexões locais em silêncio, e atualizar o Python pode deixar a permissão antiga para trás.',
      },
      network_mode: {
        title: 'Modo de rede do contêiner',
        genericRuntime: 'um contêiner',
        pass: 'Executando em {{runtime}} com rede host.',
        warn: 'O Fenrir está sendo executado em {{runtime}} com rede bridge. A descoberta de impressoras e a impressora virtual precisam da rede host — recrie o contêiner com rede host ("network_mode: host" no docker-compose, "--network=host" no Podman).',
        skip: 'Não está sendo executado em um contêiner — não aplicável.',
        skip_unknown: 'O Fenrir está sendo executado em {{runtime}}, mas não foi possível determinar o modo de rede. Se a descoberta de impressoras ou a impressora virtual não funcionarem, recrie o contêiner com rede host.',
        skip_system_container: 'O Fenrir está sendo executado em um contêiner de sistema {{runtime}}, que fica na LAN como uma máquina virtual — não aplicável.',
      },
      subnet: {
        title: 'Sub-rede',
        pass: 'A impressora e o Fenrir estão na mesma sub-rede.',
        warn: 'A impressora ({{printer_ip}}) e o Fenrir ({{host_ip}}) estão em sub-redes diferentes. Eles podem não se alcançar, a menos que o roteamento entre as sub-redes esteja configurado.',
        skip: 'Não foi possível determinar a sub-rede — ignorado.',
      },
      mqtt_auth: {
        title: 'Credenciais da impressora',
        pass: 'A impressora aceitou a conexão.',
        fail: 'A impressora está acessível mas o Fenrir não está conectado a ela. O código de acesso ou o número de série provavelmente está incorreto — o código de acesso muda toda vez que o modo Somente LAN ou o Modo Desenvolvedor é alternado, então copie-o novamente da tela da impressora. Uma impressora reiniciando, ou que já atingiu seu limite de conexões simultâneas, aparece do mesmo jeito.',
        fail_auth_rejected: 'A impressora recusou as credenciais do Fenrir. O código de acesso ou o número de série está incorreto — o código de acesso muda toda vez que o modo Somente LAN ou o Modo Desenvolvedor é alternado. Copie-o novamente da tela da impressora e salve-o nas configurações da impressora.',
  ...
  systemHealth: {
    ...
    signature: {
      'ftp-auth-rejected': {
        ...
        fix: 'Copie novamente o código de acesso da tela da impressora (configurações de LAN) e atualize-o nas configurações da impressora no Fenrir.',
      },
      'ftp-connection-timeout': {
        name: 'Tempo limite da conexão de transferência de arquivos',
        cause: 'O Fenrir não conseguiu acessar a porta de transferência de arquivos da impressora (FTPS 990). A porta está bloqueada, ou a impressora está desligada ou em outra sub-rede.',
        fix: 'Verifique se nada bloqueia a porta 990 entre o Fenrir e a impressora e se ambos estão na mesma rede.',
      },
      'ftp-ssl-error': {
      ...
      'database-locked': {
        ...
        fix: 'Migre o Fenrir para um banco de dados PostgreSQL externo. Consulte o guia do PostgreSQL na documentação.',
      },
    },
  },
  ...
  vpDiagnostic: {
    ...
    check: {
      ...
      running: {
        ...
        fail: 'A impressora virtual está habilitada, mas seus serviços não estão em execução. Verifique o log do Fenrir — geralmente um conflito de IP de vínculo ou um erro de permissão os interrompe.',
      },
      bind_interface: {
      ...
      certificate: {
        ...
        pass: 'Certificado pronto. Verifique se o certificado CA do Fenrir (acima) está importado no armazenamento de confiança do seu slicer.',
        fail: 'O certificado TLS desta impressora virtual está ausente. Verifique se o diretório de dados do Fenrir tem permissão de escrita.',
      },
    },
  },
  ...
  failureDetection: {
    ...
    externalUrlHint: 'A API ML busca a captura da câmera por URL. Defina a URL externa nas configurações gerais para que o contêiner da API ML possa alcançar o Fenrir.',
  ...
  makerworld: {
    title: 'MakerWorld',
    description: 'Cole uma URL de modelo do MakerWorld para importar e imprimir diretamente do Fenrir — sem precisar abrir o app Bambu Handy.',
    ...
    signInExpiredTitle: 'Sessão do Bambu Cloud expirada',
    signInExpiredBody: 'Você continua conectado ao Fenrir, mas a Bambu Lab deixou de aceitar o token armazenado, então os downloads vão falhar. Entre novamente no Bambu Cloud.',
    ...
    disclaimer: 'A integração com o MakerWorld usa endpoints de API documentados pela comunidade. Fenrir não é afiliado nem endossado pelo MakerWorld ou pela Bambu Lab.',
  ...
  libraryPurge: {
    ...
    effect4: 'Arquivos em pastas externas (vinculadas) são ignorados — Fenrir nunca exclui bytes que não possui.',    previewLoading: 'Verificando quantos arquivos correspondem…',
  ...
  calculator: {
    ...
    material: 'Material',
    title: 'Calculadora',
    subtitle: 'Estime custos e preços de venda das suas impressões 3D',
    easyMode: 'Modo simples',
    reset: 'Redefinir',
    resetConfirmTitle: 'Redefinir campos',
    resetConfirmMessage: 'Redefinir todos os campos da calculadora para os padrões? Filamentos, impressoras e padrões são mantidos.',
    informations: 'Informações',
    weight: 'Peso da peça',
    printingTime: 'Tempo de impressão (h)',
    printingTimeLabel: 'Tempo de impressão',
    durationDays: 'Dias',
    durationDaysShort: 'd',
    durationHours: 'Horas',
    ...
    emptyInputsTitle: 'Informe o peso e o tempo de impressão',
    emptyInputsMessage: 'Preencha o peso do objeto e o tempo de impressão para ver um preço sugerido e o detalhamento dos custos.',
    targetPrice: 'Preço-alvo',
    targetPriceLabel: 'Preço-alvo (impostos incl.)',
    targetPriceProfit: 'Margem líquida',
    measuredEnergy: 'Energia medida: {{kwh}} kWh (do arquivo)',
    measuredEnergyClear: 'Limpar energia medida',
    qtyIncrease: 'Aumentar quantidade',
    qtyDecrease: 'Diminuir quantidade',
    fixErrors: 'Algumas entradas são inválidas — corrija os campos destacados; valores inválidos são ignorados nos resultados.',
    breakEvenDiscount: 'Desconto de equilíbrio: {{pct}} — descontos maiores vendem abaixo do custo.',
    ...
    summaryCopyFailed: 'Falha ao copiar — o acesso à área de transferência foi bloqueado',
    easyAssumptions: 'Com base nas taxas salvas — revisar padrões',
    quantity: 'Quantidade',
    filament: 'Filamento',
    printer: 'Impressora',
    difficulty: 'Fator de dificuldade (%)',
    difficultyTooltip: 'Multiplicador para impressões difíceis: filamento abrasivo, alto risco de falha, manuseio delicado. 100% = sem acréscimo.',
    labor: 'Mão de obra',
    modeling: 'Modelagem',
    workingHours: 'Horas de trabalho',
    basePrice: 'Preço base',
    preparation: 'Preparação',
    modelPreparation: 'Preparação do modelo',
    slicing: 'Fatiamento',
    transferStart: 'Transferência e início',
    postProcessing: 'Pós-processamento',
    jobRemoval: 'Remoção da peça',
    supportRemoval: 'Remoção de suportes',
    additionalWork: 'Trabalho adicional',
    fulfillment: 'Envio',
    stuff: 'Suprimentos diversos',
    amount: 'Valor',
    markupPct: 'Acréscimo',
    totals: 'Totais',
    machineCost: 'Custo de máquina',
    machineCostSafety: 'Custo de máquina com segurança',
    ...
    realityCheck: {
      ...
      subtitle: 'Medido a partir das suas impressões, configurações e inventário.',
      failure: 'Taxa de falhas',
    ...
    timeCorrection: {
      ...
      hintScoped: '{{scope}} atinge em média {{pct}}% das estimativas do fatiador',
      apply: 'Aplicar tempo corrigido',
      dismiss: 'Dispensar',
    },
    waterfall: {
      tax: 'Impostos',
      aria: 'Composição do preço, dos custos ao preço final',
    },
    quote: {
      open: 'Abrir orçamento para impressão',
      back: 'Voltar à calculadora',
      print: 'Imprimir',
      title: 'Orçamento',
      empty: 'Ainda não há trabalho para orçar — preencha a calculadora primeiro.',
      jobDetails: 'Detalhes do trabalho',
      footnote: 'Preços com impostos incluídos. Orçamento sujeito à disponibilidade de material.',
    },
    marge: 'Margem',
    marginPct: 'Margem em %',
    marginGlobal: 'Margem global',
    marginFilament: 'Margem de filamento',
    marginStuff: 'Margem de suprimentos',
    perUnit: 'por unidade',
    forQuantity: 'Total para {{count}} unidades',
    breakdown: 'Detalhamento de custos',
    costSplit: 'Distribuição dos custos',
    costFilament: 'Filamento',
    costDepreciation: 'Depreciação da impressora',
    costEnergy: 'Energia',
    costConsumables: 'Consumíveis e embalagem',
    costBaseFee: 'Taxa base',
    costRepairs: 'Reparos',
    costPrototype: 'Protótipo',
    costFailures: 'Falhas',
    costAds: 'Publicidade',
    costModeling: 'Modelagem',
    costPreparation: 'Preparação',
    costPostProcessing: 'Pós-processamento',
    costStuff: 'Suprimentos',
    groupMachine: 'Máquina',
    groupProvisions: 'Provisões',
    groupOther: 'Outros',
    groupLabor: 'Mão de obra',
    splitPrinter: 'Impressora',
    splitAdsConsumables: 'Publicidade e consumíveis',
    discountTitle: 'Cálculo de descontos',
    discountMachine: 'Custo de máquina com desconto',
    discountSafety: 'Com segurança e desconto',
    discountPrice: 'Preço com desconto',
    discountAmount: 'Valor do desconto',
    potentialProfit: 'Lucro potencial',
    bulkQuantity: 'Qtd.',
    emptyTitle: 'Configure sua calculadora',
    emptyMessage: 'Adicione pelo menos um filamento e uma impressora para começar a calcular preços.',
    ...
    name: 'Nome',
    costPerKg: 'Custo por kg ({{currency}})',
    printingCostPerKg: 'Custo de impressão por kg ({{currency}})',
    marginOverCost: 'Margem sobre o custo (%)',
    zohoProductSearch: 'Produto do Zoho',
    zohoProductSearchPlaceholder: 'Buscar filamentos no Zoho…',
    zohoNoDealerPrice: 'Sem preço de revendedor',
    zohoNoResults: 'Nenhum filamento do Zoho encontrado',
    zohoSearchError: 'Não foi possível conectar ao Zoho',
    zohoLinkedProduct: 'Vinculado a {{name}}',
    zohoUnlink: 'Desvincular',
    zohoWeightInferred: 'Peso do carretel não informado no nome do Zoho; assumido 1 kg',
    spoolWeightKg: 'Peso do carretel (kg)',
    syncZohoPrices: 'Sincronizar preços',
    syncProgress: '{{done}} / {{total}}',
    syncSummary:
      '{{updated}} atualizados · {{unchanged}} sem alteração · {{skipped}} sem preço de revendedor · {{missing}} não encontrados no Zoho · {{unpriced}} sem preço (peso desconhecido)',
    syncFailed: 'Sincronização interrompida: {{error}}',
    syncTimedOut: 'A sincronização expirou; alguns blocos podem ter sido aplicados mesmo assim',
    zohoDuplicateWarning: 'Já existe um filamento para {{name}}',
    addFilament: 'Adicionar filamento',
    editFilament: 'Editar filamento',
    deleteFilamentTitle: 'Excluir filamento',
    deleteFilamentMessage: 'Excluir "{{name}}"? Esta ação não pode ser desfeita.',
    filamentCreated: 'Filamento adicionado',
    filamentUpdated: 'Filamento atualizado',
    filamentDeleted: 'Filamento excluído',
    purchasePrice: 'Preço de compra ({{currency}})',
    lifetimeYears: 'Vida útil (anos)',
    dailyUsage: 'Uso diário (h)',
    powerWatts: 'Potência (W)',
    repairRate: 'Reparos durante a vida útil (%)',
    lifetimeHours: 'Horas de vida',
    depreciationPerHour: 'Depreciação / h',
    repairsPerHour: 'Reparos / h',
    addPrinter: 'Adicionar impressora',
    editPrinter: 'Editar impressora',
    deletePrinterTitle: 'Excluir impressora',
    deletePrinterMessage: 'Excluir "{{name}}"? Esta ação não pode ser desfeita.',
    printerCreated: 'Impressora adicionada',
    printerUpdated: 'Impressora atualizada',
    printerDeleted: 'Impressora excluída',
    inUse: 'Selecionado na página da calculadora',
    electricityTariff: 'Tarifa de energia ({{currency}}/kWh)',
    laborRate: 'Taxa horária ({{currency}}/h)',
    consumablesFlat: 'Consumíveis e embalagem ({{currency}})',
    baseFee: 'Taxa base ({{currency}})',
    marginCurveHint: 'Duas curvas definem a margem global: uma margem de tamanho que diminui quanto mais a peça custa, e um desconto por quantidade que reduz a margem (nunca o custo) conforme a quantidade aumenta.',
    sizeMarginGroup: 'Margem de tamanho',
    qtyDiscountGroup: 'Desconto por quantidade',
    floorGroup: 'Mínimo',
    marginMinMult: 'Multiplicador em peças muito grandes (M_MIN)',
    marginMaxMult: 'Multiplicador em peças muito pequenas (M_MAX)',
    marginK: 'Custo unitário intermediário (K, {{currency}})',
    qtyMinFactor: 'Margem mantida em alta quantidade (Q_MIN)',
    qtyK: 'Quantidade intermediária (KQ)',
    minTaskPrice: 'Preço mínimo por tarefa ({{currency}})',
    marginCurveMaxBelowMin: 'M_MAX deve ser pelo menos M_MIN',
    marginCurvePreviewSize: 'Margem de tamanho por custo unitário',
    marginCurvePreviewQty: 'Fator de quantidade por quantidade',
    exampleTitle: 'Trabalho de exemplo',
    exampleUnitCost: 'Custo unitário de exemplo ({{currency}})',
    exampleQuantity: 'Quantidade de exemplo',
    exampleReadout: '×{{size}} margem de tamanho · ×{{qty}} fator de quantidade → ×{{total}} sobre o custo',
    dragK: 'Arraste para definir K',
    dragKQ: 'Arraste para definir KQ',
    ...
    formulaAt: 'Em {{x}} → {{y}}',
    warnFlatSize: 'A curva de tamanho está plana: cada peça recebe ×{{m}}.',
    warnKFar: 'K está bem acima do custo do seu exemplo; a curva quase não se curva onde estão seus trabalhos.',
    warnKNear: 'K está bem abaixo do custo do seu exemplo; todo trabalho fica perto de M_MIN.',
    warnNoQtyDiscount: 'Sem desconto por quantidade: Q_MIN é 1.',
    warnFloorDominates: 'O preço mínimo excede o preço do seu exemplo; as curvas nunca se aplicam abaixo dele.',
    kHint: 'Custo unitário mediano das suas últimas {{count}} impressões: {{median}}',
    kHintUse: 'Usar',
    exampleFromCalculator: 'Pré-preenchido a partir do último trabalho da calculadora',
    multiplier: '×{{value}}',
    multiplierDetail: 'tamanho ×{{size}} · qtd {{qty}}',
    floorApplied: 'Preço mínimo aplicado',
    curveTitle: 'Preço por quantidade',
    curveHint: 'Preço unitário (com impostos) em cada quantidade — custos únicos se amortizam e o desconto por quantidade reduz a margem.',
    curveUnitPrice: 'Preço unitário',
    curveTaskPrice: 'Total da tarefa',
    curveQtyFactor: 'Fator de quantidade',
    curveCurrent: 'atual',
    failureRate: 'Taxa de falhas (%)',
    prototypeRate: 'Taxa de protótipo (%)',
    adsRate: 'Taxa de publicidade (%)',
    filamentMarkup: 'Acréscimo de filamento (%)',
    taxPct: 'Imposto TGC (%)',
    defaultDifficulty: 'Dificuldade padrão (%)',
    defaultMargin: 'Margem padrão sobre o custo (%)',
    filamentSettings: 'Configurações de filamento',
    filamentSettingsHint: 'Valores iniciais para novos perfis de filamento.',
    stuffMarkup: 'Acréscimo de suprimentos (%)',
    ratesTitle: 'Tarifas',
    ratesHint: 'O que um trabalho custa para você — ajuste estes valores aos seus preços e moeda locais antes de orçar.',
    provisionsTitle: 'Provisões e despesas gerais',
    provisionsHint: 'Percentuais somados ao custo para cobrir impressões com falha, protótipos, publicidade e o acréscimo de revenda de filamento e extras.',
    unsavedChanges_one: '{{count}} alteração não salva',
    unsavedChanges_other: '{{count}} alterações não salvas',
    fixFields: 'Corrija os campos destacados para salvar.',
    discardChanges: 'Descartar',
    tabSettings: 'Configurações',
    marginCurvesTitle: 'Curvas de margem',
