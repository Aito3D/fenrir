export default {
  ...
  aito: {
    ...
    track: {
      ...
      paymentMethods: {
        referenceKnown: 'Please quote quote number {{ref}} as the reference of your payment.',
        referenceUnknown: 'Please quote your quote number as the reference of your payment.',
        ...
        tag: 'Beneficiary (tag)',
        shop: 'At the shop',
        shopSub: 'Bank card or cash.',
        copy: 'Copy',
        copied: 'Copied',
        copyIban: 'Copy the IBAN',
        copyTag: 'Copy the {{app}} tag',
        question: 'Reply to our message with any question.',
      },
      stages: {
        devis: 'Quote',
        waiting: 'Approval',
