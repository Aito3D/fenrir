  ...
  diagnostic: {
    ...
    check: {
      ...
      external_storage: {
        ...
        warn_internal_storage: 'The option is on and storage is present, but the last print still went to the printer\'s internal storage, which Fenrir cannot read. On H2-series and P2S, Bambu Studio\'s Print button always sends there whatever this option is set to. Prints archive with their name and timing, but without a thumbnail or slicer metadata. For complete archives, start prints from Fenrir or slice in OrcaSlicer — or in Bambu Studio use Send with External selected, then start the print.',
