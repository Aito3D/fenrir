export default {
  ...
  aito: {
    ...
    stats: {
      caption: '{{active}} in production · {{done}} completed overall',
      added: 'Added',
      accepted: 'Accepted',
      completed: 'Completed',
      perDay: 'Added per day',
      ...
      lost: 'Lost: {{count}} · {{total}}',
      quoteAge: 'Quotes awaiting a decision',
      ageDays: '{{range}} days',
      ...
      pickup: 'Pickup',
      decisionsHeading: 'Quotes accepted vs declined',
      declined: 'Declined',
      ...
      brief: {
        ...
        dueNone: 'Nothing is due this week.',
        finished_one: '{{count}} project finished in this period.',
        finished_other: '{{count}} projects finished in this period.',
        more: '{{count}} more than the period before.',
        fewer: '{{count}} fewer than the period before.',
        lead: 'Quote to delivery: {{days}}.',
        chaseHeading: 'Chase',
        tellHeading: 'Tell',
        collectHeading: 'Collect',
        chaseEmpty: 'Every quote has an answer.',
        tellEmpty: 'Every client has been told.',
        collectEmpty: 'Every invoice is paid.',
        ready: 'Ready for pickup',
        late: '{{days}} d late',
        andMore: 'and {{count}} more',
      },
      teaser: {
        sales: '{{pct}}% accepted · {{lost}} lost for {{total}}',
        time: '{{lead}} quote to delivery · {{moves}} backward moves',
        money: '{{accepted}} accepted · {{outstanding}} outstanding · {{service}} is {{pct}}% of revenue',
        moneyPlain: '{{accepted}} accepted · {{outstanding}} outstanding',
        clients: '{{new}} new · {{returning}} returning',
      },
    },
