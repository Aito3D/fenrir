export default {
  ...
  calculator: {
    ...
    printingTimeMin: 'Printing time (min)',
    ...
    tabPricing: 'Pricing',
    pricingHint: 'Everything a quote is built from. Changes apply to new quotes as soon as you save.',
    ratesTitle: 'Rates',
