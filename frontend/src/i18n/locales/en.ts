export default {
  ...
  aito: {
    ...
    descriptionPlaceholder: 'Describe the product to design and print…',
    ...
    sendInvoiceTitle: 'Send invoice by email',
    sendInvoiceRecipient: 'Recipient',
    sendInvoiceSubject: 'Subject',
    sendInvoiceMessage: 'Message preview',
    sendInvoiceConfirm: 'Send',
    sendInvoiceNoRecipients: 'This client has no email address in Zoho.',
    sendInvoiceLoadFailed: 'Could not load the email details',
    emailPreviewTitle: 'Email preview',
    invoiceEmailed: 'Invoice sent to {{email}}',
    invoiceEmailFailed: 'Could not send the invoice',
    createInvoice: 'Create invoice',
    createInvoiceTitle: 'Create the invoice',
    createInvoiceIntro_one: 'Quote {{quote}}, {{count}} line. A draft invoice is created in Zoho Books — nothing is emailed.',
    createInvoiceIntro_other: 'Quote {{quote}}, {{count}} lines. A draft invoice is created in Zoho Books — nothing is emailed.',
    createInvoiceAmount: 'Invoice total',
    createInvoiceRemaining: 'Left to pay',
    createInvoiceLockWarning: 'Once invoiced, this quote no longer accepts line changes from Fenrir.',
    createInvoiceConfirm: 'Create',
    createInvoiceLoadFailed: 'Could not prepare the invoice',
    createInvoiceDone: 'Invoice {{number}} created',
    createInvoiceDonePaid: 'Invoice {{number}} created and settled by the deposits',
    createInvoiceDonePartial: 'Invoice {{number}} created — {{retainers}} could not be applied',
    createInvoiceFailed: 'Could not create the invoice',
    acceptQuote: 'Accept quote',
    declineQuote: 'Decline quote',
    holdToConfirm: 'Hold 0.5s to confirm',
    quoteSent: 'Quote marked as sent',
    quoteAccepted: 'Quote accepted',
    quoteDeclined: 'Quote declined',
    quoteUnaccepted: 'Acceptance removed — quote is back in Waiting',
    unacceptLabel: 'Remove acceptance',
    unacceptHint: 'Hold 1s to remove acceptance',
    quoteConflictAccepted: 'This quote was already accepted by someone else.',
    quoteConflictDeclined: 'This quote was already declined by someone else.',
    zohoNotUpdated: 'Saved locally — Zoho was not updated',
    ...
    deleteFailed: 'Could not delete this project',
    client: 'Client',
    noClient: 'No client',
    urgent: 'Urgent',
    markUrgent: 'Mark urgent',
    clearUrgent: 'Clear urgent',
    holdToMarkUrgent: 'Hold 0.5s to mark urgent',
    holdToClearUrgent: 'Hold 0.5s to clear urgent',
    sav: 'Returned',
    markSav: 'Mark returned',
    clearSav: 'Clear returned',
    holdToMarkSav: 'Hold 0.5s to mark returned',
    holdToClearSav: 'Hold 0.5s to clear returned',
    pause: 'Paused',
    markPause: 'Mark paused',
    clearPause: 'Clear paused',
    holdToMarkPause: 'Hold 0.5s to mark paused',
    holdToClearPause: 'Hold 0.5s to clear paused',
    markFlag: 'Mark',
    flagFailed: 'Could not change the flag',
    dueDate: 'Promised date',
    dueDateClear: 'Clear the date',
    dueDateEmpty: 'Set a date',
    dueLateDays: '{{count}} d late',
    dueBadge: 'Due {{date}}',
    dueDateFailed: 'Could not change the date',
    datePickerPrev: 'Previous month',
    datePickerNext: 'Next month',
    datePickerBackToSelected: 'Back to the selected month',
    datePickerPlusTwoDays: '+2 days',
    datePickerPlusOneWeek: '+1 week',
    datePickerPlusTwoWeeks: '+2 weeks',
    datePickerSuggested: 'suggested',
    awaitingContact: 'To contact',
    markContacted: 'Mark client as contacted',
    holdToMarkContacted: 'Hold 0.5s to confirm the client was contacted',
    contacted: 'Contacted',
    clearContacted: 'Undo contacted',
    holdToClearContacted: 'Hold 0.5s to undo contacted',
    contactedFailed: 'Could not record the contact',
    smsPickupShort: 'SMS',
    smsPickup: 'Send a pickup SMS',
    smsTitle: 'Pickup SMS',
    smsMessageLabel: 'Message',
    smsGenerating: 'Drafting the message…',
    smsGenerateFailed: 'Could not draft the message',
    smsRegenerate: 'Regenerate',
    ...
    zohoNotConfigured: 'Zoho Books isn’t connected yet.',
    zohoConfigureLink: 'Connect Zoho Books',
    zohoUnreachable: 'Could not reach Zoho Books. Please try again.',
    ...
    socialLabel: 'Social network (optional)',
    socialHandleLabel: 'Username',
    socialHandlePlaceholder: 'username',
    socialRemove: 'Remove the social network',
    contactsLabel: 'Contacts',
    contactsHint: 'Who is this project for?',
    contactsLoading: 'Reading contacts from Zoho Books…',
    contactsUnavailable: 'Could not read the contacts from Zoho Books — enter a phone or an email below.',
    contactPrimary: 'primary',
    contactAdd: 'Add contact',
    contactAddTitle: 'New contact',
    contactSaveToZoho: 'Save to Zoho',
    contactFirstNameRequired: 'Enter a first name.',
    contactNeedsPhoneOrEmail: 'A phone number or an email is needed to reach them.',
    contactAddFailed: 'Could not add the contact. Please try again.',
    contactOverrideToggle: 'Use a different phone / email for this card',
    contactOverrideHint: 'Stays on this card — the contact in Zoho Books is not changed.',
    contactGone: 'This contact person no longer exists in Zoho Books — pick another.',
    clientEditFanOutPerson: 'Applies to every open card for this contact person',
    clientEditTitle: 'Contact details',
    clientEditSourceZoho: 'Zoho Books',
    clientEditSourceCard: 'This card only',
    clientEditFanOut: 'Applies to every open card of this client',
    ...
    clientHistoryNoQuote: 'no quote',
    clientHistoryThisCard: 'This card · {{stage}}',
    clientHistoryDeclined: 'Declined',
    clientHistoryOpenCard: 'Open project #{{id}}',
    clientHistoryEmpty: 'No projects for this client yet.',
    clientHistoryError: 'Could not load the client’s history.',
    clientEditLoading: 'Reading the contact from Zoho Books…',
    clientEditWalkIn: 'Walk-in client: the change stays on this card and is not sent to Zoho Books.',
    clientEditZohoReadFailed: 'Could not read the contact from Zoho Books — showing the card’s values.',
    clientEditFailed: 'Could not update the client. Please try again.',
    ...
    newClientPersonHint: 'Or a person’s first and last name',
    newClientContactTag: 'Contact person at the company',
    newClientContactHint: 'recommended — a first name is enough',
    newClientPreviewCompany: 'Company: {{name}} · contact: {{person}}',
    newClientPreviewCompanyAlone: 'Company: {{name}} · no contact person yet',
    newClientPreviewIndividual: 'Individual: {{name}}',
    ...
    duplicateReplaceTitle: "Replace the draft in progress?",
    duplicateReplaceBody: "The new-project drawer already holds work that has not been created yet. Duplicating this card replaces it.",
    duplicateReplaceConfirm: "Replace",
    ...
    editConflict: 'Someone else edited this project — the board was refreshed, please retry.',
    tasks: 'Tasks',
    addTask: 'Add task',
    taskFallbackName: 'Task {{n}}',
    track: {
      pageTitle: 'Order tracking · Aito 3D',
      title: 'Track your order',
      reference: 'Quote no. {{ref}}',
      stepOf: 'Step {{n}} of {{total}}',
      stepsAria: 'Steps',
      showSteps: 'See the steps',
      hideSteps: 'Hide the steps',
      stepsList: 'Step details',
      tasksHeading: 'Your parts',
      showAllParts: 'See all {{n}} parts',
      eta: 'Estimated availability',
      etaSoon: 'We will give you a date as soon as possible.',
      etaUpdating: 'Estimate being updated',
      updated: 'Updated {{when}}',
      updatedToday: 'today at {{time}}',
      updatedYesterday: 'yesterday at {{time}}',
      updatedOn: 'on {{date}} at {{time}}',
      error: 'The tracking page cannot be loaded right now.',
      retry: 'Try again',
      invalidTitle: 'This tracking link is no longer valid',
      invalidBody: 'It may have expired or been replaced. Contact us and we will send you a new link.',
      footerQuestion: 'A question about your order?',
      enterTitle: 'Track my order',
      enterHint: 'Enter the 6-character code from your quote or our message.',
      codeLabel: 'Tracking code',
      codeChecking: 'Checking…',
      retrying: 'Trying again…',
      codeFound: 'Code recognised, opening your tracking page.',
      codeNotFound: 'Code not found. Check it and try again.',
      codeTooMany: 'Too many attempts. Please wait a minute.',
      codeError: 'The code cannot be checked right now. Press Enter to try again.',
      ...
      paymentMethods: {
        ...
        referenceUnknown: 'Your quote number',
        transferDelay: 'A transfer can take a day or two to reach us.',
        appTag: '{{app}} tag',
        appMessage: 'Message',
        appHint: 'From the {{app}} app, send the quote amount to this tag.',
        shop: 'In shop',
        shopSub: 'Bank card, cash or cheque.',
        shopAddress: 'Address',
      ...
      status: {
        devisTitle: 'Quote in preparation',
        ...
        pickedUpTitle: 'Collected',
        pickedUpSub: 'On {{date}}. Thank you for your trust!',
        doneTitle: 'Completed',
        doneSub: 'Thank you for your trust!',
      },
      invoice: {
        paidTitle: 'Invoice paid',
        paidSub: 'Thank you for your trust.',
        unpaidTitle: 'Invoice to pay',
        unpaidSub: 'To be paid before collection or shipping.',
        overdueTitle: 'Invoice overdue',
        overdueSub: 'Contact us if you have already paid.',
      },
      payment: {
        unpaidTitle: 'Project not paid yet',
        unpaidSub: 'Pay online, or by transfer or in the shop.',
        unpaidDepositSub: 'A deposit secures your order — pay online, or by transfer or in the shop.',
        validateTitle: 'Approve your quote',
        validateSub: 'Paying online counts as accepting the quote.',
        validateDepositSub: 'A deposit approves your quote and starts production.',
        pay: 'Pay online',
        paidTitle: 'Payment received',
        depositPaidTitle: 'Deposit received',
        paidSub: 'Thank you for your trust.',
      },
    },
    trackingCopy: 'Copy tracking link',
    trackingOpen: 'Open tracking link',
    ...
    paymentLink: {
      ...
      retry: 'Retry',
      state: { expired: 'Expired', cancelled: 'Cancelled', failed: 'Refused' },
    },
    payment: {
      dueQuote: 'Deposit due',
      dueInvoice: 'Balance due',
      cellLink: 'Link',
      cellTerminal: 'Terminal',
      cellManual: 'Manual',
      cellLinkTitle: 'Payment link',
      cellTerminalTitle: 'Pay by card on the terminal',
      cellManualTitle: 'Manual — record a payment',
      terminalOff: 'Heimdall is not configured',
      stateProcessing: 'Terminal · waiting for the card',
      stateAttention: 'Unknown result · check the terminal',
      statePaid: 'Paid {{amount}} · {{channel}} · {{date}}',
      statePaidNoDate: 'Paid {{amount}} · {{channel}}',
      stateBookingFailed: 'Not recorded in Zoho Books — see Heimdall',
      stateNoLink: 'No link',
      channelTerminal: 'terminal',
      channelLink: 'online',
      amountLabel: 'Amount',
      manualTitle: 'Record a payment',
      manualIntroQuote: 'Quote {{number}} · deposit received at the counter',
      manualIntroInvoice: 'Invoice {{number}} · payment received at the counter',
      modeLabel: 'Mode',
      modeCard: 'Card',
      modeCheque: 'Cheque',
      modeCash: 'Cash',
      referenceLabel: 'Reference',
      referenceRequired: 'A cheque needs its number',
      manualHintQuote: 'Creates a retainer invoice on the quote in Zoho Books and records the payment on it.',
      manualHintInvoice: 'Records the payment against the invoice in Zoho Books.',
      manualConfirm: 'Record',
      manualDone: 'Payment recorded',
      amountInvalid: 'Enter a whole amount above zero',
      terminalTitle: 'Pay by card',
      terminalIntro: '{{number}} · on the counter terminal',
      terminalHintQuote: 'Prefilled with the deposit due; any amount is accepted on a quote.',
      terminalHintInvoice: 'Prefilled with the balance; Heimdall caps it at the balance.',
      terminalStart: 'Start the terminal',
      terminalWaiting: 'Waiting for the card on the terminal…',
      terminalWaitingHint: 'Up to 3 minutes for the PIN.',
      terminalLeave: 'Close, I will come back',
      terminalPaid: 'Payment accepted',
      terminalBookingPending: 'Recording in Zoho Books…',
      terminalBookingDone: 'Recorded in Zoho Books',
      terminalBookingFailed: 'Not recorded in Zoho Books — see Heimdall',
      terminalFailed: 'Declined',
      terminalFailedHint: 'Nothing was charged. You can try again.',
      terminalRetry: 'Try again',
      terminalAttention: 'Unknown result',
      terminalAttentionHint: 'The terminal did not answer. Check the paper receipt before trying again.',
      linkTitle: 'Payment link',
      linkCreate: 'Create the link',
      linkCreateAgain: 'Create a new link',
      linkCancel: 'Cancel the link',
      linkCancelConfirm: 'Cancel this link?',
      linkExpires: 'Expires',
      linkHintInvoice: 'Prefilled with the balance. The link expires after the quote validity period.',
      linkPending: 'Link being created…',
      linkDone: 'Payment link created',
      linkCancelled: 'Payment link cancelled',
    },
    pastCards_one: '{{count}} past card',
    pastCards_other: '{{count}} past cards',
    reuseTasks: 'Reuse',
    rating: {
      good: 'Good',
      medium: 'Medium',
      ...
      pastDue_one: '{{count}} past due',
      pastDue_other: '{{count}} past due',
    ...
    serviceScan3D: 'Scan',
    serviceModelisation3D: 'Modeling',
    serviceImpression3D: 'Printing',
    serviceUsinage: 'Machining',
    serviceMainDoeuvre: 'Labour',
    serviceDescriptionRequired: 'Description (required)',
    maindoeuvreDescriptionRequired: 'Labour needs a description',
    serviceCost: 'Cost',
    ...
    importQuote: 'Import',
    importTitle: 'Import a quote',
    quoteSearchLabel: 'Quote',
    quoteNumberLabel: 'Number',
    ...
    quoteNoServiceLines: 'This quote has no AITO 3D service lines.',
    quoteAlreadyImported: 'Already imported as project #{{id}}',
    quoteImport: 'Import',
    quoteSkipped: 'Not imported',
    quoteTotals: 'Project {{project}} · quote {{quote}}',
    quoteCurrencyMismatch: 'This quote is in {{code}}; the board shows {{configured}}.',
    quoteOpenInZoho: 'Open in Zoho Books',
    changeQuote: 'Change',
    // The list row's chip — short, unlike quoteAlreadyImported's full sentence.
    quoteRowImported: 'Imported → #{{id}}',
    beforeImport: 'Before you import',
    ruleQuoteLines: 'Quote has AITO service lines',
    ruleQuoteFresh: 'Not imported before',
    ruleCurrencyOk: 'Currency matches the board',
    ruleImportDescription: 'Description filled in',
    importTaskCount_one: '{{count}} task',
    importTaskCount_other: '{{count}} tasks',
    printer: 'Printer',
    material: 'Material',
    weightG: 'Weight (g)',
    ...
    followCalculator: 'Follow calculator',
    priceManual: 'Manual',
    priceLinked: 'Calculator',
    perPart: 'per part',
    ...
    retrySync: 'Retry',
    syncBlockedLabel: 'Sync blocked',
    forceSync: 'Force sync',
    forceSyncHint: 'Re-check the quote in Zoho and push the costs again',
    showDone: 'Show done',
    ...
    stats: {
      ...
      accepted: 'Accepted',
      completed: 'Completed',
      leadTime: 'Quote to delivery',
      median: 'median {{days}} d',
      productionTime: 'Acceptance to delivery',
      daysShort: '{{days}} d',
      activity: 'Activity per day',
      rolling7: '7-day average of completed',
      flow: 'Days spent in each stage',
      sent: 'Sent',
      ofAccepted: '{{pct}}% of accepted',
      quoted: 'Accepted quotes',
      invoiced: 'Invoiced',
      ...
      ageDays: '{{range}} days',
      winRate: 'Win rate by ticket size',
      winRateEmpty: 'Not enough decided quotes yet',
      decisions: '{{count}} decided',
      stageTime: 'Time per completed project',
      reworkMoves: 'Backward moves',
      reworkShare: '{{cards}} cards · {{pct}}% of cards that moved',
      overdue: 'Overdue invoices',
      overdueOldest: 'oldest {{days}} d',
      nothingOverdue: 'Nothing overdue',
      serviceMix: 'Service mix',
      serviceTasks: '{{count}} tasks',
      clientsNew: 'New clients',
      clientsReturning: 'Returning clients',
      returningShare: '{{pct}}% of revenue from returning clients',
      arrivals: 'When requests arrive',
      islands: 'Shipping by island',
      pickup: 'Pickup',
      declined: 'Declined',
      ...
      strip: {
        onBoard: '{{amount}} on the board',
        longest: 'the one waiting longest: <who>{{name}}, {{days}}</who> in {{stage}}',
        oldest: 'oldest {{days}} d',
        noQuote: 'no quote yet',
        dueSoon_one: '{{count}} delivery due this week',
        dueSoon_other: '{{count}} deliveries due this week',
      },
      facts: {
        perDay: '{{count}} a day',
        waiting15: 'Waiting 15+ days',
        lostWith: 'Lost with declined quotes',
        shippingBilled: 'Shipping billed',
        parcels_one: '{{count}} parcel',
        parcels_other: '{{count}} parcels',
      ...
      finding: {
        overview: '{{in}}, {{accepted}} and {{done}}.',
        overviewIn_one: '{{count}} project came in',
        overviewIn_other: '{{count}} projects came in',
        overviewAccepted_one: '{{count}} was accepted',
        overviewAccepted_other: '{{count}} were accepted',
        overviewDone_one: '{{count}} was delivered',
        overviewDone_other: '{{count}} were delivered',
        overviewPeakWeek: 'The busiest week was the week of {{date}}.',
        overviewPeakDay: 'The busiest day was {{date}}.',
        salesWin: 'You win {{pct}} % of quotes.',
        salesLost_one: '{{count}} quote was lost, worth {{total}}.',
        salesLost_other: '{{count}} quotes were lost, worth {{total}} together.',
        salesLostBig: 'The ones you lose are the big ones: {{lost}} of the {{decided}} above {{min}}, worth {{total}} together.',
        salesNone: 'No quotes were decided in this period.',
        timeLead: 'A project takes {{days}} from quote to delivery.',
        timeSlow: '{{stage}} is the slow stage at {{days}}.',
        timeRework_one: '{{count}} move went backwards.',
        timeRework_other: '{{count}} moves went backwards on {{cards}}.',
        timeNone: 'No project was delivered in this period.',
        moneyTotals: '{{accepted}} accepted and {{invoiced}} invoiced.',
        moneyOut: '{{amount}} is still out on {{invoices}}.',
        moneyOverdue_one: '{{count}} of them is overdue, by {{days}} days.',
        moneyOverdue_other: '{{count}} of them are overdue, the oldest by {{days}} days.',
        moneyClear: 'Nothing is outstanding.',
        clients: '{{new}} and {{returning}}.',
        clientsNew_one: '{{count}} new client',
        clientsNew_other: '{{count}} new clients',
        clientsReturning_one: '{{count}} returning',
        clientsReturning_other: '{{count}} returning',
        clientsPeak: 'Requests land on {{day}} around {{hour}}.',
        clientsParcels_one: '{{count}} parcel went to the islands.',
        clientsParcels_other: '{{count}} parcels went to the islands.',
        clientsNone: 'No new clients in this period.',
      },
      brief: {
        chase_one: '{{count}} quote to chase',
        chase_other: '{{count}} quotes to chase',
        tell_one: '{{count}} client to tell',
        tell_other: '{{count}} clients to tell',
        collect: '{{amount}} to collect',
        allClear: 'Nothing to chase, no one to tell, nothing to collect.',
        due_one: '{{count}} delivery is due this week.',
        due_other: '{{count}} deliveries are due this week.',
        chaseHeading: 'Chase',
        tellHeading: 'Tell',
        collectHeading: 'Collect',
    ...
    history: {
      ...
      depthStory: 'Story',
      depthDetail: 'Detail',
      depthEverything: 'Everything',
      notePlaceholder: 'Add a note…',
      noteSubmit: 'Add note',
      noteFailed: 'Could not save the note',
      changeCount: '{{count}} changes',
      automatic: 'automatic',
      fromZoho: 'from Zoho Books',
      projectCreated: 'created the project',
      quoteCreated: 'Quote created',
      quoteSent: 'marked the quote as sent',
      ...
      quoteDeclined: 'declined the quote',
      quoteExpired: 'Quote expired',
      stageChanged: 'moved the project',
      projectTrashed: 'moved the project to the trash',
      projectRestored: 'restored the project',
      ...
      projectUrgentSet: 'Marked urgent',
      projectUrgentCleared: 'Urgent cleared',
      projectSavSet: 'Marked returned',
      projectSavCleared: 'Returned cleared',
      projectPauseSet: 'Marked paused',
      ...
      paymentTerminalStarted: 'Card payment started on the terminal',
      paymentTerminalPaid: 'Paid by card on the terminal',
      paymentTerminalFailed: 'Terminal payment declined or cancelled',
      paymentTerminalAttention: 'Terminal result unknown — check the terminal',
      paymentManualRecorded: 'Payment recorded',
      paymentManualPartial: 'Deposit invoice raised, payment NOT recorded — finish it in Zoho Books',
      noteAdded: 'added a note',
      zohoComment: 'Comment in Zoho Books',
      syncQueued: 'Queued for Zoho',
      syncPushed: 'Pushed to Zoho',
      syncFailed: 'Push to Zoho failed',
      syncLocked: 'Quote locked in Zoho',
      syncConflict: 'Status conflict with Zoho',
      syncStatusRejected: 'Zoho rejected the status change',
      pollReconciled: 'Checked against Zoho',
    },
    // New-project drawer
    ...
    aiFieldHint: 'Spelling corrected by AI',
    aiChecking: 'Checking spelling…',
    aiUndo: 'Restore my text',
    ...
    ruleClientContact: 'Client needs a phone, an email or a social network',
    ...
    shippingAdd: 'Add shipping',
    shippingTitle: 'Shipping',
    shippingRemove: 'Remove shipping',
    shippingEdit: 'Edit shipping',
    shippingIsland: 'Destination island',
    shippingIslandPlaceholder: 'Search an island…',
    shippingNoIslands: 'No island found',
    ...
    shippingRate: 'Rate',
    shippingRateFromZoho: 'Zoho rate: {{rate}}',
    ...
    shippingLta: 'LTA number',
    shippingLtaPlaceholder: 'Air waybill number…',
    ...
    ruleShippingMissingIsland: 'Shipping: island missing',
    ruleShippingMissingRecipient: 'Shipping: recipient name missing',
    ruleShippingInvalidPhone: 'Shipping: invalid phone number',
  },
  // Navigation
  nav: {
    aito: 'Aito',
    ...
    installAppSuccess: 'Fenrir was installed',
  },
  ...
  printers: {
    ...
    maintenance: {
      ...
      editFieldHelp: 'When on, this printer is paused from MQTT, queue dispatch and notifications — useful for repair, parallel Fenrir installs, or temporary suspension.',
    },
    // Chamber light
    ...
    cameraGrid: {
      quality: 'Quality',
      qualityGlobalHint: 'applies to all viewers',
      auto: 'Auto',
      low: 'Low',
      medium: 'Med',
      high: 'High',
    ...
    nozzleWear: 'Wear',
    nozzleSlotEmpty: 'Slot {{slot}} — Empty',
    humidityTooltip: 'Humidity: {{value}}% - {{status}}',
    temperatureTooltip: 'Temperature: {{value}}°C - {{status}}',
    clickForHistory: 'click for history',
  ...
  archives: {
    ...
    no3mfBanner: {
      ...
      body: 'The slicer didn\'t leave the .gcode.3mf on the printer\'s SD card, so Fenrir couldn\'t pull the thumbnail or slicer metadata. This is usually because "Store sent files on external storage" is off in the slicer (Bambu Studio / OrcaSlicer Device tab).',
    ...
    card: {
      ...
      gcode: 'GCODE',
      source: 'SOURCE',
      unverifiedFile: 'Unverified',
      unverifiedFileTooltip: 'This file was matched by name only — it may not be the exact file that was printed.',
  ...
  stats: {
    ...
    failuresByFilament: 'Failures by Filament',
    failuresByPrinter: 'Failures by Printer',
    deltaVsPrevious: 'vs. previous {{days}}-day period',
    utilizationBusy: '{{hours}}h busy',
    utilizationNoData: 'No prints with timing data in this period',
    costBreakdown: 'Cost Breakdown',
    costFilament: 'Filament',
    costEnergy: 'Energy',
    costMachine: 'Machine',
    costPerPrintHour: 'Per print hour',
    costPerKg: 'Per kg',
    costCoverage: '{{priced}} of {{total}} prints priced',
    costNoData: 'No prints could be priced with the current calculator setup',
    filamentForecast: 'Filament Forecast',
    forecastDaysLeft: '≈ {{days}}d left',
    forecastNoUsage: 'No recent usage',
    forecastNoInventory: 'No spools in inventory',
    forecastRemaining: '{{amount}} remaining',
    forecastBasis: 'Projected from recent usage — details on the Inventory page',
    maintenanceReliability: 'Maintenance & Reliability',
    printsSinceMaintenance: '{{prints}} prints · {{failures}} failed since {{date}}',
    neverMaintained: 'No maintenance recorded',
    maintenanceDueBadge: '{{n}} due',
    maintenanceWarningBadge: '{{n}} soon',
    maintenanceNoData: 'No printers with maintenance tracking',
    maintenanceSinceCaption: 'Counts are within the selected timeframe',
    energyWidgetTitle: 'Energy Consumption',
    aitoPipeline: 'Aito pipeline',
    aitoPipelineEmpty: 'Nothing on the Aito board in this period',
    pipelineByStage: 'By stage',
    pipelineConversion: 'Quote conversion',
    pipelineSent: 'Sent',
    pipelineAccepted: 'Accepted',
    pipelineDeclined: 'Declined',
    pipelineAcceptedRate: '{{pct}}% accepted',
    pipelineStageDays: 'Days per stage',
    pipelineInvoicing: 'Invoicing',
    pipelineInvoiced: 'Invoiced',
    pipelineOutstanding: 'Outstanding',
    pipelineTracking: 'Client tracking',
    pipelineTrackingViews: 'Page opens',
    pipelineTrackingCards: 'Cards viewed',
    pipelineTrackingLinks: 'Cards with a link',
    pipelineDays: '{{days}} d',
    pipelineSample_one: '{{count}} card',
    pipelineSample_other: '{{count}} cards',
    energyTotalLabel: 'Total',
    energyCostLabel: 'Cost',
    energyAvgPerDay: 'Avg per day',
    energyAvgPerPrint: 'Avg per print',
    energyNoPlugs: 'No smart plugs with energy monitoring configured',
    energyNoData: 'No energy data recorded for this period',
  ...
  settings: {
    ...
    ldap: {
      ...
      feature3: 'LDAP groups are mapped to Fenrir groups on login',
      ...
      autoProvisionHint: 'Automatically create a Fenrir account on first LDAP login',
      ...
      groupMappingHint: 'Map LDAP group DNs to Fenrir groups. Available groups: ',
    ...
    preheatFilamentTargetsHint: 'Fenrir picks the highest target across the loaded AMS slots. A print whose slots all derive 0 — PLA, PETG, TPU, PVA — skips preheat entirely and starts immediately.',
    ...
    authDisabledMessage: 'Enable authentication to create user accounts, manage permissions, and secure your Fenrir instance.',
    ...
    disableAuthenticationMessage: 'Are you sure you want to disable authentication? This will make your Fenrir instance accessible without login. All users will remain in the database but authentication will be disabled.',
    disableAuthentication: 'Disable Authentication',
    // Additional settings
    configureFenrir: 'Configure Fenrir',
    ...
    captureFinishPhotoDescription: 'Take a photo from printer camera when print completes. Fenrir records a brief timelapse during the print so the photo can be sourced from the moment before the bed drops; the timelapse file is kept if you enabled timelapse for this print, otherwise it is deleted automatically after the photo is captured.',
    finishPhotoRestorePlate: 'Restore plate for finish photo',
    finishPhotoRestorePlateDescription: 'The printer drops the build plate about 100 mm when a print ends, leaving the finished print below the camera\'s framing. Fenrir raises it back to just above the last printed layer, takes the photo, then lowers it again. Skipped when the print height is unknown or another job is queued.',
    ...
    cameraGpuAccelUnavailable: 'No GPU acceleration backends detected on this server.',
    cameraGpuAccelBackends: 'Available backends: {{backends}}',
    cameraEngine: 'Camera Engine',
    cameraEngineFFmpeg: 'FFmpeg (MJPEG)',
    cameraEngineGo2rtc: 'go2rtc (WebRTC)',
    cameraEngineFFmpegDescription: 'Transcodes RTSP to MJPEG via FFmpeg. Works with all browsers but uses more CPU.',
    cameraEngineGo2rtcDescription: 'Relays H.264 directly to browser via WebRTC. Zero transcoding, lower latency, hardware-decoded. Chamber cameras (A1/P1) still use FFmpeg.',
    ...
    updateViaHomeAssistant: 'Updates are managed by the Home Assistant Supervisor. Open Settings → Add-ons → Fenrir in Home Assistant to install the new version.',
    ...
    externalUrlDescription: 'The external URL where Fenrir is accessible. Used for notification images and external integrations.',
    ...
    mqttDescription: 'Publish Fenrir events to an external MQTT broker for integration with Node-RED, Home Assistant, and other automation systems.',
    ...
    encryption: {
      ...
      notConfiguredDesc: 'TOTP secrets and OIDC client_secrets are stored in plaintext. Set MFA_ENCRYPTION_KEY or restart Fenrir with a writable data directory to auto-generate one.',
      ...
      migrationErrorWarning: '{{count}} legacy row(s) failed to re-encrypt at startup. Check server logs and restart Fenrir to retry.',
    },
  ...
  hmsErrors: {
    ...
    runoutSlotUnknown: 'Filament ran out and the print is paused. Fenrir could not determine which slot the printer now expects — check the printer screen for the requested slot.',
    actions: {
  ...
  login: {
    ...
    resetStep1: 'Contact your Fenrir administrator',
    ...
    twoFA: {
      ...
      instructionsTotp: 'Open your authenticator app and enter the 6-digit code for Fenrir.',
  ...
  setup: {
    title: 'Fenrir Setup',
    subtitle: 'Configure authentication for your Fenrir instance',
  ...
  users: {
    ...
    subtitle: 'Manage users and their access to your Fenrir instance',
    backToSettings: 'Back to Settings',
    createUser: 'Create User',
    noPermission: 'You do not have permission to access this page.',
    admin: 'Admin',
  ...
  profiles: {
    ...
    orcaCloud: {
      ...
      connect: {
        ...
        description: 'Sign in to your Orca Cloud account to sync your slicer profiles into Fenrir.',
      },
      device: {
        title: 'Approve Fenrir in Orca Cloud',
        instruction: 'Open Orca Cloud and approve this code. Fenrir connects automatically once you approve.',
    ...
    login: {
      ...
      captchaBody: 'Bambu is challenging your network before it will accept a sign-in, and the challenge cannot be answered from Fenrir. Your email and password are not the problem. The block is tied to your public IP address and normally clears by itself within a few hours — retrying repeatedly makes it last longer. To sign in now, use an access token from a browser session instead.',
  ...
  filamentProfiles: {
    ...
    import: 'Import',
    syncZohoPrices: 'Sync prices from Zoho',
    syncingZoho: 'Syncing prices from Zoho…',
    syncToPc: 'Sync to PC',
    ...
    // Sync-base modal
    baseSyncedTitle: 'Base profiles synced',
    baseSyncFailedTitle: 'Sync failed',
    ...
    close: 'Close',
    // Sync modal
    syncTitle: 'Sync to PC',
    syncSubtitle: 'Changes will be applied to the BambuStudio filament folder.',
    statRemoved: 'Removed',
    ...
    // Import
    scanFailed: 'Error reading BambuStudio folder: {{error}}',
    allImported: '{{n}} file(s) found — all already imported.',
    ...
    noServerBase: 'No BambuStudio bundle on the server — choose the base preset JSON files (or a ZIP of the BBL/filament folder) to upload.',
    exportEmpty: 'No presets with JSON content to export.',
    // Zoho price sync
    syncZohoDone: 'Priced {{priced}}, unchanged {{unchanged}}',
    syncZohoAttention: '{{count}} need attention',
    ...
    // Editor shell
    editorNewTitle: 'New preset',
    editorEditTitle: 'Edit preset',
    inheritsNotFound: '(not found)',
    reload: 'Reload',
    serverChangedBanner: 'This preset changed on the server while you were editing it.',
    serverChangedReload: 'Reload from server',
    save: 'Save',
    create: 'Create',
    saving: 'Saving…',
    nameRequiredHint: 'Brand and material required',
    deletePreset: 'Delete',
    invalidJson: 'Invalid JSON',
    tabGeneral: 'General',
    tabTemps: 'Temperatures',
    tabCooling: 'Cooling',
    tabExtrusion: 'Extrusion',
    tabRetract: 'Retraction',
    tabJson: 'JSON',
    // Editor General
    basePresetLabel: 'Base preset',
    basePresetNone: '— None (start blank) —',
    basePresetMine: 'My presets',
    basePresetBase: 'Base presets',
    basePresetLoading: 'Loading…',
    brand: 'Brand',
    brandSelect: '— Select —',
    material: 'Material',
    colorLabel: 'Color label',
    colorPlaceholder: 'White, Black…',
    ...
    tagHint: 'Enter to add · Backspace to remove',
    removeTag: 'Remove {{tag}}',
    quickAdd: '+ H2S / H2D / H2C / X2D',
    tagPlaceholder: 'Bambu Lab X1C 0.4 nozzle…',
    notes: 'Notes',
    // Editor Temps
    nozzleSection: 'Nozzle',
    tempInitial: 'Initial',
    tempPrint: 'Print',
    tempRangeMin: 'Range min',
    tempRangeMax: 'Range max',
    materialSection: 'Material',
    glassTg: 'Glass Tg',
    chamberSection: 'Chamber',
    chamberTemp: 'Chamber',
    bedPlates: 'Bed plates',
    plate: 'Plate',
    plateSuperTack: 'SuperTack',
    plateCool: 'Cool Plate',
    plateEng: 'Engineering',
    plateHot: 'Hot Plate',
    plateTextured: 'Textured',
    printCol: 'Print °C',
    initialCol: 'Initial layer °C',
    // Editor Cooling
    partFan: 'Part cooling fan',
    fanMax: 'Max speed',
    fanMin: 'Min speed',
    overhangFan: 'Overhang speed',
    noFanLayers: 'No fan (part) layers',
    noFanAdditional: 'No fan (additional) layers',
    initialFan: 'Initial layer fan',
    minLayerTime: 'Min layer time',
    overhangThreshold: 'Overhang threshold',
    preStartFan: 'Pre-start fan',
    additionalFan: 'Additional fan',
    overhangBridgeFan: 'Overhang / bridge fan',
    chamberVent: 'Chamber ventilation',
    duringPrint: 'During print',
    endOfPrint: 'End of print',
    nil: 'nil',
    off: 'Off',
    on: 'On',
    // Editor Extrusion
    ...
    cal: 'cal',
    calTitle: 'Adjust flow ratio by %',
    apply: 'Apply',
    maxVolFlow: 'Max vol. flow',
    primeVolume: 'Prime volume',
    shrinkage: 'Shrinkage',
    layerSlowdown: 'Layer slow-down',
    minTimePerLayer: 'Min time per layer',
    minSpeed: 'Min speed',
    gcodeSection: 'G-code',
    ...
    length: 'Length',
    speed: 'Speed',
    deretractSpeed: 'Deretract speed',
    zHop: 'Z-hop',
    zHopType: 'Z-hop type',
    zHopNormal: 'Normal Lift',
    zHopSlope: 'Slope Lift',
    zHopSpiral: 'Spiral Lift',
    wipeDistance: 'Wipe distance',
    retractBeforeWipe: 'Retract before wipe',
    options: 'Options',
    retractOnLayerChange: 'Retract when changing layer',
    wipeOnRetract: 'Wipe on retraction',
    // Editor JSON
    jsonCaption: 'Direct edit — other tabs update automatically',
  },
  ...
  fileManager: {
    ...
    duplicatesWillBeSkipped: '{{count}} duplicate file(s) detected — will be skipped',
    uploadAnyway: 'Upload anyway',
    skipDuplicate: 'Skip',
    skippedDuplicate: 'Skipped (already in library)',
    ...
    tags: {
      ...
      hintDeselect: '↵ to deselect',
      hintCreate: '↵ to create',
    ...
    fileHistory: {
      menuLabel: 'History',
      title: 'History — {{name}}',
      viewHistoryAria: 'View print history',
      noPermission: 'You do not have permission to view file history',
      loadFailed: 'Failed to load file history',
      statusPending: 'Queued',
      addedToLibrary: 'Added to library',
      bySomeone: 'by {{name}}',
      noPrintsYet: 'This file has not been printed yet.',
      externalUnavailable: 'Print history is not available for external files.',
      openArchive: 'Open archive',
      viewSource: 'Open source page',
      stats: {
        prints: 'Prints',
        success: 'Success',
        filament: 'Filament',
    ...
    toast: {
      ...
      moveSkipped: '{{moved}} moved, {{skipped}} skipped: {{reasons}}',
      moveSkipReason: {
        not_owner: 'not the owner',
        source_readonly: 'source is read-only',
        source_missing: 'file no longer on disk',
        target_readonly: 'target is read-only',
        target_misconfigured: 'target folder misconfigured',
        target_inaccessible: 'target folder not accessible',
        target_unwritable: 'target folder not writable',
        invalid_filename: 'unsafe filename',
        name_collision: 'filename collision',
  ...
  sponsors: {
    ...
    tagline: 'Fenrir is free and stays that way because people choose to support it. No VC, no cloud lock-in.',
    viewSupporters: 'View supporters',
    toastPrints: "You've completed {{count}} prints with Fenrir. Fenrir stays free thanks to its supporters.",
    toastCost: "You've tracked {{total}} in filament with Fenrir. See who keeps the project independent.",
    toastArchives: '{{count}} prints archived with Fenrir. See who keeps it independent.',
    toastAnniversary: 'One year with Fenrir! See who keeps the project independent.',
    toastVersionUpdate: 'Updated to v{{version}}. Fenrir stays free thanks to its supporters.',
    toastBusiness: "Running Fenrir on {{count}} printers? There's a support plan for teams — priority fixes, invoicing, and a direct line to the maintainer.",
    businessCta: 'Fenrir for business',
    businessTitle: 'Fenrir for business',
  ...
  inventory: {
    ...
    spoolmanMixedContentBody: 'Fenrir is served over HTTPS (via your reverse proxy), but your Spoolman URL is still plain HTTP. Browsers block mixed content for security, so the embedded Spoolman UI can\'t render. Spoolman needs to be reachable over HTTPS for this to work.',
    spoolmanMixedContentFixReverseProxy: 'Put Spoolman behind the same reverse proxy as Fenrir (Traefik / Nginx / Caddy) with HTTPS, then update the Spoolman URL in Settings to the new HTTPS address.',
  ...
  // Zoho Books integration (settings tab)
  zoho: {
    title: 'Zoho Books',
    subtitle: 'Connect Zoho Books to attribute Aito projects to clients and sync invoices.',
    clientId: 'Client ID',
    clientSecret: 'Client Secret',
    ...
    secretSaved: 'Value saved — leave empty to keep',
    save: 'Save',
  ...
  backup: {
    ...
    repoIsPublicWarning: 'Repository is PUBLIC. Fenrir backups include MQTT credentials, Home Assistant tokens, Prometheus tokens, your Bambu Cloud email, and printer access codes via K-profiles. Saving is blocked until you make the repository private in your provider\'s settings.',
    repoVisibilityUnknown: 'Could not determine repository visibility. Fenrir refuses to back up to anything not confirmed private; saving will be blocked.',
    ...
    appSettingsDescription: 'Fenrir configuration (complete database)',
    ...
    restoreFromGit: {
      ...
      reloadHint: 'Reload Fenrir so the restored data appears everywhere.',
      ...
      notes: {
        ...
        settingsMqttRelayFailed: 'MQTT settings restored, but the relay could not be reconnected - restart Fenrir',
    ...
    localBackupDescription: 'Create a complete backup of your Fenrir data including the database, archives, uploads, and all files.',
    ...
    backupRestoredRestart: 'Backup restored. Please restart Fenrir.',
    ...
    pathCheck: {
      title: 'Fenrir cannot write to this directory',
      howToFix: 'How to fix:',
      sandboxed: 'The Fenrir service cannot write to {{path}}. Its systemd unit runs with ProtectSystem=strict, which makes every directory outside the install, data and log directories read-only for the service - even one you can write to from your own shell.',
      read_only: '{{path}} is on a read-only filesystem.',
      permission_denied: 'Fenrir is not allowed to write to {{path}}. Check the directory owner and permissions.',
      ...
      error: 'Fenrir cannot write to {{path}}.',
      ephemeralTitle: 'These backups will not survive a container restart',
      container_ephemeral: '{{path}} is inside the Fenrir container, not on the host. Backups written there are lost when the container is recreated. Mount the directory from the host:',
    },
  ...
  kProfiles: {
    ...
    modal: {
      ...
      notesHelp: 'Notes are saved in Fenrir, not on the printer',
  ...
  virtualPrinter: {
    ...
    enable: {
      ...
      visibleInSlicer: 'Visible as "Fenrir" in slicer discovery',
    ...
    remoteInterface: {
      ...
      hint: 'Override the IP address advertised via SSDP and used in the TLS certificate. Useful when Fenrir has multiple network interfaces.',
    },
    mode: {
      title: 'Mode',
      archive: 'Archive',
    ...
    caCert: {
      ...
      description: 'Virtual printers use a TLS certificate signed by the Fenrir CA. Import this CA certificate into your slicer\'s trust store once so it accepts the connection — no need to copy it from the command line.',
      copy: 'Copy',
      copied: 'Copied',
      download: 'Download',
      fingerprint: 'SHA-256',
    ...
    howItWorks: {
      ...
      step2: 'In Archive, Review, and Queue modes, use the "Send" button in your slicer to upload 3MF files to Fenrir. The slicer will show "Print success" — the file is stored, not printed.',
  ...
  locationHaSensors: {
    ...
    autoAdd: {
      ...
      confirmMessage: 'Fenrir also found other sensors for this location. Choose which ones to add too.',
    ...
    options: {
      ...
      pollIntervalHint: 'How often Fenrir polls Home Assistant and refreshes sensor values on screen. Minimum 60 seconds.',
  ...
  notifications: {
    ...
    aitoPaymentReceivedLabel: 'Aito Payment Received',
    aitoPaymentReceivedDescription: 'Notify when an Aito quote is paid online or by a covering deposit',
    printFailed: 'Print Failed',
    printStopped: 'Print Stopped',
  ...
  time: {
    ...
    today: 'Today',
    yesterday: 'Yesterday',
    daysElapsed_one: '{{count}} day ago',
    daysElapsed_other: '{{count}} days ago',
    monthsElapsed_one: '{{count}} month ago',
    monthsElapsed_other: '{{count}} months ago',
    yearsElapsed_one: '{{count}} year ago',
    yearsElapsed_other: '{{count}} years ago',
  },
  ...
  diagnostic: {
    ...
    check: {
      ...
      external_storage: {
        ...
        warn_internal_storage: 'The option is on and storage is present, but the last print still went to the printer\'s internal storage, which Fenrir cannot read. On H2-series, P2S and X2D, Bambu Studio\'s Print button always sends there whatever this option is set to. Prints archive with their name and timing, but without a thumbnail or slicer metadata. For complete archives, start prints from Fenrir or slice in OrcaSlicer — or in Bambu Studio use Send with External selected, then start the print.',
        warn_internal_history: 'The option is on and storage is present, but the last print ran from a file that was already on the printer — a re-print from its screen, a start from Handy, or a file sent earlier. That library sits on internal storage Fenrir cannot read, and no setting changes it, because nothing was sent for that print. It still archives with its name and timing, but without a thumbnail or slicer metadata. For complete archives, start prints from Fenrir or send them from the slicer.',
      },
      port_rtsps: {
      ...
      subnet: {
        ...
        pass: 'The printer and Fenrir are on the same subnet.',
        warn: 'The printer ({{printer_ip}}) and Fenrir ({{host_ip}}) are on different subnets. They may not reach each other unless routing between the subnets is configured.',
        skip: 'Subnet could not be determined — skipped.',
      },
      mqtt_auth: {
        title: 'Printer credentials',
        pass: 'The printer accepted the connection.',
        fail: 'The printer is reachable but Fenrir is not connected to it. The access code or serial number is most likely wrong — the access code changes every time LAN Only or Developer Mode is toggled, so re-copy it from the printer screen. A printer that is rebooting, or already at its limit of simultaneous connections, can look the same.',
        fail_auth_rejected: 'The printer refused Fenrir\'s credentials. The access code or serial number is wrong — the access code changes every time LAN Only or Developer Mode is toggled, so re-copy it from the printer screen and save it in the printer settings.',
  ...
  systemHealth: {
    ...
    signature: {
      'ftp-auth-rejected': {
        ...
        fix: 'Re-copy the access code from the printer screen (LAN settings) and update it in the printer\'s settings in Fenrir.',
      },
      'ftp-connection-timeout': {
        name: 'File-transfer connection timed out',
        cause: 'Fenrir could not reach the printer\'s file-transfer port (FTPS 990). The port is blocked, or the printer is off or on another subnet.',
        fix: 'Make sure nothing blocks port 990 between Fenrir and the printer, and that both are on the same network.',
      },
      'ftp-ssl-error': {
      ...
      'database-locked': {
        ...
        fix: 'Switch Fenrir to an external PostgreSQL database. See the PostgreSQL guide in the documentation.',
      },
    },
  },
  ...
  vpDiagnostic: {
    ...
    check: {
      ...
      running: {
        ...
        fail: 'The virtual printer is enabled but its services are not running. Check the Fenrir log — a bind IP conflict or a permission error usually stops them.',
      },
      bind_interface: {
      ...
      certificate: {
        ...
        pass: 'Certificate ready. Make sure the Fenrir CA certificate (above) is imported into your slicer\'s trust store.',
        fail: 'The TLS certificate for this virtual printer is missing. Check that the Fenrir data directory is writable.',
      },
    },
  },
  ...
  failureDetection: {
    ...
    externalUrlHint: 'The ML API fetches the camera snapshot by URL. Set the External URL in General settings so the ML API container can reach Fenrir.',
  ...
  makerworld: {
    title: 'MakerWorld',
    description: 'Paste a MakerWorld model URL to import and print it directly from Fenrir — without leaving for the Bambu Handy app.',
    ...
    signInExpiredTitle: 'Bambu Cloud sign-in expired',
    signInExpiredBody: 'You are still signed in to Fenrir, but Bambu Lab has stopped accepting the stored token, so downloads will fail. Sign in to Bambu Cloud again.',
    ...
    disclaimer: 'MakerWorld integration uses community-documented API endpoints. Fenrir is not affiliated with or endorsed by MakerWorld or Bambu Lab.',
  ...
  libraryPurge: {
    ...
    effect4: 'Files in external (linked) folders are skipped — Fenrir never deletes bytes it does not own.',
  ...
  calculator: {
    ...
    material: 'Material',
    title: 'Calculator',
    subtitle: 'Estimate 3D print costs and sale prices',
    easyMode: 'Easy mode',
    reset: 'Reset',
    resetConfirmTitle: 'Reset inputs',
    resetConfirmMessage: 'Reset all calculator inputs to their defaults? Filaments, printers and defaults are kept.',
    informations: 'Print details',
    weight: 'Object weight',
    printingTime: 'Printing time (h)',
    printingTimeLabel: 'Printing time',
    durationDays: 'Days',
    durationDaysShort: 'd',
    durationHours: 'Hours',
    ...
    emptyInputsTitle: 'Enter weight and print time',
    emptyInputsMessage: 'Fill in the object weight and printing time to see a suggested price and cost breakdown.',
    targetPrice: 'Target price',
    targetPriceLabel: 'Target price (incl. tax)',
    targetPriceProfit: 'Net margin',
    measuredEnergy: 'Measured energy: {{kwh}} kWh (from archive)',
    measuredEnergyClear: 'Clear measured energy',
    qtyIncrease: 'Increase quantity',
    qtyDecrease: 'Decrease quantity',
    fixErrors: 'Some inputs are invalid — fix the highlighted fields; invalid values are ignored in the results.',
    breakEvenDiscount: 'Break-even discount: {{pct}} — deeper discounts sell below cost.',
    ...
    summaryCopyFailed: 'Copy failed — your browser blocked clipboard access',
    easyAssumptions: 'Based on your saved rates — review defaults',
    quantity: 'Quantity',
    filament: 'Filament',
    printer: 'Printer',
    difficulty: 'Difficulty factor (%)',
    difficultyTooltip: 'Multiplier for tricky prints: abrasive filament, high failure risk, delicate handling. 100% = no surcharge.',
    labor: 'Labor',
    modeling: 'Modeling',
    ...
    machineCostSafety: 'Machine cost + provisions',
    ...
    realityCheck: {
      title: 'Reality check',
      subtitle: 'Measured from your own prints, settings and inventory.',
    ...
    timeCorrection: {
      ...
      hintScoped: '{{scope}} averages {{pct}}% of slicer estimates',
      apply: 'Apply corrected time',
      dismiss: 'Dismiss',
    },
    waterfall: {
      tax: 'Tax',
      aria: 'Price build-up from costs to final price',
    },
    quote: {
      open: 'Open printable quote',
      back: 'Back to calculator',
      print: 'Print',
      title: 'Quote',
      empty: 'No job to quote yet — fill in the calculator first.',
      jobDetails: 'Job details',
      footnote: 'Prices include tax. Quote valid subject to material availability.',
    },
    marge: 'Margin',
    marginPct: 'Margin %',
    marginGlobal: 'Global margin',
    marginFilament: 'Filament margin',
    marginStuff: 'Extras margin',
    perUnit: 'per unit',
    forQuantity: 'Total for {{count}} units',
    breakdown: 'Cost breakdown',
    costSplit: 'Where the money goes',
    costFilament: 'Filament',
    costDepreciation: 'Printer depreciation',
    costEnergy: 'Energy',
    costConsumables: 'Consumables & packaging',
    costBaseFee: 'Base fee',
    costRepairs: 'Repairs',
    costPrototype: 'Prototype',
    costFailures: 'Failures',
    costAds: 'Ads',
    costModeling: 'Modeling',
    costPreparation: 'Preparation',
    costPostProcessing: 'Post-processing',
    costStuff: 'Extras',
    ...
    splitAdsConsumables: 'Ads & consumables',
    discountTitle: 'Discount calculation',
    discountMachine: 'Machine cost w/ discount',
    discountSafety: 'Safety w/ discount',
    discountPrice: 'Price w/ discount',
    discountAmount: 'Discount amount',
    potentialProfit: 'Potential profit',
    bulkQuantity: 'Qty',
    emptyTitle: 'Set up your calculator',
    emptyMessage: 'Add at least one filament and one printer to start calculating prices.',
    ...
    name: 'Name',
    costPerKg: 'Cost per kg ({{currency}})',
    printingCostPerKg: 'Printing cost per kg ({{currency}})',
    marginOverCost: 'Margin over cost (%)',
    zohoProductSearch: 'Zoho product',
    zohoProductSearchPlaceholder: 'Search filaments in Zoho…',
    zohoNoDealerPrice: 'No dealer price',
    zohoNoResults: 'No matching Zoho filament',
    zohoSearchError: 'Could not reach Zoho',
    zohoLinkedProduct: 'Linked to {{name}}',
    zohoUnlink: 'Unlink',
    zohoWeightInferred: 'Spool weight not in the Zoho name; 1 kg assumed',
    spoolWeightKg: 'Spool weight (kg)',
    ...
    addFilament: 'Add filament',
    editFilament: 'Edit filament',
    deleteFilamentTitle: 'Delete filament',
    deleteFilamentMessage: 'Delete "{{name}}"? This cannot be undone.',
    filamentCreated: 'Filament added',
    filamentUpdated: 'Filament updated',
    filamentDeleted: 'Filament deleted',
    purchasePrice: 'Purchase price ({{currency}})',
    lifetimeYears: 'Lifetime (years)',
    dailyUsage: 'Daily usage (h)',
    powerWatts: 'Power (W)',
    repairRate: 'Repairs over lifetime (%)',
    lifetimeHours: 'Lifetime hours',
    depreciationPerHour: 'Depreciation / h',
    repairsPerHour: 'Repairs / h',
    addPrinter: 'Add printer',
    editPrinter: 'Edit printer',
    deletePrinterTitle: 'Delete printer',
    deletePrinterMessage: 'Delete "{{name}}"? This cannot be undone.',
    printerCreated: 'Printer added',
    printerUpdated: 'Printer updated',
    printerDeleted: 'Printer deleted',
    inUse: 'Selected on the calculator page',
    electricityTariff: 'Electricity tariff ({{currency}}/kWh)',
    laborRate: 'Labor rate ({{currency}}/h)',
    consumablesFlat: 'Consumables & packaging ({{currency}})',
    baseFee: 'Base fee ({{currency}})',
    marginCurveHint: 'Two curves set the global margin: a size margin that shrinks as a part costs more, and a quantity discount that trims the margin (never the cost) as quantities grow.',
    sizeMarginGroup: 'Size margin',
    qtyDiscountGroup: 'Quantity discount',
    floorGroup: 'Minimum',
    marginMinMult: 'Multiplier on very large parts (M_MIN)',
    marginMaxMult: 'Multiplier on very small parts (M_MAX)',
    marginK: 'Half-way unit cost (K, {{currency}})',
    qtyMinFactor: 'Margin kept at high quantity (Q_MIN)',
    qtyK: 'Half-way quantity (KQ)',
    minTaskPrice: 'Minimum price per task ({{currency}})',
    marginCurveMaxBelowMin: 'M_MAX must be at least M_MIN',
    marginCurvePreviewSize: 'Size margin by unit cost',
    marginCurvePreviewQty: 'Quantity factor by quantity',
    exampleTitle: 'Example job',
    ...
    formulaAt: 'At {{x}} → {{y}}',
    warnFlatSize: 'Size curve is flat: every part gets ×{{m}}.',
    warnKFar: 'K is far above your example cost; the curve barely bends where your jobs are.',
    ...
    multiplier: '×{{value}}',
    multiplierDetail: 'size ×{{size}} · qty {{qty}}',
    floorApplied: 'Minimum price applied',
    curveTitle: 'Price by quantity',
    curveHint: 'Unit price (tax incl.) at each quantity — one-time costs amortize and the quantity discount trims the margin.',
    curveUnitPrice: 'Unit price',
    curveTaskPrice: 'Task total',
    curveQtyFactor: 'Qty factor',
    curveCurrent: 'current',
    failureRate: 'Failure rate (%)',
    prototypeRate: 'Prototype rate (%)',
    adsRate: 'Ads rate (%)',
    filamentMarkup: 'Filament markup (%)',
    taxPct: 'Tax (%)',
    defaultDifficulty: 'Default difficulty (%)',
    defaultMargin: 'Default margin over cost (%)',
    filamentSettings: 'Filament settings',
    filamentSettingsHint: 'Prefill values for new filament profiles.',
    stuffMarkup: 'Extras markup (%)',
    ratesTitle: 'Rates',
    ratesHint: 'What a job costs you — match these to your local prices and currency before quoting.',
    provisionsTitle: 'Provisions & overhead',
    provisionsHint: 'Percentages added on top of cost to cover failed prints, prototypes, advertising and the resale uplift on filament and extras.',
    unsavedChanges_one: '{{count}} unsaved change',
    unsavedChanges_other: '{{count}} unsaved changes',
    fixFields: 'Fix the highlighted fields to save.',
