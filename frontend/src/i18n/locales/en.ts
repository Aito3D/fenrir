export default {
  ...
  calculator: {
    ...
    modelPreparation: 'Model preparation (min)',
    slicing: 'Slicing (min)',
    transferStart: 'Transfer & start (min)',
    postProcessing: 'Post-processing',
    jobRemoval: 'Job removal (min)',
    supportRemoval: 'Support removal (min)',
    additionalWork: 'Additional work (min)',
    fulfillment: 'Fulfillment (min)',
