export default {
  ...
  aito: {
    ...
    statistics: '统计',
    stats: {
      caption: '{{active}} 个进行中 · 累计完成 {{done}} 个',
      added: '新增',
      accepted: '已接受',
      completed: '已完成',
      perDay: '每日新增',
      ...
      brief: {
        ...
        dueNone: '本周没有交付安排。',
        finished_one: '本期完成 {{count}} 个项目。',
        finished_other: '本期完成 {{count}} 个项目。',
        more: '比上期多 {{count}} 个。',
        fewer: '比上期少 {{count}} 个。',
        lead: '从报价到交付：{{days}}。',
        chaseHeading: '跟进',
        tellHeading: '通知',
        collectHeading: '收款',
        chaseEmpty: '所有报价都已有答复。',
        tellEmpty: '所有客户都已通知。',
        collectEmpty: '所有发票都已付清。',
        ready: '可以取货',
        late: '逾期 {{days}} 天',
        andMore: '还有 {{count}} 个',
      },
      teaser: {
        sales: '接受 {{pct}}% · 流失 {{lost}} 个，{{total}}',
        time: '从报价到交付 {{lead}} · 回退 {{moves}} 次',
        money: '接受 {{accepted}} · 待收 {{outstanding}} · {{service}} 占收入 {{pct}}%',
        moneyPlain: '接受 {{accepted}} · 待收 {{outstanding}}',
        clients: '新客 {{new}} · 回头客 {{returning}}',
      },
    },
    doneEmpty: '暂无已完成的项目',
