export default {
  ...
  calculator: {
    ...
    rushPct: 'Recargo por urgencia (%)',
    rushToggle: 'Pedido urgente',
    rushGroup: 'Urgencia',
    rushHint: 'Se añade al precio sin impuestos después del mínimo, solo cuando el pedido está marcado como urgente.',
