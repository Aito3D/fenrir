export default {
  ...
  aito: {
    ...
    descriptionPlaceholder: 'Describe el producto que se va a diseñar e imprimir…',
    ...
    quoteEmailed: 'Presupuesto enviado a {{email}}',
    quoteEmailedCardMoveFailed: 'Presupuesto enviado a {{email}} — no se pudo mover la tarjeta automáticamente. Muévala manualmente.',
    quoteEmailFailed: 'No se pudo enviar el presupuesto',
    sendInvoice: 'Enviar factura',
    sendInvoiceTitle: 'Enviar factura por correo',
    sendInvoiceRecipient: 'Destinatario',
    sendInvoiceSubject: 'Asunto',
    sendInvoiceMessage: 'Vista previa del mensaje',
    sendInvoiceConfirm: 'Enviar',
    sendInvoiceNoRecipients: 'Este cliente no tiene dirección de correo en Zoho.',
    sendInvoiceLoadFailed: 'No se pudieron cargar los detalles del correo',
    emailPreviewTitle: 'Vista previa del correo',
    invoiceEmailed: 'Factura enviada a {{email}}',
    invoiceEmailFailed: 'No se pudo enviar la factura',
    createInvoice: 'Crear factura',
    createInvoiceTitle: 'Crear la factura',
    createInvoiceIntro_one: 'Presupuesto {{quote}}, {{count}} línea. Se crea un borrador de factura en Zoho Books — no se envía ningún correo.',
    createInvoiceIntro_other: 'Presupuesto {{quote}}, {{count}} líneas. Se crea un borrador de factura en Zoho Books — no se envía ningún correo.',
    createInvoiceAmount: 'Total de la factura',
    createInvoiceRemaining: 'Pendiente de pago',
    createInvoiceLockWarning: 'Una vez facturado, este presupuesto ya no acepta cambios de líneas desde Fenrir.',
    createInvoiceConfirm: 'Crear',
    createInvoiceLoadFailed: 'No se pudo preparar la factura',
    createInvoiceDone: 'Factura {{number}} creada',
    createInvoiceDonePaid: 'Factura {{number}} creada y saldada con los anticipos',
    createInvoiceDonePartial: 'Factura {{number}} creada — no se pudo aplicar {{retainers}}',
    createInvoiceFailed: 'No se pudo crear la factura',
    acceptQuote: 'Aceptar presupuesto',
    declineQuote: 'Rechazar presupuesto',
    holdToConfirm: 'Mantén pulsado 0,5 s para confirmar',
    quoteSent: 'Presupuesto marcado como enviado',
    quoteAccepted: 'Presupuesto aceptado',
    quoteDeclined: 'Presupuesto rechazado',
    quoteUnaccepted: 'Aceptación eliminada — presupuesto de vuelta a En espera',
    unacceptLabel: 'Quitar la aceptación',
    unacceptHint: 'Mantén pulsado 1s para quitar la aceptación',
    quoteConflictAccepted: 'Otra persona ya aceptó este presupuesto.',
    quoteConflictDeclined: 'Otra persona ya rechazó este presupuesto.',
    zohoNotUpdated: 'Guardado localmente: Zoho no se actualizó',
    progressLabel: '{{done}} de {{total}} pasos completados',
    trash: 'Papelera',
    trashEmpty: 'La papelera está vacía',
    restore: 'Restaurar',
    restored: 'Proyecto restaurado',
    restoreFailed: 'No se pudo restaurar el proyecto.',
    ...
    deleteFailed: 'No se pudo eliminar este proyecto',
    client: 'Cliente',
    noClient: 'Sin cliente',
    urgent: 'Urgente',
    markUrgent: 'Marcar urgente',
    clearUrgent: 'Quitar urgente',
    holdToMarkUrgent: 'Mantén pulsado 0,5 s para marcar urgente',
    holdToClearUrgent: 'Mantén pulsado 0,5 s para quitar urgente',
    sav: 'Devolución',
    markSav: 'Marcar devolución',
    clearSav: 'Quitar devolución',
    holdToMarkSav: 'Mantén pulsado 0,5 s para marcar devolución',
    holdToClearSav: 'Mantén pulsado 0,5 s para quitar devolución',
    pause: 'En pausa',
    markPause: 'Marcar en pausa',
    clearPause: 'Quitar la pausa',
    holdToMarkPause: 'Mantén pulsado 0,5 s para marcar en pausa',
    holdToClearPause: 'Mantén pulsado 0,5 s para quitar la pausa',
    markFlag: 'Marcar',
    flagFailed: 'No se pudo cambiar la marca',
    dueDate: 'Fecha prometida',
    dueDateClear: 'Borrar la fecha',
    dueDateEmpty: 'Elegir una fecha',
    dueLateDays: '{{count}} d de retraso',
    dueBadge: 'Vence el {{date}}',
    dueDateFailed: 'No se pudo cambiar la fecha',
    datePickerPrev: 'Mes anterior',
    datePickerNext: 'Mes siguiente',
    datePickerBackToSelected: 'Volver al mes seleccionado',
    datePickerPlusTwoDays: '+2 días',
    datePickerPlusOneWeek: '+1 semana',
    datePickerPlusTwoWeeks: '+2 semanas',
    datePickerSuggested: 'sugerido',
    awaitingContact: 'Por avisar',
    markContacted: 'Marcar cliente como avisado',
    holdToMarkContacted: 'Mantén 0,5 s para confirmar que se avisó al cliente',
    contacted: 'Avisado',
    clearContacted: 'Deshacer avisado',
    holdToClearContacted: 'Mantén 0,5 s para deshacer avisado',
    contactedFailed: 'No se pudo registrar el aviso',
    smsPickupShort: 'SMS',
    smsPickup: 'Enviar SMS de recogida',
    smsTitle: 'SMS de recogida',
    smsMessageLabel: 'Mensaje',
    smsGenerating: 'Redactando el mensaje…',
    smsGenerateFailed: 'No se pudo redactar el mensaje',
    smsRegenerate: 'Regenerar',
    ...
    zohoNotConfigured: 'Zoho Books todavía no está conectado.',
    zohoConfigureLink: 'Conectar Zoho Books',
    zohoUnreachable: 'No se pudo contactar con Zoho Books. Inténtalo de nuevo.',
    resetToDefaultClient: 'Restablecer el cliente predeterminado',
    ...
    revertPhone: 'Revertir el teléfono',
    revertEmail: 'Revertir el correo',
    socialNetworkMessenger: 'Messenger',
    socialNetworkInstagram: 'Instagram',
    socialNetworkWhatsapp: 'WhatsApp',
    socialNetworkTiktok: 'TikTok',
    socialLabel: 'Red social (opcional)',
    socialHandleLabel: 'Nombre de usuario',
    socialHandlePlaceholder: 'nombre.usuario',
    socialRemove: 'Quitar la red social',
    contactsLabel: 'Contactos',
    contactsHint: '¿Para quién es este proyecto?',
    contactsLoading: 'Leyendo los contactos de Zoho Books…',
    contactsUnavailable: 'No se pudieron leer los contactos de Zoho Books — introduzca un teléfono o un correo electrónico a continuación.',
    contactPrimary: 'principal',
    contactAdd: 'Añadir contacto',
    contactAddTitle: 'Nuevo contacto',
    contactSaveToZoho: 'Guardar en Zoho',
    contactFirstNameRequired: 'Introduzca un nombre.',
    contactNeedsPhoneOrEmail: 'Se necesita un teléfono o un correo electrónico para contactarlo.',
    contactAddFailed: 'No se pudo añadir el contacto. Inténtelo de nuevo.',
    contactOverrideToggle: 'Usar un teléfono / correo electrónico diferente para esta tarjeta',
    contactOverrideHint: 'Se mantiene solo en esta tarjeta — el contacto en Zoho Books no se modifica.',
    contactGone: 'Esta persona de contacto ya no existe en Zoho Books — elija otra.',
    clientEditFanOutPerson: 'Se aplica a todas las tarjetas abiertas de esta persona de contacto',
    clientEditTitle: 'Datos de contacto',
    clientEditSourceZoho: 'Zoho Books',
    clientEditSourceCard: 'Solo esta tarjeta',
    clientEditFanOut: 'Se aplica a todas las tarjetas abiertas de este cliente',
    ...
    clientHistoryNoQuote: 'sin presupuesto',
    clientHistoryThisCard: 'Esta tarjeta · {{stage}}',
    clientHistoryDeclined: 'Rechazado',
    clientHistoryOpenCard: 'Abrir el proyecto #{{id}}',
    clientHistoryEmpty: 'Este cliente aún no tiene proyectos.',
    clientHistoryError: 'No se pudo cargar el historial del cliente.',
    clientEditLoading: 'Leyendo el contacto en Zoho Books…',
    clientEditWalkIn: 'Cliente de paso: el cambio se queda en esta tarjeta y no se envía a Zoho Books.',
    clientEditZohoReadFailed: 'No se pudo leer el contacto en Zoho Books — se muestran los valores de la tarjeta.',
    clientEditFailed: 'No se pudo actualizar el cliente. Inténtalo de nuevo.',
    createClient: 'Crear nuevo cliente',
    companyName: 'Nombre de la empresa',
    firstName: 'Nombre',
    lastName: 'Apellido',
    createClientSubmit: 'Crear cliente',
    back: 'Atrás',
    clientNameRequired: 'Introduce el nombre de una empresa, o un nombre y un apellido.',
    newClientPersonHint: 'O el nombre y apellido de una persona',
    newClientContactTag: 'Persona de contacto en la empresa',
    newClientContactHint: 'recomendado — basta con un nombre',
    newClientPreviewCompany: 'Empresa: {{name}} · contacto: {{person}}',
    newClientPreviewCompanyAlone: 'Empresa: {{name}} · aún sin persona de contacto',
    newClientPreviewIndividual: 'Particular: {{name}}',
    clientCreateFailed: 'No se pudo crear el cliente. Inténtalo de nuevo.',
    clientSyncFailed: 'Proyecto creado — no se pudo actualizar el cliente en Zoho.',
    ...
    createdLabel: 'Creado',
    ageAnchorAccepted: 'Aceptado',
    ageDaysShort: '{{days}} d',
    lastActivity: 'Última actividad',
    recordLabel: 'Registro',
    duplicateProject: "Duplicar",
    duplicateReplaceTitle: "¿Reemplazar el borrador en curso?",
    duplicateReplaceBody: "El panel de nuevo proyecto ya contiene trabajo que aún no se ha creado. Duplicar esta ficha lo reemplazará.",
    duplicateReplaceConfirm: "Reemplazar",
    stageAndWorkLeft: 'Etapa y trabajo restante',
    panelTabDetails: 'Detalles',
    billingLabel: 'Facturación',
    depositAvailable: 'Anticipo disponible',
    descriptionShowMore: 'Ver más',
    descriptionShowLess: 'Ver menos',
    panelTabAttention: 'Requiere atención',
    workLabel: 'Trabajo',
    moveToTrash: 'Mover a la papelera',
    stepsCount: '{{done}}/{{total}} pasos',
    amountDone: '{{amount}} hecho',
    viewingNow: '{{name}} está viendo este proyecto',
    paidOnline: 'Pagado en línea',
    workLeftAtStage: '{{amount}} restante en {{stage}}',
    actorUnknown: 'desconocido',
    actorUnknownUser: 'usuario desconocido',
    actorClient: 'el cliente',
    ...
    editConflict: 'Otra persona editó este proyecto — el tablero se actualizó, inténtalo de nuevo.',
    tasks: 'Tareas',
    addTask: 'Añadir tarea',
    taskFallbackName: 'Tarea {{n}}',
    track: {
      pageTitle: 'Seguimiento de pedido · Aito 3D',
      title: 'Seguimiento de su pedido',
      reference: 'Presupuesto n.º {{ref}}',
      stepOf: 'Paso {{n}} de {{total}}',
      stepsAria: 'Pasos',
      showSteps: 'Ver los pasos',
      hideSteps: 'Ocultar los pasos',
      stepsList: 'Detalle de los pasos',
      tasksHeading: 'Sus piezas',
      showAllParts: 'Ver las {{n}} piezas',
      eta: 'Disponibilidad estimada',
      etaSoon: 'Le comunicaremos una fecha lo antes posible.',
      etaUpdating: 'Estimación en actualización',
      updated: 'Actualizado {{when}}',
      updatedToday: 'hoy a las {{time}}',
      updatedYesterday: 'ayer a las {{time}}',
      updatedOn: 'el {{date}} a las {{time}}',
      error: 'No se puede cargar el seguimiento en este momento.',
      retry: 'Reintentar',
      invalidTitle: 'Este enlace de seguimiento ya no es válido',
      invalidBody: 'Puede que haya caducado o haya sido reemplazado. Contáctenos y le enviaremos un nuevo enlace.',
      footerQuestion: '¿Alguna pregunta sobre su pedido?',
      enterTitle: 'Seguir mi pedido',
      enterHint: 'Introduce el código de 6 caracteres de tu presupuesto o de nuestro mensaje.',
      codeLabel: 'Código de seguimiento',
      codeChecking: 'Comprobando…',
      retrying: 'Reintentando…',
      codeFound: 'Código reconocido, abriendo tu seguimiento.',
      codeNotFound: 'Código no encontrado. Compruébalo e inténtalo de nuevo.',
      codeTooMany: 'Demasiados intentos. Espera un minuto.',
      codeError: 'No se puede comprobar el código ahora mismo. Pulsa Intro para reintentar.',
      invalidEnterCode: 'Introducir un código de seguimiento',
      language: 'Idioma',
      paymentTermsToggle: 'Ver las condiciones',
      panel: {
        close: 'Cerrar',
      ...
      shop: {
        find: 'Dónde estamos',
        title: 'Encuéntranos',
        sub: 'Taller y tienda Aito 3D',
        mapTitle: 'Mapa de la tienda',
      ...
      paymentMethods: {
        ...
        bank: 'Banco',
        transferReference: 'Concepto de la transferencia',
        referenceUnknown: 'Su número de presupuesto',
        transferDelay: 'Una transferencia puede tardar uno o dos días en llegarnos.',
        appTag: 'Tag de {{app}}',
        appMessage: 'Mensaje',
        appHint: 'Desde la aplicación {{app}}, envíe el importe del presupuesto a este tag.',
        shop: 'En tienda',
        shopSub: 'Tarjeta bancaria, efectivo o cheque.',
        ...
        copyReference: 'Copiar el concepto',
        copyRib: 'Copiar el RIB',
        copyTag: 'Copiar el tag de {{app}}',
        findShop: 'Ver dónde estamos',
      },
      stages: {
        devis: 'Presupuesto',
        waiting: 'Aprobación',
      ...
      status: {
        devisTitle: 'Presupuesto en preparación',
        ...
        pickedUpTitle: 'Recogido',
        pickedUpSub: 'El {{date}}. ¡Gracias por su confianza!',
        doneTitle: 'Completado',
        doneSub: '¡Gracias por su confianza!',
      },
      invoice: {
        paidTitle: 'Factura pagada',
        paidSub: 'Gracias por su confianza.',
        unpaidTitle: 'Factura pendiente',
        unpaidSub: 'A pagar antes de la recogida o el envío.',
        overdueTitle: 'Factura vencida',
        overdueSub: 'Contáctenos si ya ha pagado.',
      },
      payment: {
        unpaidTitle: 'Proyecto aún sin pagar',
        unpaidSub: 'Pague en línea, por transferencia o en la tienda.',
        unpaidDepositSub: 'Un anticipo asegura su pedido: pague en línea, por transferencia o en la tienda.',
        validateTitle: 'Apruebe su presupuesto',
        validateSub: 'El pago en línea equivale a aceptar el presupuesto.',
        validateDepositSub: 'Un anticipo aprueba su presupuesto e inicia la fabricación.',
        pay: 'Pagar en línea',
        paidTitle: 'Pago recibido',
        depositPaidTitle: 'Anticipo recibido',
        paidSub: 'Gracias por su confianza.',
      },
    },
    trackingCopy: 'Copiar enlace de seguimiento',
    trackingOpen: 'Abrir enlace de seguimiento',
    trackingCopied: 'Copiado',
    trackingRegenerate: 'Nuevo enlace de seguimiento',
    trackingRegenerated: 'Nuevo enlace de seguimiento creado — el anterior ya no funciona',
    trackingQuoteNotUpdated: 'No se pudo actualizar el presupuesto con el nuevo enlace — se hará en la próxima sincronización',
    trackingNeedsExternalUrl: 'Configura la URL externa en Ajustes para activar los enlaces de seguimiento',
    trackingSettingsLink: 'Ajustes',
    trackingLabel: 'Enlace de seguimiento',
    paymentLink: {
      label: 'Pago en línea',
      paid: 'Pagado',
      copy: 'Copiar el enlace de pago',
      open: 'Abrir el enlace de pago',
      copied: 'Copiado',
      expiresIn_one: 'Caduca en {{count}} día',
      expiresIn_other: 'Caduca en {{count}} días',
      expiresToday: 'Caduca hoy',
      retry: 'Reintentar',
      state: { expired: 'Caducado', cancelled: 'Cancelado', failed: 'Rechazado' },
    },
    payment: {
      dueQuote: 'Depósito pendiente',
      dueInvoice: 'Saldo pendiente',
      cellLink: 'Enlace',
      cellTerminal: 'Datáfono',
      cellManual: 'Manual',
      cellLinkTitle: 'Enlace de pago',
      cellTerminalTitle: 'Pagar con tarjeta en el datáfono',
      cellManualTitle: 'Manual — registrar un pago',
      terminalOff: 'Heimdall no está configurado',
      stateProcessing: 'Datáfono · esperando la tarjeta',
      stateAttention: 'Resultado desconocido · revise el datáfono',
      statePaid: 'Pagado {{amount}} · {{channel}} · {{date}}',
      statePaidNoDate: 'Pagado {{amount}} · {{channel}}',
      stateBookingFailed: 'No registrado en Zoho Books — vea Heimdall',
      stateNoLink: 'Sin enlace',
      channelTerminal: 'datáfono',
      channelLink: 'en línea',
      amountLabel: 'Importe',
      manualTitle: 'Registrar un pago',
      manualIntroQuote: 'Presupuesto {{number}} · depósito recibido en el mostrador',
      manualIntroInvoice: 'Factura {{number}} · pago recibido en el mostrador',
      modeLabel: 'Modo',
      modeCard: 'Tarjeta',
      modeCheque: 'Cheque',
      modeCash: 'Efectivo',
      referenceLabel: 'Referencia',
      referenceRequired: 'Un cheque necesita su número',
      manualHintQuote: 'Crea una factura de depósito sobre el presupuesto en Zoho Books y registra en ella el pago.',
      manualHintInvoice: 'Registra el pago en la factura en Zoho Books.',
      manualConfirm: 'Registrar',
      manualDone: 'Pago registrado',
      amountInvalid: 'Introduzca un importe entero superior a cero',
      terminalTitle: 'Pagar con tarjeta',
      terminalIntro: '{{number}} · en el datáfono del mostrador',
      terminalHintQuote: 'Rellenado con el depósito pendiente; en un presupuesto se acepta cualquier importe.',
      terminalHintInvoice: 'Rellenado con el saldo; Heimdall lo limita al saldo.',
      terminalStart: 'Iniciar el datáfono',
      terminalWaiting: 'Esperando la tarjeta en el datáfono…',
      terminalWaitingHint: 'Hasta 3 minutos para el PIN.',
      terminalLeave: 'Cerrar, ya volveré',
      terminalPaid: 'Pago aceptado',
      terminalBookingPending: 'Registrando en Zoho Books…',
      terminalBookingDone: 'Registrado en Zoho Books',
      terminalBookingFailed: 'No registrado en Zoho Books — vea Heimdall',
      terminalFailed: 'Rechazado',
      terminalFailedHint: 'No se ha cobrado nada. Puede intentarlo de nuevo.',
      terminalRetry: 'Reintentar',
      terminalAttention: 'Resultado desconocido',
      terminalAttentionHint: 'El datáfono no respondió. Revise el recibo de papel antes de volver a intentarlo.',
      linkTitle: 'Enlace de pago',
      linkCreate: 'Crear el enlace',
      linkCreateAgain: 'Crear un nuevo enlace',
      linkCancel: 'Cancelar el enlace',
      linkCancelConfirm: '¿Cancelar este enlace?',
      linkExpires: 'Caduca',
      linkHintInvoice: 'Rellenado con el saldo. El enlace caduca tras el periodo de validez del presupuesto.',
      linkPending: 'Creando el enlace…',
      linkDone: 'Enlace de pago creado',
      linkCancelled: 'Enlace de pago cancelado',
    },
    pastCards_one: '{{count}} tarjeta anterior',
    pastCards_other: '{{count}} tarjetas anteriores',
    reuseTasks: 'Reutilizar',
    rating: {
      good: 'Bueno',
      medium: 'Medio',
      bad: 'Malo',
      new: 'Nuevo',
      ariaLabel: 'Valoración del cliente: {{tier}}. {{reason}}',
      overdue_one: '{{count}} factura vencida · peor {{days}} días, {{number}}',
      overdue_other: '{{count}} facturas vencidas · peor {{days}} días, {{number}}',
      overdueNoNumber_one: '{{count}} factura vencida · peor {{days}} días',
      overdueNoNumber_other: '{{count}} facturas vencidas · peor {{days}} días',
      chronic: 'Suele pagar tarde · {{onTime}} de {{settled}} pagadas a tiempo',
      punctual: '{{onTime}} de {{settled}} facturas pagadas a tiempo',
      mixed: '{{onTime}} de {{settled}} pagadas a tiempo',
      pastDue_one: '{{count}} vencida',
      pastDue_other: '{{count}} vencidas',
    ...
    serviceScan3D: 'Escaneo',
    serviceModelisation3D: 'Modelado',
    serviceImpression3D: 'Impresión',
    serviceUsinage: 'Mecanizado',
    serviceMainDoeuvre: 'Mano de obra',
    serviceDescriptionRequired: 'Descripción (obligatoria)',
    maindoeuvreDescriptionRequired: 'La mano de obra necesita una descripción',
    serviceCost: 'Coste',
    serviceUnitCost: 'Coste unitario',
    discount: 'Descuento',
    serviceTotal: 'Total de línea',
    done: 'Hecho',
    editTask: 'Editar tarea',
    reorderTask: 'Reordenar la tarea',
    taskFinished: 'Tarea terminada',
    noSteps: 'Aún no hay pasos — añade un coste a un paso para crearlo',
    importQuote: 'Importar',
    importTitle: 'Importar un presupuesto',
    quoteSearchLabel: 'Presupuesto',
    quoteNumberLabel: 'Número',
    ...
    quoteNoServiceLines: 'Este presupuesto no tiene líneas de servicio AITO 3D.',
    quoteAlreadyImported: 'Ya importado como proyecto n.º {{id}}',
    quoteImport: 'Importar',
    quoteSkipped: 'No importado',
    quoteTotals: 'Proyecto {{project}} · presupuesto {{quote}}',
    quoteCurrencyMismatch: 'Este presupuesto está en {{code}}; el tablero muestra {{configured}}.',
    quoteOpenInZoho: 'Abrir en Zoho Books',
    changeQuote: 'Cambiar',
    quoteRowImported: 'Importado → n.º {{id}}',
    beforeImport: 'Antes de importar',
    ruleQuoteLines: 'El presupuesto tiene líneas de servicio AITO',
    ruleQuoteFresh: 'No importado antes',
    ruleCurrencyOk: 'La moneda coincide con el tablero',
    ruleImportDescription: 'Descripción completada',
    importTaskCount_one: '{{count}} tarea',
    importTaskCount_other: '{{count}} tareas',
    printer: 'Impresora',
    material: 'Material',
    weightG: 'Peso (g)',
    ...
    followCalculator: 'Seguir la calculadora',
    priceManual: 'Manual',
    priceLinked: 'Calculadora',
    perPart: 'por pieza',
    costDetail: 'Detalle del coste',
    addNote: 'Nota para el presupuesto',
    note: 'Nota',
    quoteStatus: {
      draft: 'Borrador',
      sent: 'Enviado',
    ...
    shippingLabelPrintFailed: 'No se pudo preparar la etiqueta de envío',
    invoiceStatus: {
      draft: 'Borrador',
      sent: 'Enviada',
      unpaid: 'Sin pagar',
    ...
    quotePending: 'Creando presupuesto…',
    sync: 'Sincronización',
    ...
    syncBlockedLabel: 'Sincronización bloqueada',
    forceSync: 'Forzar sincronización',
    forceSyncHint: 'Volver a leer el presupuesto en Zoho y enviar los costes de nuevo',
    showDone: 'Ver terminados',
    ...
    stats: {
      ...
      leadTime: 'Del presupuesto a la entrega',
      median: 'mediana {{days}} d',
      productionTime: 'De la aceptación a la entrega',
      daysShort: '{{days}} d',
      activity: 'Actividad por día',
      rolling7: 'Media de terminados a 7 días',
      flow: 'Días en cada etapa',
      sent: 'Enviados',
      ofAccepted: '{{pct}} % de los aceptados',
      quoted: 'Presupuestos aceptados',
      invoiced: 'Facturado',
      ...
      money: 'Dinero',
      clients: 'Clientes',
      asOfToday: 'A día de hoy',
      ageDays: '{{range}} días',
      winRate: 'Tasa de aceptación por importe',
      winRateEmpty: 'Aún no hay suficientes presupuestos decididos',
      decisions: '{{count}} decididos',
      stageTime: 'Duración por proyecto terminado',
      reworkMoves: 'Movimientos hacia atrás',
      reworkShare: '{{cards}} tarjetas · {{pct}} % de las tarjetas movidas',
      overdue: 'Facturas vencidas',
      overdueOldest: 'la más antigua {{days}} d',
      nothingOverdue: 'Nada vencido',
      serviceMix: 'Reparto por servicio',
      serviceTasks: '{{count}} tareas',
      clientsNew: 'Clientes nuevos',
      clientsReturning: 'Clientes recurrentes',
      returningShare: '{{pct}} % de los ingresos de clientes recurrentes',
      arrivals: 'Cuándo llegan las solicitudes',
      islands: 'Envíos por isla',
      pickup: 'Recogida',
      declined: 'Rechazados',
      acceptanceRate: '{{pct}} % aceptados',
      ...
      strip: {
        onBoard: '{{amount}} en el tablero',
        longest: 'el que más lleva esperando: <who>{{name}}, {{days}}</who> en {{stage}}',
        oldest: 'el más antiguo {{days}} d',
        noQuote: 'aún sin presupuesto',
        dueSoon_one: '{{count}} entrega vence esta semana',
        dueSoon_other: '{{count}} entregas vencen esta semana',
      },
      facts: {
        perDay: '{{count}} al día',
        waiting15: 'Esperando 15 días o más',
        lostWith: 'Perdido con presupuestos rechazados',
        shippingBilled: 'Envíos facturados',
        parcels_one: '{{count}} paquete',
        parcels_other: '{{count}} paquetes',
      ...
      finding: {
        overview: '{{in}}, {{accepted}} y {{done}}.',
        overviewIn_one: 'Entró {{count}} proyecto',
        overviewIn_other: 'Entraron {{count}} proyectos',
        overviewAccepted_one: '{{count}} fue aceptado',
        overviewAccepted_other: '{{count}} fueron aceptados',
        overviewDone_one: '{{count}} fue entregado',
        overviewDone_other: '{{count}} fueron entregados',
        overviewPeakWeek: 'La semana con más movimiento fue la del {{date}}.',
        overviewPeakDay: 'El día con más movimiento fue el {{date}}.',
        salesWin: 'Gana el {{pct}} % de los presupuestos.',
        salesLost_one: 'Se perdió {{count}} presupuesto, por {{total}}.',
        salesLost_other: 'Se perdieron {{count}} presupuestos, por {{total}} en total.',
        salesLostBig: 'Los que pierde son los grandes: {{lost}} de los {{decided}} por encima de {{min}}, por {{total}} en total.',
        salesNone: 'Ningún presupuesto decidido en este periodo.',
        timeLead: 'Un proyecto tarda {{days}} del presupuesto a la entrega.',
        timeSlow: '{{stage}} es la etapa lenta, con {{days}}.',
        timeRework_one: '{{count}} movimiento fue hacia atrás.',
        timeRework_other: '{{count}} movimientos fueron hacia atrás, en {{cards}}.',
        timeNone: 'Ningún proyecto entregado en este periodo.',
        moneyTotals: '{{accepted}} aceptados y {{invoiced}} facturados.',
        moneyOut: '{{amount}} siguen pendientes en {{invoices}}.',
        moneyOverdue_one: '{{count}} de ellas está vencida, desde hace {{days}} días.',
        moneyOverdue_other: '{{count}} de ellas están vencidas, la más antigua desde hace {{days}} días.',
        moneyClear: 'No hay nada pendiente.',
        clients: '{{new}} y {{returning}}.',
        clientsNew_one: '{{count}} cliente nuevo',
        clientsNew_other: '{{count}} clientes nuevos',
        clientsReturning_one: '{{count}} recurrente',
        clientsReturning_other: '{{count}} recurrentes',
        clientsPeak: 'Las solicitudes llegan el {{day}} hacia las {{hour}}.',
        clientsParcels_one: '{{count}} paquete salió hacia las islas.',
        clientsParcels_other: '{{count}} paquetes salieron hacia las islas.',
        clientsNone: 'Ningún cliente nuevo en este periodo.',
      },
      brief: {
        chase_one: '{{count}} presupuesto por reclamar',
        chase_other: '{{count}} presupuestos por reclamar',
        tell_one: '{{count}} cliente por avisar',
        tell_other: '{{count}} clientes por avisar',
        collect: '{{amount}} por cobrar',
        allClear: 'Nada que reclamar, nadie a quien avisar, nada que cobrar.',
        due_one: '{{count}} entrega vence esta semana.',
        due_other: '{{count}} entregas vencen esta semana.',
        chaseHeading: 'Reclamar',
        tellHeading: 'Avisar',
        collectHeading: 'Cobrar',
        ready: 'Listo para recoger',
        late: '{{days}} d de retraso',
        andMore: 'y {{count}} más',
      },
    },
    ...
    followups: {
      ...
      unpaid: 'Sin pagar',
      linkExpiring: 'Enlace por caducar',
      longest: '{{days}} días',
      clear: 'Quitar el filtro de reclamación',
      hint: 'Haz clic en una tarjeta para mostrar solo esos proyectos',
    },
    ...
    allDone_one: 'Nada en producción: {{count}} proyecto terminado está en «Ver terminados»',
    allDone_other: 'Nada en producción: {{count}} proyectos terminados están en «Ver terminados»',
    columns: {
      devis: 'Presupuesto',
      waiting: 'En espera',
      scan: 'Escaneo',
    ...
    history: {
      ...
      quoteDeclined: 'rechazó el presupuesto',
      quoteExpired: 'Presupuesto caducado',
      stageChanged: 'movió el proyecto',
      projectTrashed: 'movió el proyecto a la papelera',
      projectRestored: 'restauró el proyecto',
      taskAdded: 'añadió una tarea',
      taskUpdated: 'editó una tarea',
      taskRemoved: 'eliminó una tarea',
      taskReordered: 'reordenó las tareas',
      taskStepTicked: 'marcó un paso',
      taskStepUnticked: 'desmarcó un paso',
      projectUpdated: 'editó el proyecto',
      projectUrgentSet: 'Marcado como urgente',
      projectUrgentCleared: 'Urgente quitado',
      projectSavSet: 'Marcado como devolución',
      projectSavCleared: 'Devolución quitada',
      projectPauseSet: 'Marcado como en pausa',
      ...
      paymentLinkReplaced: 'Enlace de pago sustituido',
      paymentLinkUpdated: 'Enlace de pago actualizado',
      paymentLinkPaid: 'Pagado en línea',
      paymentLinkCancelled: 'Enlace de pago cancelado',
      paymentTerminalStarted: 'Pago con tarjeta iniciado en el datáfono',
      paymentTerminalPaid: 'Pagado con tarjeta en el datáfono',
      paymentTerminalFailed: 'Pago en el datáfono rechazado o cancelado',
      paymentTerminalAttention: 'Resultado del datáfono desconocido — revise el datáfono',
      paymentManualRecorded: 'Pago registrado',
      paymentManualPartial: 'Factura de depósito creada, pago NO registrado — termínelo en Zoho Books',
      noteAdded: 'añadió una nota',
      zohoComment: 'Comentario en Zoho Books',
      syncQueued: 'En cola para Zoho',
      syncPushed: 'Enviado a Zoho',
      syncFailed: 'Fallo al enviar a Zoho',
      syncLocked: 'Presupuesto bloqueado en Zoho',
      syncConflict: 'Conflicto de estado con Zoho',
      syncStatusRejected: 'Zoho rechazó el cambio de estado',
      pollReconciled: 'Verificado con Zoho',
    },
    // New-project drawer
    workSection: 'El trabajo',
    clientSectionTitle: 'Cliente',
    workHintNone: 'sin tareas',
    workHintProgress: '{{done}} de {{total}} completas',
    addService: 'Añadir {{service}}',
    removeServiceChip: 'Quitar {{service}}',
    taskNeedsSubTask: 'añade una subtarea',
    railSummary: 'Resumen',
    summaryTitle: 'Resumen del proyecto',
    summaryWaiting: 'Se genera al llegar al paso del cliente.',
    summaryGeneratedBy: 'Generado por {{model}} — haz clic para editar',
    summaryEdited: 'Editado a mano — ya no se regenera automáticamente',
    summaryFallback: 'IA no disponible — escribe la descripción tú mismo',
    aiFieldHint: 'Ortografía corregida por la IA',
    aiChecking: 'Corrigiendo la ortografía…',
    aiUndo: 'Restaurar mi texto',
    regenerate: 'Regenerar',
    beforeCreate: 'Antes de crear',
    ruleTasksOk_one: '{{count}} tarea — se requiere al menos una',
    ruleTasksOk_other: '{{count}} tareas — se requiere al menos una',
    ruleNeedTask: 'Un proyecto necesita al menos una tarea — añade una',
    ruleSubTasksOk: 'Cada tarea tiene una subtarea con precio',
    ruleSubTaskMissing: '"{{name}}" necesita al menos una subtarea con precio',
    ruleSubTasksPending: 'Cada tarea necesita al menos una subtarea con precio',
    ruleClientAccount: 'Cuenta del cliente — {{name}}',
    ruleClientReachable: 'Cliente localizable — {{contact}}',
    ruleClientContact: 'El cliente necesita un teléfono, un correo o una red social',
    warnNoEmail: 'Sin correo — el presupuesto no podrá enviarse por correo',
    warnNoPhone: 'Sin teléfono — recuerda pedirlo',
    holdToReset: 'Mantén pulsado para restablecer el borrador',
    resetDraft: 'Restablecer borrador',
    shippingAdd: 'Añadir envío',
    shippingTitle: 'Envío',
    shippingRemove: 'Quitar envío',
    shippingEdit: 'Editar envío',
    shippingIsland: 'Isla de destino',
    shippingIslandPlaceholder: 'Buscar una isla…',
    shippingNoIslands: 'No se encontró ninguna isla',
    shippingFirstName: 'Nombre del destinatario',
    shippingLastName: 'Apellido del destinatario',
    shippingPhone: 'Teléfono del destinatario',
    shippingRecipient: 'Destinatario',
    shippingService: 'Servicio de envío',
    shippingRate: 'Tarifa',
    shippingRateFromZoho: 'Tarifa de Zoho: {{rate}}',
    shippingRateEdited: 'editada',
    shippingRateReset: 'Volver a la tarifa de Zoho',
    shippingNoRate: 'Sin tarifa de Zoho — introduce una',
    shippingRateNegative: 'La tarifa no puede ser negativa',
    shippingLta: 'Número LTA',
    shippingLtaPlaceholder: 'Número de carta de porte aéreo…',
    ...
    ruleShippingInvalidPhone: 'Envío: número de teléfono no válido',
  },
  // Navigation
  nav: {
    aito: 'Aito',
    ...
    stats: 'Estadísticas',
    profiles: 'Perfiles',
    filamentProfiles: 'Perfiles de filamento',
    ...
    installAppSuccess: 'Fenrir se ha instalado',
  },
  ...
  printers: {
    ...
    maintenance: {
      ...
      editFieldHelp: 'Cuando está activado, esta impresora se pausa de MQTT, despacho de cola y notificaciones — útil para reparaciones, instalaciones paralelas de Fenrir o suspensión temporal.',
    },
    // Chamber light
    ...
    cameraGrid: {
      quality: 'Calidad',
      qualityGlobalHint: 'se aplica a todos los usuarios',
      auto: 'Auto',
      low: 'Baja',
      medium: 'Media',
      high: 'Alta',
    ...
    nozzleWear: 'Desgaste',
    nozzleSlotEmpty: 'Ranura {{slot}} — Vacía',
    humidityTooltip: 'Humedad: {{value}}% - {{status}}',
    temperatureTooltip: 'Temperatura: {{value}}°C - {{status}}',
    clickForHistory: 'clic para ver historial',
  ...
  archives: {
    ...
    no3mfBanner: {
      ...
      body: 'El slicer no dejó el archivo .gcode.3mf en la tarjeta SD de la impresora, así que Fenrir no pudo recuperar ni la miniatura ni los metadatos del slicer. Esto suele deberse a que "Almacenar archivos enviados en almacenamiento externo" está desactivado en el slicer (pestaña Dispositivo de Bambu Studio / OrcaSlicer).',
      ...
      bodyInternalStorage: 'Bambu Studio guardó el archivo laminado en el almacenamiento interno de la impresora en lugar de la tarjeta, así que Fenrir no tenía nada que leer por FTP. En la serie H2, la P2S y la X2D su botón «Imprimir» siempre lo hace: solo «Enviar» ofrece elección, y también viene con «Caché» por defecto. Esas impresiones se siguen archivando con su nombre y sus tiempos, solo que sin miniatura ni metadatos del laminador. Para archivos completos, inicia la impresión desde Fenrir o lamina en OrcaSlicer, o bien en Bambu Studio usa «Enviar» con «Externo» y luego inicia la impresión. Todas requieren una tarjeta o memoria en la impresora.',
      titleNoExternalStorage: 'Algunas impresiones recientes no se pudieron archivar — no hay almacenamiento en la impresora',
      bodyNoExternalStorage: 'La impresora no detecta ninguna tarjeta ni memoria en su ranura, así que el archivo laminado no tenía dónde aterrizar y Fenrir nada que leer. Inserte una y la próxima impresión se archivará por completo.',
      titleInternalHistory: 'Algunas impresiones recientes se iniciaron desde un archivo que ya estaba en la impresora',
      bodyInternalHistory: 'Esas impresiones salieron de la propia biblioteca de la impresora: una reimpresión desde su pantalla, un inicio desde Handy o un archivo enviado antes e impreso después. Fenrir lee los archivos de impresión por FTP, que solo sirve la tarjeta o la memoria, mientras que la impresora guarda esa biblioteca en una zona que FTP no alcanza, así que no había ningún 3MF que leer. Ninguna opción del laminador cambia esto, porque para estas impresiones no se envió nada. Se siguen archivando con su nombre y sus tiempos, y «Editar archivo» permite anotar a mano el filamento usado. Para un archivo completo, inicia la impresión desde Fenrir o desde tu laminador.',
      titleFtpsCooloff: 'Algunas impresiones recientes no se pudieron archivar — la impresora rechazó la conexión de archivos',
      bodyFtpsCooloff: 'Fenrir abrió el puerto de transferencia de archivos de la impresora (FTPS 990) y la impresora respondió con algo que no es TLS, así que no se pudo leer nada de ella. Esas impresiones siguen archivadas con su nombre y sus tiempos, solo que sin miniatura ni metadatos del laminador. No es un ajuste del laminador ni algo que usted haya cambiado — los mismos modelos y firmware funcionan con normalidad en otras instalaciones, y una impresora afectada suele volver a funcionar sola más tarde. Tras un fallo así, Fenrir pausa las transferencias a esa impresora durante cinco minutos y vuelve a por el archivo cuando termina la pausa, de modo que un episodio breve se resuelve por sí solo; una ficha que sigue vacía significa que el rechazo duró más que el reintento. Todavía no se sabe qué lo provoca. Si se repite, active el registro de depuración en la página Sistema y adjunte un paquete de soporte a su informe.',
      ...
      bodyFtpTransferFailed: 'El archivo laminado estaba en la tarjeta de la impresora y la impresora lo sirvió, pero la transferencia no terminó en el tiempo permitido. Al iniciar la impresión la impresora también atiende su cámara, sus mensajes de estado y la subida del trabajo, y un 3MF grande no siempre consigue pasar con todo eso. Esas impresiones siguen archivadas con su nombre y sus tiempos, solo que sin miniatura ni metadatos del laminador. No es un ajuste del laminador ni algo que usted haya cambiado. Fenrir vuelve a por el archivo tres veces durante los diez minutos siguientes, así que la mayoría se completan solas; una tarjeta que sigue vacía significa que todos esos intentos también agotaron su tiempo. Si se repite, aumente Tiempo de espera de conexión en Ajustes > Red > Reintento FTP.',
    ...
    card: {
      ...
      gcode: 'GCODE',
      source: 'ORIGEN',
      unverifiedFile: 'Sin verificar',
      unverifiedFileTooltip: 'Este archivo se asoció solo por el nombre — puede que no sea el archivo que realmente se imprimió.',
  ...
  queue: {
    ...
    batchOrders: {
      ...
      strandedPlate: 'No queda de dónde copiar los ajustes',
      strandedNotice: 'No se pueden encolar {{runs}} de las {{owed}} impresiones aún pendientes: esa cama ya no tiene ninguna impresión encolada o terminada de la que copiar los ajustes. Encola la cama una vez desde el archivo o cancela el pedido.',
    ...
    cancelBatchConfirmMessage: '¿Cerrar este pedido? Las impresiones que sigan en la cola se cancelan y deja de reclamar lo que no ha producido.',
    batch: {
      defaultName: 'Lote',
    ...
    toast: {
      ...
      keptForOrder: 'Cancelado en lugar de eliminado: es la única impresión desde la que el pedido puede volver a encolar esta cama',
      historyKeptForOrders: 'Se conservan {{kept}} que los pedidos todavía necesitan.',
  ...
  stats: {
    ...
    filamentCostFromCalculator: 'Calculado a partir de los precios de filamento de la calculadora de precios',
    ...
    failuresByFilament: 'Fallos por filamento',
    failuresByPrinter: 'Fallos por impresora',
    deltaVsPrevious: 'frente al período anterior de {{days}} días',
    utilizationBusy: '{{hours}} h ocupada',
    utilizationNoData: 'No hay impresiones con datos de tiempo en este período',
    costBreakdown: 'Desglose de costes',
    costFilament: 'Filamento',
    costEnergy: 'Energía',
    costMachine: 'Máquina',
    costPerPrintHour: 'Por hora de impresión',
    costPerKg: 'Por kg',
    costCoverage: '{{priced}} de {{total}} impresiones valoradas',
    costNoData: 'No se pudo valorar ninguna impresión con la configuración actual de la calculadora',
    filamentForecast: 'Previsión de filamento',
    forecastDaysLeft: '≈ {{days}} días restantes',
    forecastNoUsage: 'Sin uso reciente',
    forecastNoInventory: 'No hay bobinas en el inventario',
    forecastRemaining: '{{amount}} restante',
    forecastBasis: 'Proyectado a partir del uso reciente — detalles en la página de inventario',
    maintenanceReliability: 'Mantenimiento y fiabilidad',
    printsSinceMaintenance: '{{prints}} impresiones · {{failures}} fallidas desde {{date}}',
    neverMaintained: 'Sin mantenimiento registrado',
    maintenanceDueBadge: '{{n}} pendiente(s)',
    maintenanceWarningBadge: '{{n}} pronto',
    maintenanceNoData: 'No hay impresoras con seguimiento de mantenimiento',
    maintenanceSinceCaption: 'Los recuentos corresponden al período seleccionado',
    energyWidgetTitle: 'Consumo de energía',
    aitoPipeline: 'Flujo Aito',
    aitoPipelineEmpty: 'Nada en el tablero Aito en este periodo',
    pipelineByStage: 'Por etapa',
    pipelineConversion: 'Conversión de presupuestos',
    pipelineSent: 'Enviados',
    pipelineAccepted: 'Aceptados',
    pipelineDeclined: 'Rechazados',
    pipelineAcceptedRate: '{{pct}} % aceptados',
    pipelineStageDays: 'Días por etapa',
    pipelineInvoicing: 'Facturación',
    pipelineInvoiced: 'Facturado',
    pipelineOutstanding: 'Pendiente de cobro',
    pipelineTracking: 'Seguimiento del cliente',
    pipelineTrackingViews: 'Aperturas de la página',
    pipelineTrackingCards: 'Tarjetas consultadas',
    pipelineTrackingLinks: 'Tarjetas con enlace',
    pipelineDays: '{{days}} días',
    pipelineSample_one: '{{count}} tarjeta',
    pipelineSample_other: '{{count}} tarjetas',
    energyTotalLabel: 'Total',
    energyCostLabel: 'Coste',
    energyAvgPerDay: 'Media por día',
    energyAvgPerPrint: 'Media por impresión',
    energyNoPlugs: 'No hay enchufes inteligentes con medición de energía configurados',
    energyNoData: 'No hay datos de energía registrados para este período',
  ...
  settings: {
    ...
    ldap: {
      ...
      feature3: 'Los grupos LDAP se asignan a los grupos de Fenrir al iniciar sesión',
      ...
      autoProvisionHint: 'Crear automáticamente una cuenta de Fenrir en el primer inicio de sesión LDAP',
      ...
      groupMappingHint: 'Asignar los DN de grupos LDAP a los grupos de Fenrir. Grupos disponibles: ',
    ...
    preheatFilamentTargetsHint: 'Fenrir elige el objetivo más alto entre los slots AMS cargados. Una impresión cuyos slots derivan todos 0 (PLA, PETG, TPU, PVA) omite el precalentamiento por completo y empieza de inmediato.',
    ...
    authDisabledMessage: 'Active la autenticación para crear cuentas de usuario, gestionar permisos y proteger su instancia de Fenrir.',
    ...
    disableAuthenticationMessage: '¿Está seguro de que desea desactivar la autenticación? Esto hará que su instancia de Fenrir sea accesible sin iniciar sesión. Todos los usuarios permanecerán en la base de datos, pero la autenticación se desactivará.',
    disableAuthentication: 'Desactivar la autenticación',
    // Additional settings
    configureFenrir: 'Configurar Fenrir',
    ...
    captureFinishPhotoDescription: 'Tomar una foto desde la cámara de la impresora cuando se completa la impresión. Fenrir graba un breve timelapse durante la impresión para que la foto pueda obtenerse del momento previo al descenso de la cama; el archivo del timelapse se conserva si activaste el timelapse para esta impresión, de lo contrario se elimina automáticamente tras capturar la foto.',
    finishPhotoRestorePlate: 'Elevar la cama para la foto final',
    finishPhotoRestorePlateDescription: 'La impresora baja la cama unos 100 mm al terminar una impresión, dejando la pieza terminada por debajo del encuadre de la cámara. Fenrir la vuelve a subir hasta justo encima de la última capa impresa, toma la foto y luego la baja de nuevo. Se omite si se desconoce la altura de la impresión o si hay otro trabajo en cola.',
    ...
    cameraQuality: 'Calidad de cámara',
    cameraQualityLow: 'Baja',
    cameraQualityMedium: 'Media',
    cameraQualityHigh: 'Alta',
    cameraQualityAuto: 'Auto',
    cameraQualityAutoWithResolved: 'Auto ({{resolved}})',
    cameraQualityAutoResolved: 'Selección automática: {{resolved}} según el hardware del servidor.',
    cameraQualityAutoResolvedDual: 'Selección automática: {{single}} (vista individual), {{grid}} (cuadrícula de cámaras) según el hardware del servidor y el número de transmisiones.',
    cameraQualityDescription: 'Controla los FPS y la resolución de la transmisión. Una calidad menor reduce el uso de CPU en configuraciones con varias cámaras.',
    cameraGpuAccel: 'Aceleración GPU',
    cameraGpuAccelDescription: 'Usa decodificación de video acelerada por hardware para las transmisiones de cámara. Reduce el uso de CPU en servidores con GPU compatibles.',
    cameraGpuAccelUnavailable: 'No se detectaron backends de aceleración GPU en este servidor.',
    cameraGpuAccelBackends: 'Backends disponibles: {{backends}}',
    cameraEngine: 'Motor de cámara',
    cameraEngineFFmpeg: 'FFmpeg (MJPEG)',
    cameraEngineGo2rtc: 'go2rtc (WebRTC)',
    cameraEngineFFmpegDescription: 'Transcodifica RTSP a MJPEG mediante FFmpeg. Funciona con todos los navegadores pero usa más CPU.',
    cameraEngineGo2rtcDescription: 'Retransmite H.264 directamente al navegador mediante WebRTC. Sin transcodificación, menor latencia, decodificación por hardware. Las cámaras de cámara interna (A1/P1) siguen usando FFmpeg.',
    ...
    fenrirSoftware: 'Software de Fenrir',
    ...
    updateViaHomeAssistant: 'Las actualizaciones las gestiona el Supervisor de Home Assistant. Abra Ajustes → Complementos → Fenrir en Home Assistant para instalar la nueva versión.',
    ...
    externalUrlDescription: 'La URL externa donde Fenrir es accesible. Se usa para las imágenes de notificación y las integraciones externas.',
    fenrirUrl: 'URL de Fenrir',
    ...
    mqttDescription: 'Publique los eventos de Fenrir en un broker MQTT externo para la integración con Node-RED, Home Assistant y otros sistemas de automatización.',
    ...
    encryption: {
      ...
      notConfiguredDesc: 'Los secretos TOTP y los client_secrets de OIDC se almacenan en texto plano. Establezca MFA_ENCRYPTION_KEY o reinicie Fenrir con un directorio de datos con permisos de escritura para generar una automáticamente.',
      ...
      migrationErrorWarning: '{{count}} fila(s) heredada(s) no se pudieron volver a cifrar al iniciar. Revise los registros del servidor y reinicie Fenrir para reintentarlo.',
    },
    ...
    aitoFollowupLinkDays: 'Enlace de pago por caducar (días)',
    aitoFollowupLinkDaysDescription: 'Marca los presupuestos cuyo enlace de pago caduca dentro de estos días',
  },
  ...
  hmsErrors: {
    ...
    runoutSlotUnknown: 'El filamento se agotó y la impresión está en pausa. Fenrir no pudo determinar qué slot espera ahora la impresora — revisa la pantalla de la impresora para ver el slot solicitado.',
    actions: {
  ...
  // Login page
  login: {
    title: 'Inicio de sesión en Fenrir',
    ...
    resetStep1: 'Póngase en contacto con su administrador de Fenrir',
    ...
    twoFA: {
      ...
      instructionsTotp: 'Abra su aplicación de autenticación e introduzca el código de 6 dígitos para Fenrir.',
  ...
  // Setup page
  setup: {
    title: 'Configuración de Fenrir',
    subtitle: 'Configure la autenticación para su instancia de Fenrir',
  ...
  camera: {
    ...
    refreshStream: 'Actualizar transmisión',
    expand: 'Ampliar',
    minimize: 'Minimizar',
    reconnectingIn: 'Reconectando en {{countdown}}s...',
    stream: 'Transmisión de cámara',
  ...
  users: {
    ...
    subtitle: 'Gestione los usuarios y su acceso a su instancia de Fenrir',
    backToSettings: 'Volver a Ajustes',
    createUser: 'Crear usuario',
    noPermission: 'No tiene permiso para acceder a esta página.',
    admin: 'Administrador',
  ...
  profiles: {
    ...
    orcaCloud: {
      ...
      connect: {
        ...
        description: 'Inicia sesión en tu cuenta Orca Cloud para sincronizar tus perfiles de slicer en Fenrir.',
      },
      device: {
        title: 'Aprueba Fenrir en Orca Cloud',
        instruction: 'Abre Orca Cloud y aprueba este código. Fenrir se conecta automáticamente en cuanto lo apruebes.',
  ...
  filamentProfiles: {
    ...
    import: 'Importar',
    syncZohoPrices: 'Sincronizar precios desde Zoho',
    syncingZoho: 'Sincronizando precios desde Zoho…',
    syncToPc: 'Sincronizar con el PC',
    ...
    // Grid
    emptyTitle: 'Todavía no hay presets',
    emptySubtitle: 'Cree un preset manualmente o impórtelo desde una carpeta.',
    ...
    deleteBody: '{{name}} se eliminará permanentemente.',
    cancel: 'Cancelar',
    deleteConfirm: 'Eliminar',
    // Sync-base modal
    baseSyncedTitle: 'Perfiles base sincronizados',
    baseSyncFailedTitle: 'Error de sincronización',
    filesScanned: '{{n}} archivos analizados',
    statNew: 'Nuevos',
    statUpdated: 'Actualizados',
    statUnchanged: 'Sin cambios',
    close: 'Cerrar',
    // Sync modal
    syncTitle: 'Sincronizar con el PC',
    syncSubtitle: 'Los cambios se aplicarán a la carpeta de filamentos de BambuStudio.',
    statRemoved: 'Eliminados',
    upToDate: 'Todo está ya actualizado.',
    syncConfirm: 'Sincronizar',
    syncConfirmNeedsDelete: 'No tienes permiso para eliminar perfiles existentes',
    syncDoneTitle: 'Sincronización completa',
    statAdded: 'Añadidos',
    syncPreviewFailed: 'Error en la vista previa de sincronización: {{error}}',
    syncFailed: 'Error de sincronización: {{error}}',
    // Import
    scanFailed: 'Error al leer la carpeta de BambuStudio: {{error}}',
    allImported: 'Se encontraron {{n}} archivo(s); todos ya estaban importados.',
    importing: 'Importando presets… {{current}}/{{total}}',
    imported: '{{n}} preset(s) importado(s)',
    ...
    syncZohoAttention: '{{count}} requieren atención',
    ...
    syncZohoContentTooLarge: 'Coincide, pero el contenido reformateado del perfil superaría el límite de tamaño — el precio no se aplicó',
    ...
    // Editor shell
    editorNewTitle: 'Nuevo preset',
    editorEditTitle: 'Editar preset',
    inheritsNotFound: '(no encontrado)',
    reload: 'Recargar',
    serverChangedBanner: 'Este ajuste preestablecido cambió en el servidor mientras lo editabas.',
    serverChangedReload: 'Recargar desde el servidor',
    save: 'Guardar',
    create: 'Crear',
    saving: 'Guardando…',
    nameRequiredHint: 'Se requieren marca y material',
    deletePreset: 'Eliminar',
    invalidJson: 'JSON no válido',
    tabGeneral: 'General',
    tabTemps: 'Temperaturas',
    tabCooling: 'Refrigeración',
    tabExtrusion: 'Extrusión',
    tabRetract: 'Retracción',
    tabJson: 'JSON',
    // Editor General
    basePresetLabel: 'Preset base',
    basePresetNone: '— Ninguno (empezar en blanco) —',
    basePresetMine: 'Mis presets',
    basePresetBase: 'Presets base',
    basePresetLoading: 'Cargando…',
    brand: 'Marca',
    brandSelect: '— Seleccionar —',
    material: 'Material',
    colorLabel: 'Etiqueta de color',
    colorPlaceholder: 'Blanco, Negro…',
    nozzleSize: 'Tamaño de boquilla',
    paKValue: 'Valor PA K',
    cost: 'Coste',
    density: 'Densidad',
    filamentColour: 'Color del filamento',
    extruder: 'Extrusor',
    compatiblePrinters: 'Impresoras compatibles',
    tagHint: 'Intro para añadir · Retroceso para quitar',
    removeTag: 'Quitar {{tag}}',
    quickAdd: '+ H2S / H2D / H2C / X2D',
    tagPlaceholder: 'Bambu Lab X1C boquilla 0,4…',
    notes: 'Notas',
    // Editor Temps
    nozzleSection: 'Boquilla',
    tempInitial: 'Inicial',
    tempPrint: 'Impresión',
    tempRangeMin: 'Rango mín.',
    tempRangeMax: 'Rango máx.',
    materialSection: 'Material',
    glassTg: 'Tg vítrea',
    chamberSection: 'Cámara',
    chamberTemp: 'Cámara',
    bedPlates: 'Placas de cama',
    plate: 'Placa',
    plateSuperTack: 'SuperTack',
    plateCool: 'Placa fría',
    plateEng: 'Ingeniería',
    plateHot: 'Placa caliente',
    plateTextured: 'Texturizada',
    printCol: 'Impresión °C',
    initialCol: 'Primera capa °C',
    // Editor Cooling
    partFan: 'Ventilador de pieza',
    fanMax: 'Velocidad máx.',
    fanMin: 'Velocidad mín.',
    overhangFan: 'Velocidad en voladizos',
    noFanLayers: 'Capas sin ventilador (pieza)',
    noFanAdditional: 'Capas sin ventilador (adicional)',
    initialFan: 'Ventilador primera capa',
    minLayerTime: 'Tiempo mín. por capa',
    overhangThreshold: 'Umbral de voladizo',
    preStartFan: 'Ventilador previo',
    additionalFan: 'Ventilador adicional',
    overhangBridgeFan: 'Ventilador de voladizo/puente',
    chamberVent: 'Ventilación de la cámara',
    duringPrint: 'Durante la impresión',
    endOfPrint: 'Al finalizar la impresión',
    nil: 'nil',
    off: 'Apagado',
    on: 'Encendido',
    // Editor Extrusion
    flowSection: 'Flujo',
    flowRatio: 'Relación de flujo',
    cal: 'cal',
    calTitle: 'Ajustar la relación de flujo en %',
    apply: 'Aplicar',
    maxVolFlow: 'Flujo vol. máx.',
    primeVolume: 'Volumen de cebado',
    shrinkage: 'Contracción',
    layerSlowdown: 'Ralentización de capa',
    minTimePerLayer: 'Tiempo mín. por capa',
    minSpeed: 'Velocidad mín.',
    gcodeSection: 'G-code',
    startGcode: 'G-code inicial',
    endGcode: 'G-code final',
    // Editor Retract
    length: 'Longitud',
    speed: 'Velocidad',
    deretractSpeed: 'Velocidad de desretracción',
    zHop: 'Salto en Z',
    zHopType: 'Tipo de salto en Z',
    zHopNormal: 'Elevación normal',
    zHopSlope: 'Elevación en rampa',
    zHopSpiral: 'Elevación en espiral',
    wipeDistance: 'Distancia de limpieza',
    retractBeforeWipe: 'Retracción antes de limpiar',
    options: 'Opciones',
    retractOnLayerChange: 'Retraer al cambiar de capa',
    wipeOnRetract: 'Limpiar al retraer',
    // Editor JSON
    jsonCaption: 'Edición directa — las demás pestañas se actualizan automáticamente',
  },
  ...
  fileManager: {
    ...
    uploading: 'Subiendo...',
    checkingDuplicates: 'Comprobando...',
    alreadyInLibrary: 'Ya está en la biblioteca',
    duplicateIn: 'en {{folder}}',
    duplicatesWillBeSkipped: '{{count}} archivo(s) duplicado(s) detectado(s) — se omitirán',
    uploadAnyway: 'Subir de todos modos',
    skipDuplicate: 'Omitir',
    skippedDuplicate: 'Omitido (ya está en la biblioteca)',
    ...
    tags: {
      ...
      hintDeselect: '↵ para deseleccionar',
      hintCreate: '↵ para crear',
    ...
    fileHistory: {
      ...
      viewHistoryAria: 'Ver historial de impresión',
      noPermission: 'No tiene permiso para ver el historial del archivo',
      loadFailed: 'Error al cargar el historial del archivo',
      statusPending: 'En cola',
      addedToLibrary: 'Añadido a la biblioteca',
      bySomeone: 'por {{name}}',
      noPrintsYet: 'Este archivo aún no se ha imprimido.',
      externalUnavailable: 'El historial de impresión no está disponible para archivos externos.',
      openArchive: 'Abrir archivo de impresión',
      viewSource: 'Abrir página de origen',
      stats: {
        prints: 'Impresiones',
        success: 'Éxito',
        filament: 'Filamento',
        lastPrinted: 'Última impresión',
      },
    },
    uploadedBy: 'Subido por',
    ...
    toast: {
      ...
      moveSkipped: '{{moved}} movidos, {{skipped}} omitidos: {{reasons}}',
      moveSkipReason: {
        not_owner: 'no es el propietario',
        source_readonly: 'el origen es de solo lectura',
        source_missing: 'el archivo ya no existe en el disco',
        target_readonly: 'el destino es de solo lectura',
        target_misconfigured: 'carpeta de destino mal configurada',
        target_inaccessible: 'carpeta de destino inaccesible',
        target_unwritable: 'sin permiso de escritura en la carpeta de destino',
        invalid_filename: 'nombre de archivo no seguro',
        name_collision: 'conflicto de nombres',
  ...
  sponsors: {
    ...
    tagline: 'Fenrir es gratuito y seguirá siéndolo porque hay quien decide apoyarlo. Sin VC, sin dependencia de la nube.',
    viewSupporters: 'Ver patrocinadores',
    toastPrints: 'Has completado {{count}} impresiones con Fenrir. Fenrir sigue siendo gratuito gracias a quienes lo apoyan.',
    toastCost: 'Has rastreado {{total}} de filamento con Fenrir. Mira quién mantiene el proyecto independiente.',
    toastArchives: '{{count}} impresiones archivadas con Fenrir. Mira quién lo mantiene independiente.',
    toastAnniversary: '¡Un año con Fenrir! Mira quién mantiene el proyecto independiente.',
    toastVersionUpdate: 'Actualizado a v{{version}}. Fenrir sigue siendo gratuito gracias a quienes lo apoyan.',
    toastBusiness: '¿Usas Fenrir en {{count}} impresoras? Existe un plan de soporte para equipos: correcciones prioritarias, facturación y contacto directo con el responsable del proyecto.',
    businessCta: 'Fenrir para empresas',
    businessTitle: 'Fenrir para empresas',
  ...
  inventory: {
    ...
    spoolmanMixedContentBody: 'Fenrir se sirve por HTTPS (mediante su proxy inverso), pero su URL de Spoolman sigue siendo HTTP sin cifrar. Los navegadores bloquean el contenido mixto por seguridad, por lo que la interfaz integrada de Spoolman no se puede mostrar. Spoolman debe ser accesible por HTTPS para que esto funcione.',
    spoolmanMixedContentFixReverseProxy: 'Ponga Spoolman tras el mismo proxy inverso que Fenrir (Traefik / Nginx / Caddy) con HTTPS y luego actualice la URL de Spoolman en Ajustes a la nueva dirección HTTPS.',
  ...
  // Integración con Zoho Books (pestaña de ajustes)
  zoho: {
    title: 'Zoho Books',
    subtitle: 'Conecta Zoho Books para atribuir proyectos de Aito a clientes y sincronizar facturas.',
    clientId: 'ID de cliente',
    clientSecret: 'Secreto de cliente',
    refreshToken: 'Token de actualización',
    organizationId: 'ID de organización',
    baseUrl: 'URL base de la API',
    accountsUrl: 'URL de cuentas',
    defaultContactId: 'ID del cliente predeterminado',
    defaultContactName: 'Nombre del cliente predeterminado',
    defaultContactHint: 'Preseleccionado en la ventana de nuevo proyecto de Aito. El teléfono y el correo electrónico nunca se escriben en este contacto.',
    secretSaved: 'Valor guardado — deja vacío para mantenerlo',
    save: 'Guardar',
    saved: 'Ajustes de Zoho guardados',
    test: 'Probar conexión',
    testOk: 'Conectado a Zoho Books',
    testUnreachable: 'Configurado, pero no se puede contactar con Zoho Books',
    testNotConfigured: 'Zoho Books no está configurado',
  },

  heimdall: {
    title: 'Pagos Heimdall',
    subtitle: 'Crea un enlace de pago en línea para cada presupuesto de Aito mediante la pasarela POS Heimdall. Un enlace pagado acepta el presupuesto automáticamente.',
    baseUrl: 'URL de Heimdall',
    token: 'Token de API',
    tokenHint: 'Solo escritura: déjelo vacío para conservar el token actual',
    depositPct: 'Anticipo (%)',
    depositPctDescription: '0 pide el presupuesto completo; si no, el enlace cubre esta parte.',
    validityDays: 'Validez del presupuesto (días)',
    validityDaysDescription: 'Fecha de caducidad escrita en cada presupuesto nuevo; el enlace de pago termina el mismo día.',
    save: 'Guardar',
    saved: 'Ajustes de Heimdall guardados',
    test: 'Probar la conexión',
    testOk: 'Conectado a Heimdall',
    testUnauthorized: 'Heimdall ha rechazado el token',
    ...
    paymentModesTitle: 'Modos de pago de Zoho',
    paymentModesHint: 'Nombres que usa Zoho Books para un pago registrado desde una ficha de proyecto.',
  ...
  backup: {
    ...
    repoIsPublicWarning: 'El repositorio es PÚBLICO. Las copias de seguridad de Fenrir incluyen credenciales de MQTT, tokens de Home Assistant, tokens de Prometheus, su correo de Bambu Cloud y los códigos de acceso de las impresoras mediante los perfiles K. El guardado está bloqueado hasta que haga el repositorio privado en los ajustes de su proveedor.',
    repoVisibilityUnknown: 'No se pudo determinar la visibilidad del repositorio. Fenrir se niega a hacer copias de seguridad en cualquier cosa que no se confirme como privada; el guardado se bloqueará.',
    ...
    appSettingsDescription: 'Configuración de Fenrir (base de datos completa)',
    ...
    restoreFromGit: {
      ...
      reloadHint: 'Recarga Fenrir para que los datos restaurados aparezcan en todas partes.',
      ...
      notes: {
        ...
        settingsMqttRelayFailed: 'Ajustes MQTT restaurados, pero no se pudo reconectar el relé - reinicia Fenrir',
    ...
    localBackupDescription: 'Cree una copia de seguridad completa de sus datos de Fenrir, incluida la base de datos, los archivos, las subidas y todos los archivos.',
    ...
    backupRestoredRestart: 'Copia de seguridad restaurada. Reinicie Fenrir.',
    ...
    pathCheck: {
      title: 'Fenrir no puede escribir en este directorio',
      howToFix: 'Cómo solucionarlo:',
      sandboxed: 'El servicio de Fenrir no puede escribir en {{path}}. Su unidad de systemd se ejecuta con ProtectSystem=strict, lo que hace que todo directorio fuera de los de instalación, datos y registros sea de solo lectura para el servicio, incluso uno en el que usted sí puede escribir desde su propia shell.',
      read_only: '{{path}} está en un sistema de archivos de solo lectura.',
      permission_denied: 'Fenrir no tiene permiso para escribir en {{path}}. Compruebe el propietario y los permisos del directorio.',
      ...
      error: 'Fenrir no puede escribir en {{path}}.',
      ephemeralTitle: 'Estas copias de seguridad no sobrevivirán a la recreación del contenedor',
      container_ephemeral: '{{path}} está dentro del contenedor de Fenrir, no en el host. Las copias escritas ahí se pierden cuando se recrea el contenedor. Monte el directorio desde el host:',
    },
  ...
  kProfiles: {
    ...
    modal: {
      ...
      notesHelp: 'Las notas se guardan en Fenrir, no en la impresora',
  ...
  virtualPrinter: {
    ...
    enable: {
      ...
      visibleInSlicer: 'Visible como "Fenrir" en la detección del laminador',
    ...
    remoteInterface: {
      ...
      hint: 'Anula la dirección IP anunciada mediante SSDP y usada en el certificado TLS. Útil cuando Fenrir tiene varias interfaces de red.',
    },
    mode: {
      title: 'Modo',
      archive: 'Archivar',
    ...
    caCert: {
      ...
      description: 'Las impresoras virtuales usan un certificado TLS firmado por la CA de Fenrir. Importe este certificado de CA en el almacén de confianza de su laminador una sola vez para que acepte la conexión — sin necesidad de copiarlo desde la línea de comandos.',
      copy: 'Copiar',
      copied: 'Copiado',
      download: 'Descargar',
      fingerprint: 'SHA-256',
    ...
    howItWorks: {
      ...
      step2: 'En los modos Archivar, Revisar y Encolar, use el botón «Enviar» de su laminador para subir archivos 3MF a Fenrir. El laminador mostrará «Impresión correcta» — el archivo se almacena, no se imprime.',
  ...
  locationHaSensors: {
    ...
    autoAdd: {
      ...
      confirmMessage: 'Fenrir también encontró otros sensores para esta ubicación. Elige cuáles añadir también.',
    ...
    options: {
      ...
      pollIntervalHint: 'Con qué frecuencia Fenrir consulta Home Assistant y actualiza los valores de los sensores en pantalla. Mínimo 60 segundos.',
  ...
  smartPlugs: {
    ...
    restEnergyTotalHint:
      'Muchos enchufes — todos los Shelly entre ellos — solo informan de un contador acumulado que nunca se reinicia. Va aquí, no en el campo de arriba: leído como el consumo de hoy nunca se pondría a cero a medianoche, y Ayer y Total seguirían vacíos. Fenrir deduce Hoy y Ayer a partir de él, lo que requiere uno o dos días de lecturas. Un Shelly informa en vatios-hora, así que usa un multiplicador de 0.001.',
  ...
  notifications: {
    ...
    aitoPaymentReceivedLabel: 'Pago de Aito recibido',
    aitoPaymentReceivedDescription: 'Notificar cuando un presupuesto de Aito se paga en línea o con un anticipo suficiente',
    printFailed: 'Impresión fallida',
    printStopped: 'Impresión detenida',
  ...
  time: {
    ...
    today: 'Hoy',
    yesterday: 'Ayer',
    daysElapsed_one: 'hace {{count}} día',
    daysElapsed_other: 'hace {{count}} días',
    monthsElapsed_one: 'hace {{count}} mes',
    monthsElapsed_other: 'hace {{count}} meses',
    yearsElapsed_one: 'hace {{count}} año',
    yearsElapsed_other: 'hace {{count}} años',
  },
  ...
  spoolbuddy: {
    ...
    settings: {
      ...
      backendUrl: 'URL del backend de Fenrir',
  ...
  diagnostic: {
    ...
    check: {
      ...
      external_storage: {
        ...
        warn_internal_storage: 'La opción está activada y hay almacenamiento presente, pero la última impresión aun así fue al almacenamiento interno de la impresora, que Fenrir no puede leer. En la serie H2, la P2S y la X2D, el botón «Imprimir» de Bambu Studio siempre envía ahí, sea cual sea este ajuste. Las impresiones se archivan con su nombre y sus tiempos, pero sin miniatura ni metadatos del laminador. Para archivos completos, inicia las impresiones desde Fenrir o lamina en OrcaSlicer, o bien en Bambu Studio usa «Enviar» con «Externo» y luego inicia la impresión.',
        warn_internal_history: 'La opción está activada y hay almacenamiento, pero la última impresión salió de un archivo que ya estaba en la impresora: una reimpresión desde su pantalla, un inicio desde Handy o un archivo enviado antes. Esa biblioteca reside en el almacenamiento interno, que Fenrir no puede leer, y ninguna opción lo cambia, porque para esa impresión no se envió nada. Se sigue archivando con su nombre y sus tiempos, pero sin miniatura ni metadatos del laminador. Para archivos completos, inicia las impresiones desde Fenrir o envíalas desde el laminador.',
      },
      port_rtsps: {
  ...
  systemHealth: {
    ...
    signature: {
      'ftp-auth-rejected': {
        ...
        fix: 'Vuelve a copiar el código de acceso desde la pantalla de la impresora (ajustes de LAN) y actualízalo en los ajustes de la impresora en Fenrir.',
      },
      'ftp-connection-timeout': {
        name: 'Se agotó el tiempo de la conexión de transferencia de archivos',
        cause: 'Fenrir no pudo alcanzar el puerto de transferencia de archivos de la impresora (FTPS 990). El puerto está bloqueado, o la impresora está apagada o en otra subred.',
        fix: 'Asegúrate de que nada bloquee el puerto 990 entre Fenrir y la impresora, y de que ambos estén en la misma red.',
      },
      'ftp-ssl-error': {
      ...
      'database-locked': {
        ...
        fix: 'Cambia Fenrir a una base de datos PostgreSQL externa. Consulta la guía de PostgreSQL en la documentación.',
      },
    },
  },
  ...
  vpDiagnostic: {
    ...
    check: {
      ...
      running: {
        ...
        fail: 'La impresora virtual está habilitada pero sus servicios no se están ejecutando. Revise el registro de Fenrir — normalmente los detiene un conflicto de IP de enlace o un error de permisos.',
      },
      bind_interface: {
      ...
      certificate: {
        ...
        pass: 'Certificado listo. Asegúrese de que el certificado de CA de Fenrir (arriba) esté importado en el almacén de confianza de su laminador.',
        fail: 'Falta el certificado TLS de esta impresora virtual. Compruebe que el directorio de datos de Fenrir tenga permisos de escritura.',
      },
    },
  },
  ...
  failureDetection: {
    ...
    externalUrlHint: 'La API de ML obtiene la captura de la cámara por URL. Establezca la URL externa en los ajustes generales para que el contenedor de la API de ML pueda alcanzar Fenrir.',
  ...
  makerworld: {
    title: 'MakerWorld',
    description: 'Pegue la URL de un modelo de MakerWorld para importarlo e imprimirlo directamente desde Fenrir — sin tener que salir a la aplicación Bambu Handy.',
    ...
    signInExpiredTitle: 'La sesión de Bambu Cloud ha caducado',
    signInExpiredBody: 'Sigue conectado a Fenrir, pero Bambu Lab ha dejado de aceptar el token almacenado, por lo que las descargas fallarán. Inicie sesión de nuevo en Bambu Cloud.',
    ...
    disclaimer: 'La integración con MakerWorld usa puntos de conexión de API documentados por la comunidad. Fenrir no está afiliado a MakerWorld ni a Bambu Lab ni cuenta con su respaldo.',
  ...
  libraryPurge: {
    ...
    effect4: 'Los archivos de carpetas externas (vinculadas) se omiten — Fenrir nunca elimina bytes que no le pertenecen.',
  ...
  calculator: {
    ...
    material: 'Material',
    title: 'Calculadora',
    subtitle: 'Estima los costes y precios de venta de tus impresiones 3D',
    easyMode: 'Modo sencillo',
    reset: 'Restablecer',
    resetConfirmTitle: 'Restablecer campos',
    resetConfirmMessage: '¿Restablecer todos los campos de la calculadora a sus valores por defecto? Los filamentos, impresoras y valores por defecto se conservan.',
    informations: 'Información',
    weight: 'Peso de la pieza',
    printingTime: 'Tiempo de impresión (h)',
    printingTimeLabel: 'Tiempo de impresión',
    durationDays: 'Días',
    durationDaysShort: 'd',
    durationHours: 'Horas',
    ...
    emptyInputsTitle: 'Introduce el peso y el tiempo de impresión',
    emptyInputsMessage: 'Indica el peso del objeto y el tiempo de impresión para ver un precio sugerido y el desglose de costes.',
    targetPrice: 'Precio objetivo',
    targetPriceLabel: 'Precio objetivo (impuestos incl.)',
    targetPriceProfit: 'Margen neto',
    measuredEnergy: 'Energía medida: {{kwh}} kWh (del archivo)',
    measuredEnergyClear: 'Borrar energía medida',
    qtyIncrease: 'Aumentar cantidad',
    qtyDecrease: 'Reducir cantidad',
    fixErrors: 'Algunas entradas no son válidas: corrige los campos resaltados; los valores no válidos se ignoran en los resultados.',
    breakEvenDiscount: 'Descuento de equilibrio: {{pct}} — con descuentos mayores se vende por debajo del coste.',
    ...
    summaryCopyFailed: 'No se pudo copiar: el navegador bloqueó el portapapeles',
    easyAssumptions: 'Basado en las tarifas guardadas — revisar valores por defecto',
    quantity: 'Cantidad',
    filament: 'Filamento',
    printer: 'Impresora',
    difficulty: 'Factor de dificultad (%)',
    difficultyTooltip: 'Multiplicador para impresiones difíciles: filamento abrasivo, alto riesgo de fallo, manipulación delicada. 100 % = sin recargo.',
    labor: 'Mano de obra',
    modeling: 'Modelado',
    workingHours: 'Horas de trabajo',
    basePrice: 'Precio base',
    preparation: 'Preparación',
    modelPreparation: 'Preparación del modelo',
    slicing: 'Laminado',
    transferStart: 'Transferencia e inicio',
    postProcessing: 'Posprocesado',
    jobRemoval: 'Retirada de la pieza',
    supportRemoval: 'Retirada de soportes',
    additionalWork: 'Trabajo adicional',
    fulfillment: 'Envío',
    stuff: 'Suministros varios',
    amount: 'Importe',
    markupPct: 'Recargo',
    totals: 'Totales',
    machineCost: 'Coste de máquina',
    machineCostSafety: 'Coste de máquina con seguridad',
    costsSoFar: 'Costes acumulados',
    totalHT: 'Total sin impuestos',
    totalTTC: 'Total con impuestos',
    byPrinter: 'Precio por impresora',
    byPrinterHint: 'Precio con {{name}} — haga clic para seleccionar esta impresora',
    realityCheck: {
      title: 'Comprobación real',
      subtitle: 'Medido a partir de sus impresiones, ajustes e inventario.',
      failure: 'Tasa de fallos',
      failureScoped: 'Tasa de fallos ({{scope}})',
      tariff: 'Precio de la electricidad',
      spoolCost: 'Coste del filamento ({{material}})',
      spoolCostBrand: 'Coste del filamento ({{brand}} {{material}})',
      time: 'Tiempo de impresión (corregido)',
      timeScoped: 'Tiempo de impresión ({{scope}})',
      power: 'Consumo eléctrico',
      powerScoped: 'Consumo eléctrico ({{scope}})',
      dailyHours: 'Uso diario',
      dailyHoursScoped: 'Uso diario ({{scope}})',
      apply: 'Aplicar',
      applyAll: 'Aplicar todo',
      applied: 'Aplicado',
      revert: 'Revertir',
      dismiss: 'Descartar',
      restore: 'Restaurar {{count}} descartados',
      allClear: 'Las suposiciones coinciden con sus datos medidos',
      deltaUnit: '{{amount}}/unidad',
      sourcePrints: 'Basado en {{count}} impresiones de los últimos {{days}} días',
      sourcePrintsFleet: 'Promedio de {{printers}} impresoras que coinciden con este perfil — {{count}} impresiones en los últimos {{days}} días',
      sourceSetting: 'Del ajuste de precio de electricidad de la aplicación',
      sourceSpools: 'Media de {{count}} bobinas de su inventario',
      sourceUsage: 'Basado en {{count}} impresiones en {{days}} días observados — un uso real menor aumenta la amortización por hora',
      sourceUsageFleet: 'Promedio por máquina de {{printers}} impresoras que coinciden con este perfil ({{count}} impresiones, {{days}} días observados) — un uso real menor aumenta la amortización por hora',
      saveDefault: 'Guardar como predeterminado',
      savedDefault: 'Valor predeterminado actualizado',
      updateProfile: 'Actualizar perfil',
      updateProfileHint: 'Fijar el coste de compra de este perfil de filamento en la media medida',
      profileUpdated: 'Perfil de filamento actualizado',
      updatePrinter: 'Actualizar perfil',
      updatePrinterHint: 'Fijar este perfil de impresora en el valor medido',
      printerUpdated: 'Perfil de impresora actualizado',
    },
    timeCorrection: {
      hint: 'Sus impresoras alcanzan de media el {{pct}}% de las estimaciones del slicer',
      hintScoped: '{{scope}} alcanza de media el {{pct}}% de las estimaciones del slicer',
      apply: 'Aplicar tiempo corregido',
      dismiss: 'Descartar',
    },
    waterfall: {
      tax: 'Impuestos',
      aria: 'Construcción del precio, de los costes al precio final',
    },
    quote: {
      open: 'Abrir presupuesto imprimible',
      back: 'Volver a la calculadora',
      print: 'Imprimir',
      title: 'Presupuesto',
      empty: 'Aún no hay trabajo que presupuestar — complete primero la calculadora.',
      jobDetails: 'Detalles del trabajo',
      footnote: 'Precios con impuestos incluidos. Presupuesto sujeto a disponibilidad de material.',
    },
    marge: 'Margen',
    marginPct: 'Margen en %',
    marginGlobal: 'Margen global',
    marginFilament: 'Margen de filamento',
    marginStuff: 'Margen de suministros',
    perUnit: 'por unidad',
    forQuantity: 'Total para {{count}} unidades',
    breakdown: 'Desglose de costes',
    costSplit: 'Distribución de costes',
    costFilament: 'Filamento',
    costDepreciation: 'Amortización de la impresora',
    costEnergy: 'Energía',
    costConsumables: 'Consumibles y embalaje',
    costBaseFee: 'Tarifa base',
    costRepairs: 'Reparaciones',
    costPrototype: 'Prototipo',
    costFailures: 'Fallos',
    costAds: 'Publicidad',
    costModeling: 'Modelado',
    costPreparation: 'Preparación',
    costPostProcessing: 'Posprocesado',
    costStuff: 'Suministros',
    groupMachine: 'Máquina',
    groupProvisions: 'Provisiones',
    groupOther: 'Otros',
    groupLabor: 'Mano de obra',
    splitPrinter: 'Impresora',
    splitAdsConsumables: 'Publicidad y consumibles',
    discountTitle: 'Cálculo de descuentos',
    discountMachine: 'Coste de máquina con descuento',
    discountSafety: 'Con seguridad y descuento',
    discountPrice: 'Precio con descuento',
    discountAmount: 'Importe del descuento',
    potentialProfit: 'Beneficio potencial',
    bulkQuantity: 'Cant.',
    emptyTitle: 'Configura tu calculadora',
    emptyMessage: 'Añade al menos un filamento y una impresora para empezar a calcular precios.',
    openSettings: 'Abrir ajustes de la calculadora',
    valNonNegative: 'Debe ser 0 o mayor',
    valQuantityMin: 'Debe ser al menos 1',
    valRange: 'Debe estar entre {{min}} y {{max}}',
    allMaterials: 'Todos los materiales',
    allBrands: 'Todas las marcas',
    noMatches: 'Sin coincidencias',
    tabFilaments: 'Filamentos',
    tabPrinters: 'Impresoras',
    name: 'Nombre',
    costPerKg: 'Coste por kg ({{currency}})',
    printingCostPerKg: 'Coste de impresión por kg ({{currency}})',
    marginOverCost: 'Margen sobre el coste (%)',
    zohoProductSearch: 'Producto de Zoho',
    zohoProductSearchPlaceholder: 'Buscar filamentos en Zoho…',
    zohoNoDealerPrice: 'Sin precio de distribuidor',
    zohoNoResults: 'Ningún filamento de Zoho coincide',
    zohoSearchError: 'No se pudo contactar con Zoho',
    zohoLinkedProduct: 'Vinculado a {{name}}',
    zohoUnlink: 'Desvincular',
    zohoWeightInferred: 'El peso de la bobina no figura en el nombre de Zoho; se asume 1 kg',
    spoolWeightKg: 'Peso de la bobina (kg)',
    ...
    addFilament: 'Añadir filamento',
    editFilament: 'Editar filamento',
    deleteFilamentTitle: 'Eliminar filamento',
    deleteFilamentMessage: '¿Eliminar «{{name}}»? Esta acción no se puede deshacer.',
    filamentCreated: 'Filamento añadido',
    filamentUpdated: 'Filamento actualizado',
    filamentDeleted: 'Filamento eliminado',
    purchasePrice: 'Precio de compra ({{currency}})',
    lifetimeYears: 'Vida útil (años)',
    dailyUsage: 'Uso diario (h)',
    powerWatts: 'Potencia (W)',
    repairRate: 'Reparaciones durante la vida útil (%)',
    lifetimeHours: 'Horas de vida',
    depreciationPerHour: 'Amortización / h',
    repairsPerHour: 'Reparaciones / h',
    addPrinter: 'Añadir impresora',
    editPrinter: 'Editar impresora',
    deletePrinterTitle: 'Eliminar impresora',
    deletePrinterMessage: '¿Eliminar «{{name}}»? Esta acción no se puede deshacer.',
    printerCreated: 'Impresora añadida',
    printerUpdated: 'Impresora actualizada',
    printerDeleted: 'Impresora eliminada',
    inUse: 'Seleccionado en la página de la calculadora',
    electricityTariff: 'Tarifa eléctrica ({{currency}}/kWh)',
    laborRate: 'Tarifa horaria ({{currency}}/h)',
    consumablesFlat: 'Consumibles y embalaje ({{currency}})',
    baseFee: 'Tarifa base ({{currency}})',
    marginCurveHint: 'Dos curvas fijan el margen global: un margen de tamaño que disminuye cuanto más cuesta la pieza, y un descuento por cantidad que recorta el margen (nunca el coste) al aumentar la cantidad.',
    sizeMarginGroup: 'Margen de tamaño',
    qtyDiscountGroup: 'Descuento por cantidad',
    floorGroup: 'Mínimo',
    marginMinMult: 'Multiplicador en piezas muy grandes (M_MIN)',
    marginMaxMult: 'Multiplicador en piezas muy pequeñas (M_MAX)',
    marginK: 'Coste unitario intermedio (K, {{currency}})',
    qtyMinFactor: 'Margen conservado en gran cantidad (Q_MIN)',
    qtyK: 'Cantidad intermedia (KQ)',
    minTaskPrice: 'Precio mínimo por tarea ({{currency}})',
    marginCurveMaxBelowMin: 'M_MAX debe ser al menos M_MIN',
    marginCurvePreviewSize: 'Margen de tamaño según el coste unitario',
    marginCurvePreviewQty: 'Factor de cantidad según la cantidad',
    exampleTitle: 'Trabajo de ejemplo',
    exampleUnitCost: 'Costo unitario de ejemplo ({{currency}})',
    exampleQuantity: 'Cantidad de ejemplo',
    exampleReadout: '×{{size}} margen de tamaño · ×{{qty}} factor de cantidad → ×{{total}} sobre el costo',
    dragK: 'Arrastrar para ajustar K',
    dragKQ: 'Arrastrar para ajustar KQ',
    formulaShow: 'Mostrar fórmula',
    ...
    formulaAt: 'En {{x}} → {{y}}',
    warnFlatSize: 'La curva de tamaño es plana: cada pieza obtiene ×{{m}}.',
    warnKFar: 'K está muy por encima del costo de su ejemplo; la curva apenas se curva donde están sus trabajos.',
    ...
    multiplier: '×{{value}}',
    multiplierDetail: 'tamaño ×{{size}} · cant. {{qty}}',
    floorApplied: 'Precio mínimo aplicado',
    curveTitle: 'Precio según la cantidad',
    curveHint: 'Precio unitario (impuestos incl.) en cada cantidad — los costes fijos se amortizan y el descuento por cantidad recorta el margen.',
    curveUnitPrice: 'Precio unitario',
    curveTaskPrice: 'Total de la tarea',
    curveQtyFactor: 'Factor de cantidad',
    curveCurrent: 'actual',
    failureRate: 'Tasa de fallos (%)',
    prototypeRate: 'Tasa de prototipo (%)',
    adsRate: 'Tasa de publicidad (%)',
    filamentMarkup: 'Recargo de filamento (%)',
    taxPct: 'Impuesto TGC (%)',
    defaultDifficulty: 'Dificultad por defecto (%)',
    defaultMargin: 'Margen por defecto sobre el coste (%)',
    filamentSettings: 'Ajustes de filamento',
    filamentSettingsHint: 'Valores iniciales para nuevos perfiles de filamento.',
    stuffMarkup: 'Recargo de suministros (%)',
    ratesTitle: 'Tarifas',
    ratesHint: 'Lo que te cuesta un trabajo: ajusta estos valores a tus precios y moneda locales antes de presupuestar.',
    provisionsTitle: 'Provisiones y gastos generales',
    provisionsHint: 'Porcentajes añadidos al coste para cubrir impresiones fallidas, prototipos, publicidad y el recargo de reventa del filamento y los extras.',
    unsavedChanges_one: '{{count}} cambio sin guardar',
    unsavedChanges_other: '{{count}} cambios sin guardar',
    fixFields: 'Corrige los campos marcados para guardar.',
