export default {
  ...
  aito: {
    ...
    firstName: 'Nombre',
    lastName: 'Apellido',
    displayNamePreview: 'Guardado como: {{name}}',
    ...
    payment: {
      ...
      cellManualTitle: 'Registrar un pago',
      ...
      linkNone: '{{number}} · aún sin enlace',
      linkOpenState: '{{number}} · abierto, {{expires}}',
