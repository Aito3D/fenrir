export default {
  ...
  calculator: {
    ...
    modelPreparation: 'Preparación del modelo (min)',
    slicing: 'Laminado (min)',
    transferStart: 'Transferencia e inicio (min)',
    postProcessing: 'Posprocesado',
    jobRemoval: 'Retirada de la pieza (min)',
    supportRemoval: 'Retirada de soportes (min)',
    additionalWork: 'Trabajo adicional (min)',
    fulfillment: 'Envío (min)',
