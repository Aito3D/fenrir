export default {
  ...
  aito: {
    ...
    track: {
      ...
      paymentMethods: {
        referenceKnown: 'Indique el número de presupuesto {{ref}} como referencia de su pago.',
        referenceUnknown: 'Indique el número de su presupuesto como referencia de su pago.',
        transfer: 'Transferencia bancaria',
        beneficiary: 'Beneficiario',
        bank: 'Banco',
        transferDelay: 'Una transferencia puede tardar uno o dos días en llegarnos.',
        appTransfer: 'Transferencia {{app}}',
        tag: 'Beneficiario (tag)',
        shop: 'En la tienda',
        shopSub: 'Tarjeta bancaria o efectivo.',
        copy: 'Copiar',
        copied: 'Copiado',
        copyIban: 'Copiar el IBAN',
        copyTag: 'Copiar el tag de {{app}}',
        question: 'Responda a nuestro mensaje para cualquier pregunta.',
      },
      stages: {
        devis: 'Presupuesto',
        waiting: 'Aprobación',
