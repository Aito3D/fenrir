export default {
  ...
  aito: {
    ...
    lockQuote: 'Esperando la aceptación del presupuesto.',
    lockWaiting: 'Con el cliente.',
  ...
  calculator: {
    ...
    printingTimeMin: 'Tiempo de impresión (min)',
    ...
    tabDefaults: 'Valores por defecto',
    name: 'Nombre',
    ...
    tabMarginCurve: 'Curva de margen',
    ...
    tabPricing: 'Precios',
    pricingHint: 'Todo lo que compone un presupuesto. Los cambios se aplican a los nuevos presupuestos en cuanto guardes.',
    ratesTitle: 'Tarifas',
