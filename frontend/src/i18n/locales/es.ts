export default {
  ...
  aito: {
    ...
    stats: {
      caption: '{{active}} en producción · {{done}} terminados en total',
      added: 'Añadidos',
      accepted: 'Aceptados',
      completed: 'Terminados',
      perDay: 'Añadidos por día',
      ...
      lost: 'Perdidos: {{count}} · {{total}}',
      quoteAge: 'Presupuestos sin respuesta',
      ageDays: '{{range}} días',
      ...
      pickup: 'Recogida',
      decisionsHeading: 'Presupuestos aceptados y rechazados',
      declined: 'Rechazados',
      ...
      brief: {
        ...
        dueNone: 'Nada vence esta semana.',
        finished_one: '{{count}} proyecto terminado en este periodo.',
        finished_other: '{{count}} proyectos terminados en este periodo.',
        more: '{{count}} más que el periodo anterior.',
        fewer: '{{count}} menos que el periodo anterior.',
        lead: 'Del presupuesto a la entrega: {{days}}.',
        chaseHeading: 'Reclamar',
        tellHeading: 'Avisar',
        collectHeading: 'Cobrar',
        chaseEmpty: 'Todos los presupuestos tienen respuesta.',
        tellEmpty: 'Todos los clientes están avisados.',
        collectEmpty: 'Todas las facturas están pagadas.',
        ready: 'Listo para recoger',
        late: '{{days}} d de retraso',
        andMore: 'y {{count}} más',
      },
      teaser: {
        sales: '{{pct}} % aceptados · {{lost}} perdidos por {{total}}',
        time: '{{lead}} del presupuesto a la entrega · {{moves}} movimientos hacia atrás',
        money: '{{accepted}} aceptados · {{outstanding}} pendiente · {{service}} es el {{pct}} % de los ingresos',
        moneyPlain: '{{accepted}} aceptados · {{outstanding}} pendiente',
        clients: '{{new}} nuevos · {{returning}} recurrentes',
      },
    },
