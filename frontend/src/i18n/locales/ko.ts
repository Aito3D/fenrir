export default {
  ...
  aito: {
    ...
    statistics: '통계',
    stats: {
      caption: '진행 중 {{active}}건 · 누적 완료 {{done}}건',
      added: '추가됨',
      accepted: '수락됨',
      completed: '완료됨',
      perDay: '일일 추가',
      ...
      thisPeriod: '이 기간',
      brief: {
        sentence: '<chase>{{chase}}</chase>, <tell>{{tell}}</tell>, <collect>{{collect}}</collect>.',
        ...
        tellNone: '알릴 고객 없음',
        collect: '수금할 {{amount}}',
        collectNone: '수금할 금액 없음',
        allClear: '독촉할 것도, 알릴 사람도, 수금할 것도 없습니다.',
        due_one: '이번 주 납품 {{count}}건이 예정되어 있습니다.',
        due_other: '이번 주 납품 {{count}}건이 예정되어 있습니다.',
        dueNone: '이번 주 예정된 납품이 없습니다.',
        finished_one: '이 기간에 {{count}}건 완료.',
        finished_other: '이 기간에 {{count}}건 완료.',
        more: '이전 기간보다 {{count}}건 많습니다.',
        fewer: '이전 기간보다 {{count}}건 적습니다.',
        lead: '견적에서 납품까지 {{days}}.',
        chaseHeading: '독촉',
        tellHeading: '알림',
        collectHeading: '수금',
        chaseEmpty: '모든 견적에 답변이 있습니다.',
        tellEmpty: '모든 고객에게 알렸습니다.',
        collectEmpty: '모든 청구서가 결제되었습니다.',
        ready: '수령 가능',
        late: '{{days}}일 연체',
        andMore: '외 {{count}}건',
      },
      teaser: {
        sales: '수락 {{pct}}% · 실패 {{lost}}건 {{total}}',
        time: '견적에서 납품까지 {{lead}} · 뒤로 이동 {{moves}}회',
        money: '수락 {{accepted}} · 미수금 {{outstanding}} · {{service}}이(가) 매출의 {{pct}}%',
        moneyPlain: '수락 {{accepted}} · 미수금 {{outstanding}}',
        clients: '신규 {{new}} · 재방문 {{returning}}',
      },
    },
