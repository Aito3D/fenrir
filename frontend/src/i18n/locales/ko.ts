export default {
  ...
  aito: {
    ...
    descriptionPlaceholder: '설계하고 출력할 제품을 설명하세요…',
    create: '프로젝트 만들기',
    created: '생성일 {{date}}',
    updated: '수정일 {{date}}',
    ...
    sendInvoice: '청구서 보내기',
    sendInvoiceTitle: '청구서를 이메일로 보내기',
    sendInvoiceRecipient: '받는 사람',
    sendInvoiceSubject: '제목',
    sendInvoiceMessage: '메시지 미리보기',
    ...
    createInvoiceTitle: '청구서 만들기',
    createInvoiceIntro_one: '견적 {{quote}}, {{count}}개 항목. Zoho Books에 청구서 초안이 생성됩니다 — 메일은 발송되지 않습니다.',
    ...
    createInvoiceDonePaid: '청구서 {{number}} 생성 후 선수금으로 정산됨',
    createInvoiceDonePartial: '청구서 {{number}} 생성됨 — {{retainers}}은(는) 적용하지 못했습니다',
    createInvoiceFailed: '청구서를 생성하지 못했습니다',
    acceptQuote: '견적서 수락',
    declineQuote: '견적서 거절',
    holdToConfirm: '0.5초 길게 눌러 확인',
    quoteSent: '견적서를 발송됨으로 표시했습니다',
    quoteAccepted: '견적서를 수락했습니다',
    quoteDeclined: '견적서를 거절했습니다',
    quoteUnaccepted: '승인이 취소되었습니다 — 견적이 대기 상태로 돌아갔습니다',
    unacceptLabel: '승인 취소',
    unacceptHint: '1초간 길게 눌러 승인을 취소합니다',
    quoteConflictAccepted: '이 견적은 이미 다른 사용자가 수락했습니다.',
    quoteConflictDeclined: '이 견적은 이미 다른 사용자가 거절했습니다.',
    zohoNotUpdated: '로컬에 저장됨 — Zoho는 업데이트되지 않았습니다',
    progressLabel: '{{total}}개 단계 중 {{done}}개 완료',
    trash: '휴지통',
    trashEmpty: '휴지통이 비어 있습니다',
    restore: '복원',
    restored: '프로젝트가 복원되었습니다',
    restoreFailed: '프로젝트를 복원할 수 없습니다.',
    deletedOn: '{{date}} 삭제됨',
    ...
    markUrgent: '긴급으로 표시',
    clearUrgent: '긴급 해제',
    holdToMarkUrgent: '0.5초 길게 눌러 긴급으로 표시',
    holdToClearUrgent: '0.5초 길게 눌러 긴급 해제',
    sav: '반품 처리',
    markSav: '반품 처리로 표시',
    clearSav: '반품 처리 해제',
    holdToMarkSav: '0.5초 길게 눌러 반품 처리로 표시',
    holdToClearSav: '0.5초 길게 눌러 반품 처리 해제',
    pause: '일시 중지',
    markPause: '일시 중지로 표시',
    clearPause: '일시 중지 해제',
    holdToMarkPause: '0.5초 길게 눌러 일시 중지로 표시',
    holdToClearPause: '0.5초 길게 눌러 일시 중지 해제',
    markFlag: '표시',
    flagFailed: '표시를 변경하지 못했습니다',
    dueDate: '약속 날짜',
    dueDateClear: '날짜 지우기',
    dueDateEmpty: '날짜 지정',
    dueLateDays: '{{count}}일 지연',
    dueBadge: '기한 {{date}}',
    dueDateFailed: '날짜를 변경할 수 없습니다',
    datePickerPrev: '이전 달',
    datePickerNext: '다음 달',
    datePickerBackToSelected: '선택한 달로 돌아가기',
    datePickerPlusTwoDays: '+2일',
    datePickerPlusOneWeek: '+1주',
    datePickerPlusTwoWeeks: '+2주',
    datePickerSuggested: '추천',
    awaitingContact: '연락 필요',
    markContacted: '고객에게 연락함으로 표시',
    holdToMarkContacted: '0.5초 길게 눌러 고객 연락을 확인',
    contacted: '연락함',
    clearContacted: '연락함 취소',
    holdToClearContacted: '0.5초 길게 눌러 연락함 취소',
    contactedFailed: '연락을 기록하지 못했습니다',
    smsPickupShort: 'SMS',
    smsPickup: '픽업 SMS 보내기',
    smsTitle: '픽업 SMS',
    smsMessageLabel: '메시지',
    smsGenerating: '메시지 작성 중…',
    smsGenerateFailed: '메시지를 작성할 수 없습니다',
    smsRegenerate: '다시 생성',
    smsSend: '휴대폰으로 보내기',
    ...
    zohoNotConfigured: 'Zoho Books가 아직 연결되지 않았습니다.',
    zohoConfigureLink: 'Zoho Books 연결',
    zohoUnreachable: 'Zoho Books에 연결할 수 없습니다. 다시 시도해 주세요.',
    resetToDefaultClient: '기본 고객으로 초기화',
    clientPhone: '전화번호',
    clientEmail: '이메일',
    countryCode: '국가 번호',
    phonePlaceholder: '87123456',
    emailPlaceholder: 'client@example.com',
    revertPhone: '전화번호 되돌리기',
    revertEmail: '이메일 되돌리기',
    socialNetworkMessenger: 'Messenger',
    socialNetworkInstagram: 'Instagram',
    socialNetworkWhatsapp: 'WhatsApp',
    socialNetworkTiktok: 'TikTok',
    socialLabel: 'SNS (선택)',
    socialHandleLabel: '사용자 이름',
    ...
    contactFirstNameRequired: '이름을 입력하세요.',
    contactNeedsPhoneOrEmail: '연락하려면 전화번호나 이메일이 필요합니다.',
    contactAddFailed: '연락처를 추가할 수 없습니다. 다시 시도해 주세요.',
    contactOverrideToggle: '이 카드에서만 다른 전화번호 / 이메일 사용',
    contactOverrideHint: '이 카드에만 적용됩니다 — Zoho Books의 연락처는 변경되지 않습니다.',
    contactGone: '이 담당자는 더 이상 Zoho Books에 없습니다 — 다른 담당자를 선택하세요.',
    clientEditFanOutPerson: '이 담당자의 모든 열린 카드에 적용',
    clientEditTitle: '연락처 정보',
    clientEditSourceZoho: 'Zoho Books',
    clientEditSourceCard: '이 카드만',
    clientEditFanOut: '이 고객의 모든 열린 카드에 적용',
    ...
    clientHistoryNoQuote: '견적 없음',
    clientHistoryThisCard: '이 카드 · {{stage}}',
    clientHistoryDeclined: '거절됨',
    clientHistoryOpenCard: '프로젝트 #{{id}} 열기',
    clientHistoryEmpty: '이 고객의 프로젝트가 아직 없습니다.',
    clientHistoryError: '고객 이력을 불러오지 못했습니다.',
    clientEditLoading: 'Zoho Books에서 연락처를 읽는 중…',
    clientEditWalkIn: '일회성 고객: 변경 사항은 이 카드에만 저장되며 Zoho Books로 전송되지 않습니다.',
    clientEditZohoReadFailed: 'Zoho Books에서 연락처를 읽을 수 없습니다 — 카드의 값을 표시합니다.',
    clientEditFailed: '고객을 업데이트할 수 없습니다. 다시 시도해 주세요.',
    createClient: '새 고객 만들기',
    companyName: '회사명',
    firstName: '이름',
    lastName: '성',
    createClientSubmit: '고객 만들기',
    back: '뒤로',
    clientNameRequired: '회사명을 입력하거나, 이름과 성을 모두 입력하세요.',
    newClientPersonHint: '또는 담당자의 이름과 성',
    newClientContactTag: '회사 담당자',
    newClientContactHint: '권장 — 이름만으로 충분',
    newClientPreviewCompany: '회사: {{name}} · 담당자: {{person}}',
    newClientPreviewCompanyAlone: '회사: {{name}} · 담당자 미지정',
    newClientPreviewIndividual: '개인: {{name}}',
    clientCreateFailed: '고객을 만들 수 없습니다. 다시 시도해 주세요.',
    clientSyncFailed: '프로젝트가 생성되었습니다 — Zoho에서 고객 정보를 업데이트하지 못했습니다.',
    ...
    recordLabel: '기록',
    duplicateProject: "복제",
    duplicateReplaceTitle: "작성 중인 초안을 대체할까요?",
    duplicateReplaceBody: "새 프로젝트 서랍에 아직 생성되지 않은 작업이 남아 있습니다. 이 카드를 복제하면 대체됩니다.",
    duplicateReplaceConfirm: "대체",
    ...
    editConflict: '다른 사용자가 이 프로젝트를 수정했습니다. 보드를 새로 고쳤으니 다시 시도하세요.',
    tasks: '작업',
    addTask: '작업 추가',
    taskFallbackName: '작업 {{n}}',
    track: {
      pageTitle: '주문 추적 · Aito 3D',
      title: '주문 추적',
      reference: '견적 번호 {{ref}}',
      ...
      hideSteps: '단계 숨기기',
      stepsList: '단계 상세',
      tasksHeading: '주문하신 부품',
      showAllParts: '{{n}}개 부품 모두 보기',
      eta: '예상 수령 시기',
      etaSoon: '가능한 한 빨리 날짜를 알려드리겠습니다.',
      etaUpdating: '예상 시기 업데이트 중',
      updated: '업데이트 {{when}}',
      updatedToday: '오늘 {{time}}',
      updatedYesterday: '어제 {{time}}',
      updatedOn: '{{date}} {{time}}',
      error: '지금은 추적 정보를 불러올 수 없습니다.',
      retry: '다시 시도',
      invalidTitle: '이 추적 링크는 더 이상 유효하지 않습니다',
      invalidBody: '만료되었거나 새 링크로 교체되었을 수 있습니다. 연락 주시면 새 링크를 보내드리겠습니다.',
      footerQuestion: '주문에 대해 궁금한 점이 있으신가요?',
      enterTitle: '내 주문 추적',
      enterHint: '견적서 또는 메시지에 적힌 6자리 코드를 입력하세요.',
      codeLabel: '추적 코드',
      codeChecking: '확인 중…',
      retrying: '다시 시도 중…',
      codeFound: '코드가 확인되었습니다. 추적 페이지를 엽니다.',
      codeNotFound: '코드를 찾을 수 없습니다. 확인 후 다시 시도하세요.',
      codeTooMany: '시도 횟수가 너무 많습니다. 1분 후 다시 시도하세요.',
      codeError: '지금은 코드를 확인할 수 없습니다. Enter 키로 다시 시도하세요.',
      ...
      paymentMethods: {
        ...
        beneficiary: '수취인',
        bank: '은행',
        transferReference: '입금자 메모',
        referenceUnknown: '견적 번호',
        transferDelay: '이체가 도착하기까지 하루 이틀 걸릴 수 있습니다.',
        appTag: '{{app}} 태그',
        appMessage: '메시지',
        appHint: '{{app}} 앱에서 견적 금액을 이 태그로 보내 주세요.',
        shop: '매장',
        shopSub: '카드, 현금 또는 수표.',
        shopAddress: '주소',
      ...
      status: {
        ...
        pickedUpTitle: '수령됨',
        pickedUpSub: '{{date}}. 믿고 맡겨 주셔서 감사합니다!',
        doneTitle: '완료',
        doneSub: '믿고 맡겨 주셔서 감사합니다!',
      },
      invoice: {
        paidTitle: '결제 완료',
        paidSub: '믿고 맡겨 주셔서 감사합니다.',
        unpaidTitle: '결제 대기',
        unpaidSub: '수령 또는 발송 전에 결제해 주세요.',
        overdueTitle: '결제 기한 초과',
        overdueSub: '이미 결제하셨다면 연락해 주세요.',
      },
      payment: {
        unpaidTitle: '아직 결제되지 않은 프로젝트',
        unpaidSub: '온라인, 계좌 이체 또는 매장에서 결제해 주세요.',
        unpaidDepositSub: '계약금을 결제하시면 주문이 확정됩니다. 온라인, 계좌 이체 또는 매장에서 결제해 주세요.',
        validateTitle: '견적을 승인해 주세요',
        validateSub: '온라인 결제는 견적 승인으로 간주됩니다.',
        validateDepositSub: '계약금을 결제하시면 견적이 승인되고 제작이 시작됩니다.',
        pay: '온라인으로 결제',
        paidTitle: '결제가 확인되었습니다',
        depositPaidTitle: '계약금이 확인되었습니다',
        paidSub: '믿고 맡겨 주셔서 감사합니다.',
      },
    },
    trackingCopy: '추적 링크 복사',
    trackingOpen: '추적 링크 열기',
    trackingCopied: '복사됨',
    ...
    paymentLink: {
      ...
      open: '결제 링크 열기',
      copied: '복사됨',
      expiresIn_one: '{{count}}일 후 만료',
      expiresIn_other: '{{count}}일 후 만료',
      expiresToday: '오늘 만료',
      retry: '재시도',
      state: { expired: '만료됨', cancelled: '취소됨', failed: '거절됨' },
    },
    payment: {
      dueQuote: '계약금 미납액',
      dueInvoice: '미결제 잔액',
      ...
      cellManual: '수동',
      cellLinkTitle: '결제 링크',
      cellTerminalTitle: '카드 단말기로 결제',
      cellManualTitle: '수동: 결제 기록',
      terminalOff: 'Heimdall이 구성되지 않았습니다',
      stateProcessing: '단말기 · 카드 대기 중',
      stateAttention: '결과 불명 · 단말기를 확인하세요',
      statePaid: '{{amount}} 결제됨 · {{channel}} · {{date}}',
      statePaidNoDate: '{{amount}} 결제됨 · {{channel}}',
      stateBookingFailed: 'Zoho Books에 기록되지 않음 — Heimdall 확인',
      stateNoLink: '링크 없음',
      channelTerminal: '단말기',
      channelLink: '온라인',
      amountLabel: '금액',
      manualTitle: '결제 기록',
      manualIntroQuote: '견적 {{number}} · 매장에서 계약금 수령',
      manualIntroInvoice: '청구서 {{number}} · 매장에서 결제 수령',
      modeLabel: '방식',
      modeCard: '카드',
      modeCheque: '수표',
      modeCash: '현금',
      referenceLabel: '참조 번호',
      referenceRequired: '수표에는 번호가 필요합니다',
      manualHintQuote: 'Zoho Books의 견적에 계약금 청구서를 생성하고 결제를 기록합니다.',
      manualHintInvoice: 'Zoho Books의 청구서에 결제를 기록합니다.',
      manualConfirm: '기록',
      manualDone: '결제가 기록되었습니다',
      amountInvalid: '0보다 큰 정수 금액을 입력하세요',
      terminalTitle: '카드로 결제',
      terminalIntro: '{{number}} · 매장 카드 단말기',
      terminalHintQuote: '계약금이 미리 입력되어 있으며, 견적에서는 모든 금액이 허용됩니다.',
      terminalHintInvoice: '잔액이 미리 입력되어 있으며, Heimdall이 잔액으로 상한을 설정합니다.',
      terminalStart: '단말기 시작',
      terminalWaiting: '단말기에서 카드를 기다리는 중…',
      terminalWaitingHint: 'PIN 입력까지 최대 3분이 걸립니다.',
      terminalLeave: '닫기, 나중에 돌아올게요',
      terminalPaid: '결제가 승인되었습니다',
      terminalBookingPending: 'Zoho Books에 기록 중…',
      terminalBookingDone: 'Zoho Books에 기록됨',
      terminalBookingFailed: 'Zoho Books에 기록되지 않음 — Heimdall 확인',
      terminalFailed: '거절됨',
      terminalFailedHint: '청구된 금액이 없습니다. 다시 시도할 수 있습니다.',
      terminalRetry: '다시 시도',
      terminalAttention: '결과 불명',
      terminalAttentionHint: '단말기가 응답하지 않았습니다. 다시 시도하기 전에 종이 영수증을 확인하세요.',
      linkTitle: '결제 링크',
      linkCreate: '링크 생성',
      linkCreateAgain: '새 링크 생성',
      linkCancel: '링크 취소',
      linkCancelConfirm: '이 링크를 취소하시겠습니까?',
      linkExpires: '만료',
      linkHintInvoice: '잔액이 미리 입력되어 있습니다. 링크는 견적 유효 기간 이후 만료됩니다.',
      linkPending: '링크를 생성하는 중…',
      linkDone: '결제 링크가 생성되었습니다',
      linkCancelled: '결제 링크가 취소되었습니다',
    },
    pastCards_one: '이전 카드 {{count}}개',
    pastCards_other: '이전 카드 {{count}}개',
    reuseTasks: '재사용',
    rating: {
      good: '양호',
      medium: '보통',
      ...
      pastDue_one: '{{count}}건 기한 경과',
      pastDue_other: '{{count}}건 기한 경과',
    ...
    taskDescriptionPlaceholder: '설명 (선택사항)',
    removeTask: '작업 제거',
    serviceScan3D: '스캔',
    serviceModelisation3D: '모델링',
    serviceImpression3D: '프린팅',
    serviceUsinage: '가공',
    serviceMainDoeuvre: '인건비',
    serviceDescriptionRequired: '설명(필수)',
    maindoeuvreDescriptionRequired: '인건비에는 설명이 필요합니다',
    serviceCost: '비용',
    serviceUnitCost: '단가',
    discount: '할인',
    serviceTotal: '항목 합계',
    ...
    quoteNoServiceLines: '이 견적에는 AITO 3D 서비스 항목이 없습니다.',
    quoteAlreadyImported: '프로젝트 #{{id}}(으)로 이미 가져왔습니다',
    quoteImport: '가져오기',
    quoteSkipped: '가져오지 않음',
    quoteTotals: '프로젝트 {{project}} · 견적 {{quote}}',
    quoteCurrencyMismatch: '이 견적의 통화는 {{code}}이며, 보드에는 {{configured}}이(가) 표시됩니다.',
    quoteOpenInZoho: 'Zoho Books에서 열기',
    changeQuote: '변경',
    quoteRowImported: '가져옴 → #{{id}}',
    beforeImport: '가져오기 전 확인',
    ruleQuoteLines: '견적에 AITO 서비스 항목이 있음',
    ruleQuoteFresh: '이전에 가져온 적 없음',
    ruleCurrencyOk: '통화가 보드와 일치',
    ruleImportDescription: '설명이 입력됨',
    importTaskCount_one: '작업 {{count}}개',
    importTaskCount_other: '작업 {{count}}개',
    printer: '프린터',
    material: '재료',
    weightG: '무게 (g)',
    printTime: '출력 시간',
    ...
    invoiceStatus: {
      ...
      unpaid: '미결제',
      paid: '결제됨',
      partiallyPaid: '부분 결제됨',
      overdue: '연체',
      void: '무효',
    },
    quotePending: '견적서 생성 중…',
    sync: '동기화',
    ...
    retrySync: '다시 시도',
    syncBlockedLabel: '동기화 차단됨',
    forceSync: '강제 동기화',
    forceSyncHint: 'Zoho에서 견적서를 다시 확인하고 비용을 다시 전송합니다',
    showDone: '완료 항목 보기',
    ...
    stats: {
      ...
      ageDays: '{{range}}일',
      winRate: '금액대별 수락률',
      winRateEmpty: '결정된 견적이 아직 부족합니다',
      decisions: '{{count}}건 결정',
      stageTime: '완료 프로젝트별 소요 시간',
      reworkMoves: '뒤로 이동',
      reworkShare: '{{cards}}개 카드 · 이동한 카드의 {{pct}}%',
      overdue: '연체된 청구서',
      overdueOldest: '가장 오래된 {{days}}일',
      nothingOverdue: '연체 없음',
      serviceMix: '서비스 구성',
      serviceTasks: '작업 {{count}}개',
      clientsNew: '신규 고객',
      clientsReturning: '재방문 고객',
      returningShare: '매출의 {{pct}}%가 재방문 고객에서',
      arrivals: '요청이 들어오는 시간',
      islands: '섬별 배송',
      pickup: '매장 수령',
      declined: '거절됨',
      acceptanceRate: '{{pct}}% 수락',
      ...
      strip: {
        onBoard: '보드에 {{amount}}',
        longest: '가장 오래 기다린 건: <who>{{name}}, {{days}}</who>, {{stage}} 단계',
        oldest: '최장 {{days}}일',
        noQuote: '아직 견적 없음',
        dueSoon_one: '이번 주 납품 {{count}}건',
        dueSoon_other: '이번 주 납품 {{count}}건',
      },
      facts: {
        perDay: '하루 {{count}}건',
        waiting15: '15일 이상 대기',
        lostWith: '거절된 견적으로 잃은 금액',
        shippingBilled: '청구한 배송비',
        parcels_one: '소포 {{count}}개',
        parcels_other: '소포 {{count}}개',
        invoices_one: '청구서 {{count}}건',
        invoices_other: '청구서 {{count}}건',
        cards_one: '카드 {{count}}개',
        cards_other: '카드 {{count}}개',
        today: '오늘',
      },
      finding: {
        overview: '{{in}}, {{accepted}}, {{done}}.',
        overviewIn_one: '프로젝트 {{count}}건이 들어왔고',
        overviewIn_other: '프로젝트 {{count}}건이 들어왔고',
        overviewAccepted_one: '{{count}}건이 수락되었으며',
        overviewAccepted_other: '{{count}}건이 수락되었으며',
        overviewDone_one: '{{count}}건이 납품되었습니다',
        overviewDone_other: '{{count}}건이 납품되었습니다',
        overviewPeakWeek: '가장 바빴던 주는 {{date}} 주였습니다.',
        overviewPeakDay: '가장 바빴던 날은 {{date}}였습니다.',
        salesWin: '견적의 {{pct}} %를 수주하고 있습니다.',
        salesLost_one: '견적 {{count}}건을 놓쳤고, 금액은 {{total}}입니다.',
        salesLost_other: '견적 {{count}}건을 놓쳤고, 합계 {{total}}입니다.',
        salesLostBig: '놓치는 건은 큰 건입니다: {{min}} 초과 {{decided}}건 중 {{lost}}건, 합계 {{total}}.',
        salesNone: '이 기간에 결정된 견적이 없습니다.',
        timeLead: '프로젝트 하나에 견적부터 납품까지 {{days}} 걸립니다.',
        timeSlow: '가장 느린 단계는 {{stage}}이며, {{days}} 걸립니다.',
        timeRework_one: '{{count}}회 뒤로 이동했습니다.',
        timeRework_other: '{{cards}}에서 {{count}}회 뒤로 이동했습니다.',
        timeNone: '이 기간에 납품된 프로젝트가 없습니다.',
        moneyTotals: '수락 {{accepted}}, 청구 {{invoiced}}.',
        moneyOut: '{{invoices}}에 아직 {{amount}}이(가) 남아 있습니다.',
        moneyOverdue_one: '그중 {{count}}건이 {{days}}일 연체되었습니다.',
        moneyOverdue_other: '그중 {{count}}건이 연체되었고, 가장 오래된 것은 {{days}}일입니다.',
        moneyClear: '미수금이 없습니다.',
        clients: '{{new}}, {{returning}}.',
        clientsNew_one: '신규 고객 {{count}}명',
        clientsNew_other: '신규 고객 {{count}}명',
        clientsReturning_one: '재방문 고객 {{count}}명',
        clientsReturning_other: '재방문 고객 {{count}}명',
        clientsPeak: '요청은 {{day}} {{hour}}쯤에 들어옵니다.',
        clientsParcels_one: '소포 {{count}}개가 섬으로 발송되었습니다.',
        clientsParcels_other: '소포 {{count}}개가 섬으로 발송되었습니다.',
        clientsNone: '이 기간에 신규 고객이 없습니다.',
      },
      brief: {
        chase_one: '독촉할 견적 {{count}}건',
        chase_other: '독촉할 견적 {{count}}건',
        tell_one: '알릴 고객 {{count}}명',
        tell_other: '알릴 고객 {{count}}명',
        collect: '수금할 {{amount}}',
        allClear: '독촉할 것도, 알릴 사람도, 수금할 것도 없습니다.',
        due_one: '이번 주 납품 {{count}}건이 예정되어 있습니다.',
        due_other: '이번 주 납품 {{count}}건이 예정되어 있습니다.',
        chaseHeading: '독촉',
        tellHeading: '알림',
        collectHeading: '수금',
        ready: '수령 가능',
    ...
    history: {
      ...
      noteSubmit: '메모 추가',
      noteFailed: '메모를 저장할 수 없습니다',
      changeCount: '{{count}}건 변경',
      automatic: '자동',
      fromZoho: 'Zoho Books에서',
      projectCreated: '프로젝트를 생성했습니다',
      quoteCreated: '견적서가 생성되었습니다',
      quoteSent: '견적서를 발송됨으로 표시했습니다',
      ...
      quoteUnaccepted: '견적 승인을 취소했습니다',
      quoteDeclined: '견적서를 거절했습니다',
      quoteExpired: '견적서가 만료되었습니다',
      stageChanged: '프로젝트를 이동했습니다',
      projectTrashed: '프로젝트를 휴지통으로 이동했습니다',
      ...
      projectUrgentSet: '긴급으로 표시함',
      projectUrgentCleared: '긴급 해제됨',
      projectSavSet: '반품 처리로 표시함',
      projectSavCleared: '반품 처리 해제됨',
      projectPauseSet: '일시 중지로 표시함',
      ...
      paymentTerminalStarted: '단말기에서 카드 결제를 시작했습니다',
      paymentTerminalPaid: '단말기에서 카드로 결제되었습니다',
      paymentTerminalFailed: '단말기 결제가 거절되거나 취소되었습니다',
      paymentTerminalAttention: '단말기 결과를 알 수 없습니다 — 단말기를 확인하세요',
      paymentManualRecorded: '결제가 기록되었습니다',
      paymentManualPartial: '계약금 청구서가 생성되었지만 결제는 기록되지 않았습니다 — Zoho Books에서 완료하세요',
      noteAdded: '메모를 추가했습니다',
      zohoComment: 'Zoho Books의 댓글',
      syncQueued: 'Zoho 전송 대기 중',
      syncPushed: 'Zoho로 전송됨',
      syncFailed: 'Zoho로 전송 실패',
      syncLocked: 'Zoho에서 견적서가 잠김',
      syncConflict: 'Zoho와 상태 충돌',
      syncStatusRejected: 'Zoho가 상태 변경을 거부했습니다',
      pollReconciled: 'Zoho와 대조 완료',
    },
    // New-project drawer
    workSection: '작업 내용',
    clientSectionTitle: '고객',
    workHintNone: '작업 없음',
    workHintProgress: '{{total}}개 중 {{done}}개 완료',
    addService: '{{service}} 추가',
    removeServiceChip: '{{service}} 제거',
    taskNeedsSubTask: '하위 작업 추가',
    railSummary: '요약',
    summaryTitle: '프로젝트 요약',
    summaryWaiting: '고객 단계로 이동하면 생성됩니다.',
    summaryGeneratedBy: '{{model}} 생성 — 클릭하여 편집',
    summaryEdited: '수동 편집됨 — 자동 재생성 중지',
    summaryFallback: 'AI를 사용할 수 없음 — 설명을 직접 작성하세요',
    aiFieldHint: 'AI가 맞춤법을 교정했습니다',
    aiChecking: '맞춤법 확인 중…',
    aiUndo: '내 텍스트 복원',
    regenerate: '재생성',
    beforeCreate: '생성 전 확인',
    ruleTasksOk_one: '작업 {{count}}개 — 최소 1개 필요',
    ruleTasksOk_other: '작업 {{count}}개 — 최소 1개 필요',
    ruleNeedTask: '프로젝트에는 최소 1개의 작업이 필요합니다 — 추가하세요',
    ruleSubTasksOk: '모든 작업에 가격이 지정된 하위 작업이 있습니다',
    ruleSubTaskMissing: '"{{name}}"에는 가격이 지정된 하위 작업이 최소 1개 필요합니다',
    ruleSubTasksPending: '각 작업에는 가격이 지정된 하위 작업이 최소 1개 필요합니다',
    ruleClientAccount: '고객 계정 — {{name}}',
    ruleClientReachable: '연락 가능 — {{contact}}',
    ruleClientContact: '고객의 전화번호, 이메일 또는 SNS가 필요합니다',
    warnNoEmail: '이메일 없음 — 견적서를 이메일로 보낼 수 없습니다',
    warnNoPhone: '전화번호 없음 — 잊지 말고 요청하세요',
    holdToReset: '길게 눌러 초안 초기화',
    resetDraft: '초안 초기화',
    shippingAdd: '배송 추가',
    shippingTitle: '배송',
    ...
    shippingLastName: '수령인 성',
    shippingPhone: '수령인 전화번호',
    shippingRecipient: '수령인',
    shippingService: '배송 서비스',
    shippingRate: '요금',
    shippingRateFromZoho: 'Zoho 요금: {{rate}}',
    ...
    shippingLta: 'LTA 번호',
    shippingLtaPlaceholder: '항공화물운송장 번호…',
    ...
    ruleShippingMissingIsland: '배송: 섬 누락',
    ruleShippingMissingRecipient: '배송: 수령인 이름 누락',
    ruleShippingInvalidPhone: '배송: 잘못된 전화번호',
  },
  nav: {
    aito: 'Aito',
    calculator: '계산기',
  ...
  printers: {
    ...
    cameraGrid: {
      quality: '화질',
      qualityGlobalHint: '모든 시청자에게 적용됩니다',
      auto: '자동',
      low: '낮음',
      medium: '중간',
      high: '높음',
    ...
    nozzleFilament: '필라멘트',
    nozzleWear: '마모',
    nozzleSlotEmpty: '슬롯 {{slot}} — 비어 있음',
    humidityTooltip: '습도: {{value}}% - {{status}}',
    temperatureTooltip: '온도: {{value}}°C - {{status}}',
    clickForHistory: '클릭하여 기록 보기',
    nozzleMaxTemp: '최대 온도',
    nozzleSerial: '일련번호',
  ...
  archives: {
    ...
    card: {
      ...
      source: '소스',
      unverifiedFile: '미확인',
      unverifiedFileTooltip: '이 파일은 이름만으로 매칭되었습니다. 실제로 인쇄된 파일이 아닐 수 있습니다.',
      project: '프로젝트: {{name}}',
      estimated: '예상: {{time}}',
      actual: '실제: {{time}}',
  ...
  queue: {
    ...
    batchOrders: {
      ...
      strandedPlate: '설정을 복사할 실행이 없습니다',
      strandedNotice: '아직 남은 {{owed}}건 중 {{runs}}건을 대기열에 추가할 수 없습니다. 해당 플레이트에는 설정을 복사할 대기 중이거나 완료된 실행이 남아 있지 않습니다. 파일에서 해당 플레이트를 한 번 대기열에 추가하거나 주문을 취소하세요.',
    ...
    cancelBatchConfirmMessage: '이 주문을 종료할까요? 대기열에 남은 실행은 취소되고, 생산하지 못한 분량도 더 이상 요구하지 않습니다.',
    batch: {
      defaultName: '배치',
      label: '{{count}}개 항목',
    ...
    toast: {
      ...
      keptForOrder: '제거 대신 취소했습니다: 배치 주문이 이 플레이트를 다시 대기열에 넣을 수 있는 유일한 실행입니다',
      historyKeptForOrders: '배치 주문에 아직 필요한 {{kept}}건은 남겨 두었습니다.',
  ...
  stats: {
    ...
    failuresByFilament: '필라멘트별 실패',
    failuresByPrinter: '프린터별 실패',
    deltaVsPrevious: '이전 {{days}}일 대비',
    utilizationBusy: '{{hours}}시간 가동',
    utilizationNoData: '이 기간에 시간 데이터가 있는 출력이 없습니다',
    costBreakdown: '비용 내역',
    costFilament: '필라멘트',
    costEnergy: '에너지',
    costMachine: '기기',
    costPerPrintHour: '출력 시간당',
    costPerKg: 'kg당',
    costCoverage: '{{total}}건 중 {{priced}}건 산정됨',
    costNoData: '현재 계산기 설정으로 비용을 산정할 수 있는 출력이 없습니다',
    filamentForecast: '필라멘트 예측',
    forecastDaysLeft: '약 {{days}}일 남음',
    forecastNoUsage: '최근 사용 없음',
    forecastNoInventory: '재고에 스풀이 없습니다',
    forecastRemaining: '{{amount}} 남음',
    forecastBasis: '최근 사용량 기반 예측 — 자세한 내용은 재고 페이지에서',
    maintenanceReliability: '유지보수 및 신뢰성',
    printsSinceMaintenance: '{{date}} 이후 출력 {{prints}}건 · 실패 {{failures}}건',
    neverMaintained: '유지보수 기록 없음',
    maintenanceDueBadge: '{{n}}건 기한 초과',
    maintenanceWarningBadge: '{{n}}건 임박',
    maintenanceNoData: '유지보수를 추적하는 프린터가 없습니다',
    maintenanceSinceCaption: '건수는 선택한 기간 내 기준입니다',
    energyWidgetTitle: '에너지 소비',
    aitoPipeline: 'Aito 파이프라인',
    aitoPipelineEmpty: '이 기간에 Aito 보드에 항목이 없습니다',
    pipelineByStage: '단계별',
    pipelineConversion: '견적 전환',
    pipelineSent: '발송',
    pipelineAccepted: '수락',
    pipelineDeclined: '거절',
    pipelineAcceptedRate: '수락률 {{pct}}%',
    pipelineStageDays: '단계별 소요일',
    pipelineInvoicing: '청구',
    pipelineInvoiced: '청구됨',
    pipelineOutstanding: '미수금',
    pipelineTracking: '고객 추적',
    pipelineTrackingViews: '페이지 열람 수',
    pipelineTrackingCards: '조회된 카드',
    pipelineTrackingLinks: '링크가 있는 카드',
    pipelineDays: '{{days}}일',
    pipelineSample_one: '{{count}}건',
    pipelineSample_other: '{{count}}건',
    energyTotalLabel: '합계',
    energyCostLabel: '비용',
    energyAvgPerDay: '일 평균',
    energyAvgPerPrint: '출력당 평균',
    energyNoPlugs: '에너지 모니터링이 설정된 스마트 플러그가 없습니다',
    energyNoData: '이 기간에 기록된 에너지 데이터가 없습니다',
  ...
  settings: {
    ...
    cameraRotation: '회전',
    cameraQuality: '카메라 화질',
    cameraQualityLow: '낮음',
    cameraQualityMedium: '중간',
    cameraQualityHigh: '높음',
    cameraQualityAuto: '자동',
    cameraQualityAutoWithResolved: '자동 ({{resolved}})',
    cameraQualityAutoResolved: '서버 하드웨어에 따라 자동 선택: {{resolved}}.',
    cameraQualityAutoResolvedDual: '서버 하드웨어와 스트림 수에 따라 자동 선택: {{single}} (단일 보기), {{grid}} (카메라 그리드).',
    cameraQualityDescription: '스트림 FPS와 해상도를 제어합니다. 화질을 낮추면 다중 카메라 환경에서 CPU 사용량이 줄어듭니다.',
    cameraGpuAccel: 'GPU 가속',
    cameraGpuAccelDescription: '카메라 스트림에 하드웨어 가속 비디오 디코딩을 사용합니다. 지원 GPU가 있는 서버에서 CPU 사용량을 줄입니다.',
    cameraGpuAccelUnavailable: '이 서버에서 GPU 가속 백엔드를 찾을 수 없습니다.',
    cameraGpuAccelBackends: '사용 가능한 백엔드: {{backends}}',
    cameraEngine: '카메라 엔진',
    cameraEngineFFmpeg: 'FFmpeg (MJPEG)',
    cameraEngineGo2rtc: 'go2rtc (WebRTC)',
    cameraEngineFFmpegDescription: 'FFmpeg로 RTSP를 MJPEG로 변환합니다. 모든 브라우저에서 작동하지만 CPU를 더 많이 사용합니다.',
    cameraEngineGo2rtcDescription: 'WebRTC로 H.264를 브라우저에 직접 전달합니다. 변환 없음, 낮은 지연 시간, 하드웨어 디코딩. 챔버 카메라(A1/P1)는 계속 FFmpeg를 사용합니다.',
    ...
    aitoFollowupLinkDays: '결제 링크 만료 (일)',
    aitoFollowupLinkDaysDescription: '결제 링크가 이 일수 이내에 만료되는 견적을 표시합니다',
  },
  notification: {
    printStarted: {
      title: '인쇄 시작됨',
  ...
  camera: {
    ...
    expand: '확대',
    minimize: '최소화',
    reconnectingIn: '{{countdown}}초 후 재연결...',
    stream: '카메라 스트림',
    resize: '드래그하여 크기 조절',
  ...
  filamentProfiles: {
    ...
    gridLarge: '큰 그리드',
    // Grid
    emptyTitle: '아직 프리셋이 없습니다',
    emptySubtitle: '프리셋을 직접 만들거나 폴더에서 가져오세요.',
    ...
    delete: '삭제',
    // Confirm
    deleteTitle: '프리셋을 삭제하시겠습니까?',
    deleteBody: '{{name}}이(가) 영구적으로 삭제됩니다.',
    cancel: '취소',
    deleteConfirm: '삭제',
    // Sync-base modal
    baseSyncedTitle: '베이스 프로필이 동기화되었습니다',
    baseSyncFailedTitle: '동기화 실패',
    filesScanned: '{{n}}개 파일 스캔됨',
    statNew: '신규',
    statUpdated: '업데이트됨',
    statUnchanged: '변경 없음',
    close: '닫기',
    // Sync modal
    syncTitle: 'PC에 동기화',
    syncSubtitle: '변경 사항이 BambuStudio 필라멘트 폴더에 적용됩니다.',
    statRemoved: '제거됨',
    ...
    // Import
    scanFailed: 'BambuStudio 폴더를 읽는 중 오류 발생: {{error}}',
    allImported: '파일 {{n}}개를 찾았지만 모두 이미 가져왔습니다.',
    importing: '프리셋 가져오는 중… {{current}}/{{total}}',
    ...
    // Editor shell
    editorNewTitle: '새 프리셋',
    editorEditTitle: '프리셋 편집',
    inheritsNotFound: '(찾을 수 없음)',
    reload: '새로고침',
    serverChangedBanner: '편집하는 동안 이 프리셋이 서버에서 변경되었습니다.',
    serverChangedReload: '서버에서 새로고침',
    save: '저장',
    create: '만들기',
    saving: '저장 중…',
    nameRequiredHint: '브랜드와 재질이 필요합니다',
    deletePreset: '삭제',
    ...
    tabJson: 'JSON',
    // Editor General
    basePresetLabel: '베이스 프리셋',
    basePresetNone: '— 없음(비어 있는 상태로 시작) —',
    basePresetMine: '내 프리셋',
    basePresetBase: '베이스 프리셋',
    basePresetLoading: '로드 중…',
    brand: '브랜드',
    brandSelect: '— 선택 —',
    material: '재질',
    colorLabel: '색상 라벨',
    colorPlaceholder: '흰색, 검정…',
    nozzleSize: '노즐 크기',
    paKValue: 'PA K 값',
    cost: '비용',
    density: '밀도',
    ...
    extruder: '익스트루더',
    compatiblePrinters: '호환 프린터',
    tagHint: 'Enter로 추가 · Backspace로 제거',
    removeTag: '{{tag}} 제거',
    quickAdd: '+ H2S / H2D / H2C / X2D',
    tagPlaceholder: 'Bambu Lab X1C 0.4 노즐…',
    notes: '메모',
    // Editor Temps
    nozzleSection: '노즐',
    tempInitial: '초기',
    ...
    fanMin: '최소 속도',
    overhangFan: '오버행 속도',
    noFanLayers: '팬 없음(파트) 레이어',
    noFanAdditional: '팬 없음(추가) 레이어',
    initialFan: '첫 레이어 팬',
    minLayerTime: '최소 레이어 시간',
    overhangThreshold: '오버행 임계값',
    preStartFan: '팬 사전 시작',
    additionalFan: '추가 팬',
    overhangBridgeFan: '오버행/브리지 팬',
    chamberVent: '챔버 환기',
    duringPrint: '출력 중',
    endOfPrint: '출력 종료 시',
    nil: 'nil',
    ...
    flowRatio: '유량 비율',
    cal: '보정',
    calTitle: '유량 비율을 %로 조정',
    apply: '적용',
    maxVolFlow: '최대 체적 유량',
    primeVolume: '프라임 볼륨',
    shrinkage: '수축률',
    layerSlowdown: '레이어 감속',
    minTimePerLayer: '레이어당 최소 시간',
    minSpeed: '최소 속도',
    gcodeSection: 'G코드',
    startGcode: '시작 G코드',
    endGcode: '종료 G코드',
    ...
    zHopSpiral: '나선형 리프트',
    wipeDistance: '와이프 거리',
    retractBeforeWipe: '와이프 전 리트랙션',
    options: '옵션',
    retractOnLayerChange: '레이어 변경 시 리트랙트',
    wipeOnRetract: '리트랙트 시 와이프',
    // Editor JSON
    jsonCaption: '직접 편집 — 다른 탭이 자동으로 업데이트됩니다',
  },
  ...
  fileManager: {
    ...
    uploading: '업로드 중...',
    checkingDuplicates: '확인 중...',
    alreadyInLibrary: '이미 라이브러리에 있음',
    duplicateIn: '{{folder}} 내',
    duplicatesWillBeSkipped: '중복 파일 {{count}}개 감지됨 — 건너뜁니다',
    uploadAnyway: '그래도 업로드',
    skipDuplicate: '건너뛰기',
    skippedDuplicate: '건너뜀 (이미 라이브러리에 있음)',
    changeLink: '링크 변경...',
    linkTo: '연결 대상...',
    ...
    fileHistory: {
      menuLabel: '기록',
      title: '기록 — {{name}}',
      viewHistoryAria: '인쇄 기록 보기',
      noPermission: '파일 기록을 볼 권한이 없습니다',
      loadFailed: '파일 기록을 불러오지 못했습니다',
      statusPending: '대기 중',
      addedToLibrary: '라이브러리에 추가됨',
      bySomeone: '{{name}} 님이',
      noPrintsYet: '이 파일은 아직 인쇄되지 않았습니다.',
      externalUnavailable: '외부 파일은 인쇄 기록을 사용할 수 없습니다.',
      openArchive: '아카이브 열기',
      viewSource: '소스 페이지 열기',
      stats: {
        prints: '인쇄 횟수',
        success: '성공률',
        filament: '필라멘트',
    ...
    toast: {
      ...
      filesMoved: '파일 이동됨',
      moveSkipped: '{{moved}}개 이동, {{skipped}}개 건너뜀: {{reasons}}',
      moveSkipReason: {
        not_owner: '소유자가 아님',
        source_readonly: '원본이 읽기 전용임',
        source_missing: '디스크에서 파일을 찾을 수 없음',
        target_readonly: '대상이 읽기 전용임',
        target_misconfigured: '대상 폴더 설정 오류',
        target_inaccessible: '대상 폴더에 접근할 수 없음',
        target_unwritable: '대상 폴더에 쓸 수 없음',
        invalid_filename: '안전하지 않은 파일 이름',
        name_collision: '파일 이름 충돌',
        copy_failed: '복사 실패',
      },
      folderLinked: '폴더 연결됨',
  ...
  zoho: {
    title: 'Zoho Books',
    subtitle: 'Zoho Books를 연결하면 Aito 프로젝트를 고객과 연결하고 청구서를 동기화할 수 있습니다.',
    clientId: '클라이언트 ID',
    clientSecret: '클라이언트 시크릿',
    ...
    baseUrl: 'API 기본 URL',
    accountsUrl: '계정 URL',
    defaultContactId: '기본 고객 ID',
    defaultContactName: '기본 고객 이름',
    defaultContactHint: 'Aito 새 프로젝트 모달에서 미리 선택됩니다. 전화번호와 이메일은 이 연락처에 기록되지 않습니다.',
    secretSaved: '값이 저장되었습니다 — 유지하려면 비워 두세요',
    save: '저장',
    saved: 'Zoho 설정이 저장되었습니다',
    test: '연결 테스트',
    testOk: 'Zoho Books에 연결됨',
    testUnreachable: '구성되었지만 Zoho Books에 연결할 수 없습니다',
    testNotConfigured: 'Zoho Books가 구성되지 않았습니다'
  },

  heimdall: {
    title: 'Heimdall 결제',
    subtitle: 'Heimdall POS 브리지를 통해 모든 Aito 견적에 온라인 결제 링크를 발행합니다. 결제된 링크는 견적을 자동으로 수락합니다.',
    baseUrl: 'Heimdall 주소',
    token: 'API 토큰',
    tokenHint: '쓰기 전용 — 현재 토큰을 유지하려면 비워 두세요',
    depositPct: '계약금 (%)',
    depositPctDescription: '0이면 견적 전액을 청구하고, 그 외에는 이 비율만큼의 링크를 만듭니다.',
    validityDays: '견적 유효 기간 (일)',
    validityDaysDescription: '새 견적마다 기록되는 만료일이며, 결제 링크도 같은 날 종료됩니다.',
    save: '저장',
    saved: 'Heimdall 설정이 저장되었습니다',
    test: '연결 테스트',
    testOk: 'Heimdall에 연결되었습니다',
    testUnauthorized: 'Heimdall이 토큰을 거부했습니다',
    ...
    paymentModesTitle: 'Zoho 결제 방식 이름',
    paymentModesHint: '프로젝트 카드에서 기록하는 결제에 Zoho Books가 사용하는 이름입니다.',
    paymentModeCard: '카드',
    paymentModeCheque: '수표',
    paymentModeCash: '현금',
  },
  backup: {
  ...
  notifications: {
    ...
    aitoPaymentReceivedLabel: 'Aito 결제 수신',
    aitoPaymentReceivedDescription: 'Aito 견적이 온라인으로 또는 충분한 계약금으로 결제되면 알림',
    printFailed: '인쇄 실패',
    printStopped: '인쇄 중지됨',
  ...
  time: {
    ...
    today: '오늘',
    yesterday: '어제',
    daysElapsed_one: '{{count}}일 전',
    daysElapsed_other: '{{count}}일 전',
    monthsElapsed_one: '{{count}}개월 전',
    monthsElapsed_other: '{{count}}개월 전',
    yearsElapsed_one: '{{count}}년 전',
    yearsElapsed_other: '{{count}}년 전'
  },
  spoolbuddy: {
    nav: {
      dashboard: '대시보드',
  ...
  diagnostic: {
    ...
    check: {
      ...
      external_storage: {
        ...
        warn_internal_storage: '옵션이 켜져 있고 저장소도 있지만 마지막 출력물은 Fenrir가 읽을 수 없는 프린터 내부 저장소에 저장되었습니다. H2 시리즈, P2S, X2D에서는 이 설정과 관계없이 Bambu Studio의 «인쇄» 버튼이 항상 그쪽으로 보냅니다. 출력물은 이름과 시간과 함께 보관되지만 썸네일과 슬라이서 메타데이터는 없습니다. 완전한 기록을 남기려면 Fenrir에서 출력을 시작하거나, OrcaSlicer로 슬라이싱하거나, Bambu Studio에서 «보내기»로 «외부 저장소»를 고른 뒤 출력을 시작하세요.',
      ...
      macos_local_network: {
        ...
        pass: 'macOS가 Fenrir의 로컬 네트워크 접근을 허용하고 있습니다.',
        warn_unsigned: 'Fenrir를 실행하는 Python에 코드 서명이 없어 macOS가 로컬 네트워크 권한을 연결할 대상을 찾지 못하고, 프린터로 향하는 모든 연결을 오류도 확인 창도 없이 조용히 차단합니다. 서명을 수행하는 Fenrir 업데이트 스크립트(install/update_macos.sh)를 실행한 다음 Fenrir를 재시작하십시오. 인터프리터: {{executable}}',
        warn_permission: '프린터가 켜져 있고 이 주소로 연결할 수 있다면 시스템 설정 > 개인 정보 보호 및 보안 > 로컬 네트워크를 열어 Fenrir의 Python이 활성화되어 있는지 확인하십시오. 활성화되어 있지 않으면 macOS는 로컬 연결을 조용히 차단하며, Python을 업데이트하면 이전 권한이 남지 않을 수 있습니다.',
      },
      network_mode: {
        title: '컨테이너 네트워크 모드',
        genericRuntime: '컨테이너',
        pass: '{{runtime}}에서 호스트 네트워크로 실행 중입니다.',
        warn: 'Fenrir가 {{runtime}}에서 브리지 네트워크로 실행 중입니다. 프린터 검색과 가상 프린터에는 호스트 네트워크가 필요합니다 — 호스트 네트워크로 컨테이너를 재생성하세요(docker-compose에서는 "network_mode: host", Podman에서는 "--network=host").',
        skip: '컨테이너에서 실행 중이 아닙니다 — 해당 없음.',
        skip_unknown: 'Fenrir가 {{runtime}}에서 실행 중이지만 네트워크 모드를 확인할 수 없습니다. 프린터 검색이나 가상 프린터가 작동하지 않으면 호스트 네트워크로 컨테이너를 재생성하세요.',
        skip_system_container: 'Fenrir가 {{runtime}} 시스템 컨테이너에서 실행 중이며, 가상 머신처럼 LAN에 연결되어 있습니다 — 해당 없음.'
      },
      subnet: {
        title: '네트워크 서브넷',
  ...
  calculator: {
    ...
    material: '재료',
    title: '계산기',
    subtitle: '3D 프린팅 비용과 판매 가격을 계산합니다',
    easyMode: '간편 모드',
    reset: '초기화',
    resetConfirmTitle: '입력 초기화',
    resetConfirmMessage: '계산기의 모든 입력을 기본값으로 되돌리시겠습니까? 필라멘트, 프린터, 기본값은 유지됩니다.',
    informations: '기본 정보',
    weight: '개체 무게',
    printingTime: '출력 시간 (h)',
    printingTimeLabel: '출력 시간',
    durationDays: '일',
    durationDaysShort: '일',
    durationHours: '시간',
    durationHoursShort: '시',
    durationMinutes: '분',
    durationMinutesShort: '분',
    emptyInputsTitle: '무게와 출력 시간을 입력하세요',
    emptyInputsMessage: '물체 무게와 출력 시간을 입력하면 추천 가격과 비용 내역이 표시됩니다.',
    targetPrice: '목표 가격',
    targetPriceLabel: '목표 가격(세금 포함)',
    targetPriceProfit: '순마진',
    measuredEnergy: '측정된 에너지: {{kwh}} kWh (아카이브에서)',
    measuredEnergyClear: '측정된 에너지 지우기',
    qtyIncrease: '수량 늘리기',
    qtyDecrease: '수량 줄이기',
    fixErrors: '잘못된 입력이 있습니다. 강조 표시된 필드를 수정하세요. 잘못된 값은 결과에 반영되지 않습니다.',
    breakEvenDiscount: '손익분기 할인율: {{pct}} — 이보다 큰 할인은 원가 이하 판매입니다.',
    laborAmortized: '모델링과 준비는 일회성 비용으로 {{count}}개에 분할됩니다.',
    copySummary: '요약 복사',
    summaryCopied: '요약이 클립보드에 복사되었습니다',
    summaryCopyFailed: '복사 실패 — 클립보드 접근이 차단되었습니다',
    easyAssumptions: '저장된 요율 기준 — 기본값 확인',
    quantity: '수량',
    filament: '필라멘트',
    printer: '프린터',
    difficulty: '난이도 계수 (%)',
    difficultyTooltip: '까다로운 출력에 대한 배수: 연마성 필라멘트, 높은 실패 위험, 섬세한 취급 등. 100% = 추가 요금 없음.',
    labor: '인건비',
    modeling: '모델링',
    workingHours: '작업 시간',
    basePrice: '기본 가격',
    preparation: '준비',
    modelPreparation: '모델 준비',
    slicing: '슬라이싱',
    transferStart: '전송 및 시작',
    postProcessing: '후처리',
    jobRemoval: '출력물 제거',
    supportRemoval: '서포트 제거',
    additionalWork: '추가 작업',
    fulfillment: '배송',
    stuff: '기타 소모품',
    amount: '금액',
    markupPct: '가산율',
    totals: '합계',
    machineCost: '기기 비용',
    machineCostSafety: '안전 여유 포함 기기 비용',
    costsSoFar: '누적 비용',
    totalHT: '합계 (세전)',
    totalTTC: '합계 (세후)',
    byPrinter: '프린터별 가격',
    ...
    realityCheck: {
      title: '실측 확인',
      subtitle: '실제 인쇄, 설정, 재고에서 측정한 값입니다.',
      failure: '실패율',
    ...
    timeCorrection: {
      ...
      hintScoped: '{{scope}}는 슬라이서 추정치의 평균 {{pct}}%를 기록합니다',
      apply: '보정된 시간 적용',
      dismiss: '닫기',
    },
    waterfall: {
      tax: '세금',
      aria: '비용에서 최종 가격까지의 가격 구성',
    },
    quote: {
      open: '인쇄용 견적 열기',
      back: '계산기로 돌아가기',
      print: '인쇄',
      title: '견적서',
      empty: '아직 견적할 작업이 없습니다. 먼저 계산기를 입력하세요.',
      jobDetails: '작업 정보',
      footnote: '가격은 세금 포함입니다. 견적은 자재 수급 상황에 따라 달라질 수 있습니다.',
    },
    marge: '마진',
    marginPct: '마진율',
    marginGlobal: '전체 마진',
    marginFilament: '필라멘트 마진',
    marginStuff: '기타 소모품 마진',
    perUnit: '개당',
    forQuantity: '{{count}}개 합계',
    breakdown: '비용 내역',
    costSplit: '비용 구성',
    costFilament: '필라멘트',
    costDepreciation: '프린터 감가상각',
    costEnergy: '전기',
    costConsumables: '소모품 및 포장',
    costBaseFee: '기본 요금',
    costRepairs: '수리',
    costPrototype: '프로토타입',
    costFailures: '실패',
    ...
    groupLabor: '인건비',
    splitPrinter: '프린터',
    splitAdsConsumables: '광고 및 소모품',
    discountTitle: '할인 계산',
    discountMachine: '할인 적용 기기 비용',
    discountSafety: '할인 적용 안전 비용',
    discountPrice: '할인 적용 가격',
    discountAmount: '할인 금액',
    potentialProfit: '예상 이익',
    bulkQuantity: '수량',
    emptyTitle: '계산기 설정하기',
    emptyMessage: '가격 계산을 시작하려면 필라멘트와 프린터를 각각 하나 이상 추가하세요.',
    ...
    tabPrinters: '프린터',
    name: '이름',
    costPerKg: 'kg당 비용 ({{currency}})',
    printingCostPerKg: 'kg당 인쇄 비용 ({{currency}})',
    marginOverCost: '비용 대비 마진 (%)',
    zohoProductSearch: 'Zoho 제품',
    zohoProductSearchPlaceholder: 'Zoho에서 필라멘트 검색…',
    zohoNoDealerPrice: '딜러 가격 없음',
    zohoNoResults: '일치하는 Zoho 필라멘트가 없습니다',
    zohoSearchError: 'Zoho에 연결할 수 없습니다',
    zohoLinkedProduct: '{{name}}에 연결됨',
    zohoUnlink: '연결 해제',
    zohoWeightInferred: 'Zoho 이름에 스풀 무게가 없어 1kg으로 가정했습니다',
    spoolWeightKg: '스풀 무게 (kg)',
    ...
    addFilament: '필라멘트 추가',
    editFilament: '필라멘트 편집',
    deleteFilamentTitle: '필라멘트 삭제',
    deleteFilamentMessage: '"{{name}}"을(를) 삭제하시겠습니까? 이 작업은 되돌릴 수 없습니다.',
    filamentCreated: '필라멘트가 추가되었습니다',
    filamentUpdated: '필라멘트가 업데이트되었습니다',
    filamentDeleted: '필라멘트가 삭제되었습니다',
    purchasePrice: '구매 가격 ({{currency}})',
    lifetimeYears: '수명 (년)',
    dailyUsage: '일일 사용 시간 (h)',
    powerWatts: '소비 전력 (W)',
    repairRate: '수명 기간 수리비 (%)',
    lifetimeHours: '수명 시간',
    depreciationPerHour: '감가상각 / h',
    repairsPerHour: '수리비 / h',
    addPrinter: '프린터 추가',
    editPrinter: '프린터 편집',
    deletePrinterTitle: '프린터 삭제',
    deletePrinterMessage: '"{{name}}"을(를) 삭제하시겠습니까? 이 작업은 되돌릴 수 없습니다.',
    printerCreated: '프린터가 추가되었습니다',
    printerUpdated: '프린터가 업데이트되었습니다',
    printerDeleted: '프린터가 삭제되었습니다',
    inUse: '계산기 페이지에서 선택됨',
    electricityTariff: '전기 요금 ({{currency}}/kWh)',
    laborRate: '인건비 단가 ({{currency}}/h)',
    consumablesFlat: '소모품 및 포장 ({{currency}})',
    baseFee: '기본 요금 ({{currency}})',
    marginCurveHint: '두 곡선이 전체 마진을 결정합니다. 부품 단가가 오를수록 줄어드는 크기 마진과, 수량이 늘수록 원가가 아닌 마진을 깎는 수량 할인입니다.',
    sizeMarginGroup: '크기 마진',
    qtyDiscountGroup: '수량 할인',
    floorGroup: '최소값',
    marginMinMult: '매우 큰 부품의 배율 (M_MIN)',
    marginMaxMult: '매우 작은 부품의 배율 (M_MAX)',
    marginK: '중간 지점 단가 (K, {{currency}})',
    qtyMinFactor: '대량 주문 시 유지되는 마진 (Q_MIN)',
    qtyK: '중간 지점 수량 (KQ)',
    minTaskPrice: '작업당 최소 가격 ({{currency}})',
    marginCurveMaxBelowMin: 'M_MAX는 M_MIN 이상이어야 합니다',
    marginCurvePreviewSize: '단가별 크기 마진',
    marginCurvePreviewQty: '수량별 수량 계수',
    exampleTitle: '예시 작업',
    ...
    formulaAt: '{{x}}에서 → {{y}}',
    warnFlatSize: '크기 곡선이 평평합니다: 모든 부품이 ×{{m}}을 받습니다.',
    warnKFar: 'K가 예시 비용보다 훨씬 높아 작업이 위치한 구간에서 곡선이 거의 휘지 않습니다.',
    ...
    multiplier: '×{{value}}',
    multiplierDetail: '크기 ×{{size}} · 수량 {{qty}}',
    floorApplied: '최소 가격 적용됨',
    curveTitle: '수량별 가격',
    curveHint: '각 수량에서의 단가(세금 포함) — 일회성 비용은 분산되고 수량 할인이 마진을 줄입니다.',
    curveUnitPrice: '단가',
    curveTaskPrice: '작업 합계',
    curveQtyFactor: '수량 계수',
    curveCurrent: '현재',
    failureRate: '실패율 (%)',
    prototypeRate: '프로토타입 비율 (%)',
    adsRate: '광고 비율 (%)',
    filamentMarkup: '필라멘트 가산율 (%)',
    taxPct: '세금 TGC (%)',
    defaultDifficulty: '기본 난이도 (%)',
    defaultMargin: '기본 비용 대비 마진 (%)',
    filamentSettings: '필라멘트 설정',
    filamentSettingsHint: '새 필라멘트 프로필의 초기값입니다.',
    stuffMarkup: '소모품 가산율 (%)',
    ratesTitle: '단가',
    ratesHint: '작업에 드는 실제 비용 — 견적 전에 현지 가격과 통화에 맞추세요.',
    provisionsTitle: '충당금 및 간접비',
    provisionsHint: '실패한 출력, 시제품, 광고, 필라멘트와 추가 품목의 재판매 가산을 충당하기 위해 원가에 더하는 비율입니다.',
    unsavedChanges_one: '저장하지 않은 변경 {{count}}개',
    unsavedChanges_other: '저장하지 않은 변경 {{count}}개',
    fixFields: '저장하려면 강조된 항목을 수정하세요.',
    discardChanges: '취소',
    tabSettings: '설정',
