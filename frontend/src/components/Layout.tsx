...
import { Printer, Archive, Calendar, BarChart3, Cloud, Settings, Sun, Moon, ChevronLeft, ChevronRight, Keyboard, Github, GripVertical, ArrowUpCircle, Wrench, FolderKanban, FolderOpen, X, Menu, Info, Plug, Bug, LogOut, Key, Loader2, Disc3, ShieldAlert, ClipboardList, type LucideIcon } from 'lucide-react';
...
export const defaultNavItems: NavItem[] = [
  { id: 'todo', to: '/todo', icon: ClipboardList, labelKey: 'nav.todo' },
