...
function openBlobInNewTab(blob: Blob): void {
  ...
  // named fenrir-labels.pdf). Two identical PDFs per click — issue #1628.
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start sm:items-center justify-center p-4 overflow-y-auto">
      ...
      <div
        ...
        className="relative w-full max-w-3xl bg-bambu-dark-secondary border border-bambu-dark-tertiary rounded-xl shadow-2xl max-h-[90vh] overflow-clip flex flex-col my-auto animate-modal-in"
      >
        {/* Header */}
