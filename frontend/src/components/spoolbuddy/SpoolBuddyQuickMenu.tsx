...
export function SpoolBuddyQuickMenu({ isOpen, onClose, deviceId, deviceOnline }: SpoolBuddyQuickMenuProps) {
  ...
  return (
    <>
      ...
      {/* Confirmation Dialog */}
      {pendingConfirm && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/60 animate-overlay-in">
          <div className="bg-zinc-800 rounded-2xl p-5 mx-4 max-w-sm w-full border border-zinc-700 animate-modal-in">
