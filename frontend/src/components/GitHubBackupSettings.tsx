                    ...
                    <div className="text-xs text-red-700 dark:text-red-400 bg-red-50 dark:bg-red-500/10 border border-red-300 dark:border-red-500/30 rounded p-2 flex items-start gap-1.5">
                      ...
                      <span>
                        {t(
                          ...
                          'Repository is PUBLIC. Fenrir backups include MQTT credentials, Home Assistant tokens, Prometheus tokens, your Bambu Cloud email, and printer access codes via K-profiles. Saving is blocked until you make the repository private in your provider\'s settings.',
                        )}
                      </span>
                    </div>
                  )}
                    ...
                    <div className="text-xs text-yellow-700 dark:text-yellow-400 bg-yellow-50 dark:bg-yellow-500/10 border border-yellow-300 dark:border-yellow-500/30 rounded p-2 flex items-start gap-1.5">
                      ...
                      <span>
                        {t(
                          ...
                          'Could not determine repository visibility. Fenrir refuses to back up to anything not confirmed private; saving will be blocked.',
                        )}
                      </span>
                    </div>
                  )}
