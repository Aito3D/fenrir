...
// use Fenrir's thumbnail proxy. MakerWorld summaries are authored HTML and
// commonly contain ``<img src="https://makerworld.bblmw.com/...">`` tags;
// Fenrir's img-src CSP only allows ``'self' data: blob:``, so these would
...
// MakerWorld CDN images can't be hotlinked — Fenrir's img-src CSP blocks
          ...
          <CardContent>
            <div className="grid gap-3">
              {instances.map((inst, idx) => {
                ...
                // — Fenrir can't actually re-slice across printers, but
                    ...
                    >
                      {item.thumbnail_path ? (
                        <img
                          ...
                          alt=""
                          className="w-12 h-12 shrink-0 object-cover rounded bg-gray-100 dark:bg-gray-800 brightness-125 contrast-110"
                          loading="lazy"
                        />
                      ) : (
