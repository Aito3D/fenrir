...
// (now sourced from `fenrir:dispatch-toast` window events that
...
export function ToastProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    window.addEventListener('fenrir:dispatch-toast', onDispatchEvent);
    return () => window.removeEventListener('fenrir:dispatch-toast', onDispatchEvent);
  }, [t]);
