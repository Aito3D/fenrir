...
Fenrir keeps a local location catalog. When Spoolman integration is enabled:
...
4. Companion PR in [fenrir-wiki](https://github.com/maziggy/bambuddy-wiki) (user-facing guide)
