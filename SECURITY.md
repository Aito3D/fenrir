...
The Fenrir team takes security seriously. We appreciate your efforts to responsibly disclose your findings.
...
Fenrir communicates with your printers over your local network using:
...
1. **Run on trusted network**: Fenrir should only be accessible on your local network
...
Anywhere a Fenrir code path joins a string from outside the function's
...
the routes verbatim and from external sources Fenrir has no control
...
Thank you for helping keep Fenrir and its users safe!
